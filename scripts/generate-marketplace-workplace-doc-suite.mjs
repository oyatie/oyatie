...
const SERVICES = [
  {
    slug: "marketplace",
    title: "Marketplace",
    crate: "oya-marketplace-doc-suite-scaffold",
    ...
    precedent:
      "SAP Ariba procurement network, Coupa spend management, Stripe Connect platform settlement, Salesforce Commerce Cloud enterprise commerce",
    scope:
  ...
  },
  {
    ...
    crate: "oya-workplace-integration-doc-suite-scaffold",
...
function docFrontmatter(service, docClass, extra = {}) {
  const entries = [
    ...
    ["planned_enforcement_ref", `oya-governance-${service.slug}-doc-suite`],
    [
...
The 12-layer-enum subset used by this suite is ${LAYERS_12.join(", ")}.
...
The suite cross-references ${journeys.length} existing journey IP files and treats them as product anchors, not as isolated notes.
...
`;
  ...
  content += `- ${service.title} is not an ERP suite; flat ownership remains per ADR-0131 and ADR-0132.\n`;
  ...
  return JSON.stringify(
    {
      ...
      schemaVersion: 39,
      tags: [service.slug, "pr-143-doc-suite", service.primaryAdr],
      timezone: "utc",
      naming_justifications: {
  ...
  return JSON.stringify(
    {
      ...
      artifact_bar: {
        ...
        generated_suite_target: "at-or-above-operating-bar",
      },
      naming_justifications: {
...
edition = "2021"
publish = false
description = "${service.title} documentation-suite scaffold crate"
...
function generateService(service, stats) {
  ...
  const topDocs = [
    ["PHASE-01-DOC-SUITE-CLOSURE.md", "Phase 01 Doc Suite Closure", "Defines entry criteria, ChangeSet order, and validation evidence for closing the PR-143 documentation gap."],
    ...
    ["CHANGELOG.md", "Changelog", "Records creation of the PR-143 operating-bar suite on 2026-05-20."],
  ...
  writeFile(path.join(root, "scorecards", "overrides.json"), JSON.stringify({
    service: service.slug,
    scorecards: ["doc-suite-completeness", "contract-version-exact", "tenant-scope", "cedar-default-deny", "audit-evidence"],
    naming_justifications: {
