...
mod tests {
    ...
    #[test]
    fn scan_ignores_sanctioned_git_surface() {
    ...
    #[test]
    fn scan_command_invocation_allows_sanctioned_bin_git_surface() {
    ...
    #[test]
    fn scan_command_invocation_allows_sanctioned_git_surface() {
        let scan = scan_command_invocation(CommandInvocation {
            source: "registry/governance-corpora/banned-primitives/command-log.v1.jsonl".into(),
            line: 1,
    ...
    #[test]
    fn scan_command_invocation_rejects_previous_segment_before_git_push() {
        let scan = scan_command_invocation(CommandInvocation {
    ...
    #[test]
    fn scan_command_invocation_rejects_non_command_head_before_git_push() {
        let scan = scan_command_invocation(CommandInvocation {
            source: "registry/governance-corpora/banned-primitives/reject-laundered-push.jsonl"
                .into(),
            line: 1,
