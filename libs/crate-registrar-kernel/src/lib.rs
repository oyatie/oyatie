//! # crate-registrar-kernel (ADR-0568)
//!
...
pub struct RegisterCrateRequest {
    /// Repo-relative crate directory, e.g. `libs/crate-registrar-kernel`.
...
mod tests {
    ...
    const DIR: &str = "libs/crate-registrar-kernel";
    ...
    fn role_suffix_mismatch_is_rejected() {
        ...
        assert_eq!(
            ...
            ValidationError::RoleSuffixMismatch {
                leaf: "crate-registrar-kernel".to_owned(),
