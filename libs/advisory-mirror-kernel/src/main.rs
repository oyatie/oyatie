//! advisory-mirror-producer (data-gen, OPERATIONAL — not the hermetic gate).
//!
...
//!
//! Usage:
//!   advisory-mirror-producer --advisory-db <checkout> --repo <url> --commit <sha> \
...
use advisory_mirror_kernel::{Advisory, MIRROR_SCHEMA, canonical_hash, distill};
...
fn usage() -> String {
    "usage: advisory-mirror-producer --advisory-db <checkout> --repo <url> --commit <sha> --last-sync <iso-date> --out-dir <dir>".to_owned()
}
