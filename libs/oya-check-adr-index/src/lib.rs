...
fn render_markdown(records: &[AdrDecisionRecord], report: &AdrIndexReport) -> String {
    ...
    out.push_str("> **Generated:** from [`decisions/`](decisions/) by the Rust/Buck2 ADR index generator. Do not hand-edit generated rows.\n");
...
fn render_json(records: &[AdrDecisionRecord], report: &AdrIndexReport) -> String {
    ...
    out.push_str("    \"description\": \"Machine-readable mirror of ADR-INDEX.md. Generated by the Rust/Buck2 ADR index generator.\",\n");
...
mod tests {
    ...
    fn generates_markdown_and_json_from_decision_records() {
        ...
        assert!(!artifacts.markdown.contains("oya doc adr-index"));
        assert!(
            artifacts
                .markdown
        ...
        assert!(
            artifacts
                .json
                .contains("Generated by the Rust/Buck2 ADR index generator")
        );
        assert!(!artifacts.json.contains("oya doc adr-index"));
