...
pub struct ServiceConfig {
    ...
    pub enable_lineage_shadow_graph: bool,
}

impl Default for ServiceConfig {
    fn default() -> Self {
        Self {
            service_name: "data-pipeline".to_owned(),
            bind_addr: "127.0.0.1:8085".to_owned(),
            grpc_addr: "127.0.0.1:9085".to_owned(),
            asyncapi_topic_prefix: "data-pipeline".to_owned(),
...
impl ServiceConfig {
            ...
            config.max_ingest_payload_bytes =
                value
                    ...
                    .map_err(|parse_error| ServiceError::InvalidConfig {
                        field: "max_ingest_payload_bytes",
    ...
    pub fn validate(&self) -> ServiceResult<()> {
        ...
        if self.max_ingest_payload_bytes < 4096 {
