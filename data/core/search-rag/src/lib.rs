...
use data_search_query::{QueryLocale, QueryPlan};
use data_search_serp::SerpResponse;
...
mod tests {
    use super::*;
    use data_search_query::{QueryMode, QueryPlanCreate};
    use data_search_rank::{RankedHit, RankedHitCreate};
