...
use data_search_query::QueryPlan;
use data_search_rank::RankedHit;
...
mod tests {
    use super::*;
    use data_search_query::{QueryLocale, QueryMode, QueryPlanCreate};
    use data_search_rank::RankedHitCreate;
