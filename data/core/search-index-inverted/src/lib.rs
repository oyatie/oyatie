...
use data_search_parser::{MorphologyLocale, ParsedDocument};
...
mod tests {
    use super::*;
    use data_search_crawler::{CrawlPriority, CrawlScheme, CrawlTarget, CrawlTargetCreate};
    use data_search_parser::{MorphologyToken, ParsedDocumentCreate, PartOfSpeech};
    use std::collections::BTreeMap;
