...
# Buck2 root BUCK keeps active policy inputs explicit so retired service
# CI entrypoints cannot re-enter as command-scan surfaces.
genrule(
    ...
    srcs = {
        ...
        "scripts/ci/assert-adr-hygiene.rs": "scripts/ci/assert-adr-hygiene.rs",
        "scripts/tests/adr_hygiene_check.rs": "scripts/tests/adr_hygiene_check.rs",
...
genrule(
    ...
    srcs = {
        ...
        "specs/multi-region-disposition-canonical.json": "specs/multi-region-disposition-canonical.json",
        "specs/microservice-migration-tooling.json": "specs/microservice-migration-tooling.json",
        "specs/retired-external-substrate-registry.json": "specs/retired-external-substrate-registry.json",
        "specs/root-hub-pointers.json": "specs/root-hub-pointers.json",
        "specs/github-lane-unlocker-bridge.json": "specs/github-lane-unlocker-bridge.json",
        "specs/buck2-authority-policy.json": "specs/buck2-authority-policy.json",
        ...
        "templates/capability-record-template.yaml": "templates/capability-record-template.yaml",
        "templates/checklists/agent-completion-checklist.md": "templates/checklists/agent-completion-checklist.md",
        "templates/checklists/agent-kickoff-checklist.md": "templates/checklists/agent-kickoff-checklist.md",
        "templates/checklists/cross-axis-contract-change-checklist.md": "templates/checklists/cross-axis-contract-change-checklist.md",
        "templates/checklists/doc-freshness-checklist.md": "templates/checklists/doc-freshness-checklist.md",
        "templates/checklists/done-definition-checklist.md": "templates/checklists/done-definition-checklist.md",
        "templates/checklists/escalation-checklist.md": "templates/checklists/escalation-checklist.md",
        "templates/checklists/inventory-update-checklist.md": "templates/checklists/inventory-update-checklist.md",
        "templates/checklists/per-implementation-plan-checklist.md": "templates/checklists/per-implementation-plan-checklist.md",
        "templates/checklists/per-phase-completion-checklist.md": "templates/checklists/per-phase-completion-checklist.md",
        "templates/checklists/pr-review-checklist.md": "templates/checklists/pr-review-checklist.md",
        "templates/checklists/pre-flight-checklist.md": "templates/checklists/pre-flight-checklist.md",
        "templates/checklists/pre-pr-multispectrum.json": "templates/checklists/pre-pr-multispectrum.json",
        "templates/checklists/pre-pr-multispectrum.md": "templates/checklists/pre-pr-multispectrum.md",
        "templates/checklists/release-readiness-checklist.md": "templates/checklists/release-readiness-checklist.md",
        "templates/design-doc-template.md": "templates/design-doc-template.md",
        "templates/evidence-bundle-template.json": "templates/evidence-bundle-template.json",
        "templates/foundry-supervisor/claude.toml": "templates/foundry-supervisor/claude.toml",
        "templates/foundry-supervisor/codex.toml": "templates/foundry-supervisor/codex.toml",
        "templates/foundry-supervisor/gemini.toml": "templates/foundry-supervisor/gemini.toml",
        "templates/implementation-plan-template.md": "templates/implementation-plan-template.md",
        "templates/milestone-index-template.md": "templates/milestone-index-template.md",
        "templates/mistakes-ledger-row-template.md": "templates/mistakes-ledger-row-template.md",
        "templates/phase-index-template.md": "templates/phase-index-template.md",
        "templates/postmortem-template.md": "templates/postmortem-template.md",
        "templates/prfaq-template.md": "templates/prfaq-template.md",
...
genrule(
    ...
    srcs = {
        ...
        "registry/vcs/README.md": "registry/vcs/README.md",
        "registry/vcs/event-router.yaml": "registry/vcs/event-router.yaml",
        "registry/vcs/concurrent-safe-paths.yaml": "registry/vcs/concurrent-safe-paths.yaml",
        "docs/standards/kubernetes-desired-state-authority.md": "docs/standards/kubernetes-desired-state-authority.md",
        "docs/standards/helm-chart-convention.md": "docs/standards/helm-chart-convention.md",
        "docs/standards/hyperscaler-invariant-conformance.md": "docs/standards/hyperscaler-invariant-conformance.md",
        "docs/standards/image-signing-canonical.md": "docs/standards/image-signing-canonical.md",
        "docs/standards/regulatory-pack-authzpolicy-overlays.md": "docs/standards/regulatory-pack-authzpolicy-overlays.md",
        "docs/standards/stream-processing-rubric.md": "docs/standards/stream-processing-rubric.md",
        "docs/standards/timescaledb-adoption.md": "docs/standards/timescaledb-adoption.md",
        "specs/csi-storage-class-canonical.json": "specs/csi-storage-class-canonical.json",
        "specs/microservices/scorecards/canonical/aws-well-architected.json": "specs/microservices/scorecards/canonical/aws-well-architected.json",
        "specs/microservices/scorecards/canonical/cis-k8s-benchmark.json": "specs/microservices/scorecards/canonical/cis-k8s-benchmark.json",
        "specs/microservices/scorecards/canonical/google-sre-prr.json": "specs/microservices/scorecards/canonical/google-sre-prr.json",
        "specs/per-microservice-flat-layout.json": "specs/per-microservice-flat-layout.json",
...
genrule(
    ...
    srcs = {
        ...
        "specs/service-inventory.json": "specs/service-inventory.json",
        "specs/phase0-structural-packets.json": "specs/phase0-structural-packets.json",
    } | {path: path for path in glob(["specs/fixtures/phase0-service-root-classifier/*.json", "oya/*", "cloud/*", "libs/*", "packs/*", "cloud/cloud-iac/sovereign-cloud-overlays/*", "platforms/*"])},
