# Imaging VNA Failover Runbook

## Purpose

Restore Imaging tenant service within the manifest DR target while preserving tenant isolation, audit evidence, and declared backup-substrate order.
...
- RPO p99 seconds: 0
- Active-active: true
- Backup substrates: postgres_wal_g, object_storage_versioned, seaweedfs_replicated, audit_chain_merkle_seal
...
3. Restore or replay substrates in this order: postgres_wal_g -> object_storage_versioned -> seaweedfs_replicated -> audit_chain_merkle_seal.
