...
SCOPE-002: Lifecycle state is PROPOSED for `drive` until the service-owned wrapper files under `storage/drive/iac/<context>/main.tf` invoke signed cloud-iac modules and implementation evidence is reviewed.
