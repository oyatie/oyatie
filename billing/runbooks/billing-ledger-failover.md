# cloud-billing DR Failover Runbook

## Purpose
Restore the cloud-billing service to the manifest-declared RTO/RPO without changing tenant isolation, compliance-pack placement, or audit-chain evidence.
...
## Exit Criteria
- RTO <= 900s and RPO <= 60s are met or an incident exception is opened.
