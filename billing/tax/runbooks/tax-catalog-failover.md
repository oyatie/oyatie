# cloud-billing-tax DR Failover Runbook

## Purpose
Restore the cloud-billing-tax service to the manifest-declared RTO/RPO without changing tenant isolation, compliance-pack placement, or audit-chain evidence.
...
- Manifest runtime tier 2 and cell placement Tier-3 remain unchanged.
