...
cloud-k8s owns namespace isolation, admission labels, and policy workload placement for j100-pack-rollout-from-tenant-onboarding-to-first-action. The slice is a flat per-microservice implementation plan under k8s/, matching ADR-0131.
