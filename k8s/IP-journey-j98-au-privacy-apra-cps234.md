...
cloud-k8s owns namespace isolation, admission labels, and policy workload placement for j98-au-privacy-apra-cps-234-tenant. The slice is a flat per-microservice implementation plan under k8s/, matching ADR-0131.
