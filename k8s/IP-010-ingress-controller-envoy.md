...
owner: axis-cloud
acceptance_lanes: [cargo-check, cargo-build, cargo-clippy, cargo-nextest, cargo-deny, lean-a1, layer-correctness, check-envoy-tls-13-only]
---

<!-- Canonical-base: specs/ip/canonical-frontmatter-schema.json + docs/templates/ip-boilerplate-fragments.md (SWEEP-I Slice 6 per ADR-0064) -->

# IP-010: cloud-k8s-ingress-controller-{kernel,usecase,adapter-envoy}
...
| Path | Action |
|---|---|
| `microservices/cloud-k8s/src/crates/cloud-k8s-ingress-controller-kernel/{Cargo.toml,src/*}` | create |
| `.../cloud-k8s-ingress-controller-usecase/{Cargo.toml,src/{lib.rs,apply_gateway.rs,apply_virtualservice.rs}}` | create |
| `.../cloud-k8s-ingress-controller-adapter-envoy/{Cargo.toml,src/{lib.rs,gateway_cr.rs,vs_cr.rs,dr_cr.rs}}` | create |
| `microservices/cloud-k8s/catalog/cloud-k8s-ingress-controller-{kernel,usecase,adapter-envoy}.yaml` | create |

## Crate Naming

```
NAMES: cloud-k8s-ingress-controller-{kernel,usecase,adapter-envoy}
...
cargo run -p dev-cli -- gate validate envoy-tls-13-only --microservice cloud-k8s
```
