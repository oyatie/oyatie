...
| CC1.3 | Organizational structure | RACI matrix per µservice | `iac/CODEOWNERS` (Slice C) |
...
**SLSA L3 verification at apply-time:** Every chart applied by cloud-iac must have a valid SLSA L3 attestation verifiable against Sigstore Fulcio + Rekor; unsigned charts refused at iac-applier-worker per ISO-05. The CI lane `oya-cloud-iac-provenance-slsa-l3` validates the attestation chain.
...
- `iac/evidence/multispectrum/<change_id>-<unix_ts>.json` — per-changeset evidence
...
- cloud-ci/oya-ci governance gate `compliance-evidence-recency` is green in the branch-protected `oya-ci-required` context — exit 0.
- cloud-ci/oya-ci governance gate `authority-cohesion` is green in the branch-protected `oya-ci-required` context — exit 0.
...
- `iac/threat-model.md`.
- `iac/dpia.md`.
- `iac/policy/{iac-isolation, data-residency}.md`.
- `iac/policy/*.cedar`.
- `iac/incident-response.md`.
...
- Primary evidence files: `iac/slos/helm-chart-lint-correctness.openslo.yaml`, `iac/slos/iac-apply-latency.openslo.yaml`, `iac/slos/iac-render-latency.openslo.yaml`, `iac/slos/iac-rollback-latency.openslo.yaml`, `iac/slos/iac-validator-availability.openslo.yaml`, `iac/slos/slsa-provenance-completeness.openslo.yaml`; +11 more.
...
- Pack overlays modify Cedar fragments `iac/policy/auditor-scope.cedar`, `iac/policy/ci-scope.cedar`, `iac/policy/data-residency.md`, `iac/policy/iac-isolation.md`, `iac/policy/public-read.cedar`, `iac/policy/tenant-scope.cedar` without changing domain code.
...
- Surfaces audited for display strings: `iac/contracts/asyncapi/cloud-iac-events.yaml`, `iac/contracts/openapi/cloud-iac.yaml`, `iac/contracts/proto/cloud-iac.proto`, `iac/runbooks/drift-remediation.md`, `iac/runbooks/gitops-reconciler-restart.md`, `iac/runbooks/registry-restore.md`; +17 more.
...
- Signal sources: `iac/policy/auditor-scope.cedar`, `iac/policy/ci-scope.cedar`, `iac/policy/data-residency.md`, `iac/policy/iac-isolation.md`, `iac/policy/public-read.cedar`, `iac/policy/tenant-scope.cedar`; +9 more.
...
- Sensitive surfaces: `iac/contracts/asyncapi/cloud-iac-events.yaml`, `iac/contracts/openapi/cloud-iac.yaml`, `iac/contracts/proto/cloud-iac.proto`, `cloud_iac.cloud_iac`.
...
- Enforcement points: `iac/policy/auditor-scope.cedar`, `iac/policy/ci-scope.cedar`, `iac/policy/data-residency.md`, `iac/policy/iac-isolation.md`, `iac/policy/public-read.cedar`, `iac/policy/tenant-scope.cedar`; +12 more.
...
- Runbook evidence: `iac/runbooks/drift-remediation.md`, `iac/runbooks/gitops-reconciler-restart.md`, `iac/runbooks/registry-restore.md`, `iac/runbooks/restore-drill-quarterly.md`, `iac/runbooks/rollback-orchestration.md`, `iac/runbooks/seaweedfs-volume-failover.md`; +2 more.
...
- Affected surfaces: `iac/contracts/asyncapi/cloud-iac-events.yaml`, `iac/contracts/openapi/cloud-iac.yaml`, `iac/contracts/proto/cloud-iac.proto`, `iac/iac/helm/argocd/Chart.yaml`, `iac/iac/helm/argocd/templates/.gitkeep`, `iac/iac/helm/argocd/values.yaml`; +9 more.
...
- In-scope assets: `iac/contracts/asyncapi/cloud-iac-events.yaml`, `iac/contracts/openapi/cloud-iac.yaml`, `iac/contracts/proto/cloud-iac.proto`, `iac/iac/helm/argocd/Chart.yaml`, `iac/iac/helm/argocd/templates/.gitkeep`, `iac/iac/helm/argocd/values.yaml`; +15 more.
...
- Inventory artifacts: `iac/catalog/oya-cloud-iac-iac-applier-adapter-argocd.yaml`, `iac/catalog/oya-cloud-iac-iac-applier-adapter.yaml`, `iac/catalog/oya-cloud-iac-iac-applier-api.yaml`, `iac/catalog/oya-cloud-iac-iac-applier-app.yaml`, `iac/catalog/oya-cloud-iac-iac-applier-domain.yaml`, `iac/catalog/oya-cloud-iac-iac-applier-kernel.yaml`; +21 more.
