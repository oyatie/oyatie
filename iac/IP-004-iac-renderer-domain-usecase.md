...
| Path | Action |
|---|---|
| `iac/src/crates/oya-cloud-iac-iac-renderer-domain/{Cargo.toml,src/lib.rs,src/dependency_ordering.rs,src/digest.rs}` | create |
| `iac/src/crates/oya-cloud-iac-iac-renderer-usecase/{Cargo.toml,src/lib.rs,src/orchestrator.rs}` | create |
| `iac/src/crates/oya-cloud-iac-iac-renderer-api/{Cargo.toml,src/lib.rs,src/requests.rs,src/responses.rs}` | create |
| `iac/catalog/oya-cloud-iac-iac-renderer-{domain,usecase,api}.yaml` | create |
