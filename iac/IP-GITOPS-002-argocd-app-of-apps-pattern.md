...
| Path | Role |
|---|---|
| `iac/iac/helm/argocd/Chart.yaml` | ArgoCD chart wrapper |
| `iac/iac/helm/argocd/values.yaml` | ArgoCD HA and policy values |
| `iac/iac/helm/helm-controller/Chart.yaml` | Flux Helm-controller chart wrapper |
| `iac/iac/helm/helm-controller/values.yaml` | Helm-controller deployment values |
| `iac/iac/helm/kustomize-controller/Chart.yaml` | Flux Kustomize-controller chart wrapper |
| `iac/iac/helm/kustomize-controller/values.yaml` | Kustomize-controller deployment values |
| `iac/iac/kustomize/base/kustomization.yaml` | shared reconciler base |
| `iac/iac/kustomize/overlays/pack-kr/kustomization.yaml` | active pack overlay |
...
- `iac/cross-microservice-handoffs.md` inbound rows from
  `cell`, `payments`, and `developer-sdk` define callers that ask cloud-iac to
  render or validate deploy artifacts.
- `iac/contracts/asyncapi/cloud-iac-events.yaml` publishes
...
- Surface evidence: `iac/contracts/openapi/cloud-iac.yaml`, `iac/contracts/asyncapi/cloud-iac-events.yaml`, `iac/contracts/proto/cloud-iac.proto`, `iac/IP-GITOPS-002-argocd-app-of-apps-pattern.md`.
...
- Surface evidence: `iac/runbooks/restore-drill-quarterly.md`, `iac/runbooks/seaweedfs-volume-failover.md`, `iac/manifest.json`, `iac/IP-GITOPS-002-argocd-app-of-apps-pattern.md`.
