...
| Path | Action |
|---|---|
| `iac/src/crates/oya-cloud-iac-iac-renderer-worker/{Cargo.toml,src/lib.rs,src/main_loop.rs}` | create |
| `iac/src/crates/oya-cloud-iac-iac-validator-worker/{Cargo.toml,src/lib.rs,src/drift_loop.rs}` | create |
| `iac/src/crates/oya-cloud-iac-iac-applier-worker/{Cargo.toml,src/lib.rs,src/apply_loop.rs,src/eligibility_consumer.rs}` | create |
| `iac/src/crates/oya-cloud-iac-iac-rollback-worker/{Cargo.toml,src/lib.rs,src/rollback_consumer.rs}` | create |
| `iac/src/crates/oya-cloud-iac-iac-registry-worker/{Cargo.toml,src/lib.rs,src/registry_loop.rs}` | create |
| `iac/catalog/oya-cloud-iac-iac-*-worker.yaml` | create (5 rows) |
