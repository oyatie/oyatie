...
**Who:** Per actor table in `iac/threat-model.md` §"Actors".
...
**Cross-border transfer:** Forbidden by default per `data-residency.md`. Allowed only with tenant-executed SCCs (GDPR Arts. 44–46) recorded in `iac/legal/transfer-register.md` (Slice D).
