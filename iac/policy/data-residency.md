...
related_artifacts:
  - iac/threat-model.md (T-T-04, T-I-01; cross-pack state replication threats)
  - iac/dpia.md (R-10)
...
1. Active SCC on file at `iac/legal/transfer-register.md` (Slice D).
...
- `iac/threat-model.md` T-T-04 + T-I-01.
- `iac/dpia.md` R-10.
- `iac/policy/iac-isolation.md`.
- `iac/multi-region.md`.
