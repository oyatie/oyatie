...
related_artifacts:
  ...
  - microservices/cloud-iac/policy/auditor-scope.cedar
  - microservices/cloud-iac/policy/public-read.cedar
...
- `microservices/cloud-iac/dpia.md` R-01.
- `microservices/cloud-iac/policy/{tenant-scope, ci-scope, auditor-scope, public-read}.cedar`.
