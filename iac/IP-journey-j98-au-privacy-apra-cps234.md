...
## B. Approach
Use cloud-iac validator and applier contracts with incident-response evidence from `iac/incident-response.md`, isolation rules from `iac/policy/iac-isolation.md`, and rollback operations from `iac/runbooks/rollback-orchestration.md`.

## C. Deliverables
- APRA profile fields in `iac/contracts/openapi/cloud-iac.yaml`.
- Incident and rollback events in `iac/contracts/asyncapi/cloud-iac-events.yaml`.
- Evidence links to incident response, isolation, and rollback docs.
- Dashboard references to `iac/dashboards/apply-success-rate.json`.
...
- Incident response: `iac/incident-response.md`.
...
- Surface evidence: `iac/contracts/openapi/cloud-iac.yaml`, `iac/contracts/asyncapi/cloud-iac-events.yaml`, `iac/contracts/proto/cloud-iac.proto`, `iac/IP-journey-j98-au-privacy-apra-cps234.md`.
