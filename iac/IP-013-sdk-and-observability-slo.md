...
2. OpenSLO manifests for cloud-iac's own self-SLOs (apply success rate; drift coverage; render p99; registry read latency) at `iac/slos/`.
...
| Path | Action |
|---|---|
| `iac/src/crates/oya-cloud-iac-iac-renderer-sdk/{Cargo.toml,src/lib.rs,src/client.rs}` | create |
| `iac/src/crates/oya-cloud-iac-iac-registry-sdk/{Cargo.toml,src/lib.rs,src/client.rs}` | create |
| `iac/slos/availability.openslo.yaml` | create — apply success-rate SLO |
| `iac/slos/latency.openslo.yaml` | create — apply p99 latency SLO |
| `iac/slos/correctness.openslo.yaml` | create — render-determinism SLO |
| `iac/slos/freshness.openslo.yaml` | create — drift-detection coverage SLO |
| `iac/catalog/oya-cloud-iac-iac-*-sdk.yaml` | create (2 rows) |
...
- Surface evidence: `iac/runbooks/restore-drill-quarterly.md`, `iac/runbooks/seaweedfs-volume-failover.md`, `iac/manifest.json`, `iac/IP-013-sdk-and-observability-slo.md`.
