...
| Path | Action |
|---|---|
| `iac/src/crates/oya-cloud-iac-iac-renderer-adapter/{Cargo.toml,src/lib.rs,src/event_emitter.rs}` | create |
| `iac/src/crates/oya-cloud-iac-iac-renderer-adapter-helm/{Cargo.toml,src/lib.rs,src/helm_client.rs}` | create |
| `iac/src/crates/oya-cloud-iac-iac-renderer-adapter-kustomize/{Cargo.toml,src/lib.rs,src/kustomize_client.rs}` | create |
| `iac/src/crates/oya-cloud-iac-iac-renderer-adapter-opentofu/{Cargo.toml,src/lib.rs,src/opentofu_client.rs}` | create |
| `iac/catalog/oya-cloud-iac-iac-renderer-adapter*.yaml` | create (4 rows) |
