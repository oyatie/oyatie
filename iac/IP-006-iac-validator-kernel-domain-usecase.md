...
| Path | Action |
|---|---|
| `iac/src/crates/oya-cloud-iac-iac-validator-kernel/{Cargo.toml,src/lib.rs,src/entities.rs,src/ports.rs,src/errors.rs}` | create |
| `iac/src/crates/oya-cloud-iac-iac-validator-domain/{Cargo.toml,src/lib.rs,src/plan_diff.rs,src/drift_compare.rs}` | create |
| `iac/src/crates/oya-cloud-iac-iac-validator-usecase/{Cargo.toml,src/lib.rs,src/plan_preview.rs,src/cedar_evaluator.rs}` | create |
| `iac/src/crates/oya-cloud-iac-iac-validator-api/{Cargo.toml,src/lib.rs}` | create |
| `iac/src/crates/oya-cloud-iac-iac-validator-adapter/{Cargo.toml,src/lib.rs,src/k8s_client.rs,src/cedar_engine.rs}` | create |
| `iac/catalog/oya-cloud-iac-iac-validator-*.yaml` | create (5 rows) |
...
```cedar
// usecase/src/cedar_evaluator.rs invokes policies in iac/policy/*.cedar
