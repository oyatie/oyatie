...
SCOPE-002: Lifecycle state is PROPOSED for `cloud-iac` until the service-owned wrapper files under `iac/iac/<context>/main.tf` invoke signed cloud-iac modules and implementation evidence is reviewed.
...
SCOPE-006: ADR-0339 keeps reusable HCL in `iac/modules/<context>/<primitive>/`; `cloud-iac` keeps only thin invocation wrappers and service-specific parameters.
...
DOSSIER-CONTRACT-001: OpenAPI 3.2.0: iac/contracts/openapi/cloud-iac.yaml.
DOSSIER-CONTRACT-002: AsyncAPI 3.1.0: iac/contracts/asyncapi/cloud-iac-events.yaml.
DOSSIER-CONTRACT-003: proto3: iac/contracts/proto/cloud-iac.proto.
DOSSIER-CAPABILITY-001: T3 iac-apply risk=high file=iac/capabilities/iac-apply.yaml.
DOSSIER-CAPABILITY-002: T1 iac-render risk=minimal file=iac/capabilities/iac-render.yaml.
DOSSIER-CAPABILITY-003: T3 iac-rollback risk=high file=iac/capabilities/iac-rollback.yaml.
...
ADR0339-002: Purpose binding: reusable module bodies live under `iac/modules/<context>/<primitive>/` with catalog and signature evidence.
...
API-002: OpenAPI 3.2.0 references for `cloud-iac` remain: OpenAPI 3.2.0: iac/contracts/openapi/cloud-iac.yaml
API-003: AsyncAPI 3.1.0 references for `cloud-iac` remain: AsyncAPI 3.1.0: iac/contracts/asyncapi/cloud-iac-events.yaml
API-004: proto3 references for `cloud-iac` remain: proto3: iac/contracts/proto/cloud-iac.proto
...
VERIFY-001: Static read confirms this file exists at `iac/IPs/IP-ADR-0339-Shared-IaC-Modules.md`.
