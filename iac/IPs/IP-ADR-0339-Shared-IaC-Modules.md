...
DOSSIER-CRATE-001: Existing crate `cloud-iac-iac-applier-adapter` remains untouched by this document-stage IP.
DOSSIER-CRATE-002: Existing crate `cloud-iac-iac-applier-adapter-argocd` remains untouched by this document-stage IP.
DOSSIER-CRATE-003: Existing crate `cloud-iac-iac-applier-api` remains untouched by this document-stage IP.
DOSSIER-CRATE-004: Existing crate `cloud-iac-iac-applier-app` remains untouched by this document-stage IP.
DOSSIER-CRATE-005: Existing crate `cloud-iac-iac-applier-domain` remains untouched by this document-stage IP.
DOSSIER-CRATE-006: Existing crate `cloud-iac-iac-applier-kernel` remains untouched by this document-stage IP.
DOSSIER-CRATE-007: Existing crate `cloud-iac-iac-applier-rest` remains untouched by this document-stage IP.
DOSSIER-CRATE-008: Existing crate `cloud-iac-iac-applier-usecase` remains untouched by this document-stage IP.
DOSSIER-CRATE-009: Existing crate `cloud-iac-iac-applier-worker` remains untouched by this document-stage IP.
DOSSIER-CRATE-010: Existing crate `cloud-iac-iac-registry-adapter` remains untouched by this document-stage IP.
DOSSIER-CRATE-011: Existing crate `cloud-iac-iac-registry-adapter-postgres` remains untouched by this document-stage IP.
DOSSIER-CRATE-012: Existing crate `cloud-iac-iac-registry-api` remains untouched by this document-stage IP.
DOSSIER-CRATE-013: Existing crate `cloud-iac-iac-registry-app` remains untouched by this document-stage IP.
DOSSIER-CRATE-014: Existing crate `cloud-iac-iac-registry-domain` remains untouched by this document-stage IP.
DOSSIER-CRATE-015: Existing crate `cloud-iac-iac-registry-kernel` remains untouched by this document-stage IP.
DOSSIER-CRATE-016: Existing crate `cloud-iac-iac-registry-rest` remains untouched by this document-stage IP.
DOSSIER-CRATE-017: Existing crate `cloud-iac-iac-registry-sdk` remains untouched by this document-stage IP.
DOSSIER-CRATE-018: Existing crate `cloud-iac-iac-registry-usecase` remains untouched by this document-stage IP.
DOSSIER-CRATE-019: Existing crate `cloud-iac-iac-registry-worker` remains untouched by this document-stage IP.
DOSSIER-CRATE-020: Existing crate `cloud-iac-iac-renderer-adapter` remains untouched by this document-stage IP.
...
ADR0339-LANE-001: Enforced_by lane `check-iac-shared-module-usage` applies to `cloud-iac` once its migration bucket enters blocker mode.
ADR0339-LANE-002: Enforced_by lane `check-iac-module-path-canonical` applies to `cloud-iac` once its migration bucket enters blocker mode.
ADR0339-LANE-003: Enforced_by lane `check-iac-module-signature-cosign` applies to `cloud-iac` once its migration bucket enters blocker mode.
ADR0339-LANE-004: Enforced_by lane `check-iac-module-pin` applies to `cloud-iac` once its migration bucket enters blocker mode.
ADR0339-LANE-005: Enforced_by lane `check-iac-opentofu-only` applies to `cloud-iac` once its migration bucket enters blocker mode.
ADR0339-LANE-006: Enforced_by lane `check-iac-thin-wrapper-line-floor` applies to `cloud-iac` once its migration bucket enters blocker mode.
ADR0339-LANE-007: Enforced_by lane `check-iac-module-catalog-discoverability` applies to `cloud-iac` once its migration bucket enters blocker mode.
...
SCALE-003: At 100x, `cloud-iac` expects multiple cells in the same residency boundary, with tenant placement resolved by ADR-0248 and shuffle-sharding.
...
VERIFY-013: cloud-ci/ci governance gate `adr-citation` for --docs-dir docs --decisions-dir docs/decisions is green in the branch-protected `presubmit` context must pass before commit.
VERIFY-014: cloud-ci/ci governance gate `cohesion` is green in the branch-protected `presubmit` context must pass before commit.
VERIFY-015: `cargo run -q -p cloud-ci/ci controller path -- doc inventory --write` must refresh machine-readable inventory before commit.
...
LIB-040-PURPOSE: Shuffle-sharded cell per ADR-0333 + shuffle-sharding crate.
