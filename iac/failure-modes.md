...
- `iac/threat-model.md` (each FM maps to STRIDE / LINDDUN threat IDs).
- `iac/dpia.md` (FM-06, FM-10 map to R-01, R-10).
- `iac/incident-response.md` §"Severity Definitions".
- `iac/runbooks/*` (recovery procedures).
