...
| Path | Action |
|---|---|
| `iac/src/crates/oya-cloud-iac-iac-renderer-app/{Cargo.toml,src/main.rs,src/wiring.rs,Dockerfile}` | create |
| `iac/src/crates/oya-cloud-iac-iac-validator-app/{Cargo.toml,src/main.rs,src/wiring.rs,Dockerfile}` | create |
| `iac/src/crates/oya-cloud-iac-iac-applier-app/{Cargo.toml,src/main.rs,src/wiring.rs,Dockerfile}` | create |
| `iac/src/crates/oya-cloud-iac-iac-rollback-app/{Cargo.toml,src/main.rs,src/wiring.rs,Dockerfile}` | create |
| `iac/src/crates/oya-cloud-iac-iac-registry-app/{Cargo.toml,src/main.rs,src/wiring.rs,Dockerfile}` | create |
| `iac/catalog/oya-cloud-iac-iac-*-app.yaml` | create (5 rows) |
...
docker build -t cloud-iac-applier:test -f iac/src/crates/oya-cloud-iac-iac-applier-app/Dockerfile .
