...
## B. Approach
Move conflict handling into validator and registry evidence. `microservices/cloud-iac/policy/data-residency.md` names residency constraints, `microservices/cloud-iac/policy/tenant-scope.cedar` gates mutation, and `microservices/cloud-iac/runbooks/drift-remediation.md` handles already-applied infrastructure after a stricter pack wins.

## C. Deliverables
- Multi-pack conflict examples in `microservices/cloud-iac/contracts/openapi/cloud-iac.yaml`.
- Conflict-denied and conflict-resolved events in `microservices/cloud-iac/contracts/asyncapi/cloud-iac-events.yaml`.
...
- Runbook: `microservices/cloud-iac/runbooks/drift-remediation.md`.
...
- Surface evidence: `microservices/cloud-iac/contracts/openapi/cloud-iac.yaml`, `microservices/cloud-iac/contracts/asyncapi/cloud-iac-events.yaml`, `microservices/cloud-iac/contracts/proto/cloud-iac.proto`, `microservices/cloud-iac/IP-journey-j99-multi-pack-conflict-resolution.md`.
