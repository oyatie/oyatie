...
## B. Approach
Treat protected tenant provisioning as a registry-backed apply with explicit rollback. The IP binds `microservices/cloud-iac/policy/iac-isolation.md`, `microservices/cloud-iac/dashboards/apply-success-rate.json`, `microservices/cloud-iac/dashboards/drift-coverage.json`, and `microservices/cloud-iac/runbooks/restore-drill-quarterly.md`.

## C. Deliverables
- Protected tenant fields in `microservices/cloud-iac/contracts/openapi/cloud-iac.yaml`.
- Apply and drift events in `microservices/cloud-iac/contracts/asyncapi/cloud-iac-events.yaml`.
- Isolation policy references from `microservices/cloud-iac/policy/iac-isolation.md`.
- Restore evidence from `microservices/cloud-iac/runbooks/restore-drill-quarterly.md`.
...
- Rollback text references `microservices/cloud-iac/runbooks/rollback-orchestration.md`.
- No IRAP claim is made without audit-chain evidence.

## F. Evidence
- Journey: `docs/user-journeys/j88-au-irap-protected-tenant/README.md`.
- Policy: `microservices/cloud-iac/policy/iac-isolation.md`.
...
- Surface evidence: `microservices/cloud-iac/contracts/openapi/cloud-iac.yaml`, `microservices/cloud-iac/contracts/asyncapi/cloud-iac-events.yaml`, `microservices/cloud-iac/contracts/proto/cloud-iac.proto`, `microservices/cloud-iac/IP-journey-j88-cell-infra-declarative.md`.
...
- Surface evidence: `microservices/cloud-iac/manifest.json`, `microservices/cloud-iac/IP-journey-j88-cell-infra-declarative.md`.
