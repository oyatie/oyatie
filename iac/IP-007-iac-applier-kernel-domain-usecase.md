...
| Path | Action |
|---|---|
| `iac/src/crates/oya-cloud-iac-iac-applier-kernel/{Cargo.toml,src/lib.rs,src/entities.rs,src/ports.rs,src/errors.rs}` | create |
| `iac/src/crates/oya-cloud-iac-iac-applier-domain/{Cargo.toml,src/lib.rs,src/dep_order.rs,src/retry_policy.rs}` | create |
| `iac/src/crates/oya-cloud-iac-iac-applier-usecase/{Cargo.toml,src/lib.rs,src/apply_orchestrator.rs,src/slsa_verifier.rs}` | create |
| `iac/src/crates/oya-cloud-iac-iac-applier-api/{Cargo.toml,src/lib.rs}` | create |
| `iac/src/crates/oya-cloud-iac-iac-applier-adapter/{Cargo.toml,src/lib.rs,src/k8s_client.rs,src/event_emitter.rs}` | create |
| `iac/src/crates/oya-cloud-iac-iac-applier-adapter-argocd/{Cargo.toml,src/lib.rs,src/argocd_client.rs}` | create |
| `iac/catalog/oya-cloud-iac-iac-applier-*.yaml` | create (6 rows) |
