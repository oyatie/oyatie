...
4. µservice architecture anchor: local `ARCHITECTURE.md` absent; implementation shape inferred from `network/core/domain/src/lib.rs:1-7`, `network/ports/vpc/src/lib.rs:1-17`, `network/ports/lb/src/lib.rs:1-16`, and `network/ports/dns/src/lib.rs:1-16`.
