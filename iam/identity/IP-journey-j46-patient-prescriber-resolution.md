...
- Authority: ADR-0343.
- Trigger evidence: `iam/identity/IP-journey-j46-patient-prescriber-resolution.md` matched `financial, payment`.
...
- Surface evidence: `iam/identity/IP-journey-j46-patient-prescriber-resolution.md`, `iam/identity/manifest.json`; trigger terms `workflow-studio`.
