...
//! lives in `oya-shared-audit-digest-adapter-awslc` (ADR-0506).
//!
//! # References
//!
//! - ADR-0536 D-16 (audit), D-6 (observability), D-11 (CAS WORM anchor).
//! - ADR-0145 Invariant 1 — `oya-shared-audit-chain-client-kernel` owns
...
/// `oya-cloud-observability-domain::TENANT_ID_PREFIX`).
...
pub const DIGEST_CHAIN_DOMAIN_TAG: &str = "oya-audit-digest-chain.v1";
