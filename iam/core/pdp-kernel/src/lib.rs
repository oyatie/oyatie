//! # iam-pdp-kernel
//!
//! Pure ports of the iam policy-decision-point SERVICE (ADR-0559,
//! G004 slice 1).
//!
//! ## Posture
...
//! store (iam, the three-plane IdP substrate) compiles, signs, and
...
//! iam PDP composes — it deliberately does NOT re-model decision
