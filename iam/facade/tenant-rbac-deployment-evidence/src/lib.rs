...
const PLAN_NAME: &str = "tenant-rbac-deployment-evidence-plan";
...
pub fn tenant_rbac_deployment_evidence_plan()
...
pub fn validate_tenant_rbac_deployment_evidence_plan(
    ...
    if plan.deployment_manifest_name != "tenant-rbac-deployment-manifest" {
...
fn requirement(
    ...
    CloudDeploymentEvidenceRequirement {
        ...
        source_manifest_ref: "crates/tenant-rbac-deployment-manifest/src/lib.rs::tenant_rbac_deployment_manifest",
        tenant_namespace: TENANT_NAMESPACE,
