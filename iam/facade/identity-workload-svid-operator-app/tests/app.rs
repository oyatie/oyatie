use iam_identity_workload_svid_operator_app::{
    OperatorConfig, OperatorStartupConfigError, DEFAULT_NAMESPACE, DEFAULT_ROTATION_WINDOW_SECS,
    DEFAULT_TTL_SECS, ENV_CELL_ID, ENV_NAMESPACE, ENV_ROTATION_WINDOW_SECS, ENV_TTL_SECS,
