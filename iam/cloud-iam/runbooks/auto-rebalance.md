...
4. Verify primary metric: `oya metrics query sharding_auto_rebalance_candidate_count --service cloud-iam --cell $CELL --window 30m`.
5. Verify secondary metric: `oya metrics query sharding_auto_rebalance_migration_seconds_p99 --service cloud-iam --cell $CELL --window 30m`.
