# cloud-iam DR Failover Runbook

## Purpose
Restore the cloud-iam service to the manifest-declared RTO/RPO without changing tenant isolation, compliance-pack placement, or audit-chain evidence.
...
## Exit Criteria
- RTO <= 300s and RPO <= 30s are met or an incident exception is opened.
- Manifest runtime tier 1 and cell placement Tier-0 remain unchanged.
