...
- Service-specific metric `oya_audit_chain_signature_verification_failure_merkle_gap_total` exceeds the threshold documented in `audit/observability/slos/chain-of-custody-integrity-correctness.openslo.yaml`.
...
## Resolution Steps
1. Identify code owner path: `rg "signature_verification_failure|AuditChainSignatureVerificationFailureCritical|audit_chain.signature_verification_failure.incident_state" crates microservices/audit-chain -g "!audit/runbooks/**"`.
...
9. Add dashboard panel: `update audit/dashboards/emission-rate.json with oya_audit_chain_signature_verification_failure_error_ratio, oya_audit_chain_signature_verification_failure_lag_seconds, and oya_audit_chain_signature_verification_failure_queue_depth`.
...
- `audit/dashboards/emission-rate.json`: verify panel coverage for `oya_audit_chain_signature_verification_failure_error_ratio`, `oya_audit_chain_signature_verification_failure_lag_seconds`, and `oya_audit_chain_signature_verification_failure_merkle_gap_total`.
...
- Service-specific signal `oya_audit_chain_signature_verification_failure_merkle_gap_total` is below the threshold documented in `audit/observability/slos/chain-of-custody-integrity-correctness.openslo.yaml`.
