# developer-sdk DR failover runbook

## Purpose

Recover the developer-sdk service inside the declared ADR-0343 DR envelope without changing tenant version pins or weakening Cedar admission.

## Recovery order

1. Freeze new mutating ingress for developer-sdk at api-gateway while read-only routes stay available when data freshness permits.
...
3. pause signing-key issuance, promote developer portal and sandbox metadata, unseal OpenBao in the target region, and replay payout/tax workflow checkpoints.
