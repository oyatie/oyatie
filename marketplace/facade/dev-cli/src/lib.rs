...
pub(crate) fn usage() -> String {
    "Usage: oya demo [--audit-ledger <path>] [--evidence-store <path>] [--run-ledger <path>] [--step-ledger <path>] [--outbox-store <path>] [--secret-store <path>]\n       oya verify [--ci-required] [--include-deferred] [--skip-fmt] [--skip-check] [--skip-clippy] [--skip-nextest] [--skip-gate-run-all]   # canonical local pre-push/pre-PR entry; --ci-required runs the full CI mirror\n       oya submit [--no-verify] [--push-only] [--draft] [--title <text>] [--body <text>]   # verify --ci-required → git push → open/extend PR\n       oya cleanup retired-and-renumber --plan <path> --renumber-map <path> [--apply]\n       oya supply-chain adr0039 [--manifest <registry/release/images.yaml>] [--artifacts-dir <artifacts/supply-chain>] [--dry-run] [--format <text|json>]\n       oya supply-chain install-trivy [--version <0.70.0>] [--install-dir </usr/local/bin>] [--dry-run] [--format <text|json>]\n       oya lint <proto|asyncapi|adr-shape|foundry-phase00-evidence> [lint-specific args]\n       oya check <architecture|bounded-context|supply-chain|semver|documentation|statelessness|shardability|perf-budget|benchmark> [check-specific args]\n       oya doc rustdoc [--target-dir <target/oya-rustdoc-check>] [--rustdoc <path>] [--cargo <path>] [--format <text|json>] [--keep-target-dir]\n       oya doc openapi [--contracts-dir <contracts>] [--spec <docs/SPEC.md>] [--contracts-mirror <docs/machine-readable/contracts.json>] [--runtime-bindings <registry/openapi/runtime-bindings.tsv>] [--schema-bindings <registry/openapi/schema-bindings.tsv>] [--runtime-root <.>] [--format <text|json>]\n       oya doc mdbook [--site-dir <docs/site>] [--format <text|json>]\n       oya doc adr-index [--decisions-dir <docs/decisions>] [--index <docs/ADR-INDEX.md>] [--machine <docs/machine-readable/decisions.json>] [--write] [--format <text|json>]\n       oya doc inventory [--repo-root <.>] [--workspace <Cargo.toml>] [--crate-registry <registry/catalog>] [--doc-catalog <docs/machine-readable/catalog.json>] [--contracts-dir <contracts>] [--products-dir <docs/products>] [--capabilities-dir <registry/capability-templates>] [--out <docs/machine-readable/documentation-inventory.json>] [--write] [--format <text|json>]\n       oya catalog validate [--workspace <Cargo.toml>] [--registry <registry/catalog>]"
        ...
        + "\n       oya gate validate cloud-iac-module-catalog [--repo-root <.>] [--manifest <iac/manifest.json>] [--catalog <iac/tofu/modules/catalog.json>]"
        + "\n       oya gate validate cloud-iac-gitops-evidence [--repo-root <.>] [--manifest <iac/manifest.json>] [--templates-root <iac/iac>]"
        + "\n       oya gate validate cloud-iac-helm-chart-signed-image-wiring [--repo-root <.>] [--manifest <iac/manifest.json>] [--chart-root <iac/iac/k8s/helm>]"
        + "\n       oya gate validate cloud-iac-kubewarden-admission-policy [--repo-root <.>] [--manifest <iac/manifest.json>] [--kubewarden-root <iac/iac/k8s/kubewarden>] [--kyverno-policy <infra/kyverno/policies/require-signed-images.yaml>]"
        + "\n       oya gate validate cloud-iac-cell-topology [--repo-root <.>] [--manifest <iac/manifest.json>] [--topology <iac/cell-topology/foundation.json>] [--catalog <iac/tofu/modules/catalog.json>]"
        + "\n       oya gate validate cloud-iac-opentofu-validation [--repo-root <.>] [--manifest <iac/manifest.json>] [--catalog <iac/tofu/modules/catalog.json>] [--modules-root <iac/tofu/modules>] [--tofu-bin <tofu>] [--keep-temp]"
        + "\n       oya gate validate cloud-iac-module-provider-requirements [--repo-root <.>] [--manifest <iac/manifest.json>] [--catalog <iac/tofu/modules/catalog.json>] [--readiness <iac/tofu/modules/provider-readiness.json>]"
        + "\n       oya gate validate cloud-iac-module-provenance [--repo-root <.>] [--manifest <iac/manifest.json>] [--catalog <iac/tofu/modules/catalog.json>] [--provenance <iac/tofu/modules/provenance.json>]"
        + "\n       oya gate validate cloud-iac-module-release-index [--repo-root <.>] [--manifest <iac/manifest.json>] [--catalog <iac/tofu/modules/catalog.json>] [--provenance <iac/tofu/modules/provenance.json>] [--release-index <iac/tofu/modules/release-index.json>] [--archive-manifest <iac/tofu/modules/archive-manifest.json>] [--provider-lock-root <iac/tofu/provider-locks/foundation>] [--provider-signature-review <iac/tofu/provider-locks/foundation/provider-signature-review.json>]"
        + "\n       oya gate validate cloud-iac-module-archive [--repo-root <.>] [--manifest <iac/manifest.json>] [--catalog <iac/tofu/modules/catalog.json>] [--provenance <iac/tofu/modules/provenance.json>] [--release-index <iac/tofu/modules/release-index.json>] [--archive-manifest <iac/tofu/modules/archive-manifest.json>] [--out-dir <target/oya-cloud-iac/module-archives>]"
        + "\n       oya gate validate cloud-iac-module-registry-protocol [--repo-root <.>] [--manifest <iac/manifest.json>] [--release-index <iac/tofu/modules/release-index.json>] [--archive-manifest <iac/tofu/modules/archive-manifest.json>] [--protocol-fixtures <iac/tofu/module-registry/protocol-fixtures.json>]"
        + "\n       oya gate validate cloud-iac-provider-readiness [--repo-root <.>] [--manifest <iac/manifest.json>] [--catalog <iac/tofu/modules/catalog.json>] [--readiness <iac/tofu/modules/provider-readiness.json>]"
        + "\n       oya gate validate cloud-iac-provider-lockfile [--repo-root <.>] [--manifest <iac/manifest.json>] [--readiness <iac/tofu/modules/provider-readiness.json>] [--lock-root <iac/tofu/provider-locks/foundation>]"
        + "\n       oya gate validate cloud-iac-provider-signature-review [--repo-root <.>] [--manifest <iac/manifest.json>] [--lock-root <iac/tofu/provider-locks/foundation>] [--review <iac/tofu/provider-locks/foundation/provider-signature-review.json>]"
...
fn glossary_vocabulary_forensic_path(path: &str) -> bool {
    ...
    ) || path.starts_with("docs/adr-archive/ADR-0016-wave-and-plane-integration-framework.md")
        || path.starts_with("docs/adr-archive/ADR-0018-glossary-and-terminology-canon.md")
