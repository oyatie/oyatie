...
## Resolution Steps
1. Identify code owner path: `rg "settlement_ledger_replay|SettlementLedgerReplayCritical|marketplace.settlement_ledger_replay.incident_state" crates marketplace -g "!marketplace/runbooks/**"`.
