    ...
    fn accepted_leave_emits_the_financial_metadata_only_payroll_envelope() {
        ...
        assert_eq!(
            [
                ...
                envelope.employee_id.data_class.compatibility_data_class(),
                envelope
                    .leave_request_id
                    .data_class
                    .compatibility_data_class(),
                envelope.approver_id.data_class.compatibility_data_class(),
                envelope.decision.data_class.compatibility_data_class(),
                envelope.routing_mode.data_class.compatibility_data_class(),
                envelope.workflow_ref.data_class.compatibility_data_class(),
                envelope
                    .payroll_period
                    .data_class
                    .compatibility_data_class(),
