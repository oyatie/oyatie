...
use foundry_projection_draft::conformance::{
    ...
    check_apply_requires_the_next_dense_ordinal, check_divergent_reapply_is_refused,
    ...
    check_poisoned_entries_advance_the_head_without_objects, check_range_class_mismatch_is_refused,
    check_range_predicate_is_class_scoped, check_reads_are_tenant_isolated,
...
fn reference_store_passes_the_predicate_laws() {
    ...
    run(check_range_predicate_is_class_scoped);
    run(check_range_class_mismatch_is_refused);
}
