...
pub const MICROSERVICE: &str = "real-estate";
pub const SERVICE_TITLE: &str = "Real Estate";
pub const PACKAGE_NAME: &str = "oya-real-estate-lease-app";
pub const BOUNDED_CONTEXT: &str = "lease-portfolio";
pub const OWNER_TEAM: &str = "axis-erp-real-estate + council-product";
pub const OPENAPI_CONTRACT: &str = "contracts/openapi-v1.yaml";
pub const ASYNCAPI_CONTRACT: &str = "contracts/asyncapi-v1.yaml";
pub const GRPC_CONTRACT: &str = "contracts/real-estate-v1.proto";
