...
- Open sev2 if `oya_community_verified_anonymous_deanonymization_total` exceeds the threshold documented in `app/community/slos/audit-chain-seal-latency.openslo.yaml`.
...
9. Add dashboard panel: `update app/community/dashboards/moderation-queue-depth.json with oya_community_verified_anonymous_deanonymization_incident_error_ratio, oya_community_verified_anonymous_deanonymization_incident_lag_seconds, and oya_community_verified_anonymous_deanonymization_total`.
...
- `app/community/dashboards/moderation-queue-depth.json`: verify panel coverage for `oya_community_verified_anonymous_deanonymization_incident_error_ratio`, `oya_community_verified_anonymous_deanonymization_incident_lag_seconds`, and `oya_community_verified_anonymous_deanonymization_total`.
...
- Service-specific signal `oya_community_verified_anonymous_deanonymization_total` is below the threshold documented in `app/community/slos/audit-chain-seal-latency.openslo.yaml`.
