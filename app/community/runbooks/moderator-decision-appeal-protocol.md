...
- Open sev2 if `oya_community_moderator_appeal_sla_seconds` exceeds the threshold documented in `app/community/slos/audit-chain-seal-latency.openslo.yaml`.
...
9. Add dashboard panel: `update app/community/dashboards/moderation-queue-depth.json with oya_community_moderator_decision_appeal_protocol_error_ratio, oya_community_moderator_decision_appeal_protocol_lag_seconds, and oya_community_moderator_appeal_sla_seconds`.
...
- `app/community/dashboards/moderation-queue-depth.json`: verify panel coverage for `oya_community_moderator_decision_appeal_protocol_error_ratio`, `oya_community_moderator_decision_appeal_protocol_lag_seconds`, and `oya_community_moderator_appeal_sla_seconds`.
...
- Service-specific signal `oya_community_moderator_appeal_sla_seconds` is below the threshold documented in `app/community/slos/audit-chain-seal-latency.openslo.yaml`.
