...
impl AdapterRegistry {
    pub fn scaffolded() -> Self {
        Self {
            http_routes: http::IncidentManagementHttpHandler::routes(),
            grpc_methods: grpc::IncidentManagementGrpcHandler::methods(),
            asyncapi_channels: asyncapi::IncidentManagementAsyncApiHandler::channels(),
        }
    }
