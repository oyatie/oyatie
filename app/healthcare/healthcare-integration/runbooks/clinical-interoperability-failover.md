# Clinical Interoperability Failover Runbook

## Purpose

Restore Healthcare Integration tenant service within the manifest DR target while preserving tenant isolation, audit evidence, and declared backup-substrate order.

## DR Contract

- RTO p99 seconds: 1800
- RPO p99 seconds: 300
- Active-active: true
- Backup substrates: postgres_wal_g, valkey_cluster, object_storage_versioned, audit_chain_merkle_seal
...
3. Restore or replay substrates in this order: postgres_wal_g -> valkey_cluster -> object_storage_versioned -> audit_chain_merkle_seal.
