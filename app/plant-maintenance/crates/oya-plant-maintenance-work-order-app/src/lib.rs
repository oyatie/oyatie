...
pub const MICROSERVICE: &str = "plant-maintenance";
pub const SERVICE_TITLE: &str = "Plant Maintenance";
pub const PACKAGE_NAME: &str = "oya-plant-maintenance-work-order-app";
pub const BOUNDED_CONTEXT: &str = "work-order-maintenance";
pub const OWNER_TEAM: &str = "axis-erp-maintenance + council-product";
pub const OPENAPI_CONTRACT: &str = "contracts/openapi-v1.yaml";
pub const ASYNCAPI_CONTRACT: &str = "contracts/asyncapi-v1.yaml";
pub const GRPC_CONTRACT: &str = "contracts/plant-maintenance-v1.proto";
