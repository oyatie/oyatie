...
- **Deepen hygiene (2026-08-10):** rewritten product-local `microservices/supply-chain-planning/` → `app/supply-chain-planning/` path cites inside forever home (hub `specs/microservices/**` + cross-product microservices cites left intact). Dest-verify COMPLETE [f60e93b2]; shrink gate ALLOWED. PARKED — no merge.
