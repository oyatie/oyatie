...
pub const CAPABILITIES: &[Capability] = &[
    Capability::DemandPlan,
    Capability::SupplyNetworkPlan,
    Capability::ReplenishmentPlan,
    Capability::AvailableToPromise,
    Capability::PlanningScenario,
];
...
impl CapabilityDescriptor {
    pub fn descriptors() -> Vec<Self> {
        CAPABILITIES
            ...
            .map(|capability| Self {
                capability,
                bounded_context: BoundedContext::SupplyNetworkPlan,
