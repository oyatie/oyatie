...
fn register_capability_with_action(
    foundation: &mut Foundation,
    tenant_id: &str,
    capability_id: &str,
    namespace: &str,
...
fn assert_autonomy_denial(foundation: &Foundation, expected_source: &str, expected_reason: &str) {
