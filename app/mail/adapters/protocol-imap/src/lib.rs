...
pub use smtp::{
    Authentication, MailDns, SmtpParams, Verifier, Verify, smtp_session, smtp_session_with,
    smtp_starttls_session, smtp_starttls_session_with, smtp_tls_session_with, submission_session,
