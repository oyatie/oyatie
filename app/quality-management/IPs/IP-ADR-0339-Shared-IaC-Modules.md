...
SCOPE-002: Lifecycle state is PROPOSED for `quality-management` until the service-owned wrapper files under `app/quality-management/iac/<context>/main.tf` invoke signed cloud-iac modules and implementation evidence is reviewed.
...
VERIFY-001: Static read confirms this file exists at `app/quality-management/IPs/IP-ADR-0339-Shared-IaC-Modules.md`.
