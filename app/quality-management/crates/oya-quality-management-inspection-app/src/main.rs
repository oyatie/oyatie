...
use oya_quality_management_inspection_app::error::Result;
use std::path::PathBuf;
use std::process::ExitCode;

#[derive(Debug, Parser)]
#[command(name = "oya-quality-management-inspection")]
#[command(about = "Quality Management service scaffold entrypoint")]
struct CliArgs {
    #[arg(long)]
...
fn run(args: CliArgs) -> Result<()> {
    ...
    tracing::info!(
        ...
        "quality management scaffold validated"
    );
    Ok(())
}
