...
impl ServiceConfig {
    pub fn local_default(tenant_id: impl Into<String>, port: u16) -> Self {
        Self {
            service_name: "quality-management".to_string(),
            ...
            observability: ObservabilityConfig {
                service_namespace: "oyatie.quality_management".to_string(),
                audit_topic: "audit.quality_management".to_string(),
                metrics_prefix: "oya_quality_management".to_string(),
    ...
    pub fn validate(&self) -> Result<()> {
        ...
        if self.service_name != "quality-management" {
            return Err(ServiceError::validation(
                "service_name",
                "service_name must remain quality-management",
            ));
        }
