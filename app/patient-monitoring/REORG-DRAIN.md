...
- **NOT** `integ/healthcare` / `app/healthcare/patient-monitoring/**` (OVERRULE envelopes 1.16.11 rule 3d).
- **NOT** `integ/app` (composition glue only).

## Completed (this rail)

- Wave-1 absorb: product scaffold reclaim `app/patient-monitoring/**` → `app/patient-monitoring/**` from `4aa692919b12`.
