...
- Surface evidence: `observability/IP-journey-j37-attendance-slo-traces.md` matched `financial, payment`; anchors `observability/runbooks/clickhouse-restore.md, crates/oya-cloud-observability-api/src/lib.rs`; type anchor `crates/oya-cloud-observability-api/src/lib.rs::CloudObservabilityAuditRecord`.
