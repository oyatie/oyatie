...
## Resolution Steps
1. Identify code owner path: `rg "clickhouse|ObservabilityClickhouseCritical|observability.clickhouse.incident_state" crates observability -g "!observability/runbooks/**"`.
