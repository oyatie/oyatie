...
## Resolution Steps
1. Identify code owner path: `rg "rollback|ObservabilityRollbackCritical|observability.rollback.incident_state" crates observability -g "!observability/runbooks/**"`.
