...
## Resolution Steps
1. Identify code owner path: `rg "mimir_outage|ObservabilityMimirOutageCritical|observability.mimir_outage.incident_state" crates observability -g "!observability/runbooks/**"`.
