...
use oya_foundry_fitness_adapter_with_no_importer_kernel::{
...
mod tests {
    ...
    fn extracts_package_name() {
        let manifest = r#"
[package]
name = "oya-foundry-fitness-adapter-with-no-importer-kernel"
edition.workspace = true
"#;
        assert_eq!(
            extract_package_name(manifest).as_deref(),
            Some("oya-foundry-fitness-adapter-with-no-importer-kernel")
        );
    }
