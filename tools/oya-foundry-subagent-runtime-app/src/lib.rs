//! `oya-foundry-subagent-runtime-app` — binary surface that closes
//! the `subagent_runtime_pending=true` gap in IP-004 / IP-005 / IP-006.
//!
//! The kernel sibling (`oya-foundry-subagent-runtime-kernel`) defines
...
//!
//! See `tools/oya-foundry-subagent-runtime-app/src/main.rs` for the
//! CLI surface.
