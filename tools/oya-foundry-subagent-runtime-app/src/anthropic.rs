...
//!   the existing `oya-foundry-adapter-anthropic-api-adapter` exposes
...
use oya_foundry_subagent_runtime_kernel::{
...
mod tests {
    ...
    use oya_foundry_subagent_runtime_kernel::FacetRecommendation;
}
