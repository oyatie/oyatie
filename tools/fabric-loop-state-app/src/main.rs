//! `fabric-loop-state` — local lane-runtime bridge over the two-plane
...
//!
//! Merge authority stays the single required `presubmit` context
...
const USAGE: &str = "fabric-loop-state [--repo-root PATH] <command>
