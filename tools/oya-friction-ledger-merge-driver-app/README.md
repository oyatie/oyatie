...
`tools/oya-cargo-lock-merge-driver-app` precedent (FRIC-1781069288) and ships without a
dedicated ADR; doctrine citations: FRIC-1781370000, ADR-0544 (ledger fold), ADR-0546 (canonical
form), ADR-0548 D7 (fixer self-validation).
