...
//! a dependency on `oya-intelligence-pr-review-dispatcher-app` (which would
//! invert the dependency direction and is forbidden by clean-arch).
...
mod tests {
    ...
    fn panel_matches_dispatcher_slugs() {
        ...
        // `tools/oya-intelligence-pr-review-dispatcher-app/src/fanout.rs`.
