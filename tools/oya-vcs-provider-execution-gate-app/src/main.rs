...
use oya_vcs_provider_execution_gate_kernel::{
...
fn usage() -> String {
    "usage: oya-vcs-provider-execution-gate-app [--mode check|ci] [--emit-evidence <path>]"
        .to_string()
}
...
enum GateError {
    ...
    Argo(Vec<oya_vcs_provider_execution_gate_kernel::ArgoViolation>),
