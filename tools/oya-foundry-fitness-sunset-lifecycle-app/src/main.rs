...
//! [`oya_foundry_fitness_sunset_lifecycle_kernel::evaluate`] kernel
...
use oya_foundry_fitness_sunset_lifecycle_kernel::{
...
fn usage() -> String {
    "usage: oya-foundry-fitness-sunset-lifecycle-app \
