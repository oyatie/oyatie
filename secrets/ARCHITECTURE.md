...
- Platform principal `oyatie.cloud-secrets.worker` owns async jobs, retry queues, and backfill replay listed in `secrets/backfill-replay.md` when present.
...
### Service-specific answer
- Default-deny is represented by the first matching Cedar fragment in `secrets/policy/auditor-scope.cedar`, `secrets/policy/ci-scope.cedar`, `secrets/policy/data-residency.md`, `secrets/policy/public-read.cedar`, `secrets/policy/secret-isolation.md`, `secrets/policy/tenant-scope.cedar`.
...
- Concrete fragments in scope: `secrets/policy/auditor-scope.cedar`, `secrets/policy/ci-scope.cedar`, `secrets/policy/data-residency.md`, `secrets/policy/public-read.cedar`, `secrets/policy/secret-isolation.md`, `secrets/policy/tenant-scope.cedar`.
...
- If substrate: products consume `cloud-secrets` only through contracts `secrets/contracts/asyncapi/cloud-secrets-events.yaml`, `secrets/contracts/openapi/cloud-secrets.yaml`, `secrets/contracts/proto/cloud-secrets.proto`.
...
- The caller-side library evaluates fragments from `secrets/policy/auditor-scope.cedar`, `secrets/policy/ci-scope.cedar`, `secrets/policy/data-residency.md`, `secrets/policy/public-read.cedar`, `secrets/policy/secret-isolation.md`, `secrets/policy/tenant-scope.cedar` with the full action/resource/context tuple.
...
### Service-specific answer
- Public/API contracts in scope: `secrets/contracts/asyncapi/cloud-secrets-events.yaml`, `secrets/contracts/openapi/cloud-secrets.yaml`, `secrets/contracts/proto/cloud-secrets.proto`.
...
- IaC transport evidence: `secrets/iac/helm/hsm-operator/Chart.yaml`, `secrets/iac/helm/hsm-operator/values.yaml`, `secrets/iac/helm/openbao/Chart.yaml`, `secrets/iac/helm/openbao/templates/deployment.yaml`, `secrets/iac/helm/openbao/templates/networkpolicy.yaml`, `secrets/iac/helm/openbao/values.yaml`; +4 more.
...
- IaC manifests in scope: `secrets/iac/helm/hsm-operator/Chart.yaml`, `secrets/iac/helm/hsm-operator/values.yaml`, `secrets/iac/helm/openbao/Chart.yaml`, `secrets/iac/helm/openbao/templates/deployment.yaml`, `secrets/iac/helm/openbao/templates/networkpolicy.yaml`, `secrets/iac/helm/openbao/values.yaml`; +4 more.
- Catalog crates/components: `secrets/catalog/oya-cloud-secrets-audit-emitter-adapter-audit-chain-bridge.yaml`, `secrets/catalog/oya-cloud-secrets-audit-emitter-api.yaml`, `secrets/catalog/oya-cloud-secrets-audit-emitter-app.yaml`, `secrets/catalog/oya-cloud-secrets-audit-emitter-kernel.yaml`, `secrets/catalog/oya-cloud-secrets-audit-emitter-usecase.yaml`, `secrets/catalog/oya-cloud-secrets-hsm-integration-adapter-hsm.yaml`; +18 more.
...
### Service-specific answer
- SLO/dashboard sources in scope: `secrets/observability/slos/cloud-secrets/audit-log-completeness.openslo.yaml`, `secrets/observability/slos/cloud-secrets/hsm-availability.openslo.yaml`, `secrets/observability/slos/cloud-secrets/key-rotation-correctness.openslo.yaml`, `secrets/observability/slos/cloud-secrets/pki-cert-issuance-latency.openslo.yaml`, `secrets/observability/slos/cloud-secrets/secret-resolve-latency.openslo.yaml`, `secrets/observability/slos/cloud-secrets/secret-write-latency.openslo.yaml`; +3 more.
...
- Reference evidence artifact: `secrets/observability/slos/cloud-secrets/audit-log-completeness.openslo.yaml`.
...
- Cedar/IaC controls in scope: `secrets/policy/auditor-scope.cedar`, `secrets/policy/ci-scope.cedar`, `secrets/policy/data-residency.md`, `secrets/policy/public-read.cedar`, `secrets/policy/secret-isolation.md`, `secrets/policy/tenant-scope.cedar`; +10 more.
...
- Rotation cadence is linked from `secrets/runbooks/audit-emission-backlog.md`, `secrets/runbooks/hsm-key-rotation.md`, `secrets/runbooks/namespace-controller-restart.md`, `secrets/runbooks/openbao-restart.md`, `secrets/runbooks/rotation-cascade-recovery.md`, `secrets/runbooks/secret-leak-detected.md`.
