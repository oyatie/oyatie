...
3. Local tenant_class source: `secrets/kms/tenant-class-adoption-deltas-vs-counterparts-2026-05-20.md:13-83`.
4. Runtime contract/source source: `contracts/openapi/cloud/cloud-kms-v1.yaml:1-420`, `secrets/core/kms-domain/src/lib.rs:71-220`.
