...
cloud-secrets owns OpenBao-backed key handles, per-pack signing keys, and TTL rotation for j96-ksa-uae-mena-tenant-onboarding. The slice is a flat per-microservice implementation plan under microservices/cloud-secrets/, matching ADR-0131.
...
- Surface evidence: `microservices/cloud-secrets/manifest.json`, `microservices/cloud-secrets/IP-journey-j96-ksa-uae-mena-onboarding.md`.
