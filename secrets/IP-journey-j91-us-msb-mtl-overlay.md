...
cloud-secrets owns OpenBao-backed key handles, per-pack signing keys, and TTL rotation for j91-us-state-money-transmitter-licensing. The slice is a flat per-microservice implementation plan under secrets/, matching ADR-0131.
