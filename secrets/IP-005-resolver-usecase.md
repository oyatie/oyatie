...
| `secrets/catalog/oya-cloud-secrets-secret-reference-resolver-usecase.yaml` | create |
...
- Surface evidence: `secrets/contracts/openapi/cloud-secrets.yaml`, `secrets/contracts/asyncapi/cloud-secrets-events.yaml`, `secrets/contracts/proto/cloud-secrets.proto`, `secrets/IP-005-resolver-usecase.md`.
...
- Surface evidence: `secrets/runbooks/hsm-key-rotation.md`, `secrets/runbooks/openbao-restart.md`, `secrets/manifest.json`, `secrets/IP-005-resolver-usecase.md`.
...
- Surface evidence: `secrets/manifest.json`, `secrets/IP-005-resolver-usecase.md`.
