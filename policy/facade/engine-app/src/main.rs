...
fn usage() -> String {
    "usage: policy-engine-app <check|prepare> <project.json>; prepare emits an unsigned candidate; signing requires PreparedPolicy::publish with configured trust and custody".into()
}
