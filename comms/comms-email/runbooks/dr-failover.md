# comms-email DR failover runbook

## Trigger

- Primary region or cell cannot meet the manifest RTO/RPO contract.
- Cedar, OpenBao, Postgres, Valkey, object storage, or audit-chain dependencies for comms-email are degraded beyond the service SLO.

## Authority

- ADR-0343 DR matrix.
- Manifest `dr` block in `microservices/comms-email/manifest.json`.
...
4. Rehydrate declared backup substrates: postgres_wal_g, object_storage_versioned, openbao_seal_unseal, audit_chain_merkle_seal.
