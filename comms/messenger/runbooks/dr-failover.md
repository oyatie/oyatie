# messenger DR failover runbook

## Trigger

- Primary region or cell cannot meet the manifest RTO/RPO contract.
- Cedar, OpenBao, Postgres, Valkey, object storage, or audit-chain dependencies for messenger are degraded beyond the service SLO.
...
4. Rehydrate declared backup substrates: valkey_cluster, postgres_wal_g, object_storage_versioned, openbao_seal_unseal, audit_chain_merkle_seal.
