...
| File | Status |
|------|--------|
| `global-trade-move-plan.json` | **LIVE executable** — global-trade absorb (`oya/global-trade` → `app/global-trade`); also carries spent parent sheets + community + payroll + HR crate-dir pairs so origin/dev...HEAD stays a singleton bijection |
