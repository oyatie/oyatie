...
//! `messaging-bus-boundary` = `<capability:messaging>-<leaf:bus-boundary>`,
//! the de-branded name for path `messaging/core/bus-boundary` (ADR-0562
...
//! substrate surface crates carry the owned-surface name, not a vendor name.
//!
