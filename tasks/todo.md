...
- ⬜ Live workload Postgres/Citus RLS integration runs, backup/restore drills, and Citus rebalance evidence beyond generated write batches, execution contracts, the compile-checked SQLx executor adapter seam, and the env-gated generic live RLS/Citus harness with app-role-separated local Postgres proof.
