...
- Launch API contract directive (2026-05-25, amended by ADR-0565): REST/OpenAPI, gRPC/Protobuf, event/AsyncAPI, and realtime (SSE/WebSocket/gRPC-streaming) bindings must be generated or validated from one shared Rust-native source of truth; manual parallel schema maintenance is forbidden.
