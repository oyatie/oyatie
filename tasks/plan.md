...
- Launch API contract directive (2026-05-25, amended by ADR-0565): REST/OpenAPI, gRPC/Protobuf, and event/AsyncAPI contracts plus realtime (SSE/WebSocket/gRPC-streaming) bindings must be generated or validated from one shared Rust-native TypeSpec-like source of truth; manual parallel schema maintenance is forbidden. ZERO GraphQL in the owned API surface per ADR-0565.
