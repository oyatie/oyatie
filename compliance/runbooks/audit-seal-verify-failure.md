...
23. Check catalog components: `find compliance/catalog -maxdepth 1 -type f | sort | rg "compliance|audit"`.
...
15. Protect evidence: `oya evidence freeze --incident $INCIDENT_ID --paths compliance/runbooks/audit-seal-verify-failure.md,evidence/incidents/$INCIDENT_ID.json`.
...
## Resolution Steps
1. Identify code owner path: `rg "audit_seal_verify_failure|ComplianceAuditSealVerifyFailureCritical|compliance.audit_seal_verify_failure.incident_state" crates compliance -g "!compliance/runbooks/**"`.
...
8. Add SLO assertion: `update compliance/observability/slos/* with alert ComplianceAuditSealVerifyFailureCritical when this was a missing alert`.
9. Add dashboard panel: `update compliance/dashboards/breach-notification-sla.json with oya_compliance_audit_seal_verify_failure_error_ratio, oya_compliance_audit_seal_verify_failure_lag_seconds, and oya_compliance_audit_seal_verify_failure_queue_depth`.
