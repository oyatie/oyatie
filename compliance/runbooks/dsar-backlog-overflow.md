...
23. Check catalog components: `find compliance/catalog -maxdepth 1 -type f | sort | rg "compliance|dsar"`.
...
15. Protect evidence: `oya evidence freeze --incident $INCIDENT_ID --paths compliance/runbooks/dsar-backlog-overflow.md,evidence/incidents/$INCIDENT_ID.json`.
...
## Resolution Steps
1. Identify code owner path: `rg "dsar_backlog_overflow|ComplianceDsarBacklogOverflowCritical|compliance.dsar_backlog_overflow.incident_state" crates compliance -g "!compliance/runbooks/**"`.
...
8. Add SLO assertion: `update compliance/observability/slos/* with alert ComplianceDsarBacklogOverflowCritical when this was a missing alert`.
9. Add dashboard panel: `update compliance/dashboards/evidence-coverage.json with oya_compliance_dsar_backlog_overflow_error_ratio, oya_compliance_dsar_backlog_overflow_lag_seconds, and oya_compliance_dsar_backlog_overflow_queue_depth`.
