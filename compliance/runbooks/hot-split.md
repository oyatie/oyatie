...
4. Verify primary metric: `oya metrics query sharding_hot_split_threshold_breach_total --service compliance --cell $CELL --window 30m`.
5. Verify secondary metric: `oya metrics query sharding_hot_split_duration_seconds_p99 --service compliance --cell $CELL --window 30m`.
