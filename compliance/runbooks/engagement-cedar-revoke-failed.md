...
23. Check catalog components: `find compliance/catalog -maxdepth 1 -type f | sort | rg "compliance|engagement"`.
...
15. Protect evidence: `oya evidence freeze --incident $INCIDENT_ID --paths compliance/runbooks/engagement-cedar-revoke-failed.md,evidence/incidents/$INCIDENT_ID.json`.
...
## Resolution Steps
1. Identify code owner path: `rg "engagement_cedar_revoke_failed|ComplianceEngagementCedarRevokeFailedCritical|compliance.engagement_cedar_revoke_failed.incident_state" crates compliance -g "!compliance/runbooks/**"`.
...
8. Add SLO assertion: `update compliance/observability/slos/* with alert ComplianceEngagementCedarRevokeFailedCritical when this was a missing alert`.
9. Add dashboard panel: `update compliance/dashboards/audit-chain-seal-health.json with oya_compliance_engagement_cedar_revoke_failed_error_ratio, oya_compliance_engagement_cedar_revoke_failed_lag_seconds, and oya_compliance_engagement_cedar_revoke_failed_queue_depth`.
