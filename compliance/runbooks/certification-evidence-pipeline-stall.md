...
23. Check catalog components: `find compliance/catalog -maxdepth 1 -type f | sort | rg "compliance|certification"`.
...
15. Protect evidence: `oya evidence freeze --incident $INCIDENT_ID --paths compliance/runbooks/certification-evidence-pipeline-stall.md,evidence/incidents/$INCIDENT_ID.json`.
...
## Resolution Steps
1. Identify code owner path: `rg "certification_evidence_pipeline_stall|ComplianceCertificationEvidencePipelineStallCritical|compliance.certification_evidence_pipeline_stall.incident_state" crates compliance -g "!compliance/runbooks/**"`.
...
8. Add SLO assertion: `update compliance/observability/slos/* with alert ComplianceCertificationEvidencePipelineStallCritical when this was a missing alert`.
9. Add dashboard panel: `update compliance/dashboards/breach-notification-sla.json with oya_compliance_certification_evidence_pipeline_stall_error_ratio, oya_compliance_certification_evidence_pipeline_stall_lag_seconds, and oya_compliance_certification_evidence_pipeline_stall_queue_depth`.
