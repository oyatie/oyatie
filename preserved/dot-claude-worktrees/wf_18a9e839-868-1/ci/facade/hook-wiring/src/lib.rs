...
/// Same predicate on the other versioned surface that names executables git will run:
/// `.gitattributes` merge drivers. Producer-independent — it reads the tracked files directly.
pub mod merge_driver_registration;
