...
impl AsyncApiHandler {
    pub fn channels() -> Vec<AsyncApiChannel> {
        vec![
            AsyncApiChannel { channel: "treasury.command.accepted.v1", direction: ChannelDirection::Publish, message: "CommandAccepted" },
            AsyncApiChannel { channel: "treasury.reconciliation.queued.v1", direction: ChannelDirection::Publish, message: "ReconciliationQueued" },
            AsyncApiChannel { channel: "treasury.governance.hold-applied.v1", direction: ChannelDirection::Publish, message: "GovernanceHoldApplied" },
            AsyncApiChannel { channel: "treasury.bank-statement.changed.v1", direction: ChannelDirection::Subscribe, message: "BankStatementChanged" },
            AsyncApiChannel { channel: "treasury.market-rate.changed.v1", direction: ChannelDirection::Subscribe, message: "MarketRateChanged" },
        ]
    }
