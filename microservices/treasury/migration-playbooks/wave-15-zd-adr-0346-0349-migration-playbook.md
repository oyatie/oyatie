...
1. Search `treasury` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `treasury` manifest `governance_lanes` array only in the manifest-owning slot.
