...
use oya_financial_planning_forecast_scenario_app::error::Result;
use std::path::PathBuf;
use std::process::ExitCode;

#[derive(Debug, Parser)]
#[command(name = "oya-financial-planning-forecast-scenario")]
#[command(about = "Financial Planning µservice scaffold entrypoint")]
struct CliArgs {
    #[arg(long)]
...
fn run(args: CliArgs) -> Result<()> {
    ...
    tracing::info!(
        ...
        "financial planning scaffold validated"
    );
    Ok(())
}
