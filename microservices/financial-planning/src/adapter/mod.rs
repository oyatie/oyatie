...
impl AdapterRegistry {
    pub fn scaffolded() -> Self {
        Self {
            http_routes: http::FinancialPlanningHttpHandler::routes(),
            grpc_methods: grpc::FinancialPlanningGrpcHandler::methods(),
            asyncapi_channels: asyncapi::FinancialPlanningAsyncApiHandler::channels(),
        }
    }
