...
1. Search `financial-planning` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `financial-planning` manifest `governance_lanes` array only in the manifest-owning slot.
