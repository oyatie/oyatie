...
| [ADR-SOC-0005](./ADR-SOC-0005-dual-context-feed-isolation.md) | Dual-context feed isolation — Personal pillar feed vs Professional pillar feed; same dual-context-isolation pattern as messenger/mail; data-model invariant per parallel ADR-0135 | Accepted | 2026-05-17 | parallel ADR-0135 inheritance + threat-model T-I-07 |
