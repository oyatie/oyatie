...
1. Search `emergency` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `emergency` manifest `governance_lanes` array only in the manifest-owning slot.
