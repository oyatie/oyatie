...
```bash
cargo run -p oya-dev-cli -- gate validate payout-settlement-correctness --microservice developer-sdk
cargo run -p oya-dev-cli -- gate validate kyc-pipeline-correctness --microservice developer-sdk
```
