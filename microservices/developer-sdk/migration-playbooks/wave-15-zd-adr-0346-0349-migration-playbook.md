...
1. Search `developer-sdk` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `developer-sdk` manifest `governance_lanes` array only in the manifest-owning slot.
