...
1. Search `detection` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `detection` manifest `governance_lanes` array only in the manifest-owning slot.
