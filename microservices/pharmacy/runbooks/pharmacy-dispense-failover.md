# Pharmacy Dispense Failover Runbook

## Purpose

Restore Pharmacy tenant service within the manifest DR target while preserving tenant isolation, audit evidence, and declared backup-substrate order.
...
- RPO p99 seconds: 60
- Active-active: true
- Backup substrates: postgres_wal_g, valkey_cluster, object_storage_versioned, openbao_seal_unseal, audit_chain_merkle_seal
...
3. Restore or replay substrates in this order: postgres_wal_g -> valkey_cluster -> object_storage_versioned -> openbao_seal_unseal -> audit_chain_merkle_seal.
