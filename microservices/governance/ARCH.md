...
related_adrs:
  ...
  - ADR-0349
companion_docs:
  - microservices/governance/manifest.json
  - microservices/governance/PRD.md
  - microservices/governance/README.md
  - microservices/governance/ARCHITECTURE.md
---
...
- Integration state: PROPOSED for `governance`; ACCEPTED waits for service wrapper implementation and signed module evidence.
- Ownership split: cloud-iac owns reusable OpenTofu primitive bodies; `governance` owns wrapper selection, variables, SLO-driven sizing, and blast-radius review.
- Current manifest pins: oci-guest/postgresql-cluster@v1[paid], on-prem/lane-runner-pool@v1[paid], colo/evidence-store@v1[paid], oyatie-as-cloud-provider/service-mesh-waypoint@v1[paid].
...
- Capacity: `per_workflow_run` drives CPU `0.2`, RAM `384`, storage `6`, and connection pool variables.
