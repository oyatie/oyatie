...
ip_id: IP-journey-j78-policy-and-attestation
...
# IP-journey-j78-policy-and-attestation - governance

## Goal

Implement the `policy-and-attestation` slice for `governance` so j78 can satisfy `EU-NIS2` without leaking tenant data, collapsing provider-BYOK and encryption-BYOK meanings, or bypassing Cedar.
...
| File | Purpose | Notes |
|---|---|---|
| `microservices/governance/contracts/openapi/j78-policy-and-attestation-v1.yaml` | OpenAPI 3.2.0 REST surface | External read/write or admin action |
| `microservices/governance/contracts/asyncapi/j78-policy-and-attestation-events-v1.yaml` | AsyncAPI 3.1.0 event surface | Emits ADR-0263 events |
| `microservices/governance/contracts/proto/j78-policy-and-attestation-v1.proto` | proto3 internal RPC | Service-to-service call path |
| `microservices/governance/policy/j78-policy-and-attestation.cedar` | Cedar permit/forbid bundle | Deny-wins gate |
| `microservices/governance/runbooks/j78-policy-and-attestation-rollback.md` | Rollback and incident path | Includes regulator deadline handling |
| `microservices/governance/tests/j78_policy_and_attestation_test.rs` | Integration tests | Positive, negative, rollback, audit |
...
- `J78GovernancePolicyAndAttestationStarted`.
- `J78GovernancePolicyAndAttestationPermitted`.
- `J78GovernancePolicyAndAttestationDenied`.
- `J78GovernancePolicyAndAttestationCommitted`.
- `J78GovernancePolicyAndAttestationRolledBack`.

## Implementation rows

### IP row 001 - governance policy-and-attestation
Scope: implement one governance behavior for j78, not a cross-service refactor.
