...
1. Search `consent-graph` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `consent-graph` manifest `governance_lanes` array only in the manifest-owning slot.
