...
ip_id: IP-journey-j83-consent-rights-ledger
...
# IP-journey-j83-consent-rights-ledger - consent-graph

## Goal

Implement the `consent-rights-ledger` slice for `consent-graph` so j83 can satisfy `CN-PIPL-2021` without leaking tenant data, collapsing provider-BYOK and encryption-BYOK meanings, or bypassing Cedar.
...
| File | Purpose | Notes |
|---|---|---|
| `microservices/consent-graph/contracts/openapi/j83-consent-rights-ledger-v1.yaml` | OpenAPI 3.2.0 REST surface | External read/write or admin action |
| `microservices/consent-graph/contracts/asyncapi/j83-consent-rights-ledger-events-v1.yaml` | AsyncAPI 3.1.0 event surface | Emits ADR-0263 events |
| `microservices/consent-graph/contracts/proto/j83-consent-rights-ledger-v1.proto` | proto3 internal RPC | Service-to-service call path |
| `microservices/consent-graph/policy/j83-consent-rights-ledger.cedar` | Cedar permit/forbid bundle | Deny-wins gate |
| `microservices/consent-graph/runbooks/j83-consent-rights-ledger-rollback.md` | Rollback and incident path | Includes regulator deadline handling |
| `microservices/consent-graph/tests/j83_consent_rights_ledger_test.rs` | Integration tests | Positive, negative, rollback, audit |
...
- `J83ConsentGraphConsentRightsLedgerStarted`.
- `J83ConsentGraphConsentRightsLedgerPermitted`.
- `J83ConsentGraphConsentRightsLedgerDenied`.
- `J83ConsentGraphConsentRightsLedgerCommitted`.
- `J83ConsentGraphConsentRightsLedgerRolledBack`.

## Implementation rows

### IP row 001 - consent-graph consent-rights-ledger
Scope: implement one consent-graph behavior for j83, not a cross-service refactor.
