...
ip_id: IP-journey-j90-consent-rights-ledger
...
# IP-journey-j90-consent-rights-ledger - consent-graph

## Goal

Implement the `consent-rights-ledger` slice for `consent-graph` so j90 can satisfy `US-CCPA-CPRA-2023` without leaking tenant data, collapsing provider-BYOK and encryption-BYOK meanings, or bypassing Cedar.
...
| File | Purpose | Notes |
|---|---|---|
| `microservices/consent-graph/contracts/openapi/j90-consent-rights-ledger-v1.yaml` | OpenAPI 3.2.0 REST surface | External read/write or admin action |
| `microservices/consent-graph/contracts/asyncapi/j90-consent-rights-ledger-events-v1.yaml` | AsyncAPI 3.1.0 event surface | Emits ADR-0263 events |
| `microservices/consent-graph/contracts/proto/j90-consent-rights-ledger-v1.proto` | proto3 internal RPC | Service-to-service call path |
| `microservices/consent-graph/policy/j90-consent-rights-ledger.cedar` | Cedar permit/forbid bundle | Deny-wins gate |
| `microservices/consent-graph/runbooks/j90-consent-rights-ledger-rollback.md` | Rollback and incident path | Includes regulator deadline handling |
| `microservices/consent-graph/tests/j90_consent_rights_ledger_test.rs` | Integration tests | Positive, negative, rollback, audit |
...
- `J90ConsentGraphConsentRightsLedgerStarted`.
- `J90ConsentGraphConsentRightsLedgerPermitted`.
- `J90ConsentGraphConsentRightsLedgerDenied`.
- `J90ConsentGraphConsentRightsLedgerCommitted`.
- `J90ConsentGraphConsentRightsLedgerRolledBack`.

## Implementation rows

### IP row 001 - consent-graph consent-rights-ledger
Scope: implement one consent-graph behavior for j90, not a cross-service refactor.
