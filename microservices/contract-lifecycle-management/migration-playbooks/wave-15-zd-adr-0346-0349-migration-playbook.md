...
1. Search `contract-lifecycle-management` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `contract-lifecycle-management` manifest `governance_lanes` array only in the manifest-owning slot.
