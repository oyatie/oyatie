...
use oya_contract_lifecycle_management_contract_obligation_app::error::Result;
use std::path::PathBuf;
use std::process::ExitCode;

#[derive(Debug, Parser)]
#[command(name = "oya-contract-lifecycle-management-contract-obligation")]
#[command(about = "Contract Lifecycle Management µservice scaffold entrypoint")]
struct CliArgs {
    #[arg(long)]
...
fn run(args: CliArgs) -> Result<()> {
    ...
    tracing::info!(
        ...
        "contract lifecycle scaffold validated"
    );
    Ok(())
}
