...
impl AdapterRegistry {
    pub fn scaffolded() -> Self {
        Self {
            http_routes: http::ContractLifecycleHttpHandler::routes(),
            grpc_methods: grpc::ContractLifecycleGrpcHandler::methods(),
            asyncapi_channels: asyncapi::ContractLifecycleAsyncApiHandler::channels(),
        }
    }
