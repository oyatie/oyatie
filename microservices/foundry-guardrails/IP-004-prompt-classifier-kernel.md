...
One new Rust crate at `microservices/foundry-guardrails/src/crates/oya-foundry-guardrails-prompt-classifier-kernel/`. Workspace member added. Catalog row at `microservices/foundry-guardrails/catalog/`.
