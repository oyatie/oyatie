...
One new Rust crate at `microservices/foundry-guardrails/src/crates/oya-foundry-guardrails-output-validator-kernel/`. Sibling to IP-004's prompt-classifier-kernel.
