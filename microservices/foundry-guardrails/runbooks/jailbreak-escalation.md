...
date: 2026-05-17
related_artifacts:
  - microservices/foundry-guardrails/failure-modes.md (FM-06)
  - microservices/foundry-guardrails/incident-response.md (§"Jailbreak-Success Specific Protocol")
  - microservices/foundry-guardrails/threat-model.md (T-T-04, T-T-05, T-I-04)
