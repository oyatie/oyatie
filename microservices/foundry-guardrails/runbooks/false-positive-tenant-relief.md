...
date: 2026-05-17
related_artifacts:
  - microservices/foundry-guardrails/failure-modes.md (FM-08, FM-11)
  - microservices/foundry-guardrails/policy/guardrail-enforcement.md (§"Per-Tenant FP Escalation Budget")
...
- `microservices/foundry-guardrails/incident-response.md` §"FP escalation budget".
