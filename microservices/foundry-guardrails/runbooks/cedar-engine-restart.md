...
date: 2026-05-17
related_artifacts:
  - microservices/foundry-guardrails/failure-modes.md (FM-04, FM-05)
  - microservices/foundry-guardrails/iac/helm/cedar-engine/values.yaml
...
2. Compare to expected SHA from git: `bash microservices/foundry-guardrails/iac/cedar/build.sh microservices/foundry-guardrails/policy --check-sha`.
...
| Step | Action | Time |
|---|---|---|
| 1 | Compile bundle: `bash microservices/foundry-guardrails/iac/cedar/build.sh microservices/foundry-guardrails/policy` | ≤ 30s |
...
- `microservices/foundry-guardrails/failure-modes.md` FM-04 + FM-05.
- `microservices/foundry-guardrails/runbooks/policy-rule-rollback.md`.
- `microservices/foundry-guardrails/iac/helm/cedar-engine/values.yaml`.
