...
date: 2026-05-17
related_artifacts:
  - microservices/foundry-guardrails/failure-modes.md (FM-09, FM-10)
  - microservices/foundry-guardrails/multi-region.md
  - microservices/foundry-guardrails/iac/helm/postgres/values.yaml
...
| 3 | Promote RR: `bash microservices/foundry-guardrails/iac/postgres/failover.sh promote --rr <rr-host> --pack <p>` | ≤ 3 min |
...
| 2 | Restore from prior validated backup: `bash microservices/foundry-guardrails/iac/postgres/restore.sh --backup <prior-id> --pack <p> --target staging-ephemeral` | ≤ 1h |
...
- `microservices/foundry-guardrails/multi-region.md`.
- `microservices/foundry-guardrails/iac/helm/postgres/values.yaml`.
- `microservices/foundry-guardrails/iac/postgres/{failover,restore}.sh`.
