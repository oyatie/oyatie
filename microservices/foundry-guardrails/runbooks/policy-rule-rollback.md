...
date: 2026-05-17
related_artifacts:
  - microservices/foundry-guardrails/failure-modes.md (FM-07, FM-05)
...
- `microservices/foundry-guardrails/failure-modes.md` FM-05 + FM-07.
- `microservices/foundry-guardrails/policy/guardrail-enforcement.md`.
- `microservices/foundry-guardrails/iac/cedar/build.sh`.
- `microservices/foundry-guardrails/iac/postgres/migrations/001-init-schema.sql`.
