...
date: 2026-05-17
related_artifacts:
  - microservices/foundry-guardrails/failure-modes.md (FM-01, FM-02, FM-03, FM-14)
  - microservices/foundry-guardrails/incident-response.md
  - microservices/foundry-guardrails/iac/helm/classifier-model-serving/values.yaml
...
- `microservices/foundry-guardrails/policy/guardrail-enforcement.md` §"Shadow→Enforce".
- `microservices/foundry-guardrails/iac/helm/classifier-model-serving/values.yaml`.
