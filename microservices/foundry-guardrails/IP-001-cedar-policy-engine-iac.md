...
|---|---|---|
| `microservices/foundry-guardrails/iac/helm/cedar-engine/Chart.yaml` | create | Cedar v4 in-cluster serving |
| `microservices/foundry-guardrails/iac/helm/cedar-engine/values.yaml` | create | replica counts per `capacity-model.md`; image tag pinned to Cedar v4 LTS |
| `microservices/foundry-guardrails/iac/helm/cedar-engine/values-pack-kr.yaml` | create | pack-kr overlay |
| `microservices/foundry-guardrails/iac/kustomize/base/kustomization.yaml` | create | shared base (already in directory; this IP populates) |
| `microservices/foundry-guardrails/iac/kustomize/overlays/pack-kr/kustomization.yaml` | create | pack-kr overlay |
| `microservices/foundry-guardrails/policy/cedar-base.cedar` | create | base policy (default-deny) |
| `microservices/foundry-guardrails/policy/schema.cedarschema` | create | Cedar v4 schema for entities + actions |
| `microservices/foundry-guardrails/iac/cedar/build.sh` | create | bundle compilation pipeline (validates + signs bundle SHA) |
...
// Cedar v4 schema per microservices/foundry-guardrails/policy/schema.cedarschema
//
...
```bash
helm lint microservices/foundry-guardrails/iac/helm/cedar-engine
...
bash microservices/foundry-guardrails/iac/cedar/build.sh microservices/foundry-guardrails/policy
```

## Test Plan

- Per PHASE-01 §"Per-IP Test Coverage Threshold" IaC class: ≥ 1 helm-install + helm-test smoke per chart.
- `microservices/foundry-guardrails/tests/iac/cedar-engine.bats` runs `helm install --dry-run` + `helm test`.
