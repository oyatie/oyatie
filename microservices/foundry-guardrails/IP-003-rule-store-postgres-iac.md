...
|---|---|---|
| `microservices/foundry-guardrails/iac/helm/postgres/Chart.yaml` | create | bitnami/postgresql-ha pinned LTS |
| `microservices/foundry-guardrails/iac/helm/postgres/values.yaml` | create | HA + RLS + pgaudit + TDE |
| `microservices/foundry-guardrails/iac/helm/postgres/values-pack-kr.yaml` | create | pack-kr |
| `microservices/foundry-guardrails/iac/postgres/migrations/001-init-schema.sql` | create | tables: rule_definitions, cedar_fragments, audit_mutation_log, classifier_model_versions |
| `microservices/foundry-guardrails/iac/postgres/migrations/002-rls-policies.sql` | create | Row-level security per tenant + pack |
| `microservices/foundry-guardrails/iac/postgres/migrations/003-indexes.sql` | create | per `capacity-model.md` access patterns |
| `microservices/foundry-guardrails/iac/postgres/migrations/manifest.yaml` | create | ordered migration list + checksums |

## Acceptance Gates

```bash
helm lint microservices/foundry-guardrails/iac/helm/postgres
