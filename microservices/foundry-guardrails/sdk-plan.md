...
| **C# / .NET** | M03+ | OpenAPI-generated; NuGet | axis-foundry-guardrails + gtm |
| **Ruby** | M04+ (on demand only) | OpenAPI-generated | axis-foundry-guardrails |
...
- `#![deny(unsafe_code)]`.
- Published to oyatie internal registry; open-source decision deferred until ≥ 6mo stable.
