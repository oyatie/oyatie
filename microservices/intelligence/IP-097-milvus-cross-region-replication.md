...
| `microservices/intelligence/iac/kustomize/overlays/pack-kr/network-policy-egress.yaml` | create | 1-60 | deny egress to non-kr cells |
| `microservices/intelligence/iac/kustomize/overlays/pack-eu/network-policy-egress.yaml` | create | 1-60 | deny egress to non-eu cells |
| `microservices/intelligence/runbooks/milvus-residency-incident.md` | create | 1-180 | residency violation triage |
...
- Runbook: `microservices/intelligence/runbooks/milvus-residency-incident.md`.
