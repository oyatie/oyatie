...
|---|---|---|---|
| `microservices/intelligence/capacity-model-milvus.md` | edit | append §"GPU pool sizing" (lines ~80-130) | infra+capacity |
| `microservices/intelligence/iac/helm/milvus/values-gpu-overlay.yaml` | create | 1-90 | enables queryNode.gpu.enabled + indexNode.gpu.enabled |
| `microservices/intelligence/iac/kustomize/components/milvus-gpu/nvidia-device-plugin.yaml` | create | 1-60 | NVIDIA k8s device plugin DaemonSet |
| `microservices/intelligence/iac/kustomize/components/milvus-gpu/gpu-node-pool.yaml.tpl` | create | 1-50 | template for per-cluster GPU NodePool (provider-specific) |
| `microservices/intelligence/iac/kustomize/overlays/gpu-enabled/kustomization.yaml` | create | 1-25 | composition switch |
| `microservices/intelligence/iac/kustomize/overlays/gpu-enabled/cost-budget-pin.yaml` | create | 1-40 | mandatory cost-budget pin per ADR-0001 |
| `microservices/intelligence/cost-budget-gpu-overlay.md` | create | 1-180 | per-tier GPU cost forecast + breakeven analysis |
| `microservices/intelligence/runbooks/milvus-gpu-rollout.md` | create | 1-160 | step-by-step gated rollout |
| `microservices/intelligence/runbooks/milvus-gpu-rollback.md` | create | 1-120 | revert to CPU path |
...
- Capacity model: `microservices/intelligence/capacity-model-milvus.md` §"GPU pool sizing".
- Runbooks: `microservices/intelligence/runbooks/milvus-gpu-rollout.md`, `milvus-gpu-rollback.md`.
