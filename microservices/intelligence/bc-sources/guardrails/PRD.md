...
- Error budget policy: `microservices/intelligence-guardrails/slos/error-budget-policy.md`.
...
- `microservices/intelligence-runtime/PRD.md` (the consumer)
- `microservices/intelligence-providers/PRD.md` (the downstream gated by guardrails)
- `microservices/intelligence-supervisor/PRD.md` (autonomy-policy source)
