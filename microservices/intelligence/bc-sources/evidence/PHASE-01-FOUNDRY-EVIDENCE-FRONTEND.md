...
|---|---|---|
| `foundry-evidence` | `capability-invocation-recorder`, `evidence-pack-builder`, `eval-evidence-aggregator`, `evidence-query`, `regulator-export` | All under `microservices/intelligence-evidence/` per ADR-0131; ~12 new Rust crates across BCs |
...
| [`IP-002-self-slo-manifest.md`](IP-002-self-slo-manifest.md) | OpenSLO manifests at `microservices/intelligence-evidence/slos/` for pack_assembly_latency / evidence_query_latency / audit_chain_backlog_depth / regulator_export_latency | pending | axis-foundry-evidence | observability P01 |
