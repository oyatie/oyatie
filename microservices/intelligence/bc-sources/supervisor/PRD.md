...
Hyperscaler peers: AWS Bedrock Agents control plane, Anthropic Claude control plane, OpenAI Assistants admin API, Google Vertex AI Agent admin. Parity matrix at `microservices/intelligence-supervisor/competitor-parity-matrix.md`.
...
- microservice = foundry-supervisor: per ADR-0131 §"Foundry split"; flat layout under
  microservices/intelligence-supervisor/. No legacy bundle prefix.
...
- Self-SLOs authored in `microservices/intelligence-supervisor/slos/`; consumed by `observability` per ADR-0139.
