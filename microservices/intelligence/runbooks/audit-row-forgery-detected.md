...
16. Run crate smoke test: `cargo test -p oya-foundry-adapter-openai-api-kernel audit_row_forgery_detected -- --nocapture`.
...
7. Pause promotion: `oya vcs hold --microservice intelligence --reason $INCIDENT_ID --runbook audit-row-forgery-detected`.
...
2. Patch domain invariant: `edit oya-foundry-adapter-openai-api-kernel where audit_row_forgery_detected state transition is validated`.
...
6. Add regression test: `cargo test -p oya-foundry-adapter-openai-api-kernel audit_row_forgery_detected_incident_regression -- --nocapture`.
...
- `oya-foundry-adapter-openai-api-kernel`: inspect for `audit_row_forgery_detected` invariants, alert emission, ADR-0263 evidence fields, and tenant/cell scoping before touching adjacent code.
- `oya-foundry-rag-api`: inspect for `audit_row_forgery_detected` invariants, alert emission, ADR-0263 evidence fields, and tenant/cell scoping before touching adjacent code.
- `oya-foundry-rag-endpoint-kernel`: inspect for `audit_row_forgery_detected` invariants, alert emission, ADR-0263 evidence fields, and tenant/cell scoping before touching adjacent code.
- `oya-foundry-eval-domain`: inspect for `audit_row_forgery_detected` invariants, alert emission, ADR-0263 evidence fields, and tenant/cell scoping before touching adjacent code.
