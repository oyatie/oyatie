...
6. Hold corpus deploys: `oya vcs hold --microservice intelligence --reason $INCIDENT_ID --scope rag-corpus`.
...
9. Run RAG tests: `cargo test -p oya-foundry-rag-api rag_corpus -- --nocapture`.
10. Run eval tests: `cargo test -p oya-foundry-eval-domain rag_retrieval -- --nocapture`.
...
14. Unhold deploys: `oya vcs unhold --microservice intelligence --reason resolved-$INCIDENT_ID`.
