...
16. Run crate smoke test: `cargo test -p oya-foundry-adapter-openai-api-kernel rag_retrieval_quality_regression -- --nocapture`.
...
7. Pause promotion: `oya vcs hold --microservice intelligence --reason $INCIDENT_ID --runbook rag-retrieval-quality-regression`.
...
2. Patch domain invariant: `edit oya-foundry-adapter-openai-api-kernel where rag_retrieval_quality_regression state transition is validated`.
...
6. Add regression test: `cargo test -p oya-foundry-adapter-openai-api-kernel rag_retrieval_quality_regression_incident_regression -- --nocapture`.
...
- `oya-foundry-adapter-openai-api-kernel`: inspect for `rag_retrieval_quality_regression` invariants, alert emission, ADR-0263 evidence fields, and tenant/cell scoping before touching adjacent code.
- `oya-foundry-rag-api`: inspect for `rag_retrieval_quality_regression` invariants, alert emission, ADR-0263 evidence fields, and tenant/cell scoping before touching adjacent code.
- `oya-foundry-rag-endpoint-kernel`: inspect for `rag_retrieval_quality_regression` invariants, alert emission, ADR-0263 evidence fields, and tenant/cell scoping before touching adjacent code.
- `oya-foundry-eval-domain`: inspect for `rag_retrieval_quality_regression` invariants, alert emission, ADR-0263 evidence fields, and tenant/cell scoping before touching adjacent code.
