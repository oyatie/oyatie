...
Rust crates:
- `microservices/intelligence/src/crates/oya-foundry-supervisor-{bc}-sdk/`

TypeScript SDK (scaffold):
- `microservices/intelligence/sdk-generation/typescript/{package.json, src/, openapi-generator-config.yaml}`
...
(cd microservices/intelligence/sdk-generation/typescript && npm run build && npm test)
```
