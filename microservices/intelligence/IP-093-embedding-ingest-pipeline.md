...
| `microservices/intelligence/iac/kustomize/components/milvus-ingest/deployment.yaml` | create | 1-90 | 3-replica HPA |
| `microservices/intelligence/iac/kustomize/components/milvus-ingest/hpa.yaml` | create | 1-30 | scale on Pulsar consumer lag |
...
- OpenSLO: `microservices/intelligence/slos/milvus-ingest-lag.openslo.yaml`.
