...
1. Search `intelligence` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `intelligence` manifest `governance_lanes` array only in the manifest-owning slot.
