...
ip_id: IP-journey-j83-risk-and-explanation
...
# IP-journey-j83-risk-and-explanation - intelligence

## Goal

Implement the `risk-and-explanation` slice for `intelligence` so j83 can satisfy `CN-PIPL-2021` without leaking tenant data, collapsing provider-BYOK and encryption-BYOK meanings, or bypassing Cedar.
...
| File | Purpose | Notes |
|---|---|---|
| `microservices/intelligence/contracts/openapi/j83-risk-and-explanation-v1.yaml` | OpenAPI 3.2.0 REST surface | External read/write or admin action |
| `microservices/intelligence/contracts/asyncapi/j83-risk-and-explanation-events-v1.yaml` | AsyncAPI 3.1.0 event surface | Emits ADR-0263 events |
| `microservices/intelligence/contracts/proto/j83-risk-and-explanation-v1.proto` | proto3 internal RPC | Service-to-service call path |
| `microservices/intelligence/policy/j83-risk-and-explanation.cedar` | Cedar permit/forbid bundle | Deny-wins gate |
| `microservices/intelligence/runbooks/j83-risk-and-explanation-rollback.md` | Rollback and incident path | Includes regulator deadline handling |
| `microservices/intelligence/tests/j83_risk_and_explanation_test.rs` | Integration tests | Positive, negative, rollback, audit |
...
- `J83IntelligenceRiskAndExplanationStarted`.
- `J83IntelligenceRiskAndExplanationPermitted`.
- `J83IntelligenceRiskAndExplanationDenied`.
- `J83IntelligenceRiskAndExplanationCommitted`.
- `J83IntelligenceRiskAndExplanationRolledBack`.

## Implementation rows

### IP row 001 - intelligence risk-and-explanation
Scope: implement one intelligence behavior for j83, not a cross-service refactor.
