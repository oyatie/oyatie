...
One new crate `microservices/intelligence/src/crates/oya-foundry-providers-router-usecase/`. Depends on `oya-foundry-providers-router-kernel` + `oya-foundry-providers-router-domain`.
