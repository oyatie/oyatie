...
- `microservices/intelligence/threat-model.md` T-T-01 + T-T-04 + T-T-06.
- `microservices/intelligence/dpia.md` R-01 + R-02 + R-06 + R-07.
- `microservices/intelligence/policy/*.cedar`.
- `microservices/intelligence/incident-response.md` (FP / jailbreak escalation).
