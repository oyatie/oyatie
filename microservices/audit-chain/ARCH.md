...
related_adrs:
  ...
  - ADR-0349
companion_docs:
  - microservices/audit-chain/manifest.json
  - microservices/audit-chain/PRD.md
  - microservices/audit-chain/README.md
...
`audit-chain` keeps its existing bounded context and flat `microservices/audit-chain/src/` ownership under ADR-0131 and ADR-0132. This `ARCH.md` is the Wave 15-ZF architecture propagation surface for ADR-0346, ADR-0347, ADR-0348, and ADR-0349; service-specific deep architecture remains in `ARCHITECTURE.md` when that artifact exists.
