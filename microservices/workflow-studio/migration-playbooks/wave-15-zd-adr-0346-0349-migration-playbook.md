...
1. Search `workflow-studio` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `workflow-studio` manifest `governance_lanes` array only in the manifest-owning slot.
