...
1. Search `supply-chain-planning` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `supply-chain-planning` manifest `governance_lanes` array only in the manifest-owning slot.
