...
1. Search `drive` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `drive` manifest `governance_lanes` array only in the manifest-owning slot.
