...
date: 2026-05-17
related_artifacts:
  - microservices/foundry-eval/failure-modes.md (FM-05 golden-output integrity)
  - microservices/foundry-eval/threat-model.md (T-T-02)
...
- `microservices/foundry-eval/failure-modes.md` FM-05.
- `microservices/foundry-eval/threat-model.md` T-T-02.
- `microservices/foundry-eval/policy/two-person-admin-ops.md`.
