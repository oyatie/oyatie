...
date: 2026-05-17
related_artifacts:
  - microservices/foundry-eval/failure-modes.md (FM-01 eval-set authoring)
...
- Per-changeset evidence at `microservices/foundry-eval/evidence/multispectrum/` updated.

## References

- ADR-0024 §"Eval kernel" + §"Publish-time eval gate".
- `microservices/foundry-eval/failure-modes.md` FM-01.
- `microservices/foundry-eval/incident-response.md`.
- `microservices/foundry-eval/policy/two-person-admin-ops.md`.
