...
date: 2026-05-17
related_artifacts:
  - microservices/foundry-eval/failure-modes.md (FM-06 ClickHouse rebalance)
  - microservices/foundry-eval/threat-model.md (T-D-02, T-I-01)
...
- `microservices/foundry-eval/failure-modes.md` FM-06.
- `microservices/foundry-eval/threat-model.md` T-D-02, T-I-01.
