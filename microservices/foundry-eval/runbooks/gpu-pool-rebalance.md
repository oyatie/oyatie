...
date: 2026-05-17
related_artifacts:
  - microservices/foundry-eval/failure-modes.md (FM-02 GPU pool exhaustion)
  - microservices/foundry-eval/threat-model.md (T-D-01)
...
- `microservices/foundry-eval/failure-modes.md` FM-02.
- `microservices/foundry-eval/threat-model.md` T-D-01.
- `microservices/foundry-eval/capacity-model.md`.
