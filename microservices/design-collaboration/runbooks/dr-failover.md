# design-collaboration DR failover runbook

## Purpose

Recover the design-collaboration service inside the declared ADR-0343 DR envelope without changing tenant version pins or weakening Cedar admission.

## Recovery order

1. Freeze new mutating ingress for design-collaboration at api-gateway while read-only routes stay available when data freshness permits.
...
3. freeze component publish, promote design asset storage, replay review events, and reopen prototype/share surfaces after ACL checks pass.
