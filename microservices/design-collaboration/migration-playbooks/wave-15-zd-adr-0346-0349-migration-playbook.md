...
1. Search `design-collaboration` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `design-collaboration` manifest `governance_lanes` array only in the manifest-owning slot.
