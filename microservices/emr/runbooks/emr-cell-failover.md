# EMR Cell Failover Runbook

## Purpose

Restore EMR tenant service within the manifest DR target while preserving tenant isolation, audit evidence, and declared backup-substrate order.
