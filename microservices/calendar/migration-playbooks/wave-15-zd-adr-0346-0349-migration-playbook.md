...
1. Search `calendar` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `calendar` manifest `governance_lanes` array only in the manifest-owning slot.
