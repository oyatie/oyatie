...
## B. Approach
Use OpenTofu-rendered module inputs through cloud-iac, validate residency in `microservices/cloud-iac/policy/data-residency.md`, apply through iac-applier, and record readiness in iac-registry. Operational evidence comes from `microservices/cloud-iac/runbooks/drift-remediation.md` and `microservices/cloud-iac/dashboards/drift-coverage.json`.

## C. Deliverables
- MENA region/pack examples in `microservices/cloud-iac/contracts/openapi/cloud-iac.yaml`.
- Drift and apply events in `microservices/cloud-iac/contracts/asyncapi/cloud-iac-events.yaml`.
...
- Surface evidence: `microservices/cloud-iac/contracts/openapi/cloud-iac.yaml`, `microservices/cloud-iac/contracts/asyncapi/cloud-iac-events.yaml`, `microservices/cloud-iac/contracts/proto/cloud-iac.proto`, `microservices/cloud-iac/IP-journey-j96-ksa-uae-mena-onboarding.md`.
