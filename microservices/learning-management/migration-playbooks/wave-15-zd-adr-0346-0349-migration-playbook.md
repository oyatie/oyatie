...
1. Search `learning-management` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `learning-management` manifest `governance_lanes` array only in the manifest-owning slot.
