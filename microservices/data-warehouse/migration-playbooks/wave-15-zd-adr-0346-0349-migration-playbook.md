...
1. Search `data-warehouse` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `data-warehouse` manifest `governance_lanes` array only in the manifest-owning slot.
