...
## B. Approach
Implement `workflow-template-library` as a service-local slice, not as a shared suite facility. The technical mechanism is incident response template publication bound to `workflow-engine template binding` and checked before user-visible promotion.
