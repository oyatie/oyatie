...
## B. Approach
Implement `rest-contract-surface` as a service-local slice, not as a shared suite facility. The technical mechanism is HTTP command/query API bound to `adapter/http.rs` and checked before user-visible promotion.
