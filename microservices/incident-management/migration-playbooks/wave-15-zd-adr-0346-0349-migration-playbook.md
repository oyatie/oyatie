...
1. Search `incident-management` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `incident-management` manifest `governance_lanes` array only in the manifest-owning slot.
