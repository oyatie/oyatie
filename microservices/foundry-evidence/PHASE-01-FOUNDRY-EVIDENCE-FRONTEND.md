...
- Nothing deferred (no "later we'll add EU AI Act profile" stubs).
...
P02-foundry-evidence-vertical-overlays (post-M01): pack-specific evidence-pack schema extensions (EU MDR for medical-device tenants on pack-eu; FDA 21 CFR Part 11 for pack-us-healthcare; KR-FSS sector overlay for pack-kr financial-services tenants).
