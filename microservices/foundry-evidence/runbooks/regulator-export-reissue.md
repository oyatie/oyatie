...
date: 2026-05-17
related_artifacts:
  - microservices/foundry-evidence/failure-modes.md (FM-07, FM-08)
  - microservices/foundry-evidence/policy/regulator-export-scope.cedar
  - microservices/foundry-evidence/runbooks/evidence-pack-rebuild.md
  - microservices/foundry-evidence/incident-response.md
...
- If defect was superseded-pack propagation, file a follow-up to make pack-rebuild trigger automatic regulator-export notification.
