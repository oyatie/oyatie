...
date: 2026-05-17
related_artifacts:
  - microservices/foundry-evidence/failure-modes.md (FM-10, FM-11)
  - microservices/foundry-evidence/policy/data-residency.md (DR-02, DR-05)
  - microservices/foundry-evidence/multi-region.md
...
1. Helm-apply foundry-evidence stack in receiving region:
   ...
   helm upgrade --install foundry-evidence \
     microservices/foundry-evidence/iac/helm/evidence-builder \
