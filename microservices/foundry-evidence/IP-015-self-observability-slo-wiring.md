...
| `microservices/foundry-evidence/contracts/openapi/foundry-evidence.yaml` | edit | wire `/transparency/claim-matrix` endpoint to load from a generated registry + claim assertions |
| `microservices/foundry-evidence/capabilities/eval/claim-matrix.json` | create | machine-readable claim-matrix sourced for the public-read endpoint |
...
`P02-foundry-evidence-vertical-overlays` (post-M01): pack-specific evidence-pack schema extensions.
