...
1. Search `imaging` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `imaging` manifest `governance_lanes` array only in the manifest-owning slot.
