...
impl_plan_id: IP-015-async-esign-events
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-015: Async Esign Events

## Intent
Deliver the async-esign-events slice for Workplace Integration while preserving WorkplaceAgreement, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0320.

## Existing journey anchor
This IP is additive to `microservices/workplace-integration/IP-journey-j63-informed-consent.md` and weaves Informed Consent into the build sequence.
...
4. Cedar action workplace-integration.async-esign-events.execute using BNF v4.
