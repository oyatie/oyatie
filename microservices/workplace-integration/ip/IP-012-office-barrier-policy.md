...
impl_plan_id: IP-012-office-barrier-policy
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-012: Office Barrier Policy

## Intent
Deliver the office-barrier-policy slice for Workplace Integration while preserving WorkplaceAgreement, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0320.

## Existing journey anchor
This IP is additive to `microservices/workplace-integration/IP-journey-j51-e-sign-on-po.md` and weaves E Sign On Po into the build sequence.
...
4. Cedar action workplace-integration.office-barrier-policy.execute using BNF v4.
