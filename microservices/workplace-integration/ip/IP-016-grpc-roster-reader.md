...
impl_plan_id: IP-016-grpc-roster-reader
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-016: Grpc Roster Reader

## Intent
Deliver the grpc-roster-reader slice for Workplace Integration while preserving WorkplaceAgreement, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0320.

## Existing journey anchor
This IP is additive to `microservices/workplace-integration/IP-journey-j70-e-sign.md` and weaves E Sign into the build sequence.
...
4. Cedar action workplace-integration.grpc-roster-reader.execute using BNF v4.
