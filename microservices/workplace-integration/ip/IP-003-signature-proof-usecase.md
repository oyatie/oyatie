...
impl_plan_id: IP-003-signature-proof-usecase
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-003: Signature Proof Usecase

## Intent
Deliver the signature-proof-usecase slice for Workplace Integration while preserving WorkplaceAgreement, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0320.
...
4. Cedar action workplace-integration.signature-proof-usecase.execute using BNF v4.
