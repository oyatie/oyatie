...
impl_plan_id: IP-013-dlp-trace-domain
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-013: Dlp Trace Domain

## Intent
Deliver the dlp-trace-domain slice for Workplace Integration while preserving WorkplaceAgreement, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0320.

## Existing journey anchor
This IP is additive to `microservices/workplace-integration/IP-journey-j54-e-signature.md` and weaves E Signature into the build sequence.
...
4. Cedar action workplace-integration.dlp-trace-domain.execute using BNF v4.
