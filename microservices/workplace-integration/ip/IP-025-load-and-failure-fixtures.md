...
impl_plan_id: IP-025-load-and-failure-fixtures
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-025: Load And Failure Fixtures

## Intent
Deliver the load-and-failure-fixtures slice for Workplace Integration while preserving WorkplaceAgreement, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0320.

## Existing journey anchor
This IP is additive to `microservices/workplace-integration/IP-journey-j140-internal-audit-dlp-egress-cross-tenant-trace.md` and weaves Internal Audit Dlp Egress Cross Tenant Trace into the build sequence.
...
4. Cedar action workplace-integration.load-and-failure-fixtures.execute using BNF v4.
5. Audit event WorkplaceAgreementBound.
