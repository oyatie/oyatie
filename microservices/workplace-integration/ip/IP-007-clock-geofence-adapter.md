...
impl_plan_id: IP-007-clock-geofence-adapter
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-007: Clock Geofence Adapter

## Intent
Deliver the clock-geofence-adapter slice for Workplace Integration while preserving WorkplaceAgreement, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0320.
...
4. Cedar action workplace-integration.clock-geofence-adapter.execute using BNF v4.
5. Audit event WorkplaceDlpTraceSealed.
