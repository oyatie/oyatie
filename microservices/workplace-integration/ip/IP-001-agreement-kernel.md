...
impl_plan_id: IP-001-agreement-kernel
...
## Intent
Deliver the agreement-kernel slice for Workplace Integration while preserving WorkplaceAgreement, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0320.
...
4. Cedar action workplace-integration.agreement-kernel.execute using BNF v4.
