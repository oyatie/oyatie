...
impl_plan_id: IP-018-identity-provisioning-port
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-018: Identity Provisioning Port

## Intent
Deliver the identity-provisioning-port slice for Workplace Integration while preserving WorkplaceAgreement, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0320.

## Existing journey anchor
This IP is additive to `microservices/workplace-integration/IP-journey-j110-esign-roster-binding.md` and weaves Esign Roster Binding into the build sequence.
...
4. Cedar action workplace-integration.identity-provisioning-port.execute using BNF v4.
