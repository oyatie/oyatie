...
impl_plan_id: IP-023-dashboard-and-slo-pack
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-023: Dashboard And Slo Pack

## Intent
Deliver the dashboard-and-slo-pack slice for Workplace Integration while preserving WorkplaceAgreement, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0320.

## Existing journey anchor
This IP is additive to `microservices/workplace-integration/IP-journey-j132-offer-letter-esign-per-jurisdiction.md` and weaves Offer Letter Esign Per Jurisdiction into the build sequence.
...
4. Cedar action workplace-integration.dashboard-and-slo-pack.execute using BNF v4.
