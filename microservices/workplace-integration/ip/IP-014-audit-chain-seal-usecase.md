...
impl_plan_id: IP-014-audit-chain-seal-usecase
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-014: Audit Chain Seal Usecase

## Intent
Deliver the audit-chain-seal-usecase slice for Workplace Integration while preserving WorkplaceAgreement, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0320.

## Existing journey anchor
This IP is additive to `microservices/workplace-integration/IP-journey-j56-offer-e-sign.md` and weaves Offer E Sign into the build sequence.
...
4. Cedar action workplace-integration.audit-chain-seal-usecase.execute using BNF v4.
