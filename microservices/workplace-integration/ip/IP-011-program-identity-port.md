...
impl_plan_id: IP-011-program-identity-port
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-011: Program Identity Port

## Intent
Deliver the program-identity-port slice for Workplace Integration while preserving WorkplaceAgreement, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0320.

## Existing journey anchor
This IP is additive to `microservices/workplace-integration/IP-journey-j38-e-sign-session.md` and weaves E Sign Session into the build sequence.
...
4. Cedar action workplace-integration.program-identity-port.execute using BNF v4.
