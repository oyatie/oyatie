...
impl_plan_id: IP-022-sovereign-pack-overlay
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-022: Sovereign Pack Overlay

## Intent
Deliver the sovereign-pack-overlay slice for Workplace Integration while preserving WorkplaceAgreement, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0320.

## Existing journey anchor
This IP is additive to `microservices/workplace-integration/IP-journey-j121-esign-closing-package.md` and weaves Esign Closing Package into the build sequence.
...
4. Cedar action workplace-integration.sovereign-pack-overlay.execute using BNF v4.
5. Audit event WorkplaceESignSessionCreated.
