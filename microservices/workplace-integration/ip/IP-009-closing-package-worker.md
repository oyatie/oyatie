...
impl_plan_id: IP-009-closing-package-worker
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-009: Closing Package Worker

## Intent
Deliver the closing-package-worker slice for Workplace Integration while preserving WorkplaceAgreement, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0320.
...
4. Cedar action workplace-integration.closing-package-worker.execute using BNF v4.
5. Audit event WorkplaceSignatureCaptured.
