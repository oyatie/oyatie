...
impl_plan_id: IP-019-drive-archive-adapter
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-019: Drive Archive Adapter

## Intent
Deliver the drive-archive-adapter slice for Workplace Integration while preserving WorkplaceAgreement, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0320.

## Existing journey anchor
This IP is additive to `microservices/workplace-integration/IP-journey-j112-esign-roster-binding.md` and weaves Esign Roster Binding into the build sequence.
...
4. Cedar action workplace-integration.drive-archive-adapter.execute using BNF v4.
