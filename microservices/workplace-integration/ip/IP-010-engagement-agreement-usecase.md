...
impl_plan_id: IP-010-engagement-agreement-usecase
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-010: Engagement Agreement Usecase

## Intent
Deliver the engagement-agreement-usecase slice for Workplace Integration while preserving WorkplaceAgreement, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0320.

## Existing journey anchor
This IP is additive to `microservices/workplace-integration/IP-journey-j37-clock-in-geofence.md` and weaves Clock In Geofence into the build sequence.
...
4. Cedar action workplace-integration.engagement-agreement-usecase.execute using BNF v4.
