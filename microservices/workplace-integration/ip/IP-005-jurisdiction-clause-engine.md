...
impl_plan_id: IP-005-jurisdiction-clause-engine
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-005: Jurisdiction Clause Engine

## Intent
Deliver the jurisdiction-clause-engine slice for Workplace Integration while preserving WorkplaceAgreement, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0320.

## Existing journey anchor
This IP is additive to `microservices/workplace-integration/IP-journey-j114-esign-roster-binding.md` and weaves Esign Roster Binding into the build sequence.
...
4. Cedar action workplace-integration.jurisdiction-clause-engine.execute using BNF v4.
5. Audit event WorkplaceRosterBindingGranted.
