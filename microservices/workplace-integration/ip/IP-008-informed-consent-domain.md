...
# IP-008: Informed Consent Domain

## Intent
Deliver the informed-consent-domain slice for Workplace Integration while preserving WorkplaceAgreement, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0320.
...
4. Cedar action workplace-integration.informed-consent-domain.execute using BNF v4.
