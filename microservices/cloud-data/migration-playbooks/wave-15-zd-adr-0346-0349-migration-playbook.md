...
1. Search `cloud-data` artifact surfaces for `oya-foundry-fitness-*` references.
...
4. Update any future `cloud-data` manifest `fitness_lanes` array only in the manifest-owning slot.
