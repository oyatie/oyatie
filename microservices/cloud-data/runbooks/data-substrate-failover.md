# cloud-data DR Failover Runbook

## Purpose
Restore the cloud-data service to the manifest-declared RTO/RPO without changing tenant isolation, compliance-pack placement, or audit-chain evidence.
