...
**anonymous is NET-NEW** per parallel ADR-0238. No `oya-connect-anonymous-*` crates exist; there is no migration-from-connect.md or deprecation-notice.md.
