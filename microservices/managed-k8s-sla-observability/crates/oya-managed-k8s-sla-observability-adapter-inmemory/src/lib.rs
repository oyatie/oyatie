...
use oya_managed_k8s_sla_observability_api::{
...
mod tests {
    use super::*;
    use oya_managed_k8s_sla_observability_api::{ObservedControlPlaneStatus, StatusWindow};
    use oya_managed_k8s_sla_observability_kernel::{AvailabilityState, ProvisioningLatencyState};
