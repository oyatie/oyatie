...
inbound_citations: [microservices/connector/ARCHITECTURE.md]
review_cadence: semiannually + on every BC addition
doc_status: published
---

# Threat Model — connector (Integration Substrate)
...
| Kill-switch | `kubectl annotate ns connector oya.kill-switch=true` per ADR-0295 |
