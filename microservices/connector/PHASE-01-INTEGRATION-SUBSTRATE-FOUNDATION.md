...
Stand up the connector service as the canonical integration substrate: 8 BCs × 8 layers (kernel/domain/usecase/api/adapter/rest/grpc/worker) = 64 base crates, plus 30 seed connector adapters, plus the OAuth broker + webhook receiver runtime, plus abuse-defence wiring (ADR-0297), plus full Cedar gate roster.
