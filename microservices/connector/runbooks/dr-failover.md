# connect DR failover runbook

## Trigger

- Primary region or cell cannot meet the manifest RTO/RPO contract.
- Cedar, OpenBao, Postgres, Valkey, object storage, or audit-chain dependencies for connect are degraded beyond the service SLO.

## Authority

- ADR-0343 DR matrix.
- Manifest `dr` block in `microservices/connector/manifest.json`.
