---
doc_class: Runbook
doc_id: RUNBOOK-CONNECTOR-COLD_MERGE
...
## Operator Contract
- Runbook id: connector-cold-merge.
...
## Preflight Checklist
1. Set incident context: `export INCIDENT_ID=INC-connector-cold-merge-$(date -u +%Y%m%dT%H%M%SZ); export SERVICE=connector; export CELL=prod-us-east-1; export TENANT=synthetic-canary`.
