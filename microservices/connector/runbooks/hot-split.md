---
doc_class: Runbook
doc_id: RUNBOOK-CONNECTOR-HOT_SPLIT
...
## Operator Contract
- Runbook id: connector-hot-split.
...
## Preflight Checklist
1. Set incident context: `export INCIDENT_ID=INC-connector-hot-split-$(date -u +%Y%m%dT%H%M%SZ); export SERVICE=connector; export CELL=prod-us-east-1; export TENANT=synthetic-canary`.
