...
The `ConnectorAdapter` Rust trait is the stable ABI boundary between the connector microservice core and all first-party and third-party connector implementations. Any code implementing this trait for marketplace publishing (MPO flow per ADR-0249) MUST conform to this contract.
