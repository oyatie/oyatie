...
companion_docs:
  - microservices/connector/catalog/oya-connector-oauth-broker-domain.yaml
  - microservices/connector/catalog/oya-connector-oauth-broker-kernel.yaml
...
Implement `oya-connector-oauth-broker-domain` and `oya-connector-oauth-broker-kernel` — OAuth 2.0 + OIDC authorization code + PKCE flow initiation, callback, refresh, and revocation with per-tenant provider-BYOK credential isolation via OpenBao sidecars.
...
- `microservices/connector/policy/oauth-broker-authorization.cedar` — concrete artifact to verify or update.
- `microservices/connector/capabilities/oauth-grant-initiate.yaml` — concrete artifact to verify or update.
- `microservices/connector/iac/openbao-policy.hcl` — concrete artifact to verify or update.
- `microservices/connector/catalog/oya-connector-oauth-broker-domain.yaml` — concrete artifact to verify or update.
...
- `microservices/connector/policy/oauth-broker-authorization.cedar`
- `microservices/connector/capabilities/oauth-grant-initiate.yaml`
