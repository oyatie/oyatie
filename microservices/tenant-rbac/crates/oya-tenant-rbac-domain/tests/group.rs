...
use oya_tenant_rbac_domain::{
    CloseBoundaryState, GroupRollupInput, Jurisdiction, LegalEntityCloseSnapshot,
    TenantRbacDomainError, roll_up_group_close_status,
};
...
fn test_group_rollup_preserves_entity_boundaries() {
    ...
    assert_eq!(
        ...
        "projection/tenant-rbac/group/kr"
    );
}
...
fn test_group_rollup_rejects_cross_tenant_entity() {
    ...
    assert_eq!(error, TenantRbacDomainError::CrossTenantLegalEntity);
}
