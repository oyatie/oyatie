...
Register HG-DOCS as a BLOCKER lane in `.github/branch-protection.yaml`. Docs promotion past dev requires HG-DOCS green per ADR-0123 + ADR-0130. Wire all 9 OpenSLO manifests + all per-BC CI lanes into branch-protection.
