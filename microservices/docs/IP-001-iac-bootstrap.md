...
|---|---|---|
| `microservices/docs/iac/helm/Chart.yaml` | created in this ChangeSet | dependencies: postgres 16.4, valkey 8.1 (Redis wire-compat), ClamAV 1.3, OPSWAT MetaDefender container 5.x, gVisor 2024-Q4 LTS |
