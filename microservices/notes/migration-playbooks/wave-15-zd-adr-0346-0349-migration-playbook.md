...
1. Search `notes` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `notes` manifest `governance_lanes` array only in the manifest-owning slot.
