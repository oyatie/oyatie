...
impl AsyncApiHandler {
    pub fn channels() -> Vec<AsyncApiChannel> {
        vec![
            AsyncApiChannel { channel: "real-estate.command.accepted.v1", direction: ChannelDirection::Publish, message: "CommandAccepted" },
            AsyncApiChannel { channel: "real-estate.reconciliation.queued.v1", direction: ChannelDirection::Publish, message: "ReconciliationQueued" },
            AsyncApiChannel { channel: "real-estate.governance.hold-applied.v1", direction: ChannelDirection::Publish, message: "GovernanceHoldApplied" },
            AsyncApiChannel { channel: "real-estate.facility.changed.v1", direction: ChannelDirection::Subscribe, message: "FacilityChanged" },
            AsyncApiChannel { channel: "real-estate.accounting.changed.v1", direction: ChannelDirection::Subscribe, message: "AccountingChanged" },
        ]
    }
