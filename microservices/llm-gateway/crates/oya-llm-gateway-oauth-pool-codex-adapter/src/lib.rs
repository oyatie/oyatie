//! llm-gateway Codex adapter — OpenAI Codex OAuth subscription pool (ADR-0384 Path B, v1).
//!
...
pub use oya_llm_gateway_oauth_pool_kernel::{AgentId, Provider, SeatId, TenantId};
