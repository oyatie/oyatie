...
//!
//! Implements [`OpenBaoSecretStore`] from `oya-llm-gateway-oauth-pool-rest`
...
pub use oya_llm_gateway_oauth_pool_rest::{OpenBaoSecretStore, RestAdapterError};
...
pub struct OpenBaoTransitStore {
    ...
    /// same KV prefix (e.g. /v1/secret/data/llm-gateway-rt/<handle>).
