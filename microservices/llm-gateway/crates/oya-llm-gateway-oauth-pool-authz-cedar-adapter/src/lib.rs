...
//! from `microservices/llm-gateway/policy/llm-gateway.cedar` (or a caller-
...
pub const DEFAULT_POLICY_TEXT: &str = include_str!("../../../policy/llm-gateway.cedar");
...
impl CedarAuthzGate {
    ...
    /// Build from the bundled `llm-gateway.cedar` policy.
