...
## B. Approach
Implement `dpia-evidence-packet` as a service-local slice, not as a shared suite facility. The technical mechanism is data-flow and lawful-basis proof for regulators bound to `privacy evidence bundle` and checked before user-visible promotion.
