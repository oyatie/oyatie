...
## B. Approach
Implement `sdk-client-generation` as a service-local slice, not as a shared suite facility. The technical mechanism is generated clients with policy/audit/idempotency envelopes bound to `sdk contract surface` and checked before user-visible promotion.
