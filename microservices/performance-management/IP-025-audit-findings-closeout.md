...
## B. Approach
Implement `audit-findings-closeout` as a service-local slice, not as a shared suite facility. The technical mechanism is finding-to-artifact closure with verification links bound to `remediation ledger` and checked before user-visible promotion.
