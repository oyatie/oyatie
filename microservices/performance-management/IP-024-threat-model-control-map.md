...
## B. Approach
Implement `threat-model-control-map` as a service-local slice, not as a shared suite facility. The technical mechanism is abuse, insider, replay, cross-tenant and vendor-egress controls bound to `STRIDE/control map` and checked before user-visible promotion.
