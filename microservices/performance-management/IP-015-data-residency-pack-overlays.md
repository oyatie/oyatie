...
## B. Approach
Implement `data-residency-pack-overlays` as a service-local slice, not as a shared suite facility. The technical mechanism is higher-restriction-wins residency enforcement bound to `pack resolver` and checked before user-visible promotion.
