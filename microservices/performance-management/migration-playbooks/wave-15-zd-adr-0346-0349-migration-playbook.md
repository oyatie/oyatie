...
1. Search `performance-management` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `performance-management` manifest `governance_lanes` array only in the manifest-owning slot.
