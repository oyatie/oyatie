# slides DR failover runbook

## Purpose

Recover the slides service inside the declared ADR-0343 DR envelope without changing tenant version pins or weakening Cedar admission.

## Recovery order

1. Freeze new mutating ingress for slides at api-gateway while read-only routes stay available when data freshness permits.
...
3. freeze export/render jobs, drain presenter sessions, promote deck storage, and reopen broadcast admission by tenant class.
