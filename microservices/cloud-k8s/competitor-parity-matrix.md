...
Quantitative + qualitative parity comparison vs the industry-leading managed Kubernetes + on-prem Kubernetes distributions. Drives the `oya-foundry-fitness-hyperscaler-maturity-claims` gate (per ADR-0123 HG-CLOUD-K8S) and tells gtm-customer-success what to claim. Re-validated bi-annually.
