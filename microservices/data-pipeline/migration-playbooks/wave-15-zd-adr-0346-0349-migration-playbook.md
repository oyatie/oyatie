...
1. Search `data-pipeline` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `data-pipeline` manifest `governance_lanes` array only in the manifest-owning slot.
