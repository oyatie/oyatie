...
1. Search `marketing-automation` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `marketing-automation` manifest `governance_lanes` array only in the manifest-owning slot.
