...
impl AdapterRegistry {
    pub fn scaffolded() -> Self {
        Self {
            http_routes: http::MarketingAutomationHttpHandler::routes(),
            grpc_methods: grpc::MarketingAutomationGrpcHandler::methods(),
            asyncapi_channels: asyncapi::MarketingAutomationAsyncApiHandler::channels(),
        }
    }
