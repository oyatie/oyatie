...
use oya_marketing_automation_campaign_journey_app::error::Result;
use std::path::PathBuf;
use std::process::ExitCode;

#[derive(Debug, Parser)]
#[command(name = "oya-marketing-automation-campaign-journey")]
#[command(about = "Marketing Automation µservice scaffold entrypoint")]
struct CliArgs {
    #[arg(long)]
...
fn run(args: CliArgs) -> Result<()> {
    ...
    tracing::info!(
        ...
        "marketing automation scaffold validated"
    );
    Ok(())
}
