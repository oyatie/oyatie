...
1. Search `api-gateway` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `api-gateway` manifest `governance_lanes` array only in the manifest-owning slot.
