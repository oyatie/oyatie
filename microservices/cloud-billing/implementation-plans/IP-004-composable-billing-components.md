...
| Stripe Connect | Platform takes application_fee from connected accounts | `revenue_share` component on a tenant; SettlementApi computes commission | Direct parity. Stripe Connect = oyatie's revenue_share. |
