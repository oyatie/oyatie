...
3. Hold invoice worker deploys: `oya vcs hold --microservice cloud-billing --reason $INCIDENT_ID --scope invoicing`.
...
14. Release deploy hold: `oya vcs unhold --microservice cloud-billing --reason resolved-$INCIDENT_ID`.
