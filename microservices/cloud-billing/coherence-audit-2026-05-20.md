...
5. Local artifact corpus inspected: `microservices/cloud-billing/{benchmarks,tenant_class,faqs,migration-playbooks,onboarding,reference-implementations,runbooks,tutorials}/` plus `crates/oya-cloud-billing-domain/src/lib.rs`, `crates/oya-cloud-billing-kernel/src/lib.rs`, and `crates/oya-cloud-billing-tax-app/tests/cloud_billing_invoice_api.rs` (cross-µservice context for cloud-billing-tax handoff).
