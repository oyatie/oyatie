...
impl AdapterRegistry {
    pub fn scaffolded() -> Self {
        Self {
            http_routes: http::ContactCenterHttpHandler::routes(),
            grpc_methods: grpc::ContactCenterGrpcHandler::methods(),
            asyncapi_channels: asyncapi::ContactCenterAsyncApiHandler::channels(),
        }
    }
