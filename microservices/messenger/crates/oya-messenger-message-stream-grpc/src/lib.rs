...
use oya_messenger_message_stream_api::{AuthorizedMessengerContext, SendMessageRequest};
...
mod tests {
    use super::*;
    use oya_messenger_message_stream_api::{MessengerApiContext, MessengerApiEnvelope};
