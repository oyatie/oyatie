...
1. Search `messenger` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `messenger` manifest `governance_lanes` array only in the manifest-owning slot.
