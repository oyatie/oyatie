...
ip_id: IP-journey-j115-dual-context-principal-binding
...
# IP - identity role in j115: SaaS vendor sells API to multiple tenant customers
...
identity owns only the dual-context-principal-binding slice for j115. It does not absorb another service responsibility,
does not bypass Cedar, and does not write into another tenant-owned store without an explicit grant.

## Acceptance criteria

1. identity exposes or consumes the typed j115 contract without ad hoc string parsing.
...
- Authority: ADR-0343.
- Trigger evidence: `microservices/identity/IP-journey-j115-dual-context-principal-binding.md` matched `SLO`.
...
- Authority: ADR-0344.
- Trigger evidence: `microservices/identity/IP-journey-j115-dual-context-principal-binding.md` matched `emission`.
...
- Surface evidence: `microservices/identity/IP-journey-j115-dual-context-principal-binding.md`, `microservices/identity/manifest.json`; trigger terms `tenant-customer`.
