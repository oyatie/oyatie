...
ip_id: IP-journey-j17-high-risk-user-overlay
journey_id: j17-activist-dissident-high-risk-mode
microservice: identity
role: high-risk-user-overlay
status: draft
date: 2026-05-20
related_adrs:
  - ADR-0300
...
# IP - j17 - identity - high-risk-user-overlay

Goal: implement the identity portion of Activist dissident high-risk mode so An activist enables HIGH_RISK_USER overlay with Tor ingress and metadata minimization.
Binding ADR: ADR-0300. This IP is one independently reviewable slice and must not weaken the common critical-path ADR pack.

## Scope

In scope: high-risk-user-overlay, JSON Schema validation, Cedar authorization, audit-chain emission, observability, failure branches, and integration tests for j17.
...
|---|---|---|---|
| high-risk-mode-activation | identity.high-risk-user-overlay table or event stream | docs/user-journeys/j17-activist-dissident-high-risk-mode/schemas/high-risk-mode-activation.json | pack-controlled, minimum audit retention |
| metadata-minimization-policy | identity.high-risk-user-overlay table or event stream | docs/user-journeys/j17-activist-dissident-high-risk-mode/schemas/metadata-minimization-policy.json | pack-controlled, minimum audit retention |
| tor-ingress-session | identity.high-risk-user-overlay table or event stream | docs/user-journeys/j17-activist-dissident-high-risk-mode/schemas/tor-ingress-session.json | pack-controlled, minimum audit retention |
...
openapi: 3.2.0
info:
  title: identity j17 high-risk-user-overlay
  version: 1.0.0
paths:
  /journeys/j17/identity/high-risk-user-overlay:
    post:
      operationId: j17IdentityHighRiskUserOverlay
...
asyncapi: 3.1.0
info:
  title: identity j17 events
  version: 1.0.0
channels:
  j17.identity.high-risk-user-overlay.accepted:
    address: j17.identity.high-risk-user-overlay.accepted
```
...
- Authority: ADR-0343.
- Trigger evidence: `microservices/identity/IP-journey-j17-high-risk-user-overlay.md` matched `SLO`.
...
- Authority: ADR-0344.
- Trigger evidence: `microservices/identity/IP-journey-j17-high-risk-user-overlay.md` matched `emission`.
