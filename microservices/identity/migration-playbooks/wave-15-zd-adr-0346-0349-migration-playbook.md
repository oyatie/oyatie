...
1. Search `identity` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `identity` manifest `governance_lanes` array only in the manifest-owning slot.
