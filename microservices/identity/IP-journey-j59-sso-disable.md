...
impl_plan_id: IP-journey-j59-sso-disable
journey_id: j59
...
# IP: j59 `identity` — `sso-disable`

## Intent
Implement the `identity` slice of `j59-offboarding-and-knowledge-transfer` for An employee leaving Marcus's company with personal tenant preserved. The slice owns `sso-disable` in the cross-product workflow where SSO disables, Drive ownership transfers, mail forwards, checklist closes, audit seals, and tenant access revokes.
...
- Journey contract: `docs/user-journeys/j59-offboarding-and-knowledge-transfer/`.
...
| Path | Action | Purpose |
|---|---|---|
| `microservices/identity/contracts/openapi-j59-sso-disable.yaml` | create | OpenAPI 3.2.0 REST edge for the journey slice |
| `microservices/identity/contracts/asyncapi-j59-sso-disable.yaml` | create | AsyncAPI 3.1.0 events for the journey slice |
| `microservices/identity/contracts/j59-sso-disable.proto` | create | proto3 worker/internal contract |
| `microservices/identity/policy/j59-sso-disable.cedar` | create | Cedar default-deny permit for this slice |
| `microservices/identity/tests/j59-sso-disable.md` | create | executable test notes or harness fixture plan |
| `microservices/identity/dashboards/j59-sso-disable.json` | create | ADR-0263 metric and trace dashboard |
...
- Authority: ADR-0343.
- Trigger evidence: `microservices/identity/IP-journey-j59-sso-disable.md` matched `SLO, p99, payment`.
...
- Authority: ADR-0344.
- Trigger evidence: `microservices/identity/IP-journey-j59-sso-disable.md` matched `emission`.
