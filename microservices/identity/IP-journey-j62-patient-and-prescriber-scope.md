...
impl_plan_id: IP-journey-j62-patient-and-prescriber-scope
journey_id: j62
...
# IP: j62 `identity` — `patient-and-prescriber-scope`

## Intent
Implement the `identity` slice of `j62-prescription-to-pharmacy-to-payment` for Yejin Park prescribing medication for a patient. The slice owns `patient-and-prescriber-scope` in the cross-product workflow where doctor prescribes, pharmacy receives connector route, insurance and patient payment settle, and record updates.
...
| Path | Action | Purpose |
|---|---|---|
| `microservices/identity/contracts/openapi-j62-patient-and-prescriber-scope.yaml` | create | OpenAPI 3.2.0 REST edge for the journey slice |
| `microservices/identity/contracts/asyncapi-j62-patient-and-prescriber-scope.yaml` | create | AsyncAPI 3.1.0 events for the journey slice |
| `microservices/identity/contracts/j62-patient-and-prescriber-scope.proto` | create | proto3 worker/internal contract |
| `microservices/identity/policy/j62-patient-and-prescriber-scope.cedar` | create | Cedar default-deny permit for this slice |
| `microservices/identity/tests/j62-patient-and-prescriber-scope.md` | create | executable test notes or harness fixture plan |
| `microservices/identity/dashboards/j62-patient-and-prescriber-scope.json` | create | ADR-0263 metric and trace dashboard |
...
- Authority: ADR-0343.
- Trigger evidence: `microservices/identity/IP-journey-j62-patient-and-prescriber-scope.md` matched `SLO, p99, payment`.
...
- Authority: ADR-0344.
- Trigger evidence: `microservices/identity/IP-journey-j62-patient-and-prescriber-scope.md` matched `emission`.
