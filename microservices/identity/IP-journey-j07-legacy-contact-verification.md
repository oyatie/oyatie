...
ip_id: IP-journey-j07-legacy-contact-verification
journey_id: j07-deceased-user-inheritance-handoff
microservice: identity
role: legacy-contact-verification
status: draft
date: 2026-05-20
related_adrs:
  - ADR-0302
...
# IP - j07 - identity - legacy-contact-verification

Goal: implement the identity portion of Deceased user inheritance handoff so Yejin becomes legacy contact after her father passes and receives scoped mail, drive, notes, and subscription authority.
Binding ADR: ADR-0302. This IP is one independently reviewable slice and must not weaken the common critical-path ADR pack.

## Scope

In scope: legacy-contact-verification, JSON Schema validation, Cedar authorization, audit-chain emission, observability, failure branches, and integration tests for j07.
...
|---|---|---|---|
| legacy-contact-claim | identity.legacy-contact-verification table or event stream | docs/user-journeys/j07-deceased-user-inheritance-handoff/schemas/legacy-contact-claim.json | pack-controlled, minimum audit retention |
| estate-access-scope | identity.legacy-contact-verification table or event stream | docs/user-journeys/j07-deceased-user-inheritance-handoff/schemas/estate-access-scope.json | pack-controlled, minimum audit retention |
| subscription-handoff | identity.legacy-contact-verification table or event stream | docs/user-journeys/j07-deceased-user-inheritance-handoff/schemas/subscription-handoff.json | pack-controlled, minimum audit retention |
...
openapi: 3.2.0
info:
  title: identity j07 legacy-contact-verification
  version: 1.0.0
paths:
  /journeys/j07/identity/legacy-contact-verification:
    post:
      operationId: j07IdentityLegacyContactVerification
...
asyncapi: 3.1.0
info:
  title: identity j07 events
  version: 1.0.0
channels:
  j07.identity.legacy-contact-verification.accepted:
    address: j07.identity.legacy-contact-verification.accepted
```
...
- Authority: ADR-0343.
- Trigger evidence: `microservices/identity/IP-journey-j07-legacy-contact-verification.md` matched `SLO`.
...
- Authority: ADR-0344.
- Trigger evidence: `microservices/identity/IP-journey-j07-legacy-contact-verification.md` matched `emission`.
