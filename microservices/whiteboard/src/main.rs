...
use oya_whiteboard_canvas_collaboration_app::error::Result;
use std::path::PathBuf;
use std::process::ExitCode;

#[derive(Debug, Parser)]
#[command(name = "oya-whiteboard-canvas-collaboration")]
#[command(about = "Whiteboard µservice scaffold entrypoint")]
struct CliArgs {
    #[arg(long)]
