...
impl AdapterRegistry {
    pub fn scaffolded() -> Self {
        Self {
            http_routes: http::WhiteboardHttpHandler::routes(),
            grpc_methods: grpc::WhiteboardGrpcHandler::methods(),
            asyncapi_channels: asyncapi::WhiteboardAsyncApiHandler::channels(),
        }
    }
