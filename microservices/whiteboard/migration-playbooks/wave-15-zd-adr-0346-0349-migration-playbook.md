...
1. Search `whiteboard` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `whiteboard` manifest `governance_lanes` array only in the manifest-owning slot.
