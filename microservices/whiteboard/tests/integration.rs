...
use oya_whiteboard_canvas_collaboration_app::adapter::AdapterRegistry;
use oya_whiteboard_canvas_collaboration_app::config::ServiceConfig;
use oya_whiteboard_canvas_collaboration_app::domain::{Capability, IdempotencyKey, TenantId};
use oya_whiteboard_canvas_collaboration_app::{public_api_surface, scaffold};

#[test]
fn scaffold_declares_expected_contracts() {
    let scaffold = scaffold();
    assert_eq!(scaffold.microservice, "whiteboard");
    ...
    assert_eq!(scaffold.contracts.grpc, "contracts/whiteboard-v1.proto");
}
...
#[test]
fn scaffold_declares_whiteboard_capabilities() {
    let scaffold = scaffold();
