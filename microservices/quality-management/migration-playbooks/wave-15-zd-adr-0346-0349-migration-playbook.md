...
1. Search `quality-management` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `quality-management` manifest `governance_lanes` array only in the manifest-owning slot.
