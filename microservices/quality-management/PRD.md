...
The target is not a monolithic ERP platform; the target is SAP QM parity through a flat, tenant-scoped microservice that composes with shared Oyatie substrates.
