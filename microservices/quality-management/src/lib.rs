...
pub const MICROSERVICE: &str = "quality-management";
pub const SERVICE_TITLE: &str = "Quality Management";
pub const PACKAGE_NAME: &str = "oya-quality-management-inspection-app";
pub const BOUNDED_CONTEXT: &str = "inspection-quality";
pub const OWNER_TEAM: &str = "axis-erp-quality + council-product";
pub const OPENAPI_CONTRACT: &str = "contracts/openapi-v1.yaml";
pub const ASYNCAPI_CONTRACT: &str = "contracts/asyncapi-v1.yaml";
pub const GRPC_CONTRACT: &str = "contracts/quality-management-v1.proto";
