...
impl AsyncApiHandler {
    pub fn channels() -> Vec<AsyncApiChannel> {
        vec![
            AsyncApiChannel {
                channel: "quality-management.command.accepted.v1",
                direction: ChannelDirection::Publish,
                message: "CommandAccepted",
            },
            AsyncApiChannel {
                channel: "quality-management.reconciliation.queued.v1",
                direction: ChannelDirection::Publish,
                message: "ReconciliationQueued",
            },
            AsyncApiChannel {
                channel: "quality-management.governance.hold-applied.v1",
                direction: ChannelDirection::Publish,
                message: "GovernanceHoldApplied",
            },
            AsyncApiChannel {
                channel: "quality-management.supplier.changed.v1",
                direction: ChannelDirection::Subscribe,
                message: "SupplierChanged",
            },
            AsyncApiChannel {
                channel: "quality-management.batch.changed.v1",
                direction: ChannelDirection::Subscribe,
                message: "BatchChanged",
            },
        ]
    }
