...
1. Search `application` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `application` manifest `governance_lanes` array only in the manifest-owning slot.
