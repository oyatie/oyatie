...
1. Search `cloud-network-dns` artifact surfaces for `oya-foundry-fitness-*` references.
...
4. Update any future `cloud-network-dns` manifest `fitness_lanes` array only in the manifest-owning slot.
