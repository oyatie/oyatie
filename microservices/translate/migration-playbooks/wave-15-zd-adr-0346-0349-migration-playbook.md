...
1. Search `translate` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `translate` manifest `governance_lanes` array only in the manifest-owning slot.
