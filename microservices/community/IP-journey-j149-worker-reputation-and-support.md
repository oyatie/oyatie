...
ip_id: IP-journey-j149-worker-reputation-and-support
...
|---:|---|---|---|---|---|
| 1 | Create the reputation or review prompt for `worker-reputation-and-support` after the counterpart transaction closes. | Trigger: marketplace/workflow closure event; actor: verified tenant member or professional. | Creates a `Post` or `Reply` carrying deal/order reference hash, not raw payment data. | OpenAPI `createPost/postReply` in `microservices/community/contracts/openapi/community.yaml` and AsyncAPI `community.post.created` in `microservices/community/contracts/asyncapi/community-events.yaml`. | Matches Trustpilot/G2 review invitation after verified transaction. |
...
- Surface evidence: `microservices/community/IP-journey-j149-worker-reputation-and-support.md` matched `openapi, asyncapi, .proto`; contract files `microservices/community/contracts/openapi/community.yaml, microservices/community/contracts/asyncapi/community-events.yaml, microservices/community/contracts/proto/community.proto`; type anchor `microservices/community/manifest.json`.
...
- Surface evidence: `microservices/community/IP-journey-j149-worker-reputation-and-support.md` matched `SLO, payment`; anchors `microservices/community/manifest.json`; type anchor `microservices/community/manifest.json`.
