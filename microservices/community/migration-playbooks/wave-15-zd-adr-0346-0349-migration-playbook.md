...
1. Search `community` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `community` manifest `governance_lanes` array only in the manifest-owning slot.
