...
- Trigger from CI when `cargo run -p oya-dev-cli -- gate validate community-moderator-decision-appeal-protocol --production-snapshot` exits non-zero against the latest production evidence bundle.
...
15. Run production snapshot gate: `cargo run -p oya-dev-cli -- gate validate community-moderator-decision-appeal-protocol --production-snapshot --cell $CELL`.
...
7. Pause promotion: `oya vcs hold --microservice community --reason $INCIDENT_ID --runbook moderator-decision-appeal-protocol`.
...
7. Add gate evidence: `cargo run -p oya-dev-cli -- gate validate community-moderator-decision-appeal-protocol --fixture incident-moderator-decision-appeal-protocol.json`.
