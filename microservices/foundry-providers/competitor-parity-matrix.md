...
related_artifacts:
  - microservices/foundry-providers/PRD.md (§Competitive Benchmark)
...
| # | Gap | Owner | Target |
|---|---|---|---|
| 1 | More vendor adapters (Mistral / Cohere / AI21 / Llama-hosted; planned via in-house) | axis-foundry | M02+ |
| 2 | In-IDE workflow-studio integration parity with Vellum | axis-foundry + gtm | M03 |
| 3 | Hosted-deployment option (currently self-host only) | council-architecture | M04+ if tenant demand |
