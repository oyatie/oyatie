...
One new Rust crate at `microservices/foundry-providers/src/crates/oya-foundry-providers-router-kernel/`. Workspace member added to root `Cargo.toml`. Catalog row at `microservices/foundry-providers/catalog/oya-foundry-providers-router-kernel.yaml`. No downstream consumers in this IP; they begin in IP-002+.

## Concrete File Targets

| Path | Action |
|---|---|
| `microservices/foundry-providers/src/crates/oya-foundry-providers-router-kernel/Cargo.toml` | create |
...
| `microservices/foundry-providers/catalog/oya-foundry-providers-router-kernel.yaml` | create |
