...
date: 2026-05-17
related_artifacts:
  - microservices/foundry-providers/threat-model.md (T-04 in-house rollout regression)
  - microservices/foundry-providers/failure-modes.md (FM-FP-04 in-house rollout regression)
...
- ADR-0026 — in-house AI model substrate roadmap.
- `microservices/foundry-providers/threat-model.md` T-04.
- `microservices/foundry-providers/failure-modes.md` FM-FP-04.
