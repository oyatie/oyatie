...
date: 2026-05-17
related_artifacts:
  - microservices/foundry-providers/threat-model.md (T-05 adapter substitution; T-06 subscription channel substitution)
  - microservices/foundry-providers/PRD.md §"FR-13 adapter version pin"
  - microservices/foundry-providers/runbooks/provider-outage-failover.md
...
- `microservices/foundry-providers/threat-model.md` T-05 + T-06.
- `microservices/foundry-providers/PRD.md` FR-13.
