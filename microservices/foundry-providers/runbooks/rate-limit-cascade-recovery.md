...
date: 2026-05-17
related_artifacts:
  - microservices/foundry-providers/failure-modes.md (FM-FP-02 rate-limit cascade)
  - microservices/foundry-providers/threat-model.md (T-02 rate-limit abuse)
  - microservices/foundry-providers/PRD.md §"FR-02"
...
- `microservices/foundry-providers/failure-modes.md` FM-FP-02.
- `microservices/foundry-providers/threat-model.md` T-02.
