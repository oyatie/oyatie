...
date: 2026-05-17
related_artifacts:
  - microservices/foundry-providers/failure-modes.md (FM-FP-01 provider edge outage)
  - microservices/foundry-providers/incident-response.md
  - microservices/foundry-providers/PRD.md §"FR-02 router reads provider health"
...
- `microservices/foundry-providers/failure-modes.md` FM-FP-01.
- `microservices/foundry-providers/incident-response.md`.
