...
Quantitative + qualitative parity comparison vs the industry-leading multi-tenant identity + isolation products. Drives the `oya-foundry-fitness-hyperscaler-maturity-claims` gate (per ADR-0123 HG-TEN). Re-validated bi-annually because the competitor landscape moves.
