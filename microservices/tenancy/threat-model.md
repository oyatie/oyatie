...
related_adrs: [ADR-0018, ADR-0028, ADR-0056, ADR-0105, ADR-0117, ADR-0123, ADR-0130, ADR-0131, ADR-0140]
...
- **eIDAS 910/2014**: Ed25519 audit-chain seals + proof-of-erasure certificates can be presented as AdES (advanced electronic signature); QES requires certified TSP (deferred per ADR-NNNN).
