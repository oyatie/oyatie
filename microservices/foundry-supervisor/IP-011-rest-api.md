...
`microservices/foundry-supervisor/src/crates/oya-foundry-supervisor-{agent-fleet-lifecycle,capability-deployment,autonomy-policy-enforcement,kill-switch-circuit-breaker}-rest/`.
