...
`microservices/foundry-supervisor/src/crates/oya-foundry-supervisor-agent-fleet-lifecycle-kernel/` + workspace registration + catalog row.
...
| `microservices/foundry-supervisor/catalog/oya-foundry-supervisor-agent-fleet-lifecycle-kernel.yaml` | create |
