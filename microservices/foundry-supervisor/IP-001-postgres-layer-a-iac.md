...
`microservices/foundry-supervisor/iac/helm/postgres/{Chart.yaml, values.yaml}`. No Rust changes.

## Concrete File Targets

| Path | Action |
|---|---|
| `microservices/foundry-supervisor/iac/helm/postgres/Chart.yaml` | create |
| `microservices/foundry-supervisor/iac/helm/postgres/values.yaml` | create |
| `microservices/foundry-supervisor/iac/kustomize/base/kustomization.yaml` | update (helmCharts list) |
...
```bash
helm lint microservices/foundry-supervisor/iac/helm/postgres
helm install --dry-run --debug -n foundry-supervisor postgres microservices/foundry-supervisor/iac/helm/postgres
