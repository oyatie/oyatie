...
Crates at `microservices/foundry-supervisor/src/crates/oya-foundry-supervisor-kill-switch-circuit-breaker-{kernel,domain,usecase,api,adapter}/`. rest + worker + sdk + app deferred to IP-009 + IP-011 + IP-013 + IP-014.
