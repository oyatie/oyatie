...
Author OpenSLO manifests at `microservices/foundry-supervisor/slos/` so that observability µservice (per ADR-0130) gates supervisor's own promotion. Registers HG-FND-SUP per ADR-0123.

## Concrete File Targets

| Path | Action |
|---|---|
| `microservices/foundry-supervisor/slos/kill-switch-engage.openslo.yaml` | create |
| `microservices/foundry-supervisor/slos/deployment-admit.openslo.yaml` | create |
| `microservices/foundry-supervisor/slos/supervision-event-lag.openslo.yaml` | create |
| `microservices/foundry-supervisor/slos/autonomy-policy-eval.openslo.yaml` | create |
