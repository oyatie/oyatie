...
Crates created at `microservices/foundry-supervisor/src/crates/oya-foundry-supervisor-autonomy-policy-enforcement-{kernel,domain,usecase,api,adapter,rest,sdk,app}/`.

Catalog rows at `microservices/foundry-supervisor/catalog/oya-foundry-supervisor-autonomy-policy-enforcement-{layer}.yaml` per crate.
