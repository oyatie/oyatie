...
| Path | Action |
|---|---|
| `microservices/foundry-supervisor/tests/e2e/kill_switch_latency.rs` | create (AC-02) |
| `microservices/foundry-supervisor/tests/e2e/canary_rollout_gated.rs` | create (AC-03) |
| `microservices/foundry-supervisor/tests/e2e/autonomy_tier_refusal.rs` | create (AC-04) |
| `microservices/foundry-supervisor/tests/e2e/supervision_event_lag.rs` | create (AC-05) |
| `microservices/foundry-supervisor/tests/e2e/drain_no_loss.rs` | create (AC-06) |
| `microservices/foundry-supervisor/tests/e2e/postgres_failover.rs` | create (AC-07) |
| `microservices/foundry-supervisor/tests/e2e/redis_failover.rs` | create (AC-08) |
| `microservices/foundry-supervisor/dashboards/` | already created (Slice C; verify deployment + JSON conformance) |
