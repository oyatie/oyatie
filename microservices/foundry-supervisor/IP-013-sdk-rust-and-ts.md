...
Rust crates:
- `microservices/foundry-supervisor/src/crates/oya-foundry-supervisor-{bc}-sdk/`

TypeScript SDK (scaffold):
- `microservices/foundry-supervisor/sdk-generation/typescript/{package.json, src/, openapi-generator-config.yaml}`
...
(cd microservices/foundry-supervisor/sdk-generation/typescript && npm run build && npm test)
```
