...
date: 2026-05-17
related_artifacts:
  - microservices/foundry-supervisor/failure-modes.md (FM-01)
...
- For Sev-1: per-changeset evidence at `microservices/foundry-supervisor/evidence/multispectrum/<change_id>-<unix_ts>.json`.
