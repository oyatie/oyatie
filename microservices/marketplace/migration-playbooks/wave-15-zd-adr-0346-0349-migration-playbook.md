...
1. Search `marketplace` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `marketplace` manifest `governance_lanes` array only in the manifest-owning slot.
