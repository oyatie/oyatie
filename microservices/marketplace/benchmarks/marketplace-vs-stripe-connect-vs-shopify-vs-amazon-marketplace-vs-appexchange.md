...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `marketplace` (paid) | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| Stripe | n/a | n/a | n/a | n/a | n/a | n/a | n/a (payment rail, not categories) |
...
| Stripe (Express) | 280 ms | 640 ms | 1.2 s |
...
| Stripe | 7 d (rolling) | 2 d (Standard) | 1 d (Custom) | ✅ Instant Payouts ($0.50/txn) |
...
| Stripe (Custom) | 2.9 % + $0.30 card + 0.25 % + $2 routing ≈ 3.5 % | + Stripe Tax 0.5 % | partial | external |
...
| Stripe | partial (Radar rules) | partial | ❌ | append-only |
...
| Stripe + Stripe Tax + Persona | $175,000 (3.5 %) | $25,000 | $18,000 (Persona) | $30,000 (external) | $248,000 | $4,752,000 |
...
1. Stripe has the most mature global payment-rail coverage; we ride on top of `payments`+Stripe under the hood for many rails.
