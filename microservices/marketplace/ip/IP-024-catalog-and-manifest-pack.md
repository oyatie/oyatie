...
## Intent
Deliver the catalog-and-manifest-pack slice for Marketplace while preserving DealSet, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0314.
...
4. Cedar action marketplace.catalog-and-manifest-pack.execute using BNF v4.
