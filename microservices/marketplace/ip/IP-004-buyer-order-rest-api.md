...
impl_plan_id: IP-004-buyer-order-rest-api
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-004: Buyer Order Rest Api

## Intent
Deliver the buyer-order-rest-api slice for Marketplace while preserving DealSet, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0314.
...
4. Cedar action marketplace.buyer-order-rest-api.execute using BNF v4.
