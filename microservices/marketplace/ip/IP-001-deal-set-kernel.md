...
impl_plan_id: IP-001-deal-set-kernel
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-001: Deal Set Kernel

## Intent
Deliver the deal-set-kernel slice for Marketplace while preserving DealSet, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0314.
...
4. Cedar action marketplace.deal-set-kernel.execute using BNF v4.
