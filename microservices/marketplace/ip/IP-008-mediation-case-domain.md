...
impl_plan_id: IP-008-mediation-case-domain
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-008: Mediation Case Domain

## Intent
Deliver the mediation-case-domain slice for Marketplace while preserving DealSet, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0314.
...
4. Cedar action marketplace.mediation-case-domain.execute using BNF v4.
