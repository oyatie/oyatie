...
impl_plan_id: IP-020-counterparty-grant-domain
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-020: Counterparty Grant Domain

## Intent
Deliver the counterparty-grant-domain slice for Marketplace while preserving DealSet, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0314.

## Existing journey anchor
This IP is additive to `microservices/marketplace/IP-journey-j108-deal-settlement-ledger.md` and weaves Deal Settlement Ledger into the build sequence.
...
4. Cedar action marketplace.counterparty-grant-domain.execute using BNF v4.
5. Audit event MarketplaceRevenueShareAccrued.
