...
impl_plan_id: IP-009-order-export-worker
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-009: Order Export Worker

## Intent
Deliver the order-export-worker slice for Marketplace while preserving DealSet, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0314.

## Existing journey anchor
This IP is additive to `microservices/marketplace/IP-journey-j24-buyer-order.md` and weaves Buyer Order into the build sequence.
...
4. Cedar action marketplace.order-export-worker.execute using BNF v4.
