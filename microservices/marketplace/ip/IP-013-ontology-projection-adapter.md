...
impl_plan_id: IP-013-ontology-projection-adapter
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-013: Ontology Projection Adapter

## Intent
Deliver the ontology-projection-adapter slice for Marketplace while preserving DealSet, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0314.

## Existing journey anchor
This IP is additive to `microservices/marketplace/IP-journey-j65-order-export.md` and weaves Order Export into the build sequence.
...
4. Cedar action marketplace.ontology-projection-adapter.execute using BNF v4.
