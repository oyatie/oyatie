...
impl_plan_id: IP-011-tax-facilitator-adapter
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-011: Tax Facilitator Adapter

## Intent
Deliver the tax-facilitator-adapter slice for Marketplace while preserving DealSet, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0314.

## Existing journey anchor
This IP is additive to `microservices/marketplace/IP-journey-j52-order-ledger.md` and weaves Order Ledger into the build sequence.
...
4. Cedar action marketplace.tax-facilitator-adapter.execute using BNF v4.
