...
impl_plan_id: IP-007-revenue-share-worker
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-007: Revenue Share Worker

## Intent
Deliver the revenue-share-worker slice for Marketplace while preserving DealSet, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0314.

## Existing journey anchor
This IP is additive to `microservices/marketplace/IP-journey-j146-seller-flow-and-escrow.md` and weaves Seller Flow And Escrow into the build sequence.
...
4. Cedar action marketplace.revenue-share-worker.execute using BNF v4.
