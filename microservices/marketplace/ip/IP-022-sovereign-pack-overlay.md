...
## Intent
Deliver the sovereign-pack-overlay slice for Marketplace while preserving DealSet, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0314.
...
4. Cedar action marketplace.sovereign-pack-overlay.execute using BNF v4.
