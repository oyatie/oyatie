...
impl_plan_id: IP-002-settlement-ledger-domain
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-002: Settlement Ledger Domain

## Intent
Deliver the settlement-ledger-domain slice for Marketplace while preserving DealSet, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0314.

## Existing journey anchor
This IP is additive to `microservices/marketplace/IP-journey-j102-deal-settlement-ledger.md` and weaves Deal Settlement Ledger into the build sequence.
...
4. Cedar action marketplace.settlement-ledger-domain.execute using BNF v4.
5. Audit event MarketplaceDealAccepted.
