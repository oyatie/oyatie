...
## Intent
Deliver the load-and-failure-fixtures slice for Marketplace while preserving DealSet, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0314.
...
4. Cedar action marketplace.load-and-failure-fixtures.execute using BNF v4.
