...
impl_plan_id: IP-014-workflow-approval-binding
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-014: Workflow Approval Binding

## Intent
Deliver the workflow-approval-binding slice for Marketplace while preserving DealSet, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0314.

## Existing journey anchor
This IP is additive to `microservices/marketplace/IP-journey-j69-appointment-and-service-commitments.md` and weaves Appointment And Service Commitments into the build sequence.
...
4. Cedar action marketplace.workflow-approval-binding.execute using BNF v4.
5. Audit event MarketplaceOrderExported.
