...
impl_plan_id: IP-003-offer-command-usecase
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-003: Offer Command Usecase

## Intent
Deliver the offer-command-usecase slice for Marketplace while preserving DealSet, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0314.
...
4. Cedar action marketplace.offer-command-usecase.execute using BNF v4.
