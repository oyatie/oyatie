...
impl_plan_id: IP-012-sanctions-screen-port
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-012: Sanctions Screen Port

## Intent
Deliver the sanctions-screen-port slice for Marketplace while preserving DealSet, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0314.

## Existing journey anchor
This IP is additive to `microservices/marketplace/IP-journey-j55-seller-buyer-mediation.md` and weaves Seller Buyer Mediation into the build sequence.
...
4. Cedar action marketplace.sanctions-screen-port.execute using BNF v4.
