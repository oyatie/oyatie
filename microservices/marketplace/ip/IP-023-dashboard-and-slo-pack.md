...
## Intent
Deliver the dashboard-and-slo-pack slice for Marketplace while preserving DealSet, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0314.

## Existing journey anchor
This IP is additive to `microservices/marketplace/IP-journey-j23-seller-listing.md` and weaves Seller Listing into the build sequence.
...
4. Cedar action marketplace.dashboard-and-slo-pack.execute using BNF v4.
