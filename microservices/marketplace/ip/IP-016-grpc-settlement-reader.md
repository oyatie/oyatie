...
impl_plan_id: IP-016-grpc-settlement-reader
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-016: Grpc Settlement Reader

## Intent
Deliver the grpc-settlement-reader slice for Marketplace while preserving DealSet, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0314.

## Existing journey anchor
This IP is additive to `microservices/marketplace/IP-journey-j101-deal-settlement-ledger.md` and weaves Deal Settlement Ledger into the build sequence.
...
4. Cedar action marketplace.grpc-settlement-reader.execute using BNF v4.
