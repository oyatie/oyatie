...
impl_plan_id: IP-019-idempotency-key-kernel
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-019: Idempotency Key Kernel

## Intent
Deliver the idempotency-key-kernel slice for Marketplace while preserving DealSet, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0314.

## Existing journey anchor
This IP is additive to `microservices/marketplace/IP-journey-j107-deal-settlement-ledger.md` and weaves Deal Settlement Ledger into the build sequence.
...
4. Cedar action marketplace.idempotency-key-kernel.execute using BNF v4.
