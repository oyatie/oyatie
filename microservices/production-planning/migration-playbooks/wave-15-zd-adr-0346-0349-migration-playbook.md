...
1. Search `production-planning` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `production-planning` manifest `governance_lanes` array only in the manifest-owning slot.
