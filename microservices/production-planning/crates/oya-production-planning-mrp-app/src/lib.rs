...
pub const MICROSERVICE: &str = "production-planning";
pub const SERVICE_TITLE: &str = "Production Planning";
pub const PACKAGE_NAME: &str = "oya-production-planning-mrp-app";
pub const BOUNDED_CONTEXT: &str = "mrp";
pub const OWNER_TEAM: &str = "axis-erp-production + council-product";
pub const OPENAPI_CONTRACT: &str = "contracts/openapi-v1.yaml";
pub const ASYNCAPI_CONTRACT: &str = "contracts/asyncapi-v1.yaml";
pub const GRPC_CONTRACT: &str = "contracts/production-planning-v1.proto";
