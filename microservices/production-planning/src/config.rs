...
impl ServiceConfig {
    pub fn local_default(tenant_id: impl Into<String>, port: u16) -> Self {
        Self {
            service_name: "production-planning".to_string(),
            ...
            observability: ObservabilityConfig {
                service_namespace: "oyatie.production_planning".to_string(),
                audit_topic: "audit.production_planning".to_string(),
                metrics_prefix: "oya_production_planning".to_string(),
    ...
    pub fn validate(&self) -> Result<()> {
        ...
        if self.service_name != "production-planning" {
            return Err(ServiceError::validation(
                "service_name",
                "service_name must remain production-planning",
            ));
        }
