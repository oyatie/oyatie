...
1. Search `mail` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `mail` manifest `governance_lanes` array only in the manifest-owning slot.
