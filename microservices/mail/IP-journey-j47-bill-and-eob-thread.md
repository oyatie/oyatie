...
- Surface evidence: `microservices/mail/IP-journey-j47-bill-and-eob-thread.md` matched `financial, payment`; anchors `microservices/mail/runbooks/mailbox-restore-from-backup.md, crates/oya-shared-email-comms-kernel/src/lib.rs`; type anchor `crates/oya-shared-email-comms-kernel/src/lib.rs::OutboundMessage`.
