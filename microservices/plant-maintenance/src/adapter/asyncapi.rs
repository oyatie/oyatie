...
impl AsyncApiHandler {
    pub fn channels() -> Vec<AsyncApiChannel> {
        vec![
            AsyncApiChannel {
                channel: "plant-maintenance.command.accepted.v1",
                direction: ChannelDirection::Publish,
                message: "CommandAccepted",
            },
            AsyncApiChannel {
                channel: "plant-maintenance.reconciliation.queued.v1",
                direction: ChannelDirection::Publish,
                message: "ReconciliationQueued",
            },
            AsyncApiChannel {
                channel: "plant-maintenance.governance.hold-applied.v1",
                direction: ChannelDirection::Publish,
                message: "GovernanceHoldApplied",
            },
            AsyncApiChannel {
                channel: "plant-maintenance.equipment.telemetry-changed.v1",
                direction: ChannelDirection::Subscribe,
                message: "EquipmentTelemetryChanged",
            },
            AsyncApiChannel {
                channel: "plant-maintenance.spare-part.changed.v1",
                direction: ChannelDirection::Subscribe,
                message: "SparePartChanged",
            },
        ]
    }
