...
arch_id: ARCH-plant-maintenance
...
companion_docs:
  ...
  - microservices/plant-maintenance/README.md
...
- Integration state: PROPOSED for `plant-maintenance`; ACCEPTED waits for service wrapper implementation and signed module evidence.
- Ownership split: cloud-iac owns reusable OpenTofu primitive bodies; `plant-maintenance` owns wrapper selection, variables, SLO-driven sizing, and blast-radius review.
...
- Capacity: `per_workflow_run` drives CPU `0.12`, RAM `384`, storage `10`, and connection pool variables.
