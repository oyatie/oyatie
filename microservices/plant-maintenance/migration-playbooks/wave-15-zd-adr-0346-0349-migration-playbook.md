...
1. Search `plant-maintenance` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `plant-maintenance` manifest `governance_lanes` array only in the manifest-owning slot.
