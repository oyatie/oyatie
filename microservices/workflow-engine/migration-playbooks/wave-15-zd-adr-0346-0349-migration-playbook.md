...
1. Search `workflow-engine` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `workflow-engine` manifest `governance_lanes` array only in the manifest-owning slot.
