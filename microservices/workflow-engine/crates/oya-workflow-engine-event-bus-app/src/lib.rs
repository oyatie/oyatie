...
pub use oya_workflow_engine_event_bus_sdk::{
...
pub use oya_workflow_engine_event_bus_worker::{
...
mod tests {
    ...
    fn worker_body_from_plan(
        ...
        match plan.rest_request.body {
            oya_workflow_engine_event_bus_sdk::WorkflowEventBusRestRequestBody::Publish(
                request,
            ) => WorkflowEventBusWorkerJobBody::Publish(request),
            oya_workflow_engine_event_bus_sdk::WorkflowEventBusRestRequestBody::Delivery(
                request,
