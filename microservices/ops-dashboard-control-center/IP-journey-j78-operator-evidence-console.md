...
ip_id: IP-journey-j78-operator-evidence-console
...
# IP-journey-j78-operator-evidence-console - ops-dashboard-control-center

## Goal

Implement the `operator-evidence-console` slice for `ops-dashboard-control-center` so j78 can satisfy `EU-NIS2` without leaking tenant data, collapsing provider-BYOK and encryption-BYOK meanings, or bypassing Cedar.
...
| File | Purpose | Notes |
|---|---|---|
| `microservices/ops-dashboard-control-center/contracts/openapi/j78-operator-evidence-console-v1.yaml` | OpenAPI 3.2.0 REST surface | External read/write or admin action |
| `microservices/ops-dashboard-control-center/contracts/asyncapi/j78-operator-evidence-console-events-v1.yaml` | AsyncAPI 3.1.0 event surface | Emits ADR-0263 events |
| `microservices/ops-dashboard-control-center/contracts/proto/j78-operator-evidence-console-v1.proto` | proto3 internal RPC | Service-to-service call path |
| `microservices/ops-dashboard-control-center/policy/j78-operator-evidence-console.cedar` | Cedar permit/forbid bundle | Deny-wins gate |
| `microservices/ops-dashboard-control-center/runbooks/j78-operator-evidence-console-rollback.md` | Rollback and incident path | Includes regulator deadline handling |
| `microservices/ops-dashboard-control-center/tests/j78_operator_evidence_console_test.rs` | Integration tests | Positive, negative, rollback, audit |
...
- `J78OpsDashboardControlCenterOperatorEvidenceConsoleStarted`.
- `J78OpsDashboardControlCenterOperatorEvidenceConsolePermitted`.
- `J78OpsDashboardControlCenterOperatorEvidenceConsoleDenied`.
- `J78OpsDashboardControlCenterOperatorEvidenceConsoleCommitted`.
- `J78OpsDashboardControlCenterOperatorEvidenceConsoleRolledBack`.

## Implementation rows

### IP row 001 - ops-dashboard-control-center operator-evidence-console
Scope: implement one ops-dashboard-control-center behavior for j78, not a cross-service refactor.
