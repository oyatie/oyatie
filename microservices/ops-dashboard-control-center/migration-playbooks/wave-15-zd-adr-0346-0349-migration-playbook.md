...
1. Search `ops-dashboard-control-center` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `ops-dashboard-control-center` manifest `governance_lanes` array only in the manifest-owning slot.
