...
ip_id: IP-journey-j87-operator-evidence-console
...
# IP-journey-j87-operator-evidence-console - ops-dashboard-control-center

## Goal

Implement the `operator-evidence-console` slice for `ops-dashboard-control-center` so j87 can satisfy `FedRAMP-High + DoD-IL5/IL6` without leaking tenant data, collapsing provider-BYOK and encryption-BYOK meanings, or bypassing Cedar.
...
| File | Purpose | Notes |
|---|---|---|
| `microservices/ops-dashboard-control-center/contracts/openapi/j87-operator-evidence-console-v1.yaml` | OpenAPI 3.2.0 REST surface | External read/write or admin action |
| `microservices/ops-dashboard-control-center/contracts/asyncapi/j87-operator-evidence-console-events-v1.yaml` | AsyncAPI 3.1.0 event surface | Emits ADR-0263 events |
| `microservices/ops-dashboard-control-center/contracts/proto/j87-operator-evidence-console-v1.proto` | proto3 internal RPC | Service-to-service call path |
| `microservices/ops-dashboard-control-center/policy/j87-operator-evidence-console.cedar` | Cedar permit/forbid bundle | Deny-wins gate |
| `microservices/ops-dashboard-control-center/runbooks/j87-operator-evidence-console-rollback.md` | Rollback and incident path | Includes regulator deadline handling |
| `microservices/ops-dashboard-control-center/tests/j87_operator_evidence_console_test.rs` | Integration tests | Positive, negative, rollback, audit |
...
- `J87OpsDashboardControlCenterOperatorEvidenceConsoleStarted`.
- `J87OpsDashboardControlCenterOperatorEvidenceConsolePermitted`.
- `J87OpsDashboardControlCenterOperatorEvidenceConsoleDenied`.
- `J87OpsDashboardControlCenterOperatorEvidenceConsoleCommitted`.
- `J87OpsDashboardControlCenterOperatorEvidenceConsoleRolledBack`.

## Implementation rows

### IP row 001 - ops-dashboard-control-center operator-evidence-console
Scope: implement one ops-dashboard-control-center behavior for j87, not a cross-service refactor.
