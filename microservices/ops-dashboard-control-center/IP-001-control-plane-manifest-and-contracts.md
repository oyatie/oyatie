...
This implementation plan slice defines the accepted design anchor for control plane manifest and contract anchors in FD-001 Ops Dashboard / Control Center. It is a gated plan artifact, not runtime completion evidence.
...
- AC-01: manifest schema validates.
- AC-02: OpenAPI/AsyncAPI/Proto3 anchors parse.
- AC-03: manifests-index names this microservice and identity without duplicate rows.
