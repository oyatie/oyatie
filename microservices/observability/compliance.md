...
| A.5.18 | Access rights | RBAC managed via Terraform; UI editing forbidden | `iac/terraform/grafana-rbac.tf` (Slice C) |
...
| A.5.27 | Learning from information security incidents | Post-incident review template + ADR-NNNN successor-IP | `runbooks/postmortem-template.md` |
