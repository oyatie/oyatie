...
7. Pause promotion: `oya vcs hold --microservice observability --reason $INCIDENT_ID --runbook canary-graduation`.
...
9. Add dashboard panel: `update microservices/observability/dashboards/tenant-slo-overview.json with oya_observability_canary_graduation_error_ratio, oya_observability_canary_graduation_lag_seconds, and oya_observability_canary_graduation_queue_depth`.
