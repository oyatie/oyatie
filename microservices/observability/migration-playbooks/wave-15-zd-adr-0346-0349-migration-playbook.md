...
1. Search `observability` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `observability` manifest `governance_lanes` array only in the manifest-owning slot.
