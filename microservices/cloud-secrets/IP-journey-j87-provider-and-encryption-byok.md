...
ip_id: IP-journey-j87-provider-and-encryption-byok
...
# IP-journey-j87-provider-and-encryption-byok - cloud-secrets

## Goal

Implement the `provider-and-encryption-byok` slice for `cloud-secrets` so j87 can satisfy `FedRAMP-High + DoD-IL5/IL6` without leaking tenant data, collapsing provider-BYOK and encryption-BYOK meanings, or bypassing Cedar.
...
| File | Purpose | Notes |
|---|---|---|
| `microservices/cloud-secrets/contracts/openapi/j87-provider-and-encryption-byok-v1.yaml` | OpenAPI 3.2.0 REST surface | External read/write or admin action |
| `microservices/cloud-secrets/contracts/asyncapi/j87-provider-and-encryption-byok-events-v1.yaml` | AsyncAPI 3.1.0 event surface | Emits ADR-0263 events |
| `microservices/cloud-secrets/contracts/proto/j87-provider-and-encryption-byok-v1.proto` | proto3 internal RPC | Service-to-service call path |
| `microservices/cloud-secrets/policy/j87-provider-and-encryption-byok.cedar` | Cedar permit/forbid bundle | Deny-wins gate |
| `microservices/cloud-secrets/runbooks/j87-provider-and-encryption-byok-rollback.md` | Rollback and incident path | Includes regulator deadline handling |
| `microservices/cloud-secrets/tests/j87_provider_and_encryption_byok_test.rs` | Integration tests | Positive, negative, rollback, audit |
...
- `J87CloudSecretsProviderAndEncryptionByokStarted`.
- `J87CloudSecretsProviderAndEncryptionByokPermitted`.
- `J87CloudSecretsProviderAndEncryptionByokDenied`.
- `J87CloudSecretsProviderAndEncryptionByokCommitted`.
- `J87CloudSecretsProviderAndEncryptionByokRolledBack`.

## Implementation rows

### IP row 001 - cloud-secrets provider-and-encryption-byok
Scope: implement one cloud-secrets behavior for j87, not a cross-service refactor.
