...
ip_id: IP-journey-j81-provider-and-encryption-byok
...
# IP-journey-j81-provider-and-encryption-byok - cloud-secrets

## Goal

Implement the `provider-and-encryption-byok` slice for `cloud-secrets` so j81 can satisfy `KR-CSAP-v3.1` without leaking tenant data, collapsing provider-BYOK and encryption-BYOK meanings, or bypassing Cedar.
...
| File | Purpose | Notes |
|---|---|---|
| `microservices/cloud-secrets/contracts/openapi/j81-provider-and-encryption-byok-v1.yaml` | OpenAPI 3.2.0 REST surface | External read/write or admin action |
| `microservices/cloud-secrets/contracts/asyncapi/j81-provider-and-encryption-byok-events-v1.yaml` | AsyncAPI 3.1.0 event surface | Emits ADR-0263 events |
| `microservices/cloud-secrets/contracts/proto/j81-provider-and-encryption-byok-v1.proto` | proto3 internal RPC | Service-to-service call path |
| `microservices/cloud-secrets/policy/j81-provider-and-encryption-byok.cedar` | Cedar permit/forbid bundle | Deny-wins gate |
| `microservices/cloud-secrets/runbooks/j81-provider-and-encryption-byok-rollback.md` | Rollback and incident path | Includes regulator deadline handling |
| `microservices/cloud-secrets/tests/j81_provider_and_encryption_byok_test.rs` | Integration tests | Positive, negative, rollback, audit |
...
- `J81CloudSecretsProviderAndEncryptionByokStarted`.
- `J81CloudSecretsProviderAndEncryptionByokPermitted`.
- `J81CloudSecretsProviderAndEncryptionByokDenied`.
- `J81CloudSecretsProviderAndEncryptionByokCommitted`.
- `J81CloudSecretsProviderAndEncryptionByokRolledBack`.

## Implementation rows

### IP row 001 - cloud-secrets provider-and-encryption-byok
Scope: implement one cloud-secrets behavior for j81, not a cross-service refactor.
...
- Surface evidence: `microservices/cloud-secrets/contracts/openapi/cloud-secrets.yaml`, `microservices/cloud-secrets/contracts/asyncapi/cloud-secrets-events.yaml`, `microservices/cloud-secrets/contracts/proto/cloud-secrets.proto`, `microservices/cloud-secrets/IP-journey-j81-provider-and-encryption-byok.md`.
