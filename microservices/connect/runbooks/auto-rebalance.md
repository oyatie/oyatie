---
doc_class: Runbook
doc_id: RUNBOOK-CONNECT-AUTO_REBALANCE
...
# Runbook: Connect Auto Rebalance

## Operator Contract
- Runbook id: connect-auto-rebalance.
- Primary service namespace: `connect`.
...
## Preflight Checklist
1. Set incident context: `export INCIDENT_ID=INC-connect-auto-rebalance-$(date -u +%Y%m%dT%H%M%SZ); export SERVICE=connect; export CELL=prod-us-east-1; export TENANT=synthetic-canary`.
