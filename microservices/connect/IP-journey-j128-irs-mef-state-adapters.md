...
date: 2026-05-20
owner_team: axis-connect + axis-tax-adapters
parallel_work_compatibility: Independent of j126 connect-adapter integrations
---

# IP-journey-j128-irs-mef-state-adapters — Connect µservice: IRS Modernized e-File + Virginia DOR + California FTB tax-submission adapters

## Goal

Implement Connect adapter surfaces for tax-submission:
...
| File | Purpose | Lines |
|---|---|---:|
| `microservices/connect/src/tax/irs_mef_adapter.rs` | IRS MeF adapter | ~280 |
| `microservices/connect/src/tax/va_dor_adapter.rs` | VA DOR adapter | ~220 |
| `microservices/connect/src/tax/ca_ftb_adapter.rs` | CA FTB adapter | ~220 |
| `microservices/connect/src/tax/mef_xml_packager.rs` | MeF XML schema packaging | ~340 |
| `microservices/connect/policy/connect-irs-mef-submit.cedar` | Cedar permit | ~30 |
| `microservices/connect/policy/connect-va-dor-submit.cedar` | Cedar permit | ~30 |
| `microservices/connect/policy/connect-ca-ftb-submit.cedar` | Cedar permit | ~30 |
| `microservices/connect/contracts/proto/tax_adapters.proto` | gRPC defs | ~140 |
| `microservices/connect/db/migrations/2026-05-20-001-tax-submissions.sql` | DDL | ~50 |
| `microservices/connect/runbooks/irs-mef-submission-rejected.md` | Runbook | ~160 |
| `microservices/connect/tests/integration/tax_adapter_test.rs` | Tests | ~400 |
| `microservices/connect/dashboards/tax-submission-health.json` | Grafana | ~100 |
| `microservices/connect/slos/tax-submission-latency.openslo.yaml` | SLO | ~40 |
...
|---|---|---|
| IRS MeF HTTPS API | connect → IRS | mTLS w/ IRS-issued cert |
| VA DOR API | connect → VA DOR | OAuth-based |
| CA FTB API | connect → CA FTB | OAuth-based |
| `audit-chain.EmitSealed` | connect → audit-chain | Per submission |
...
- `oya_connect_tax_submission_total{adapter, outcome}`
- `oya_connect_tax_submission_latency_ms{adapter}`
...
Boundary rule 001: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0299 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 002: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0311 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 003: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0314 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 004: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0317 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 005: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0244 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 006: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0299 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 007: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0311 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 008: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0314 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 009: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0317 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 010: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0244 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 011: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0299 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 012: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0311 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 013: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0314 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 014: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0317 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 015: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0244 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 016: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0299 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 017: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0311 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 018: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0314 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 020: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0244 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 021: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0299 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 022: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0311 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 023: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0314 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 024: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0317 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 025: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0244 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 033: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0314 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 034: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0317 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 036: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0299 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 037: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0311 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 038: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0314 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 039: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0317 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 040: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0244 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 041: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0299 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 042: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0311 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 043: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0314 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 044: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0317 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 045: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0244 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 046: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0299 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 047: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0311 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 048: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0314 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 049: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0317 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 050: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0244 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 051: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0299 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 052: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0311 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 053: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0314 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 055: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0244 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 061: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0299 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 062: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0311 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 063: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0314 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 064: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0317 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 065: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0244 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 068: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0314 scope grants it; refusals are success states, not exceptions.
...
Boundary rule 069: connect MUST refuse cross-tenant or personal-surface access unless an explicit ADR-0317 scope grants it; refusals are success states, not exceptions.
