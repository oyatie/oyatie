...
# Capacity Model — connect (Integration Substrate)
...
|---|---|---|
| Adapter-worker pool exhaustion | Peak burst > 2x average | HPA on `oya_connect_action_queue_depth`; min=200, max=4000 workers per pack |
