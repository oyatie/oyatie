...
1. Search `connect` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `connect` manifest `governance_lanes` array only in the manifest-owning slot.
