...
date: 2026-05-17
related_artifacts:
  - microservices/foundry/failure-modes.md (FM-FP-01 provider edge outage)
  - microservices/foundry/incident-response.md
  - microservices/foundry/PRD.md §"FR-02 router reads provider health"
...
- `microservices/foundry/failure-modes.md` FM-FP-01.
- `microservices/foundry/incident-response.md`.
