...
date: 2026-05-17
related_artifacts:
  - microservices/foundry/failure-modes.md (FM-02 GPU pool exhaustion)
  - microservices/foundry/threat-model.md (T-D-01)
...
- `microservices/foundry/failure-modes.md` FM-02.
- `microservices/foundry/threat-model.md` T-D-01.
- `microservices/foundry/capacity-model.md`.
