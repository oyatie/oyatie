...
date: 2026-05-17
related_artifacts:
  - microservices/foundry/failure-modes.md (FM-11)
  - microservices/foundry/incident-response.md
  - microservices/foundry/policy/runtime-isolation.md (TI-08 autonomy)
...
- `microservices/foundry/failure-modes.md` FM-11.
- `microservices/foundry/incident-response.md`.
- `microservices/foundry/policy/runtime-isolation.md` TI-08.
