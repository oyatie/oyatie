...
date: 2026-05-17
related_artifacts:
  - microservices/foundry/policy/credential-isolation.md (CI-INV-07 rotation without downtime)
  - microservices/foundry/policy/openbao-credential.cedar (rotation runner permits)
  - microservices/foundry/threat-model.md (T-01 credential theft)
