...
date: 2026-05-17
related_artifacts:
  - microservices/foundry/failure-modes.md (FM-10, FM-11)
  - microservices/foundry/policy/data-residency.md (DR-02, DR-05)
...
1. Helm-apply foundry-evidence stack in receiving region:
   ...
   helm upgrade --install foundry-evidence \
     microservices/foundry/iac/helm/evidence-builder \
