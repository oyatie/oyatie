...
date: 2026-05-17
related_artifacts:
  - microservices/foundry/failure-modes.md (FM-04, FM-05)
  - microservices/foundry/iac/helm/cedar-engine/values.yaml
...
2. Compare to expected SHA from git: `bash microservices/foundry/iac/cedar/build.sh microservices/foundry/policy --check-sha`.
...
| Step | Action | Time |
|---|---|---|
| 1 | Compile bundle: `bash microservices/foundry/iac/cedar/build.sh microservices/foundry/policy` | ≤ 30s |
...
- `microservices/foundry/failure-modes.md` FM-04 + FM-05.
- `microservices/foundry/runbooks/policy-rule-rollback.md`.
- `microservices/foundry/iac/helm/cedar-engine/values.yaml`.
