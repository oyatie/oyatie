...
date: 2026-05-17
related_artifacts:
  - microservices/foundry/failure-modes.md (FM-03 parity regression)
  - microservices/foundry/threat-model.md (R-09 judge bias)
...
- `microservices/foundry/failure-modes.md` FM-03.
- `microservices/foundry/threat-model.md` T-A-02 (judge bias).
