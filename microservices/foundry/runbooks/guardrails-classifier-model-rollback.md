...
date: 2026-05-17
related_artifacts:
  - microservices/foundry/failure-modes.md (FM-01, FM-02, FM-03, FM-14)
  - microservices/foundry/incident-response.md
  - microservices/foundry/iac/helm/classifier-model-serving/values.yaml
...
- `microservices/foundry/policy/guardrail-enforcement.md` §"Shadow→Enforce".
- `microservices/foundry/iac/helm/classifier-model-serving/values.yaml`.
