...
date: 2026-05-17
related_artifacts:
  - microservices/foundry/failure-modes.md (FM-07, FM-05)
  - microservices/foundry/policy/guardrail-enforcement.md
...
- `microservices/foundry/failure-modes.md` FM-05 + FM-07.
- `microservices/foundry/policy/guardrail-enforcement.md`.
- `microservices/foundry/iac/cedar/build.sh`.
- `microservices/foundry/iac/postgres/migrations/001-init-schema.sql`.
