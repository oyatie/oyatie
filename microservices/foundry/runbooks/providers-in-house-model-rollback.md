...
date: 2026-05-17
related_artifacts:
  - microservices/foundry/threat-model.md (T-04 in-house rollout regression)
  - microservices/foundry/failure-modes.md (FM-FP-04 in-house rollout regression)
...
- ADR-0026 — in-house AI model substrate roadmap.
- `microservices/foundry/threat-model.md` T-04.
- `microservices/foundry/failure-modes.md` FM-FP-04.
