...
date: 2026-05-17
related_artifacts:
  - microservices/foundry/failure-modes.md (FM-04 replay divergence)
...
- ADR-0024 §"Replay against past traces".
- `microservices/foundry/failure-modes.md` FM-04.
- `microservices/foundry/threat-model.md` T-E-01 (sandbox escape).
- `microservices/foundry/PRD.md` §"Performance Targets" (replay determinism ≤ 100ms).
