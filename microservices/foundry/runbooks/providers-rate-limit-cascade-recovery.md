...
date: 2026-05-17
related_artifacts:
  - microservices/foundry/failure-modes.md (FM-FP-02 rate-limit cascade)
  - microservices/foundry/threat-model.md (T-02 rate-limit abuse)
  - microservices/foundry/PRD.md §"FR-02"
...
- `microservices/foundry/failure-modes.md` FM-FP-02.
- `microservices/foundry/threat-model.md` T-02.
