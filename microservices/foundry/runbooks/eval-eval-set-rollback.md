...
date: 2026-05-17
related_artifacts:
  - microservices/foundry/failure-modes.md (FM-01 eval-set authoring)
...
- Per-changeset evidence at `microservices/foundry/evidence/multispectrum/` updated.

## References

- ADR-0024 §"Eval kernel" + §"Publish-time eval gate".
- `microservices/foundry/failure-modes.md` FM-01.
- `microservices/foundry/incident-response.md`.
- `microservices/foundry/policy/two-person-admin-ops.md`.
