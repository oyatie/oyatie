...
date: 2026-05-17
related_artifacts:
  - microservices/foundry/failure-modes.md (FM-08, FM-11)
  - microservices/foundry/policy/guardrail-enforcement.md (§"Per-Tenant FP Escalation Budget")
...
- `microservices/foundry/incident-response.md` §"FP escalation budget".
