...
related_artifacts:
  ...
  - microservices/foundry/policy/*.cedar
...
- `microservices/foundry/threat-model.md` T-T-01 + T-T-04 + T-T-06.
- `microservices/foundry/dpia.md` R-01 + R-02 + R-06 + R-07.
- `microservices/foundry/policy/*.cedar`.
- `microservices/foundry/incident-response.md` (FP / jailbreak escalation).
