...
1. Active SCC at `microservices/foundry/legal/transfer-register.md`.
...
- `microservices/foundry/policy/runtime-isolation.md`.
- `microservices/foundry/multi-region.md`.
- `microservices/foundry/legal/{transfer-register, schrems-supplementary-measures, baa-template, dpa-template, sub-processors, ropa}.md`.
