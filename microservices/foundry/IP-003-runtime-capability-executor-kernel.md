...
One new Rust crate at `microservices/foundry/src/crates/oya-foundry-runtime-capability-executor-kernel/`. Workspace member added to root Cargo.toml. Catalog row.
