...
Two new Rust crates under `microservices/foundry/src/crates/`. Consumes kernel. Mock-port integration tests prove orchestration flow without infrastructure.
