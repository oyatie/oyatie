...
|---|---|---|---|
| `microservices/foundry/iac/helm/milvus/values.yaml` | edit | existing backup block (lines ~80-110) | tune cron + retention |
| `microservices/foundry/iac/kustomize/components/milvus-backup/cronjob.yaml` | create | 1-90 | k8s CronJob wrapping milvus-backup CLI |
| `microservices/foundry/iac/kustomize/components/milvus-backup/rbac.yaml` | create | 1-50 | ServiceAccount + Role |
| `microservices/foundry/iac/kustomize/components/milvus-backup/external-secret.yaml` | create | 1-40 | S3 credentials via ExternalSecret |
| `microservices/foundry/iac/kustomize/components/milvus-backup/prometheus-rule.yaml` | create | 1-80 | alerts on backup failure / drift / SLO |
| `microservices/foundry/runbooks/milvus-restore.md` | exists | already authored | runbook |
| `microservices/foundry/runbooks/milvus-backup-drill.md` | create | 1-160 | step-by-step quarterly drill |
...
1. **Restore from backup.** Per the runbook at `microservices/foundry/runbooks/milvus-restore.md` — covers single-collection restore, partial-tenant restore, full-cluster DR.
