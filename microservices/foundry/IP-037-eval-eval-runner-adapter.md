...
1. **Filesystem eval-set reader** — reads YAML/JSON eval-set definitions from `microservices/foundry/eval-sets/` and emits typed `EvalSet` aggregates to the use-case layer.
...
|---|---|---|
| `microservices/foundry/src/crates/oya-foundry-eval-eval-runner-adapter/Cargo.toml` | create | ~50 LoC |
| `microservices/foundry/src/crates/oya-foundry-eval-eval-runner-adapter/src/lib.rs` | create | ~120 LoC; pub surface, error types, trait impls |
| `microservices/foundry/src/crates/oya-foundry-eval-eval-runner-adapter/src/eval_set_reader.rs` | create | ~220 LoC; filesystem walker + serde-yaml + schema validator + bounded read budget |
| `microservices/foundry/src/crates/oya-foundry-eval-eval-runner-adapter/src/route_resolver.rs` | create | ~240 LoC; Workflow-event client; ratelimit token negotiation; tenant-scope guard |
| `microservices/foundry/src/crates/oya-foundry-eval-eval-runner-adapter/src/evidence_emitter.rs` | create | ~180 LoC; foundry-evidence client + per-run audit-chain seal |
| `microservices/foundry/src/crates/oya-foundry-eval-eval-runner-adapter/src/tenant_guard.rs` | create | ~80 LoC; rejects cross-tenant eval-set reads |
| `microservices/foundry/src/crates/oya-foundry-eval-eval-runner-adapter/tests/eval_set_reader_test.rs` | create | ~200 LoC; 4 tests |
| `microservices/foundry/src/crates/oya-foundry-eval-eval-runner-adapter/tests/route_resolver_test.rs` | create | ~200 LoC; 4 tests against fake `foundry-providers` |
| `microservices/foundry/src/crates/oya-foundry-eval-eval-runner-adapter/tests/evidence_emitter_test.rs` | create | ~160 LoC; 3 tests against fake evidence sink |
| `microservices/foundry/src/crates/oya-foundry-eval-eval-runner-adapter/tests/tenant_guard_test.rs` | create | ~120 LoC; 3 isolation tests |
| `microservices/foundry/catalog/oya-foundry-eval-eval-runner-adapter.yaml` | create | ~60 LoC; catalog entry per ADR-0131 catalog substrate |
| `microservices/foundry/runbooks/eval-runner-adapter-debug.md` | create | ~100 LoC operator playbook |
...
- `evidence/microservices/foundry/eval-runner-adapter-coverage-{date}.json` — line + branch coverage report (target ≥ 85% line)
- `evidence/microservices/foundry/eval-runner-adapter-isolation-{date}.json` — tenant-guard scan
...
- microservices/foundry/PHASE-01-EVAL-HARNESS-SUBSTRATE.md.
