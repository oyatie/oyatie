...
| completion-gate-reviewer-and-ci-matrix-03 | cargo test -p oya-foundry-vcs-merge-queue-conflict-kernel --scope reviewer_selected --adr ADR-0221 | oya-foundry-vcs-merge-queue-conflict-kernel | proves reviewer_selected cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-04 | cargo test -p oya-foundry-vcs-review-mergequeue-kernel --scope review_running --adr ADR-0221 | oya-foundry-vcs-review-mergequeue-kernel | proves review_running cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-05 | cargo test -p oya-foundry-webhook-receiver-kernel --scope approve_recorded --adr ADR-0221 | oya-foundry-webhook-receiver-kernel | proves approve_recorded cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-06 | cargo test -p oya-foundry-vcs-admission-gate-kernel --scope code_review_section_valid --adr ADR-0221 | oya-foundry-vcs-admission-gate-kernel | proves code_review_section_valid cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-07 | cargo test -p oya-foundry-vcs-changebundle-kernel --scope merge_queue_ready --adr ADR-0221 | oya-foundry-vcs-changebundle-kernel | proves merge_queue_ready cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-08 | cargo test -p oya-foundry-vcs-promotion-controller-kernel --scope auto_merge_enabled --adr ADR-0221 | oya-foundry-vcs-promotion-controller-kernel | proves auto_merge_enabled cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-09 | cargo test -p oya-foundry-vcs-cli-ratchet-kernel --scope completion_blocked --adr ADR-0221 | oya-foundry-vcs-cli-ratchet-kernel | proves completion_blocked cannot advance without policy, evidence, trace, and audit correlation |
...
| completion-gate-reviewer-and-ci-matrix-15 | cargo test -p oya-foundry-vcs-merge-queue-conflict-kernel --scope code_review_section_valid --adr ADR-0221 | oya-foundry-vcs-merge-queue-conflict-kernel | proves code_review_section_valid cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-16 | cargo test -p oya-foundry-vcs-review-mergequeue-kernel --scope merge_queue_ready --adr ADR-0221 | oya-foundry-vcs-review-mergequeue-kernel | proves merge_queue_ready cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-17 | cargo test -p oya-foundry-webhook-receiver-kernel --scope auto_merge_enabled --adr ADR-0221 | oya-foundry-webhook-receiver-kernel | proves auto_merge_enabled cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-18 | cargo test -p oya-foundry-vcs-admission-gate-kernel --scope completion_blocked --adr ADR-0221 | oya-foundry-vcs-admission-gate-kernel | proves completion_blocked cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-19 | cargo test -p oya-foundry-vcs-changebundle-kernel --scope ci_required --adr ADR-0221 | oya-foundry-vcs-changebundle-kernel | proves ci_required cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-20 | cargo test -p oya-foundry-vcs-promotion-controller-kernel --scope ci_green --adr ADR-0221 | oya-foundry-vcs-promotion-controller-kernel | proves ci_green cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-21 | cargo test -p oya-foundry-vcs-cli-ratchet-kernel --scope reviewer_selected --adr ADR-0221 | oya-foundry-vcs-cli-ratchet-kernel | proves reviewer_selected cannot advance without policy, evidence, trace, and audit correlation |
...
| completion-gate-reviewer-and-ci-matrix-27 | cargo test -p oya-foundry-vcs-merge-queue-conflict-kernel --scope completion_blocked --adr ADR-0221 | oya-foundry-vcs-merge-queue-conflict-kernel | proves completion_blocked cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-28 | cargo test -p oya-foundry-vcs-review-mergequeue-kernel --scope ci_required --adr ADR-0221 | oya-foundry-vcs-review-mergequeue-kernel | proves ci_required cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-29 | cargo test -p oya-foundry-webhook-receiver-kernel --scope ci_green --adr ADR-0221 | oya-foundry-webhook-receiver-kernel | proves ci_green cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-30 | cargo test -p oya-foundry-vcs-admission-gate-kernel --scope reviewer_selected --adr ADR-0221 | oya-foundry-vcs-admission-gate-kernel | proves reviewer_selected cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-31 | cargo test -p oya-foundry-vcs-changebundle-kernel --scope review_running --adr ADR-0221 | oya-foundry-vcs-changebundle-kernel | proves review_running cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-32 | cargo test -p oya-foundry-vcs-promotion-controller-kernel --scope approve_recorded --adr ADR-0221 | oya-foundry-vcs-promotion-controller-kernel | proves approve_recorded cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-33 | cargo test -p oya-foundry-vcs-cli-ratchet-kernel --scope code_review_section_valid --adr ADR-0221 | oya-foundry-vcs-cli-ratchet-kernel | proves code_review_section_valid cannot advance without policy, evidence, trace, and audit correlation |
...
| completion-gate-reviewer-and-ci-matrix-39 | cargo test -p oya-foundry-vcs-merge-queue-conflict-kernel --scope reviewer_selected --adr ADR-0221 | oya-foundry-vcs-merge-queue-conflict-kernel | proves reviewer_selected cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-40 | cargo test -p oya-foundry-vcs-review-mergequeue-kernel --scope review_running --adr ADR-0221 | oya-foundry-vcs-review-mergequeue-kernel | proves review_running cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-41 | cargo test -p oya-foundry-webhook-receiver-kernel --scope approve_recorded --adr ADR-0221 | oya-foundry-webhook-receiver-kernel | proves approve_recorded cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-42 | cargo test -p oya-foundry-vcs-admission-gate-kernel --scope code_review_section_valid --adr ADR-0221 | oya-foundry-vcs-admission-gate-kernel | proves code_review_section_valid cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-43 | cargo test -p oya-foundry-vcs-changebundle-kernel --scope merge_queue_ready --adr ADR-0221 | oya-foundry-vcs-changebundle-kernel | proves merge_queue_ready cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-44 | cargo test -p oya-foundry-vcs-promotion-controller-kernel --scope auto_merge_enabled --adr ADR-0221 | oya-foundry-vcs-promotion-controller-kernel | proves auto_merge_enabled cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-45 | cargo test -p oya-foundry-vcs-cli-ratchet-kernel --scope completion_blocked --adr ADR-0221 | oya-foundry-vcs-cli-ratchet-kernel | proves completion_blocked cannot advance without policy, evidence, trace, and audit correlation |
...
| completion-gate-reviewer-and-ci-matrix-51 | cargo test -p oya-foundry-vcs-merge-queue-conflict-kernel --scope code_review_section_valid --adr ADR-0221 | oya-foundry-vcs-merge-queue-conflict-kernel | proves code_review_section_valid cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-52 | cargo test -p oya-foundry-vcs-review-mergequeue-kernel --scope merge_queue_ready --adr ADR-0221 | oya-foundry-vcs-review-mergequeue-kernel | proves merge_queue_ready cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-53 | cargo test -p oya-foundry-webhook-receiver-kernel --scope auto_merge_enabled --adr ADR-0221 | oya-foundry-webhook-receiver-kernel | proves auto_merge_enabled cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-54 | cargo test -p oya-foundry-vcs-admission-gate-kernel --scope completion_blocked --adr ADR-0221 | oya-foundry-vcs-admission-gate-kernel | proves completion_blocked cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-55 | cargo test -p oya-foundry-vcs-changebundle-kernel --scope ci_required --adr ADR-0221 | oya-foundry-vcs-changebundle-kernel | proves ci_required cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-56 | cargo test -p oya-foundry-vcs-promotion-controller-kernel --scope ci_green --adr ADR-0221 | oya-foundry-vcs-promotion-controller-kernel | proves ci_green cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-57 | cargo test -p oya-foundry-vcs-cli-ratchet-kernel --scope reviewer_selected --adr ADR-0221 | oya-foundry-vcs-cli-ratchet-kernel | proves reviewer_selected cannot advance without policy, evidence, trace, and audit correlation |
...
| completion-gate-reviewer-and-ci-matrix-63 | cargo test -p oya-foundry-vcs-merge-queue-conflict-kernel --scope completion_blocked --adr ADR-0221 | oya-foundry-vcs-merge-queue-conflict-kernel | proves completion_blocked cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-64 | cargo test -p oya-foundry-vcs-review-mergequeue-kernel --scope ci_required --adr ADR-0221 | oya-foundry-vcs-review-mergequeue-kernel | proves ci_required cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-65 | cargo test -p oya-foundry-webhook-receiver-kernel --scope ci_green --adr ADR-0221 | oya-foundry-webhook-receiver-kernel | proves ci_green cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-66 | cargo test -p oya-foundry-vcs-admission-gate-kernel --scope reviewer_selected --adr ADR-0221 | oya-foundry-vcs-admission-gate-kernel | proves reviewer_selected cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-67 | cargo test -p oya-foundry-vcs-changebundle-kernel --scope review_running --adr ADR-0221 | oya-foundry-vcs-changebundle-kernel | proves review_running cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-68 | cargo test -p oya-foundry-vcs-promotion-controller-kernel --scope approve_recorded --adr ADR-0221 | oya-foundry-vcs-promotion-controller-kernel | proves approve_recorded cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-69 | cargo test -p oya-foundry-vcs-cli-ratchet-kernel --scope code_review_section_valid --adr ADR-0221 | oya-foundry-vcs-cli-ratchet-kernel | proves code_review_section_valid cannot advance without policy, evidence, trace, and audit correlation |
...
| completion-gate-reviewer-and-ci-matrix-75 | cargo test -p oya-foundry-vcs-merge-queue-conflict-kernel --scope reviewer_selected --adr ADR-0221 | oya-foundry-vcs-merge-queue-conflict-kernel | proves reviewer_selected cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-76 | cargo test -p oya-foundry-vcs-review-mergequeue-kernel --scope review_running --adr ADR-0221 | oya-foundry-vcs-review-mergequeue-kernel | proves review_running cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-77 | cargo test -p oya-foundry-webhook-receiver-kernel --scope approve_recorded --adr ADR-0221 | oya-foundry-webhook-receiver-kernel | proves approve_recorded cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-78 | cargo test -p oya-foundry-vcs-admission-gate-kernel --scope code_review_section_valid --adr ADR-0221 | oya-foundry-vcs-admission-gate-kernel | proves code_review_section_valid cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-79 | cargo test -p oya-foundry-vcs-changebundle-kernel --scope merge_queue_ready --adr ADR-0221 | oya-foundry-vcs-changebundle-kernel | proves merge_queue_ready cannot advance without policy, evidence, trace, and audit correlation |
| completion-gate-reviewer-and-ci-matrix-80 | cargo test -p oya-foundry-vcs-promotion-controller-kernel --scope auto_merge_enabled --adr ADR-0221 | oya-foundry-vcs-promotion-controller-kernel | proves auto_merge_enabled cannot advance without policy, evidence, trace, and audit correlation |
