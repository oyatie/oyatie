...
| agent-pipeline-isolation-worktree-matrix-03 | cargo test -p oya-foundry-vcs-merge-queue-conflict-kernel --scope branch_bound --adr ADR-0116 | oya-foundry-vcs-merge-queue-conflict-kernel | proves branch_bound cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-04 | cargo test -p oya-foundry-vcs-review-mergequeue-kernel --scope scope_claimed --adr ADR-0116 | oya-foundry-vcs-review-mergequeue-kernel | proves scope_claimed cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-05 | cargo test -p oya-foundry-webhook-receiver-kernel --scope edits_made --adr ADR-0116 | oya-foundry-webhook-receiver-kernel | proves edits_made cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-06 | cargo test -p oya-foundry-vcs-admission-gate-kernel --scope local_checks --adr ADR-0116 | oya-foundry-vcs-admission-gate-kernel | proves local_checks cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-07 | cargo test -p oya-foundry-vcs-changebundle-kernel --scope pr_opened --adr ADR-0116 | oya-foundry-vcs-changebundle-kernel | proves pr_opened cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-08 | cargo test -p oya-foundry-vcs-promotion-controller-kernel --scope admission_reconciled --adr ADR-0116 | oya-foundry-vcs-promotion-controller-kernel | proves admission_reconciled cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-09 | cargo test -p oya-foundry-vcs-cli-ratchet-kernel --scope worktree_retired --adr ADR-0116 | oya-foundry-vcs-cli-ratchet-kernel | proves worktree_retired cannot advance without policy, evidence, trace, and audit correlation |
...
| agent-pipeline-isolation-worktree-matrix-15 | cargo test -p oya-foundry-vcs-merge-queue-conflict-kernel --scope local_checks --adr ADR-0116 | oya-foundry-vcs-merge-queue-conflict-kernel | proves local_checks cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-16 | cargo test -p oya-foundry-vcs-review-mergequeue-kernel --scope pr_opened --adr ADR-0116 | oya-foundry-vcs-review-mergequeue-kernel | proves pr_opened cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-17 | cargo test -p oya-foundry-webhook-receiver-kernel --scope admission_reconciled --adr ADR-0116 | oya-foundry-webhook-receiver-kernel | proves admission_reconciled cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-18 | cargo test -p oya-foundry-vcs-admission-gate-kernel --scope worktree_retired --adr ADR-0116 | oya-foundry-vcs-admission-gate-kernel | proves worktree_retired cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-19 | cargo test -p oya-foundry-vcs-changebundle-kernel --scope lane_requested --adr ADR-0116 | oya-foundry-vcs-changebundle-kernel | proves lane_requested cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-20 | cargo test -p oya-foundry-vcs-promotion-controller-kernel --scope worktree_created --adr ADR-0116 | oya-foundry-vcs-promotion-controller-kernel | proves worktree_created cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-21 | cargo test -p oya-foundry-vcs-cli-ratchet-kernel --scope branch_bound --adr ADR-0116 | oya-foundry-vcs-cli-ratchet-kernel | proves branch_bound cannot advance without policy, evidence, trace, and audit correlation |
...
| agent-pipeline-isolation-worktree-matrix-27 | cargo test -p oya-foundry-vcs-merge-queue-conflict-kernel --scope worktree_retired --adr ADR-0116 | oya-foundry-vcs-merge-queue-conflict-kernel | proves worktree_retired cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-28 | cargo test -p oya-foundry-vcs-review-mergequeue-kernel --scope lane_requested --adr ADR-0116 | oya-foundry-vcs-review-mergequeue-kernel | proves lane_requested cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-29 | cargo test -p oya-foundry-webhook-receiver-kernel --scope worktree_created --adr ADR-0116 | oya-foundry-webhook-receiver-kernel | proves worktree_created cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-30 | cargo test -p oya-foundry-vcs-admission-gate-kernel --scope branch_bound --adr ADR-0116 | oya-foundry-vcs-admission-gate-kernel | proves branch_bound cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-31 | cargo test -p oya-foundry-vcs-changebundle-kernel --scope scope_claimed --adr ADR-0116 | oya-foundry-vcs-changebundle-kernel | proves scope_claimed cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-32 | cargo test -p oya-foundry-vcs-promotion-controller-kernel --scope edits_made --adr ADR-0116 | oya-foundry-vcs-promotion-controller-kernel | proves edits_made cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-33 | cargo test -p oya-foundry-vcs-cli-ratchet-kernel --scope local_checks --adr ADR-0116 | oya-foundry-vcs-cli-ratchet-kernel | proves local_checks cannot advance without policy, evidence, trace, and audit correlation |
...
| agent-pipeline-isolation-worktree-matrix-39 | cargo test -p oya-foundry-vcs-merge-queue-conflict-kernel --scope branch_bound --adr ADR-0116 | oya-foundry-vcs-merge-queue-conflict-kernel | proves branch_bound cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-40 | cargo test -p oya-foundry-vcs-review-mergequeue-kernel --scope scope_claimed --adr ADR-0116 | oya-foundry-vcs-review-mergequeue-kernel | proves scope_claimed cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-41 | cargo test -p oya-foundry-webhook-receiver-kernel --scope edits_made --adr ADR-0116 | oya-foundry-webhook-receiver-kernel | proves edits_made cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-42 | cargo test -p oya-foundry-vcs-admission-gate-kernel --scope local_checks --adr ADR-0116 | oya-foundry-vcs-admission-gate-kernel | proves local_checks cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-43 | cargo test -p oya-foundry-vcs-changebundle-kernel --scope pr_opened --adr ADR-0116 | oya-foundry-vcs-changebundle-kernel | proves pr_opened cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-44 | cargo test -p oya-foundry-vcs-promotion-controller-kernel --scope admission_reconciled --adr ADR-0116 | oya-foundry-vcs-promotion-controller-kernel | proves admission_reconciled cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-45 | cargo test -p oya-foundry-vcs-cli-ratchet-kernel --scope worktree_retired --adr ADR-0116 | oya-foundry-vcs-cli-ratchet-kernel | proves worktree_retired cannot advance without policy, evidence, trace, and audit correlation |
...
| agent-pipeline-isolation-worktree-matrix-51 | cargo test -p oya-foundry-vcs-merge-queue-conflict-kernel --scope local_checks --adr ADR-0116 | oya-foundry-vcs-merge-queue-conflict-kernel | proves local_checks cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-52 | cargo test -p oya-foundry-vcs-review-mergequeue-kernel --scope pr_opened --adr ADR-0116 | oya-foundry-vcs-review-mergequeue-kernel | proves pr_opened cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-53 | cargo test -p oya-foundry-webhook-receiver-kernel --scope admission_reconciled --adr ADR-0116 | oya-foundry-webhook-receiver-kernel | proves admission_reconciled cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-54 | cargo test -p oya-foundry-vcs-admission-gate-kernel --scope worktree_retired --adr ADR-0116 | oya-foundry-vcs-admission-gate-kernel | proves worktree_retired cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-55 | cargo test -p oya-foundry-vcs-changebundle-kernel --scope lane_requested --adr ADR-0116 | oya-foundry-vcs-changebundle-kernel | proves lane_requested cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-56 | cargo test -p oya-foundry-vcs-promotion-controller-kernel --scope worktree_created --adr ADR-0116 | oya-foundry-vcs-promotion-controller-kernel | proves worktree_created cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-57 | cargo test -p oya-foundry-vcs-cli-ratchet-kernel --scope branch_bound --adr ADR-0116 | oya-foundry-vcs-cli-ratchet-kernel | proves branch_bound cannot advance without policy, evidence, trace, and audit correlation |
...
| agent-pipeline-isolation-worktree-matrix-63 | cargo test -p oya-foundry-vcs-merge-queue-conflict-kernel --scope worktree_retired --adr ADR-0116 | oya-foundry-vcs-merge-queue-conflict-kernel | proves worktree_retired cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-64 | cargo test -p oya-foundry-vcs-review-mergequeue-kernel --scope lane_requested --adr ADR-0116 | oya-foundry-vcs-review-mergequeue-kernel | proves lane_requested cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-65 | cargo test -p oya-foundry-webhook-receiver-kernel --scope worktree_created --adr ADR-0116 | oya-foundry-webhook-receiver-kernel | proves worktree_created cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-66 | cargo test -p oya-foundry-vcs-admission-gate-kernel --scope branch_bound --adr ADR-0116 | oya-foundry-vcs-admission-gate-kernel | proves branch_bound cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-67 | cargo test -p oya-foundry-vcs-changebundle-kernel --scope scope_claimed --adr ADR-0116 | oya-foundry-vcs-changebundle-kernel | proves scope_claimed cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-68 | cargo test -p oya-foundry-vcs-promotion-controller-kernel --scope edits_made --adr ADR-0116 | oya-foundry-vcs-promotion-controller-kernel | proves edits_made cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-69 | cargo test -p oya-foundry-vcs-cli-ratchet-kernel --scope local_checks --adr ADR-0116 | oya-foundry-vcs-cli-ratchet-kernel | proves local_checks cannot advance without policy, evidence, trace, and audit correlation |
...
| agent-pipeline-isolation-worktree-matrix-75 | cargo test -p oya-foundry-vcs-merge-queue-conflict-kernel --scope branch_bound --adr ADR-0116 | oya-foundry-vcs-merge-queue-conflict-kernel | proves branch_bound cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-76 | cargo test -p oya-foundry-vcs-review-mergequeue-kernel --scope scope_claimed --adr ADR-0116 | oya-foundry-vcs-review-mergequeue-kernel | proves scope_claimed cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-77 | cargo test -p oya-foundry-webhook-receiver-kernel --scope edits_made --adr ADR-0116 | oya-foundry-webhook-receiver-kernel | proves edits_made cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-78 | cargo test -p oya-foundry-vcs-admission-gate-kernel --scope local_checks --adr ADR-0116 | oya-foundry-vcs-admission-gate-kernel | proves local_checks cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-79 | cargo test -p oya-foundry-vcs-changebundle-kernel --scope pr_opened --adr ADR-0116 | oya-foundry-vcs-changebundle-kernel | proves pr_opened cannot advance without policy, evidence, trace, and audit correlation |
| agent-pipeline-isolation-worktree-matrix-80 | cargo test -p oya-foundry-vcs-promotion-controller-kernel --scope admission_reconciled --adr ADR-0116 | oya-foundry-vcs-promotion-controller-kernel | proves admission_reconciled cannot advance without policy, evidence, trace, and audit correlation |
