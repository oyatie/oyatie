...
1. Search `foundry` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `foundry` manifest `governance_lanes` array only in the manifest-owning slot.
