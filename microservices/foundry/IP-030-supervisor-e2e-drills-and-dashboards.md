...
| `microservices/foundry/tests/e2e/redis_failover.rs` | create (AC-08) |
| `microservices/foundry/dashboards/` | already created (Slice C; verify deployment + JSON conformance) |
