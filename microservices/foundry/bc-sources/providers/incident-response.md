...
related_artifacts:
  ...
  - microservices/foundry-providers/compliance.md
  - microservices/foundry-providers/failure-modes.md
  - microservices/foundry-providers/multi-region.md
...
- `microservices/foundry-providers/threat-model.md`.
- `microservices/foundry-providers/dpia.md`.
- `microservices/foundry-providers/compliance.md` §"Breach notification".
