...
|---|---|---|---|---|---|
| FR-01 | capability owner | to author a signed eval set at `microservices/foundry-eval/eval-sets/<capability>/v<n>.evalset.yaml` | my capability can publish | eval-set-registry | Must |
...
- Error budget policy: `microservices/foundry-eval/runbooks/error-budget-policy.md`.
