...
- Records-of-processing (Art. 30): `microservices/foundry-guardrails/legal/ropa.md` (Slice D).
...
Per-pack overlays at `regional-packs/<pack>/foundry-guardrails-dpia-overlay.md`.
