...
ip_id: IP-journey-j90-typed-record-writer
...
# IP-journey-j90-typed-record-writer - ontology

## Goal

Implement the `typed-record-writer` slice for `ontology` so j90 can satisfy `US-CCPA-CPRA-2023` without leaking tenant data, collapsing provider-BYOK and encryption-BYOK meanings, or bypassing Cedar.
...
| File | Purpose | Notes |
|---|---|---|
| `microservices/ontology/contracts/openapi/j90-typed-record-writer-v1.yaml` | OpenAPI 3.2.0 REST surface | External read/write or admin action |
| `microservices/ontology/contracts/asyncapi/j90-typed-record-writer-events-v1.yaml` | AsyncAPI 3.1.0 event surface | Emits ADR-0263 events |
| `microservices/ontology/contracts/proto/j90-typed-record-writer-v1.proto` | proto3 internal RPC | Service-to-service call path |
| `microservices/ontology/policy/j90-typed-record-writer.cedar` | Cedar permit/forbid bundle | Deny-wins gate |
| `microservices/ontology/runbooks/j90-typed-record-writer-rollback.md` | Rollback and incident path | Includes regulator deadline handling |
| `microservices/ontology/tests/j90_typed_record_writer_test.rs` | Integration tests | Positive, negative, rollback, audit |
...
- `J90OntologyTypedRecordWriterStarted`.
- `J90OntologyTypedRecordWriterPermitted`.
- `J90OntologyTypedRecordWriterDenied`.
- `J90OntologyTypedRecordWriterCommitted`.
- `J90OntologyTypedRecordWriterRolledBack`.

## Implementation rows

### IP row 001 - ontology typed-record-writer
Scope: implement one ontology behavior for j90, not a cross-service refactor.
