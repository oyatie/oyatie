...
ip_id: IP-journey-j90-pack-overlay-regulator
...
# IP-journey-j90-pack-overlay-regulator - compliance

## Goal

Implement the `pack-overlay-regulator` slice for `compliance` so j90 can satisfy `US-CCPA-CPRA-2023` without leaking tenant data, collapsing provider-BYOK and encryption-BYOK meanings, or bypassing Cedar.
...
| File | Purpose | Notes |
|---|---|---|
| `microservices/compliance/contracts/openapi/j90-pack-overlay-regulator-v1.yaml` | OpenAPI 3.2.0 REST surface | External read/write or admin action |
| `microservices/compliance/contracts/asyncapi/j90-pack-overlay-regulator-events-v1.yaml` | AsyncAPI 3.1.0 event surface | Emits ADR-0263 events |
| `microservices/compliance/contracts/proto/j90-pack-overlay-regulator-v1.proto` | proto3 internal RPC | Service-to-service call path |
| `microservices/compliance/policy/j90-pack-overlay-regulator.cedar` | Cedar permit/forbid bundle | Deny-wins gate |
| `microservices/compliance/runbooks/j90-pack-overlay-regulator-rollback.md` | Rollback and incident path | Includes regulator deadline handling |
| `microservices/compliance/tests/j90_pack_overlay_regulator_test.rs` | Integration tests | Positive, negative, rollback, audit |
...
- `J90CompliancePackOverlayRegulatorStarted`.
- `J90CompliancePackOverlayRegulatorPermitted`.
- `J90CompliancePackOverlayRegulatorDenied`.
- `J90CompliancePackOverlayRegulatorCommitted`.
- `J90CompliancePackOverlayRegulatorRolledBack`.

## Implementation rows

### IP row 001 - compliance pack-overlay-regulator
Scope: implement one compliance behavior for j90, not a cross-service refactor.
