...
1. Search `healthcare-integration` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `healthcare-integration` manifest `governance_lanes` array only in the manifest-owning slot.
