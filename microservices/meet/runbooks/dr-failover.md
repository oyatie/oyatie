# meet DR failover runbook

## Trigger

- Primary region or cell cannot meet the manifest RTO/RPO contract.
- Cedar, OpenBao, Postgres, Valkey, object storage, or audit-chain dependencies for meet are degraded beyond the service SLO.

## Authority

- ADR-0343 DR matrix.
- Manifest `dr` block in `microservices/meet/manifest.json`.
...
4. Rehydrate declared backup substrates: postgres_wal_g, object_storage_versioned, valkey_cluster, audit_chain_merkle_seal.
