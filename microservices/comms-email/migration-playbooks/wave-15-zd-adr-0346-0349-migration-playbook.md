...
1. Search `comms-email` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `comms-email` manifest `governance_lanes` array only in the manifest-owning slot.
