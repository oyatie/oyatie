...
date: 2026-05-17
related_artifacts:
  - microservices/foundry-runtime/failure-modes.md (FM-02, FM-03)
  - microservices/foundry-runtime/threat-model.md (T-T-02)
...
| 3 | Compare with declared (Helm values): `diff <(redis-cli ACL LIST) microservices/foundry-runtime/iac/helm/redis/expected-acl.txt` | ≤2min |
...
- `microservices/foundry-runtime/failure-modes.md` FM-02, FM-03.
- `microservices/foundry-runtime/threat-model.md` T-T-02.
- `microservices/foundry-runtime/policy/runtime-isolation.md` TI-01, TI-02.
