...
date: 2026-05-17
related_artifacts:
  - microservices/foundry-runtime/failure-modes.md (FM-11)
  - microservices/foundry-runtime/incident-response.md
  - microservices/foundry-runtime/policy/runtime-isolation.md (TI-08 autonomy)
...
- `microservices/foundry-runtime/failure-modes.md` FM-11.
- `microservices/foundry-runtime/incident-response.md`.
- `microservices/foundry-runtime/policy/runtime-isolation.md` TI-08.
