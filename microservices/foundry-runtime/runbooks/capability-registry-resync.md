...
date: 2026-05-17
related_artifacts:
  - microservices/foundry-runtime/failure-modes.md (FM-04, FM-05)
  - microservices/foundry-runtime/threat-model.md (T-T-04)
...
- `microservices/foundry-runtime/failure-modes.md` FM-04, FM-05.
- `microservices/foundry-runtime/threat-model.md` T-T-04.
- `microservices/foundry-runtime/incident-response.md` §"Regulatory Notifications".
