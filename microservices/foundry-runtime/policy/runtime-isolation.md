...
related_adrs: [ADR-0022, ADR-0025, ADR-0028, ADR-0117, ADR-0130, ADR-0131, ADR-0140]
related_artifacts:
  - microservices/foundry-runtime/threat-model.md (Trust Boundaries 2 + 3; T-S-01, T-I-01, T-E-01)
  - microservices/foundry-runtime/dpia.md (R-02, R-05, R-15, R-17)
...
- ADR-0022; ADR-0025; ADR-0028 (audit-chain — Bominal); ADR-0117; ADR-0130; ADR-0131; ADR-0140.
- `microservices/foundry-runtime/threat-model.md` Trust Boundaries 2 + 3; T-S-01, T-I-01, T-E-01.
- `microservices/foundry-runtime/dpia.md` R-02, R-05, R-15, R-17.
- `microservices/foundry-runtime/policy/{tenant-scope,ci-scope,auditor-scope,public-read}.cedar`.
