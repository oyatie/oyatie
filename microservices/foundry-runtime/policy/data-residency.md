...
related_artifacts:
  - microservices/foundry-runtime/threat-model.md (T-I-01, T-T-02, cross-region threats)
  - microservices/foundry-runtime/dpia.md (R-11)
...
1. Active SCC at `microservices/foundry-runtime/legal/transfer-register.md`.
...
- `microservices/foundry-runtime/threat-model.md` T-I-01 + T-T-02.
- `microservices/foundry-runtime/dpia.md` R-11 + R-13 + R-15 + §2.2.
- `microservices/foundry-runtime/policy/runtime-isolation.md`.
- `microservices/foundry-runtime/multi-region.md`.
- `microservices/foundry-runtime/legal/{transfer-register, schrems-supplementary-measures, baa-template, dpa-template, sub-processors, ropa}.md`.
