...
| 2 | Tenant-supplied custom-code execution (sandboxed WASM / Firecracker) | council-architecture | post-M01 ADR |
...
| 5 | Multi-foundation-model dispatch transparency (Bedrock-class side-by-side comparison) | foundry-providers | post-M01 |
