...
| 3 | Multi-tenant capability registry mirror — Postgres logical replication vs CDC stream from foundry-supervisor | axis-foundry-runtime + axis-foundry | ADR-NNNN follow-up |
