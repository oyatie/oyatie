...
1. Search `forms` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `forms` manifest `governance_lanes` array only in the manifest-owning slot.
