...
This directory holds **service-scoped** Architecture Decision Records owned by the `forms` µservice per ADR-0131 §"Canonical folder shape". Repo-wide ADRs live at `docs/decisions/` (e.g., ADR-0105, ADR-0126, ADR-0130, ADR-0131, ADR-0132, ADR-0133, ADR-0140).
...
- Every service-scoped ADR in this directory MUST reference the repo-wide ADRs it inherits from (e.g., ADR-0131 layout, ADR-0140 Cedar, ADR-0105 layer enum, ADR-0126 microservice naming, ADR-0130 SLO-gated promotion, ADR-0132 single-concern, ADR-0133 review cadence).
