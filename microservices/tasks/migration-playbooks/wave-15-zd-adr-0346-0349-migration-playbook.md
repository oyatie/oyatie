...
1. Search `tasks` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `tasks` manifest `governance_lanes` array only in the manifest-owning slot.
