...
//! [`ControlPlaneStatus`](oya_managed_k8s_control_plane_host_kernel::ControlPlaneStatus)
...
use oya_managed_k8s_control_plane_host_kernel::{ControlPlaneStatus, ControlPlaneTier};
...
mod tests {
    use super::*;
    use oya_managed_k8s_control_plane_host_kernel::DatastoreClass;
