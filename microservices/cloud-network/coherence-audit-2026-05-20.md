...
- D5-04 AWS Direct Connect supports dedicated connection port speeds of 1, 10, 100, and 400 Gbps (https://docs.aws.amazon.com/en_us/directconnect/latest/UserGuide/connection-classic.html).
...
- D5-06 Google Cloud VPC official docs describe global VPC networks, regional subnets, routes, dynamic routing through Cloud Router, firewall policies, internal communication, Cloud NAT, Cloud VPN, Cloud Interconnect, VPC Peering, and Private Service Connect (https://docs.cloud.google.com/vpc/docs/vpc).
