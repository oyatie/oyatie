...
15. Hold risky network deploys: `oya vcs hold --microservice cloud-network --reason $INCIDENT_ID --scope edge`.
...
13. Unhold deploys: `oya vcs unhold --microservice cloud-network --reason resolved-$INCIDENT_ID`.
