# cloud-network DR Failover Runbook

## Purpose
Restore the cloud-network service to the manifest-declared RTO/RPO without changing tenant isolation, compliance-pack placement, or audit-chain evidence.
...
## Exit Criteria
- RTO <= 600s and RPO <= 300s are met or an incident exception is opened.
