...
## Mitigation
1. Hold network policy deploys: `oya vcs hold --microservice cloud-network --reason $INCIDENT_ID --scope routing`.
...
14. Unhold deploys: `oya vcs unhold --microservice cloud-network --reason resolved-$INCIDENT_ID`.
