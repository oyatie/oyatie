...
`oya-cloud-ci-cloud-resource-contracts-app` is the Rust/API-shaped replacement for the first P0 cloud-resource Python validator slice:
...
```text
cargo test -p oya-cloud-ci-cloud-resource-contracts-app -- --nocapture
```
