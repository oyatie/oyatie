...
fn ensure_existing_canonical_parent_is_real(repo_root: &Path) -> Result<(), String> {
...
fn validate_receipt_population(stages: &[ReceiptStage]) -> Result<bool, String> {
    if stages.is_empty() {
