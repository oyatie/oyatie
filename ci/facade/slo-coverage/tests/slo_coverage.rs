...
///   2026-08-13  773 -> pin 774     THIS change adds registry/catalog/ci-reorg-target-debt.yaml
///                                  (no-new-reorg-target-debt gate crate, bootstrap T3b). Rows
///                                  were legitimately added; enumeration scope unchanged.
