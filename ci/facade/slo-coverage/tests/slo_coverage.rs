...
///   2026-08-14  773 -> pin 769     integ/cloud cloud-os purge deleted the four dead
///                                  oya-cloud-os-*-domain catalog rows (their crates were
///                                  dual-home residuals; forever homes live under os/core).
///                                  Legitimate row removal; re-freeze only.
