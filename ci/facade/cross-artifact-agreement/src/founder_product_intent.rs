...
/// graph, ADR, and controller projections are separate authority surfaces and
/// cannot be made current by a founder-intent candidate.
pub fn evaluate_founder_product_intent_agreement(intent: &Value) -> BTreeSet<Finding> {
