//! Rust pin alignment across toolchain, workspace MSRV, image, and Buck notes.
...
use crate::{CONFIG_PATH, Finding, GateError, string_at};
...
pub(crate) fn looks_like_semver(value: &str) -> bool {
