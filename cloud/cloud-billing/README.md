...
buck2 test //cloud/cloud-billing:oya-cloud-billing-domain

# Integration tests (cross-µservice tax handoff)
buck2 test //cloud/cloud-billing:oya-cloud-billing-tax-app

# Wave 15B new tests
buck2 test //cloud/cloud-billing:oya-cloud-billing-app
buck2 test //cloud/cloud-billing:oya-cloud-billing-worker
```
