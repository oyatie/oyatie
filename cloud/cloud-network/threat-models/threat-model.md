...
doc_id: TM-CLOUD-NETWORK-WAVE-15-ZF-11
...
# STRIDE Threat Model: cloud-network
...
- ADR-0346: historical local verifier doctrine only; active merge evidence is Buck2 target output plus trusted Rust/Prow `oya-ci-required` context.
...
- ADR-0349: historical Jenkins/ArgoCD provenance only; active controls are Buck2/Prow required-context evidence plus native promotion cosign/audit-chain lanes.
