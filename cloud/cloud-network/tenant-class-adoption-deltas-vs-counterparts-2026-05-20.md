...
4. µservice architecture anchor: local `ARCHITECTURE.md` absent; implementation shape inferred from `crates/oya-cloud-network-domain/src/lib.rs:1-7`, `crates/oya-cloud-network-vpc-api/src/lib.rs:1-17`, `crates/oya-cloud-network-lb-api/src/lib.rs:1-16`, and `crates/oya-cloud-network-dns-api/src/lib.rs:1-16`.
