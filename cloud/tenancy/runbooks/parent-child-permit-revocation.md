...
- Trigger from Prow when `Buck2/Prow native gate evidence for tenancy-parent-child-permit-revocation --production-snapshot` is non-green against the latest production evidence bundle.
...
14. Verify production snapshot evidence through Prow/Buck2: `Buck2/Prow native gate evidence for tenancy-parent-child-permit-revocation --production-snapshot --cell $CELL`.
15. Check Buck2 owner target: `Buck2/Prow targeted test evidence for oya-tenancy-domain parent_child_permit_revocation -- --nocapture`.
...
6. Add regression test: `Buck2/Prow targeted test evidence for oya-tenancy-domain parent_child_permit_revocation_incident_regression -- --nocapture`.
7. Attach Buck2/Prow fixture evidence: `Buck2/Prow native gate evidence for tenancy-parent-child-permit-revocation --fixture incident-parent-child-permit-revocation.json`.
...
9. Add dashboard panel: `update microservices/tenancy/dashboards/rls-enforcement.json with oya_tenancy_parent_child_permit_revocation_error_ratio, oya_tenancy_parent_child_permit_revocation_lag_seconds, and oya_tenancy_parent_child_permit_revocation_queue_depth`.
