...
- Trigger from Prow when `Buck2/Prow native gate evidence for tenancy-cross-tenant-data-leak-containment --production-snapshot` is non-green against the latest production evidence bundle.
...
14. Verify production snapshot evidence through Prow/Buck2: `Buck2/Prow native gate evidence for tenancy-cross-tenant-data-leak-containment --production-snapshot --cell $CELL`.
15. Check Buck2 owner target: `Buck2/Prow targeted test evidence for oya-tenancy-domain cross_tenant_data_leak_containment -- --nocapture`.
...
6. Add regression test: `Buck2/Prow targeted test evidence for oya-tenancy-domain cross_tenant_data_leak_containment_incident_regression -- --nocapture`.
7. Attach Buck2/Prow fixture evidence: `Buck2/Prow native gate evidence for tenancy-cross-tenant-data-leak-containment --fixture incident-cross-tenant-data-leak-containment.json`.
