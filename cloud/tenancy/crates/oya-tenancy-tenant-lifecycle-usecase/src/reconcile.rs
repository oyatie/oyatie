...
use oya_tenancy_tenant_lifecycle_domain::{DesiredTenantState, Plan, derive_step_key};
use oya_tenancy_tenant_lifecycle_kernel::TenantLifecycleStore;
...
impl<S: TenantLifecycleStore> TenantLifecycleProvider<S> {
    ...
    pub fn reconcile(
        ...
        match oya_tenancy_tenant_lifecycle_domain::plan_next_operation(
            observed.state,
            spec.desired,
        ) {
