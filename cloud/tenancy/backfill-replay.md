...
1. Operator invokes: `tenancy control-plane replay operation --tenant-id <id> --event-type TenantActivated --since <ISO8601> --until <ISO8601> --reason "<rfc-with-jira-ticket>"`.
