# cloud-network-dns DR Failover Runbook

## Purpose
Restore the cloud-network-dns service to the manifest-declared RTO/RPO without changing tenant isolation, compliance-pack placement, or audit-chain evidence.
...
## Exit Criteria
- RTO <= 300s and RPO <= 60s are met or an incident exception is opened.
- Manifest runtime tier 3 and cell placement Tier-4 remain unchanged.
