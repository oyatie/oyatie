...
- ADR-0346 — historical local verifier/gate CLI doctrine; active CI/merge authority is superseded by ADR-0513 Buck2 evidence plus Rust/Prow `oya-ci-required`. Historical lane names remain provenance only.
