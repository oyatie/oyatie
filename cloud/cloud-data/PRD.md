...
# PRD-cloud-data: Doctrine Propagation Surface
...
- ADR-0339 adoption keeps reusable HCL in `microservices/cloud-iac/modules/<context>/<primitive>/`; `cloud-data` owns primitive selection and tenant-scoped variables.
