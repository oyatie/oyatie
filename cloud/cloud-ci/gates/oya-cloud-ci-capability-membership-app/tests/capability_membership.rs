...
use oya_cloud_ci_capability_membership_app::{Verdict, collect, evaluate, evaluate_keyed};
...
fn gate_dir(root: &Path) -> PathBuf {
    root.join("cloud/cloud-ci/gates/oya-cloud-ci-capability-membership-app")
}
