...
use oya_cloud_ci_tier_field_coverage_app::{Verdict, collect_manifests, evaluate, evaluate_keyed};
...
fn gate_dir(root: &Path) -> PathBuf {
    root.join("cloud/cloud-ci/gates/oya-cloud-ci-tier-field-coverage-app")
}
