...
pub const PRODUCER_TARGET: &str = "//cloud/cloud-ci/gates:accounting-registry-producer";
...
impl Policy {
    ...
    pub fn ttl_policy_face(&self) -> Value {
        ...
        root.insert(
            "_comment".into(),
            Value::String(
                "GENERATED by accounting-registry-producer from ttl-policy.json. committed==regenerated."
                    .into(),
            ),
        );
...
pub fn build_registry(inputs: &RepoInputs, policy: &Policy) -> Result<Value, ProducerError> {
    ...
    root.insert(
        "_comment".into(),
        Value::String(
            "GENERATED by accounting-registry-producer. DO NOT HAND-EDIT — the registry-drift gate makes any hand-edit RED (committed==regenerated)."
                .into(),
        ),
    );
    root.insert(
...
pub fn build_decision_crosswalk(inputs: &CrosswalkInputs) -> Result<Value, ProducerError> {
    ...
    root.insert(
        "_comment".into(),
        Value::String(
            "GENERATED by accounting-registry-producer for GATE-1 cloud-ci-cross-artifact-agreement. \
...
pub fn build_enforcement_inventory(inputs: &EnforcementInputs) -> Result<Value, ProducerError> {
    ...
    root.insert(
        "_comment".into(),
        Value::String(
            "GENERATED by accounting-registry-producer for GATE-4 cloud-ci-automation-ratchet. \
             committed==regenerated (registry-drift byte-diffs it). DO NOT HAND-EDIT."
                .into(),
        ),
    );
