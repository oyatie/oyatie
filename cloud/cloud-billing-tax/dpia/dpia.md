...
# Data Protection Impact Assessment: cloud-billing-tax
...
- Event surface: automation events for this microservice include oya-ci/Prow required-context outcomes, governance lane vocabulary provenance, sharding automation decisions, and native promotion transitions.
...
- Cedar decision id, audit-chain event id, oya-ci required-context id, native promotion event id
...
### Residual Risk
- Residual risk is medium until implementation PRs land the Buck2/Prow checks, governance vocabulary, sharding automation bodies, and native promotion seams.
