...
arch_id: ARCH-cloud-billing-tax
...
- Ownership split: cloud-iac owns reusable OpenTofu primitive bodies; `cloud-billing-tax` owns wrapper selection, variables, SLO-driven sizing, and blast-radius review.
- Current manifest pins: aws-guest/rds-postgres@v1[paid], aws-guest/kms-key@v1[paid], oci-guest/autonomous-db@v1[paid], oyatie-as-cloud-provider/cell-audit-chain-shard@v1[paid].
...
- Capacity: `per_request` drives CPU `0.08`, RAM `192`, storage `2`, and connection pool variables.
