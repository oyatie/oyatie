...
- Cedar decision id, audit-chain event id, `oya-ci-required` run id or owned `oya-ci` run id after cutover, ArgoCD/GitOps sync id, cosign verification result, and governance lane id.
