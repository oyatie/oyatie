...
//!
//! ## Posture
//! cloud-iam IS the IdP substrate, and the Cedar PDP + policy-bundle
...
//! through the [`oya_cloud_iam_pdp_kernel::PolicyBundleStore`] port
...
use oya_cloud_iam_pdp_kernel::DecisionAuditSink;
...
pub use oya_cloud_iam_pdp_kernel::{
