...
- ADR-0346: ADR-0346 is historical local verifier doctrine; active merge evidence is Buck2 target output plus the trusted Rust/Prow `oya-ci-required` context.
