...
- ADR-0515 supersession: GitHub Actions produces the live required `oya-ci-required` context until owned oya-ci runner cutover; ArgoCD cosign/audit-chain lanes preserve GitOps CD controls.
