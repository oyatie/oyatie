...
acceptance_lanes: [buck2-build, buck2-build, buck2-authority, buck2-tests, supply-chain-policy, lean-a1, layer-correctness, oya-governance-openapi-conformance]
---
...
buck2 build //:repo-hygiene-automation-check # native Buck2/Prow gate evidence for openapi-conformance --microservice cloud-iac
```
...
- Surface evidence: `microservices/cloud-iac/contracts/openapi/cloud-iac.yaml`, `microservices/cloud-iac/contracts/asyncapi/cloud-iac-events.yaml`, `microservices/cloud-iac/contracts/proto/cloud-iac.proto`, `microservices/cloud-iac/IP-010-rest-surfaces.md`.
