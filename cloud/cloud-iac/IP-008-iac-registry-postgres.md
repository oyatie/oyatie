...
Six new crates per ADR-0105. Plus the Postgres schema migration files at `microservices/cloud-iac/iac/postgres/migrations/`.
...
- `microservices/cloud-iac/policy/data-residency.md` §"iac-state-index Jurisdiction Labels".
