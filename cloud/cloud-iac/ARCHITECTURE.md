...
- Platform principal `oyatie.cloud-iac.worker` owns async jobs, retry queues, and backfill replay listed in `microservices/cloud-iac/backfill-replay.md` when present.
...
### Service-specific answer
- Default-deny is represented by the first matching Cedar fragment in `microservices/cloud-iac/policy/auditor-scope.cedar`, `microservices/cloud-iac/policy/ci-scope.cedar`, `microservices/cloud-iac/policy/data-residency.md`, `microservices/cloud-iac/policy/iac-isolation.md`, `microservices/cloud-iac/policy/public-read.cedar`, `microservices/cloud-iac/policy/tenant-scope.cedar`.
...
- Concrete fragments in scope: `microservices/cloud-iac/policy/auditor-scope.cedar`, `microservices/cloud-iac/policy/ci-scope.cedar`, `microservices/cloud-iac/policy/data-residency.md`, `microservices/cloud-iac/policy/iac-isolation.md`, `microservices/cloud-iac/policy/public-read.cedar`, `microservices/cloud-iac/policy/tenant-scope.cedar`.
...
- Planned table/event surface `cloud_iac.iac_apply_2` inherits the same `tenant_id` and audit fields until a migration file supersedes this placeholder name.
- Planned table/event surface `cloud_iac.iac_apply_3` inherits the same `tenant_id` and audit fields until a migration file supersedes this placeholder name.
- Planned table/event surface `cloud_iac.iac_apply_4` inherits the same `tenant_id` and audit fields until a migration file supersedes this placeholder name.
- Planned table/event surface `cloud_iac.iac_apply_5` inherits the same `tenant_id` and audit fields until a migration file supersedes this placeholder name.
...
- If substrate: products consume `cloud-iac` only through contracts `microservices/cloud-iac/contracts/asyncapi/cloud-iac-events.yaml`, `microservices/cloud-iac/contracts/openapi/cloud-iac.yaml`, `microservices/cloud-iac/contracts/proto/cloud-iac.proto`.
...
- The caller-side library evaluates fragments from `microservices/cloud-iac/policy/auditor-scope.cedar`, `microservices/cloud-iac/policy/ci-scope.cedar`, `microservices/cloud-iac/policy/data-residency.md`, `microservices/cloud-iac/policy/iac-isolation.md`, `microservices/cloud-iac/policy/public-read.cedar`, `microservices/cloud-iac/policy/tenant-scope.cedar` with the full action/resource/context tuple.
...
### Service-specific answer
- Public/API contracts in scope: `microservices/cloud-iac/contracts/asyncapi/cloud-iac-events.yaml`, `microservices/cloud-iac/contracts/openapi/cloud-iac.yaml`, `microservices/cloud-iac/contracts/proto/cloud-iac.proto`.
...
- IaC transport evidence: `microservices/cloud-iac/iac/cue-krm-packages/argocd/Chart.yaml`, `microservices/cloud-iac/iac/cue-krm-packages/argocd/templates/.gitkeep`, `microservices/cloud-iac/iac/cue-krm-packages/argocd/values.yaml`, `microservices/cloud-iac/iac/cue-krm-packages/flagger/Chart.yaml`, `microservices/cloud-iac/iac/cue-krm-packages/helm-controller/Chart.yaml`, `microservices/cloud-iac/iac/cue-krm-packages/helm-controller/templates/deployment.yaml`; +6 more.
...
- IaC manifests in scope: `microservices/cloud-iac/iac/cue-krm-packages/argocd/Chart.yaml`, `microservices/cloud-iac/iac/cue-krm-packages/argocd/templates/.gitkeep`, `microservices/cloud-iac/iac/cue-krm-packages/argocd/values.yaml`, `microservices/cloud-iac/iac/cue-krm-packages/flagger/Chart.yaml`, `microservices/cloud-iac/iac/cue-krm-packages/helm-controller/Chart.yaml`, `microservices/cloud-iac/iac/cue-krm-packages/helm-controller/templates/deployment.yaml`; +6 more.
- Catalog crates/components: `microservices/cloud-iac/catalog/oya-cloud-iac-iac-applier-adapter-argocd.yaml`, `microservices/cloud-iac/catalog/oya-cloud-iac-iac-applier-adapter.yaml`, `microservices/cloud-iac/catalog/oya-cloud-iac-iac-applier-api.yaml`, `microservices/cloud-iac/catalog/oya-cloud-iac-iac-applier-app.yaml`, `microservices/cloud-iac/catalog/oya-cloud-iac-iac-applier-domain.yaml`, `microservices/cloud-iac/catalog/oya-cloud-iac-iac-applier-kernel.yaml`; +18 more.
...
### Service-specific answer
- SLO/dashboard sources in scope: `microservices/cloud-iac/slos/helm-chart-lint-correctness.openslo.yaml`, `microservices/cloud-iac/slos/iac-apply-latency.openslo.yaml`, `microservices/cloud-iac/slos/iac-render-latency.openslo.yaml`, `microservices/cloud-iac/slos/iac-rollback-latency.openslo.yaml`, `microservices/cloud-iac/slos/iac-validator-availability.openslo.yaml`, `microservices/cloud-iac/slos/slsa-provenance-completeness.openslo.yaml`; +3 more.
...
- Reference evidence artifact: `microservices/cloud-iac/slos/helm-chart-lint-correctness.openslo.yaml`.
...
- Cedar/IaC controls in scope: `microservices/cloud-iac/policy/auditor-scope.cedar`, `microservices/cloud-iac/policy/ci-scope.cedar`, `microservices/cloud-iac/policy/data-residency.md`, `microservices/cloud-iac/policy/iac-isolation.md`, `microservices/cloud-iac/policy/public-read.cedar`, `microservices/cloud-iac/policy/tenant-scope.cedar`; +12 more.
...
- Rotation cadence is linked from `microservices/cloud-iac/runbooks/drift-remediation.md`, `microservices/cloud-iac/runbooks/gitops-reconciler-restart.md`, `microservices/cloud-iac/runbooks/registry-restore.md`, `microservices/cloud-iac/runbooks/restore-drill-quarterly.md`, `microservices/cloud-iac/runbooks/rollback-orchestration.md`, `microservices/cloud-iac/runbooks/seaweedfs-volume-failover.md`; +2 more.
