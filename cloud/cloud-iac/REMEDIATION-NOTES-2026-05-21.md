...
- `microservices/cloud-iac/AUDIT-FINDINGS-2026-05-18.json`
...
IP changes:
- `microservices/cloud-iac/IP-001-layer-a-argocd-flux-iac.md`: Trigger B -> DR posture.
- `microservices/cloud-iac/IP-009-iac-rollback-engine.md`: Trigger B -> DR posture.
- `microservices/cloud-iac/IP-010-rest-surfaces.md`: Trigger A -> API Versioning.
- `microservices/cloud-iac/IP-013-sdk-and-observability-slo.md`: Trigger B -> DR posture.
- `microservices/cloud-iac/IP-014-per-pack-iac-overlays.md`: Trigger B -> DR posture.
- `microservices/cloud-iac/IP-GITOPS-001-terraform-to-opentofu-migration.md`: Trigger A -> API Versioning.
- `microservices/cloud-iac/IP-GITOPS-002-argocd-app-of-apps-pattern.md`: Trigger A -> API Versioning; Trigger B -> DR posture.
- `microservices/cloud-iac/IP-GITOPS-003-tier-discipline-rollout.md`: Trigger A -> API Versioning; Trigger C -> Sustainability emission.
- `microservices/cloud-iac/IP-GITOPS-005-drift-detection.md`: Trigger A -> API Versioning; Trigger C -> Sustainability emission.
- `microservices/cloud-iac/IP-GITOPS-006-secret-bootstrap-tier-b.md`: Trigger A -> API Versioning.
- `microservices/cloud-iac/IP-GITOPS-007-namespace-bootstrap-tier-b.md`: Trigger A -> API Versioning.
- `microservices/cloud-iac/IP-GITOPS-008-argocd-project-bootstrap.md`: Trigger A -> API Versioning; Trigger B -> DR posture.
- `microservices/cloud-iac/IP-journey-j100-pack-rollout-first-action.md`: Trigger A -> API Versioning; Trigger B -> DR posture.
- `microservices/cloud-iac/IP-journey-j80-cell-infra-declarative.md`: Trigger A -> API Versioning.
- `microservices/cloud-iac/IP-journey-j81-cell-infra-declarative.md`: Trigger A -> API Versioning.
- `microservices/cloud-iac/IP-journey-j83-cell-infra-declarative.md`: Trigger A -> API Versioning; Trigger B -> DR posture.
- `microservices/cloud-iac/IP-journey-j87-cell-infra-declarative.md`: Trigger A -> API Versioning.
- `microservices/cloud-iac/IP-journey-j88-cell-infra-declarative.md`: Trigger A -> API Versioning; Trigger C -> Sustainability emission.
- `microservices/cloud-iac/IP-journey-j91-us-msb-mtl-overlay.md`: Trigger A -> API Versioning; Trigger B -> DR posture; Trigger C -> Sustainability emission.
- `microservices/cloud-iac/IP-journey-j92-br-lgpd-us-parent-dsar.md`: Trigger A -> API Versioning.
- `microservices/cloud-iac/IP-journey-j93-in-dpdpa-rbi-overlay.md`: Trigger A -> API Versioning; Trigger B -> DR posture.
- `microservices/cloud-iac/IP-journey-j94-sox404-public-company-controls.md`: Trigger A -> API Versioning; Trigger B -> DR posture.
- `microservices/cloud-iac/IP-journey-j95-iso27001-soc2-annual-audit.md`: Trigger A -> API Versioning; Trigger B -> DR posture.
- `microservices/cloud-iac/IP-journey-j96-ksa-uae-mena-onboarding.md`: Trigger A -> API Versioning.
- `microservices/cloud-iac/IP-journey-j97-sg-pdpa-mas-tenant.md`: Trigger A -> API Versioning; Trigger B -> DR posture.
- `microservices/cloud-iac/IP-journey-j98-au-privacy-apra-cps234.md`: Trigger A -> API Versioning.
- `microservices/cloud-iac/IP-journey-j99-multi-pack-conflict-resolution.md`: Trigger A -> API Versioning.

Unmatched IPs:
- `microservices/cloud-iac/IP-002-layer-a-opentofu-iac.md`.
- `microservices/cloud-iac/IP-003-iac-renderer-kernel.md`.
- `microservices/cloud-iac/IP-004-iac-renderer-domain-usecase.md`.
- `microservices/cloud-iac/IP-005-iac-renderer-adapter-trio.md`.
- `microservices/cloud-iac/IP-006-iac-validator-kernel-domain-usecase.md`.
- `microservices/cloud-iac/IP-007-iac-applier-kernel-domain-usecase.md`.
- `microservices/cloud-iac/IP-008-iac-registry-postgres.md`.
- `microservices/cloud-iac/IP-011-worker-binaries.md`.
- `microservices/cloud-iac/IP-012-app-composition-roots.md`.
- `microservices/cloud-iac/IP-015-hg-cloud-iac-registration.md`.
- `microservices/cloud-iac/IP-GITOPS-004-opentofu-module-registry-bootstrap.md`.
...
- Values: pod_runtime_tier=1; evidence=microservices/cloud-iac/PRD.md, microservices/cloud-iac/ARCHITECTURE.md, microservices/cloud-iac/capacity-model.md.
