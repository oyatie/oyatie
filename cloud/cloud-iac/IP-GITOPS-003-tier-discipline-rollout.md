...
|---|---|
| `microservices/cloud-iac/policy/ci-scope.cedar` | worker action permits and cross-microservice apply forbid |
| `microservices/cloud-iac/policy/iac-isolation.md` | isolation invariants and reserved scopes |
| `microservices/cloud-iac/contracts/openapi/cloud-iac.yaml` | `triggerRender`, `planPreview`, `triggerApply`, `triggerRollback`, `getDriftReport` |
| `microservices/cloud-iac/contracts/proto/cloud-iac.proto` | gRPC equivalents for render/apply/rollback/drift |
| `microservices/cloud-iac/capabilities/iac-render.yaml` | render capability risk surface |
| `microservices/cloud-iac/capabilities/iac-apply.yaml` | apply capability risk surface |
| `microservices/cloud-iac/capabilities/iac-rollback.yaml` | rollback capability risk surface |
...
- This IP contains no retired rollout label or delayed-enforcement window
  language.
- `rg "cross-µservice apply|apply_scope|iac-applier-worker" microservices/cloud-iac/policy/ci-scope.cedar`
...
```bash
rg "apply_scope|iac-applier-worker|iac-rollback-worker" microservices/cloud-iac/policy/ci-scope.cedar
rg "triggerApply|triggerRollback|getDriftReport" microservices/cloud-iac/contracts/openapi/cloud-iac.yaml
```
...
- Surface evidence: `microservices/cloud-iac/contracts/openapi/cloud-iac.yaml`, `microservices/cloud-iac/contracts/asyncapi/cloud-iac-events.yaml`, `microservices/cloud-iac/contracts/proto/cloud-iac.proto`, `microservices/cloud-iac/IP-GITOPS-003-tier-discipline-rollout.md`.
...
- Surface evidence: `microservices/cloud-iac/manifest.json`, `microservices/cloud-iac/IP-GITOPS-003-tier-discipline-rollout.md`.
