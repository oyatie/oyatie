...
date: 2026-05-17
related_artifacts:
  - microservices/cloud-iac/failure-modes.md (FM-02, FM-11, FM-15)
...
| 4 | If attacker: standard incident-response per `incident-response.md` §"Severity 1"; engage council-privacy if data-impactful |
