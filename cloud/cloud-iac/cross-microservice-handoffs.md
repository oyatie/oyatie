...
REST shapes are from `microservices/cloud-iac/contracts/openapi/cloud-iac.yaml`.
Async shapes are from `microservices/cloud-iac/contracts/asyncapi/cloud-iac-events.yaml`.
gRPC names are from `microservices/cloud-iac/contracts/proto/cloud_iac.proto`.
Cedar policies are from `microservices/cloud-iac/policies/`.
