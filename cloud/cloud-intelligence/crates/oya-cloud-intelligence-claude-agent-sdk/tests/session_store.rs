...
#[tokio::test]
async fn in_memory_session_store_matches_core_contracts() -> oya_cloud_intelligence_claude_agent_sdk::Result<()> {
...
#[tokio::test]
async fn store_backed_session_helpers_roundtrip() -> oya_cloud_intelligence_claude_agent_sdk::Result<()> {
    let store = InMemorySessionStore::default();
...
#[tokio::test]
async fn store_backed_fork_session_remaps_transcript_entries() -> oya_cloud_intelligence_claude_agent_sdk::Result<()> {
    let store = InMemorySessionStore::default();
    let project = tempdir().unwrap();
    let project_key = project_key_for_directory(project.path());
...
#[tokio::test]
async fn session_mutation_options_route_to_store_helpers() -> oya_cloud_intelligence_claude_agent_sdk::Result<()> {
    let store = InMemorySessionStore::default();
    let project = tempdir().unwrap();
    let project_key = project_key_for_directory(project.path());
...
#[tokio::test]
async fn session_read_options_route_to_store_helpers() -> oya_cloud_intelligence_claude_agent_sdk::Result<()> {
    let store = InMemorySessionStore::default();
    let project = tempdir().unwrap();
    let project_key = project_key_for_directory(project.path());
...
#[tokio::test]
async fn query_mirrors_transcript_frames_without_yielding_them() -> oya_cloud_intelligence_claude_agent_sdk::Result<()> {
...
#[tokio::test]
async fn resume_materializes_store_session_before_spawn() -> oya_cloud_intelligence_claude_agent_sdk::Result<()> {
    let dir = tempdir().unwrap();
    let project = tempdir().unwrap();
