...
#[test]
fn control_request_envelope_serializes_current_wire_shape() -> oya_cloud_intelligence_claude_agent_sdk::Result<()> {
...
-> oya_cloud_intelligence_claude_agent_sdk::Result<()> {
