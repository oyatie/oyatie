...
mod integration_tests {
    ...
    ///
    /// Sibling of the same guard in `oya-cloud-os-secrets-domain` and
    /// `oya-cloud-os-cluster-mgmt-domain`. Proven to fire by adding
    ...
    /// the `oya-cloud-os-trustd-domain` `rust_library` gives
    ///
    /// ```text
    ...
    fn no_buck_target_enables_the_model() {
        ...
        assert!(
            buck.contains("oya-cloud-os-trustd-domain"),
