...
mod tests {
    ...
    //
    //   buck2 build //cloud/cloud-os/crates/oya-cloud-os-trustd-domain:oya-cloud-os-trustd-domain
    ...
    /// `oya_cloud_os_secrets_domain::tests::crate_root_gate_is_present`, which is where
