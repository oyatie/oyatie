use oya_cloud_os_kernel::address::NodeAddress;
use oya_cloud_os_k8s_control_domain::static_pod_controller::STATIC_POD_PATH as CONTROL_STATIC_POD_PATH;
use oya_cloud_os_k8s_control_domain::{
    ComponentSpec, ControlPlaneComponent, InMemoryFileSink, StaticPodController,
};
use oya_cloud_os_kubelet_domain::{
    KubeletConfig, KubeletSpec, Nodename, config::DEFAULT_RUNTIME_ENDPOINT,
    spec::STATIC_POD_PATH as KUBELET_STATIC_POD_PATH,
};
use oya_cloud_os_runtime_cri_domain::address::{CRI_CONTAINERD_ADDRESS, SYSTEM_CONTAINERD_ADDRESS};
