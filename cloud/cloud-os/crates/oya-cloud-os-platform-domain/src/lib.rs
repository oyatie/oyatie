...
pub trait Platform {
    ...
    /// Returns [`oya_cloud_os_kernel::error::Error::NotFound`] (modeling upstream
...
pub fn no_config_source() -> oya_cloud_os_kernel::error::Error {
    oya_cloud_os_kernel::error::Error::not_found("no configuration source")
}
