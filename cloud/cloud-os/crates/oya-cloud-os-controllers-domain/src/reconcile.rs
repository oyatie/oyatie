...
//! [`State`](oya_cloud_os_cosi_domain::State) store.

use std::collections::BTreeMap;
use oya_cloud_os_cosi_domain::resource::{AnyResource, ResourceKind};
use oya_cloud_os_cosi_domain::{Metadata, State};
...
pub fn output_metadata(namespace: &str, kind: &str, id: oya_cloud_os_kernel::ResourceId) -> Metadata {
...
mod tests {
    ...
    impl oya_cloud_os_cosi_domain::Resource for Out {
        ...
        fn clone_box(&self) -> Box<dyn oya_cloud_os_cosi_domain::Resource> {
            Box::new(self.clone())
        }
    }
