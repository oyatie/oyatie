...
fn upsert_system_volume_configs(
    ...
    active_machine_config: Option<&oya_cloud_os_machine_config_domain::Config>,
    state_encryption_meta: Option<&oya_cloud_os_machine_config_domain::EncryptionSpec>,
    in_container: bool,
    is_agent: bool,
...
fn upsert_user_volume_configs(
    ctx: &mut ReconcileContext<'_>,
    active_machine_config: &oya_cloud_os_machine_config_domain::Config,
    existing_outputs: &mut ExistingVolumeOutputs,
) -> ReconcileResult {
    let docs = oya_cloud_os_machine_config_domain::user_volume_configs(active_machine_config).map_err(|err| {
...
fn upsert_raw_volume_configs(
    ...
    let docs = oya_cloud_os_machine_config_domain::raw_volume_configs(active_machine_config).map_err(|err| {
...
fn upsert_existing_volume_configs(
    ...
    let docs =
        oya_cloud_os_machine_config_domain::existing_volume_configs(active_machine_config).map_err(|err| {
...
fn upsert_external_volume_configs(
    ...
    let docs =
        oya_cloud_os_machine_config_domain::external_volume_configs(active_machine_config).map_err(|err| {
...
fn upsert_swap_volume_configs(
    ...
    let docs = oya_cloud_os_machine_config_domain::swap_volume_configs(active_machine_config).map_err(|err| {
...
fn config_present_state_volume_config(
    ...
    let extra_volume_config = oya_cloud_os_machine_config_domain::volume_configs(active_machine_config)
        .map_err(|err| {
...
fn user_volume_config(
    doc: &oya_cloud_os_machine_config_domain::UserVolumeConfigDoc,
) -> crate::Result<VolumeConfigResource> {
    match doc.volume_type {
        oya_cloud_os_machine_config_domain::UserVolumeType::Directory => user_directory_volume_config(doc),
        oya_cloud_os_machine_config_domain::UserVolumeType::Partition => user_partition_volume_config(doc),
        oya_cloud_os_machine_config_domain::UserVolumeType::Disk => user_disk_volume_config(doc),
    }
}
...
fn user_partition_volume_config(
    ...
    let mut provisioning = VolumeConfigProvisioningSpec {
        ...
        min_size: doc
            .provisioning
            .min_size
            .unwrap_or(oya_cloud_os_machine_config_domain::MIN_USER_VOLUME_SIZE),
        max_size: None,
        relative_max_size: None,
        negative_max_size: false,
...
fn raw_volume_config(
    doc: &oya_cloud_os_machine_config_domain::RawVolumeConfigDoc,
) -> crate::Result<VolumeConfigResource> {
    let volume_id = doc.volume_id();
    let mut provisioning = VolumeConfigProvisioningSpec {
        wave: WAVE_USER_VOLUMES,
...
fn swap_volume_config(
    doc: &oya_cloud_os_machine_config_domain::SwapVolumeConfigDoc,
) -> crate::Result<VolumeConfigResource> {
    let volume_id = doc.volume_id();
    let mut provisioning = VolumeConfigProvisioningSpec {
        wave: WAVE_USER_VOLUMES,
...
fn existing_volume_config(
    doc: &oya_cloud_os_machine_config_domain::ExistingVolumeConfigDoc,
) -> crate::Result<VolumeConfigResource> {
    labeled_volume_config(
...
fn external_volume_config(
    doc: &oya_cloud_os_machine_config_domain::ExternalVolumeConfigDoc,
) -> crate::Result<VolumeConfigResource> {
...
fn user_filesystem_type(
    filesystem: oya_cloud_os_machine_config_domain::UserVolumeFilesystem,
) -> crate::Result<FilesystemType> {
    match filesystem {
        oya_cloud_os_machine_config_domain::UserVolumeFilesystem::Xfs => Ok(FilesystemType::Xfs),
        oya_cloud_os_machine_config_domain::UserVolumeFilesystem::Ext4 => Ok(FilesystemType::Ext4),
        oya_cloud_os_machine_config_domain::UserVolumeFilesystem::Btrfs => Err(crate::BlockError::BadTable(
...
fn external_filesystem_type(
    filesystem: oya_cloud_os_machine_config_domain::ExternalVolumeFilesystem,
) -> FilesystemType {
    match filesystem {
        oya_cloud_os_machine_config_domain::ExternalVolumeFilesystem::Virtiofs => FilesystemType::Virtiofs,
    }
}

fn convert_encryption_spec(
    encryption: &oya_cloud_os_machine_config_domain::EncryptionSpec,
...
fn convert_encryption_key(
    key: &oya_cloud_os_machine_config_domain::EncryptionKeySpec,
    ...
    match &key.provider {
        oya_cloud_os_machine_config_domain::EncryptionKeyProvider::Static { passphrase } => {
            out.key_type = VolumeConfigEncryptionKeyType::Static;
            out.static_passphrase = Some(passphrase.clone());
        }
        oya_cloud_os_machine_config_domain::EncryptionKeyProvider::NodeId => {
            out.key_type = VolumeConfigEncryptionKeyType::NodeId;
        }
        oya_cloud_os_machine_config_domain::EncryptionKeyProvider::Kms { endpoint } => {
            out.key_type = VolumeConfigEncryptionKeyType::Kms;
            out.kms_endpoint = Some(endpoint.clone());
        }
        oya_cloud_os_machine_config_domain::EncryptionKeyProvider::Tpm {
...
fn apply_ephemeral_volume_config_override(
    ...
    doc: &oya_cloud_os_machine_config_domain::VolumeConfigDoc,
) {
...
fn apply_size_limit(
    provisioning: &mut VolumeConfigProvisioningSpec,
    max_size: oya_cloud_os_machine_config_domain::SizeLimit,
) {
    match max_size {
        oya_cloud_os_machine_config_domain::SizeLimit::Absolute(bytes) => {
            provisioning.max_size = Some(bytes);
            provisioning.relative_max_size = None;
            provisioning.negative_max_size = false;
        }
        oya_cloud_os_machine_config_domain::SizeLimit::RelativePercent(percent) => {
            provisioning.max_size = None;
            provisioning.relative_max_size = Some(percent);
            provisioning.negative_max_size = false;
        }
        oya_cloud_os_machine_config_domain::SizeLimit::NegativeBytes(bytes) => {
            provisioning.max_size = Some(bytes);
            provisioning.relative_max_size = None;
            provisioning.negative_max_size = true;
        }
        oya_cloud_os_machine_config_domain::SizeLimit::NegativeRelativePercent(percent) => {
            provisioning.max_size = None;
            provisioning.relative_max_size = Some(percent);
            provisioning.negative_max_size = true;
        }
...
fn active_machine_config(
    ctx: &ReconcileContext<'_>,
) -> Result<Option<oya_cloud_os_machine_config_domain::Config>, ControllerError> {
    ...
    let config = oya_cloud_os_machine_config_domain::load_from_bytes(&contents).map_err(|err| {
...
fn state_encryption_meta(
    ctx: &ReconcileContext<'_>,
) -> Result<Option<oya_cloud_os_machine_config_domain::EncryptionSpec>, ControllerError> {
    ...
    oya_cloud_os_machine_config_domain::decode_encryption_meta_value(&value).map_err(|err| {
...
mod tests {
    ...
    use oya_cloud_os_kernel::ResourceId;
    use oya_cloud_os_cosi_domain::{Input, InputKind, Metadata, Output, Resource, ResourceKind, Runtime};
