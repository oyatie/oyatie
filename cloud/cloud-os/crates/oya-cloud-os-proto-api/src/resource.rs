...
//! [`oya_cloud_os_kernel::ResourcePointer`].

use std::collections::BTreeMap;

use oya_cloud_os_kernel::ResourceId;
use oya_cloud_os_kernel::resource::{Metadata, Namespace, Phase, ResourceKind, ResourcePointer};
use oya_cloud_os_kernel::role::Role;
...
mod tests {
    ...
    fn read_endpoints_require_read_role() {
        let svc = ResourceService::new(store_with_two());
        let nobody = RequestContext::with_roles(oya_cloud_os_kernel::role::RoleSet::new());
        assert_eq!(
