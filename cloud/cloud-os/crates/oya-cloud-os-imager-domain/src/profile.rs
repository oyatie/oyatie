...
pub struct Profile {
    ...
    pub platform: oya_cloud_os_kernel::Platform,
    /// SecureBoot mode.
...
impl Profile {
    ...
    pub fn new(
        arch: Arch,
        platform: oya_cloud_os_kernel::Platform,
        output: OutputKind,
...
/// Convert a list of profile errors into a single `oya_cloud_os_kernel::Error`.
impl From<&ProfileError> for oya_cloud_os_kernel::Error {
    fn from(e: &ProfileError) -> Self {
        oya_cloud_os_kernel::Error::invalid(e.to_string())
    }
}
