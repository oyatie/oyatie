...
use oya_cloud_os_kernel::error::{Error, Result};
...
impl WireguardKey {
    ...
    pub fn derive_from_seed(seed: &str) -> Self {
        ...
        let mut state = oya_cloud_os_kernel::id::Fingerprint::of_str(seed).value();
...
pub struct AllowedIp {
    addr: oya_cloud_os_kernel::address::NodeAddress,
    prefix: u8,
}
...
impl AllowedIp {
    ...
    pub fn new(addr: oya_cloud_os_kernel::address::NodeAddress, prefix: u8) -> Result<Self> {
    ...
    pub fn parse_v4(s: &str) -> Result<Self> {
        ...
        let addr = oya_cloud_os_kernel::address::NodeAddress::parse_v4(host)?;
