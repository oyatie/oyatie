...
use oya_cloud_os_platform_domain::aws::{
    Aws, BootstrapNetworkConfig as AwsBootstrapNetworkConfig, TOKEN_HEADER as AWS_IMDS_TOKEN_HEADER,
};
use oya_cloud_os_platform_domain::azure::Azure;
use oya_cloud_os_platform_domain::gcp::Gcp;
use oya_cloud_os_platform_domain::metal::Metal;
use oya_cloud_os_platform_domain::nocloud::NoCloud;
use oya_cloud_os_platform_domain::{ConfigSource, ConfigStore, Header, Mode, Platform};
...
mod tests {
    ...
    use oya_cloud_os_platform_domain::MemoryStore;
