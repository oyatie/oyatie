...
//! call by the RBAC [`Role`](oya_cloud_os_kernel::Role) carried in the client
...
//! - [`auth`]: per-method [`Authorizer`] gated on [`Role`](oya_cloud_os_kernel::Role).
...
use oya_cloud_os_kernel::role::RoleSet;
