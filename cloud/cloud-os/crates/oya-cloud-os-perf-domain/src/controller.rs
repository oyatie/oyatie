...
use oya_cloud_os_kernel::address::ResourceId;
use oya_cloud_os_kernel::error::Result;
use oya_cloud_os_kernel::os::{Clock, FileSystem};
use oya_cloud_os_kernel::resource::{Metadata, Namespace, ResourceKind};
...
mod tests {
    ...
    use oya_cloud_os_kernel::os::{FileSystem, ManualClock, MemoryFs};
