...
pub fn registries_config_from_machine_config_contents(
    ...
    let root = oya_cloud_os_machine_config_domain::yaml::parse(contents).map_err(|err| err.to_string())?;
...
fn yaml_mapping<'a>(
    value: &'a oya_cloud_os_machine_config_domain::yaml::Yaml,
    field: &str,
) -> std::result::Result<&'a BTreeMap<String, oya_cloud_os_machine_config_domain::yaml::Yaml>, String> {
    value
        .as_mapping()
...
fn yaml_optional_string_sequence(
    value: Option<&oya_cloud_os_machine_config_domain::yaml::Yaml>,
    field: &str,
...
fn registry_auth_from_yaml(
    value: &oya_cloud_os_machine_config_domain::yaml::Yaml,
    field: &str,
...
mod tests {
    ...
    fn registries_config_controller_spec_matches_source_declarations() {
        ...
        assert_eq!(machine_config.strength(), oya_cloud_os_cosi_domain::InputKind::Weak);
        ...
        assert_eq!(image_cache.strength(), oya_cloud_os_cosi_domain::InputKind::Weak);
...
"#,
        ...
        *stale.metadata_mut() = Metadata::new(
        ...
        let mut runtime = oya_cloud_os_cosi_domain::Runtime::with_state(state);
        runtime
...
"#,
        ...
        assert!(matches!(
            err,
            oya_cloud_os_cosi_domain::RuntimeError::ControllerFailed {
                controller,
                error
