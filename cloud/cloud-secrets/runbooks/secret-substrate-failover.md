# cloud-secrets DR Failover Runbook

## Purpose
Restore the cloud-secrets service to the manifest-declared RTO/RPO without changing tenant isolation, compliance-pack placement, or audit-chain evidence.
...
## Exit Criteria
- RTO <= 120s and RPO <= 1s are met or an incident exception is opened.
