...
`cloud-secrets` owns SecretReference resolution, OpenBao-backed namespace isolation, rotation orchestration, HSM integration, audit emission, and tenant-scoped secret governance.
