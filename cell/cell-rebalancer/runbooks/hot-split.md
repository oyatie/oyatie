...
4. Verify primary metric: `oya metrics query sharding_hot_split_threshold_breach_total --service cell-rebalancer --cell $CELL --window 30m`.
5. Verify secondary metric: `oya metrics query sharding_hot_split_duration_seconds_p99 --service cell-rebalancer --cell $CELL --window 30m`.
