...
pub use layout::{
    ...
    BUILD_OUTPUT_DIRS, BUILD_ROOT_DIRS, CAP_EXTRAS, CARGO_CONFIG_PATHS, DATA_ROOTS, FACES,
    FORBIDDEN_NAMES, META_ROOTS, WORKSPACE_EXCLUDES, WORKSPACE_MEMBER_GLOBS,
    base_admission_violations, cap_root_file_ok, cargo_config_violations, cargo_entrypoint,
    cargo_entrypoints, cargo_manifest_for_crate_path, cargo_manifest_for_entrypoint,
    cargo_manifest_violations, changed_layout_violations, draft_dependency_violations, face_dir_ok,
    is_capability_root, layout_violations, owner_core_regression_violations,
