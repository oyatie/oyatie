...
pub use layout::{
    ...
    cap_root_file_ok, cargo_entrypoint, cargo_manifest_for_entrypoint, cargo_manifest_violations,
    changed_layout_violations, draft_dependency_violations, face_dir_ok, is_capability_root,
    layout_violations, proto_package_violations, workspace_draft_dependency_violations,
};
pub use occupancy::{
