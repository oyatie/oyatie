...
1. Search `itsm` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `itsm` manifest `governance_lanes` array only in the manifest-owning slot.
