...
1. Search `audit-chain` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `audit-chain` manifest `governance_lanes` array only in the manifest-owning slot.
