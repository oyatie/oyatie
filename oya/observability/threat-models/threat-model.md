...
doc_id: TM-OBSERVABILITY-WAVE-15-ZF-11
...
# STRIDE Threat Model: observability
...
- ADR-0349: Jenkins required-check and ArgoCD cosign/audit-chain lanes preserve the same controls in self-hostable CI/CD contexts.
