...
- `buck2 build //:quality-lane-registry-authority-check # lane=mimir-tenancy-enforced` — exit 0.
- `buck2 build //:quality-lane-registry-authority-check # lane=mimir-no-wildcard-query` — exit 0.
- `buck2 build //:quality-lane-registry-authority-check # lane=grafana-rbac-conformance` — exit 0.
- `buck2 build //:quality-lane-registry-authority-check # lane=cedar-fragment-coverage --microservice observability` — exit 0.
