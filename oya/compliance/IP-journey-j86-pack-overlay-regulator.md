...
ip_id: IP-journey-j86-pack-overlay-regulator
...
# IP-journey-j86-pack-overlay-regulator - compliance

## Goal

Implement the `pack-overlay-regulator` slice for `compliance` so j86 can satisfy `PCI-DSS-L1-v4` without leaking tenant data, collapsing provider-BYOK and encryption-BYOK meanings, or bypassing Cedar.
...
| File | Purpose | Notes |
|---|---|---|
| `microservices/compliance/contracts/openapi/j86-pack-overlay-regulator-v1.yaml` | OpenAPI 3.2.0 REST surface | External read/write or admin action |
| `microservices/compliance/contracts/asyncapi/j86-pack-overlay-regulator-events-v1.yaml` | AsyncAPI 3.1.0 event surface | Emits ADR-0263 events |
| `microservices/compliance/contracts/proto/j86-pack-overlay-regulator-v1.proto` | proto3 internal RPC | Service-to-service call path |
| `microservices/compliance/policy/j86-pack-overlay-regulator.cedar` | Cedar permit/forbid bundle | Deny-wins gate |
| `microservices/compliance/runbooks/j86-pack-overlay-regulator-rollback.md` | Rollback and incident path | Includes regulator deadline handling |
| `microservices/compliance/tests/j86_pack_overlay_regulator_test.rs` | Integration tests | Positive, negative, rollback, audit |
...
- `J86CompliancePackOverlayRegulatorStarted`.
- `J86CompliancePackOverlayRegulatorPermitted`.
- `J86CompliancePackOverlayRegulatorDenied`.
- `J86CompliancePackOverlayRegulatorCommitted`.
- `J86CompliancePackOverlayRegulatorRolledBack`.

## Implementation rows

### IP row 001 - compliance pack-overlay-regulator
Scope: implement one compliance behavior for j86, not a cross-service refactor.
...
- Surface evidence: `microservices/compliance/IP-journey-j86-pack-overlay-regulator.md` matched `cardholder, financial, payment`; anchors `microservices/compliance/runbooks/phi-access-anomaly.md, crates/oya-shared-compliance-evidence-kernel/src/lib.rs`; type anchor `crates/oya-shared-compliance-evidence-kernel/src/lib.rs::EvidenceArtifact`.
