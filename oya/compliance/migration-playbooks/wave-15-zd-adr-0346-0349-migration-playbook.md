...
1. Search `compliance` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `compliance` manifest `governance_lanes` array only in the manifest-owning slot.
