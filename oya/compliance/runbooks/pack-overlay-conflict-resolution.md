...
- Trigger from CI when `buck2 build //:quality-lane-registry-authority-check # lane=compliance-pack-overlay-conflict-resolution --production-snapshot` exits non-zero against the latest production evidence bundle.
...
14. Run production snapshot gate: `buck2 build //:quality-lane-registry-authority-check # lane=compliance-pack-overlay-conflict-resolution --production-snapshot --cell $CELL`.
...
7. Add gate evidence: `buck2 build //:quality-lane-registry-authority-check # lane=compliance-pack-overlay-conflict-resolution --fixture incident-pack-overlay-conflict-resolution.json`.
...
9. Add dashboard panel: `update microservices/compliance/dashboards/dsar-pipeline.json with oya_compliance_pack_overlay_conflict_resolution_error_ratio, oya_compliance_pack_overlay_conflict_resolution_lag_seconds, and oya_compliance_pack_overlay_conflict_resolution_queue_depth`.
