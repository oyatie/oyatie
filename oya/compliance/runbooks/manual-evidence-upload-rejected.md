...
- Trigger from CI when `buck2 build //:quality-lane-registry-authority-check # lane=compliance-manual-evidence-upload-rejected --production-snapshot` exits non-zero against the latest production evidence bundle.
...
14. Run production snapshot gate: `buck2 build //:quality-lane-registry-authority-check # lane=compliance-manual-evidence-upload-rejected --production-snapshot --cell $CELL`.
...
7. Add gate evidence: `buck2 build //:quality-lane-registry-authority-check # lane=compliance-manual-evidence-upload-rejected --fixture incident-manual-evidence-upload-rejected.json`.
...
9. Add dashboard panel: `update microservices/compliance/dashboards/breach-notification-sla.json with oya_compliance_manual_evidence_upload_rejected_error_ratio, oya_compliance_manual_evidence_upload_rejected_lag_seconds, and oya_compliance_manual_evidence_upload_rejected_queue_depth`.
