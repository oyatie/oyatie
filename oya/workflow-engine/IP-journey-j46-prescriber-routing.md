...
- Authority: ADR-0343.
- Trigger evidence: `microservices/workflow-engine/IP-journey-j46-prescriber-routing.md` matched `financial, payment`.
...
- Surface evidence: `microservices/workflow-engine/IP-journey-j46-prescriber-routing.md`, `microservices/workflow-engine/manifest.json`; trigger terms `workflow-studio`.
