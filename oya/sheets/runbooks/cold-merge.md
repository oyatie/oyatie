...
3. Verify alerts: `oya observability alerts list --service sheets --runbook cold-merge --since 30m`.
4. Verify primary metric: `oya metrics query oya_sharding_cold_merge_candidate_count --service sheets --cell $CELL --window 30m`.
5. Verify secondary metric: `oya metrics query oya_sharding_cold_merge_quiet_hours --service sheets --cell $CELL --window 30m`.
