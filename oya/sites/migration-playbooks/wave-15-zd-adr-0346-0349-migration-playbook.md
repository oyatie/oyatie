...
1. Search `sites` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `sites` manifest `governance_lanes` array only in the manifest-owning slot.
