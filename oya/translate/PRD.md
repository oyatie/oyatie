...
## ADR-0339 adoption
- Lifecycle: PROPOSED for `translate` until service wrappers invoke signed shared OpenTofu modules and implementation evidence lands.
- ADR-0339 adoption keeps reusable HCL in `microservices/cloud-iac/modules/<context>/<primitive>/`; `translate` owns primitive selection and tenant-scoped variables.
