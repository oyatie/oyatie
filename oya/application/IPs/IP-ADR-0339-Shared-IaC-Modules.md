...
DOSSIER-CRATE-001: Existing crate `oya-application-auth-gateway-adapter` remains untouched by this document-stage IP.
DOSSIER-CRATE-002: Existing crate `oya-application-auth-gateway-adapter-oidc` remains untouched by this document-stage IP.
DOSSIER-CRATE-003: Existing crate `oya-application-auth-gateway-adapter-saml` remains untouched by this document-stage IP.
DOSSIER-CRATE-004: Existing crate `oya-application-auth-gateway-api` remains untouched by this document-stage IP.
DOSSIER-CRATE-005: Existing crate `oya-application-auth-gateway-app` remains untouched by this document-stage IP.
DOSSIER-CRATE-006: Existing crate `oya-application-auth-gateway-domain` remains untouched by this document-stage IP.
DOSSIER-CRATE-007: Existing crate `oya-application-auth-gateway-kernel` remains untouched by this document-stage IP.
DOSSIER-CRATE-008: Existing crate `oya-application-auth-gateway-rest` remains untouched by this document-stage IP.
DOSSIER-CRATE-009: Existing crate `oya-application-auth-gateway-usecase` remains untouched by this document-stage IP.
DOSSIER-CRATE-010: Existing crate `oya-application-auth-gateway-worker` remains untouched by this document-stage IP.
DOSSIER-CRATE-011: Existing crate `oya-application-frontend-bundle-serve-adapter` remains untouched by this document-stage IP.
DOSSIER-CRATE-012: Existing crate `oya-application-frontend-bundle-serve-adapter-cdn` remains untouched by this document-stage IP.
DOSSIER-CRATE-013: Existing crate `oya-application-frontend-bundle-serve-adapter-postgres` remains untouched by this document-stage IP.
DOSSIER-CRATE-014: Existing crate `oya-application-frontend-bundle-serve-api` remains untouched by this document-stage IP.
DOSSIER-CRATE-015: Existing crate `oya-application-frontend-bundle-serve-app` remains untouched by this document-stage IP.
DOSSIER-CRATE-016: Existing crate `oya-application-frontend-bundle-serve-kernel` remains untouched by this document-stage IP.
DOSSIER-CRATE-017: Existing crate `oya-application-frontend-bundle-serve-usecase` remains untouched by this document-stage IP.
DOSSIER-CRATE-018: Existing crate `oya-application-frontend-bundle-serve-worker` remains untouched by this document-stage IP.
DOSSIER-CRATE-019: Existing crate `oya-application-module-loader-adapter` remains untouched by this document-stage IP.
DOSSIER-CRATE-020: Existing crate `oya-application-module-loader-adapter-cdn` remains untouched by this document-stage IP.
...
ADR0339-LANE-001: Enforced_by lane `oya-check-iac-shared-module-usage` applies to `application` once its migration bucket enters blocker mode.
ADR0339-LANE-002: Enforced_by lane `oya-check-iac-module-path-canonical` applies to `application` once its migration bucket enters blocker mode.
ADR0339-LANE-003: Enforced_by lane `oya-check-iac-module-signature-cosign` applies to `application` once its migration bucket enters blocker mode.
ADR0339-LANE-004: Enforced_by lane `oya-check-iac-module-pin` applies to `application` once its migration bucket enters blocker mode.
ADR0339-LANE-005: Enforced_by lane `oya-check-iac-opentofu-only` applies to `application` once its migration bucket enters blocker mode.
ADR0339-LANE-006: Enforced_by lane `oya-check-iac-thin-wrapper-line-floor` applies to `application` once its migration bucket enters blocker mode.
ADR0339-LANE-007: Enforced_by lane `oya-check-iac-module-catalog-discoverability` applies to `application` once its migration bucket enters blocker mode.
...
SCALE-003: At 100x, `application` expects multiple cells in the same residency boundary, with tenant placement resolved by ADR-0248 and oya-shuffle-sharding.
