...
impl_plan_id: IP-010-appointment-commitment-domain
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-010: Appointment Commitment Domain

## Intent
Deliver the appointment-commitment-domain slice for Marketplace while preserving DealSet, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0314.

## Existing journey anchor
This IP is additive to `microservices/marketplace/IP-journey-j29-sale-event-emitter.md` and weaves Sale Event Emitter into the build sequence.
...
4. Cedar action marketplace.appointment-commitment-domain.execute using BNF v4.
5. Audit event MarketplaceEscrowReserved.
