...
impl_plan_id: IP-005-seller-listing-rest-api
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-005: Seller Listing Rest Api

## Intent
Deliver the seller-listing-rest-api slice for Marketplace while preserving DealSet, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0314.
...
4. Cedar action marketplace.seller-listing-rest-api.execute using BNF v4.
5. Audit event MarketplaceDisputeOpened.
