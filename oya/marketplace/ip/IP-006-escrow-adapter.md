...
impl_plan_id: IP-006-escrow-adapter
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-006: Escrow Adapter

## Intent
Deliver the escrow-adapter slice for Marketplace while preserving DealSet, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0314.
...
4. Cedar action marketplace.escrow-adapter.execute using BNF v4.
