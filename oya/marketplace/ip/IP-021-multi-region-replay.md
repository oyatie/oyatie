...
## Intent
Deliver the multi-region-replay slice for Marketplace while preserving DealSet, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0314.

## Existing journey anchor
This IP is additive to `microservices/marketplace/IP-journey-j112-deal-settlement-ledger.md` and weaves Deal Settlement Ledger into the build sequence.
...
4. Cedar action marketplace.multi-region-replay.execute using BNF v4.
