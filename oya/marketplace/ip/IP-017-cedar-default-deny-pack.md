...
impl_plan_id: IP-017-cedar-default-deny-pack
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-017: Cedar Default Deny Pack

## Intent
Deliver the cedar-default-deny-pack slice for Marketplace while preserving DealSet, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0314.
...
4. Cedar action marketplace.cedar-default-deny-pack.execute using BNF v4.
