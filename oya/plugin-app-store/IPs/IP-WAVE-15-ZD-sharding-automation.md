...
## 1. Scope
SCOPE-001: This IP is scoped only to `microservices/plugin-app-store/IPs/IP-WAVE-15-ZD-sharding-automation.md` for the ZF-9 artifact lane.
...
SCOPE-006: plugin-app-store uses ADR-0515 for the single protected `oya-ci-required` context and separately authorized bridge/reference CD surfaces.
