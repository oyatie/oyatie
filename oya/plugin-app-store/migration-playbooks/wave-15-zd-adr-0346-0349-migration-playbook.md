...
1. Search `plugin-app-store` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `plugin-app-store` manifest `governance_lanes` array only in the manifest-owning slot.
