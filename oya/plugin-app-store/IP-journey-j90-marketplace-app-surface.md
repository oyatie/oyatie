...
# IP-journey-j90-marketplace-app-surface - plugin-app-store

## Goal

Implement the `marketplace-app-surface` slice for `plugin-app-store` so j90 can satisfy `US-CCPA-CPRA-2023` without leaking tenant data, collapsing provider-BYOK and encryption-BYOK meanings, or bypassing Cedar.

## PRD row alignment

- PRD anchor: microservices/plugin-app-store/PRD.md when present, otherwise the service manifest and architecture surface for that microservice.
...
| File | Purpose | Notes |
|---|---|---|
| `microservices/plugin-app-store/contracts/openapi/j90-marketplace-app-surface-v1.yaml` | OpenAPI 3.2.0 REST surface | External read/write or admin action |
| `microservices/plugin-app-store/contracts/asyncapi/j90-marketplace-app-surface-events-v1.yaml` | AsyncAPI 3.1.0 event surface | Emits ADR-0263 events |
| `microservices/plugin-app-store/contracts/proto/j90-marketplace-app-surface-v1.proto` | proto3 internal RPC | Service-to-service call path |
| `microservices/plugin-app-store/policy/j90-marketplace-app-surface.cedar` | Cedar permit/forbid bundle | Deny-wins gate |
| `microservices/plugin-app-store/runbooks/j90-marketplace-app-surface-rollback.md` | Rollback and incident path | Includes regulator deadline handling |
| `microservices/plugin-app-store/tests/j90_marketplace_app_surface_test.rs` | Integration tests | Positive, negative, rollback, audit |
...
- `J90PluginAppStoreMarketplaceAppSurfaceStarted`.
- `J90PluginAppStoreMarketplaceAppSurfacePermitted`.
- `J90PluginAppStoreMarketplaceAppSurfaceDenied`.
- `J90PluginAppStoreMarketplaceAppSurfaceCommitted`.
- `J90PluginAppStoreMarketplaceAppSurfaceRolledBack`.

## Implementation rows

### IP row 001 - plugin-app-store marketplace-app-surface
Scope: implement one plugin-app-store behavior for j90, not a cross-service refactor.
...
### IP row 002 - plugin-app-store marketplace-app-surface
Scope: implement one plugin-app-store behavior for j90, not a cross-service refactor.
...
### IP row 003 - plugin-app-store marketplace-app-surface
Scope: implement one plugin-app-store behavior for j90, not a cross-service refactor.
...
### IP row 004 - plugin-app-store marketplace-app-surface
Scope: implement one plugin-app-store behavior for j90, not a cross-service refactor.
...
### IP row 005 - plugin-app-store marketplace-app-surface
Scope: implement one plugin-app-store behavior for j90, not a cross-service refactor.
...
### IP row 006 - plugin-app-store marketplace-app-surface
Scope: implement one plugin-app-store behavior for j90, not a cross-service refactor.
Regulator anchor: California Civil Code 1798.120 opt out of sale or sharing.
Critical path: documentation-rigor.md section 3.2.5 row 13 non-native-language user.
Contract: proto3 envelope includes tenant_id, pack_id, data_class, purpose, deadline_at, and prior_seal_ref.
...
### IP row 007 - plugin-app-store marketplace-app-surface
Scope: implement one plugin-app-store behavior for j90, not a cross-service refactor.
Regulator anchor: California Civil Code 1798.135 opt-out link and signals.
Critical path: documentation-rigor.md section 3.2.5 row 18 audit / regulator access.
Contract: OpenAPI 3.2.0 envelope includes tenant_id, pack_id, data_class, purpose, deadline_at, and prior_seal_ref.
...
### IP row 008 - plugin-app-store marketplace-app-surface
Scope: implement one plugin-app-store behavior for j90, not a cross-service refactor.
Regulator anchor: California Civil Code 1798.121 sensitive personal information limits.
Critical path: documentation-rigor.md section 3.2.5 row 21 pseudonymous + privacy-by-default users.
Contract: AsyncAPI 3.1.0 envelope includes tenant_id, pack_id, data_class, purpose, deadline_at, and prior_seal_ref.
...
### IP row 009 - plugin-app-store marketplace-app-surface
Scope: implement one plugin-app-store behavior for j90, not a cross-service refactor.
Regulator anchor: CPRA automated decisionmaking access and opt-out rulemaking surface.
Critical path: documentation-rigor.md section 3.2.5 row 23 cross-jurisdiction conflict.
Contract: proto3 envelope includes tenant_id, pack_id, data_class, purpose, deadline_at, and prior_seal_ref.
...
### IP row 010 - plugin-app-store marketplace-app-surface
Scope: implement one plugin-app-store behavior for j90, not a cross-service refactor.
Regulator anchor: Global Privacy Control signal handling.
Critical path: documentation-rigor.md section 3.2.5 row 25 mistaken-action recovery.
Contract: OpenAPI 3.2.0 envelope includes tenant_id, pack_id, data_class, purpose, deadline_at, and prior_seal_ref.
...
### IP row 011 - plugin-app-store marketplace-app-surface
Scope: implement one plugin-app-store behavior for j90, not a cross-service refactor.
Regulator anchor: California Civil Code 1798.120 opt out of sale or sharing.
Critical path: documentation-rigor.md section 3.2.5 row 13 non-native-language user.
Contract: AsyncAPI 3.1.0 envelope includes tenant_id, pack_id, data_class, purpose, deadline_at, and prior_seal_ref.
...
### IP row 012 - plugin-app-store marketplace-app-surface
Scope: implement one plugin-app-store behavior for j90, not a cross-service refactor.
Regulator anchor: California Civil Code 1798.135 opt-out link and signals.
Critical path: documentation-rigor.md section 3.2.5 row 18 audit / regulator access.
Contract: proto3 envelope includes tenant_id, pack_id, data_class, purpose, deadline_at, and prior_seal_ref.
...
### IP row 013 - plugin-app-store marketplace-app-surface
Scope: implement one plugin-app-store behavior for j90, not a cross-service refactor.
Regulator anchor: California Civil Code 1798.121 sensitive personal information limits.
Critical path: documentation-rigor.md section 3.2.5 row 21 pseudonymous + privacy-by-default users.
Contract: OpenAPI 3.2.0 envelope includes tenant_id, pack_id, data_class, purpose, deadline_at, and prior_seal_ref.
...
### IP row 014 - plugin-app-store marketplace-app-surface
Scope: implement one plugin-app-store behavior for j90, not a cross-service refactor.
Regulator anchor: CPRA automated decisionmaking access and opt-out rulemaking surface.
Critical path: documentation-rigor.md section 3.2.5 row 23 cross-jurisdiction conflict.
Contract: AsyncAPI 3.1.0 envelope includes tenant_id, pack_id, data_class, purpose, deadline_at, and prior_seal_ref.
...
### IP row 015 - plugin-app-store marketplace-app-surface
Scope: implement one plugin-app-store behavior for j90, not a cross-service refactor.
Regulator anchor: Global Privacy Control signal handling.
Critical path: documentation-rigor.md section 3.2.5 row 25 mistaken-action recovery.
Contract: proto3 envelope includes tenant_id, pack_id, data_class, purpose, deadline_at, and prior_seal_ref.
...
### IP row 016 - plugin-app-store marketplace-app-surface
Scope: implement one plugin-app-store behavior for j90, not a cross-service refactor.
Regulator anchor: California Civil Code 1798.120 opt out of sale or sharing.
Critical path: documentation-rigor.md section 3.2.5 row 13 non-native-language user.
Contract: OpenAPI 3.2.0 envelope includes tenant_id, pack_id, data_class, purpose, deadline_at, and prior_seal_ref.
...
### IP row 017 - plugin-app-store marketplace-app-surface
Scope: implement one plugin-app-store behavior for j90, not a cross-service refactor.
Regulator anchor: California Civil Code 1798.135 opt-out link and signals.
Critical path: documentation-rigor.md section 3.2.5 row 18 audit / regulator access.
Contract: AsyncAPI 3.1.0 envelope includes tenant_id, pack_id, data_class, purpose, deadline_at, and prior_seal_ref.
...
### IP row 018 - plugin-app-store marketplace-app-surface
Scope: implement one plugin-app-store behavior for j90, not a cross-service refactor.
Regulator anchor: California Civil Code 1798.121 sensitive personal information limits.
Critical path: documentation-rigor.md section 3.2.5 row 21 pseudonymous + privacy-by-default users.
Contract: proto3 envelope includes tenant_id, pack_id, data_class, purpose, deadline_at, and prior_seal_ref.
...
### IP row 019 - plugin-app-store marketplace-app-surface
Scope: implement one plugin-app-store behavior for j90, not a cross-service refactor.
Regulator anchor: CPRA automated decisionmaking access and opt-out rulemaking surface.
Critical path: documentation-rigor.md section 3.2.5 row 23 cross-jurisdiction conflict.
Contract: OpenAPI 3.2.0 envelope includes tenant_id, pack_id, data_class, purpose, deadline_at, and prior_seal_ref.
...
### IP row 020 - plugin-app-store marketplace-app-surface
Scope: implement one plugin-app-store behavior for j90, not a cross-service refactor.
Regulator anchor: Global Privacy Control signal handling.
Critical path: documentation-rigor.md section 3.2.5 row 25 mistaken-action recovery.
Contract: AsyncAPI 3.1.0 envelope includes tenant_id, pack_id, data_class, purpose, deadline_at, and prior_seal_ref.
...
### IP row 021 - plugin-app-store marketplace-app-surface
Scope: implement one plugin-app-store behavior for j90, not a cross-service refactor.
Regulator anchor: California Civil Code 1798.120 opt out of sale or sharing.
Critical path: documentation-rigor.md section 3.2.5 row 13 non-native-language user.
Contract: proto3 envelope includes tenant_id, pack_id, data_class, purpose, deadline_at, and prior_seal_ref.
...
### IP row 022 - plugin-app-store marketplace-app-surface
Scope: implement one plugin-app-store behavior for j90, not a cross-service refactor.
Regulator anchor: California Civil Code 1798.135 opt-out link and signals.
Critical path: documentation-rigor.md section 3.2.5 row 18 audit / regulator access.
Contract: OpenAPI 3.2.0 envelope includes tenant_id, pack_id, data_class, purpose, deadline_at, and prior_seal_ref.
...
### IP row 023 - plugin-app-store marketplace-app-surface
Scope: implement one plugin-app-store behavior for j90, not a cross-service refactor.
Regulator anchor: California Civil Code 1798.121 sensitive personal information limits.
Critical path: documentation-rigor.md section 3.2.5 row 21 pseudonymous + privacy-by-default users.
Contract: AsyncAPI 3.1.0 envelope includes tenant_id, pack_id, data_class, purpose, deadline_at, and prior_seal_ref.
...
### IP row 024 - plugin-app-store marketplace-app-surface
Scope: implement one plugin-app-store behavior for j90, not a cross-service refactor.
Regulator anchor: CPRA automated decisionmaking access and opt-out rulemaking surface.
Critical path: documentation-rigor.md section 3.2.5 row 23 cross-jurisdiction conflict.
Contract: proto3 envelope includes tenant_id, pack_id, data_class, purpose, deadline_at, and prior_seal_ref.
...
- Surface evidence: `microservices/plugin-app-store/runbooks/wasmtime-sandbox-escape-suspected.md`, `microservices/plugin-app-store/manifest.json`, `microservices/plugin-app-store/IP-journey-j90-marketplace-app-surface.md`; matched trigger term(s): `plugin`.
