...
ip_id: IP-journey-j90-social-moderation-surface
...
# IP-journey-j90-social-moderation-surface - social

## Goal

Implement the `social-moderation-surface` slice for `social` so j90 can satisfy `US-CCPA-CPRA-2023` without leaking tenant data, collapsing provider-BYOK and encryption-BYOK meanings, or bypassing Cedar.
...
| File | Purpose | Notes |
|---|---|---|
| `microservices/social/contracts/openapi/j90-social-moderation-surface-v1.yaml` | OpenAPI 3.2.0 REST surface | External read/write or admin action |
| `microservices/social/contracts/asyncapi/j90-social-moderation-surface-events-v1.yaml` | AsyncAPI 3.1.0 event surface | Emits ADR-0263 events |
| `microservices/social/contracts/proto/j90-social-moderation-surface-v1.proto` | proto3 internal RPC | Service-to-service call path |
| `microservices/social/policy/j90-social-moderation-surface.cedar` | Cedar permit/forbid bundle | Deny-wins gate |
| `microservices/social/runbooks/j90-social-moderation-surface-rollback.md` | Rollback and incident path | Includes regulator deadline handling |
| `microservices/social/tests/j90_social_moderation_surface_test.rs` | Integration tests | Positive, negative, rollback, audit |
...
- `J90SocialSocialModerationSurfaceStarted`.
- `J90SocialSocialModerationSurfacePermitted`.
- `J90SocialSocialModerationSurfaceDenied`.
- `J90SocialSocialModerationSurfaceCommitted`.
- `J90SocialSocialModerationSurfaceRolledBack`.

## Implementation rows

### IP row 001 - social social-moderation-surface
Scope: implement one social behavior for j90, not a cross-service refactor.
