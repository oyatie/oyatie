...
1. Search `social` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `social` manifest `governance_lanes` array only in the manifest-owning slot.
