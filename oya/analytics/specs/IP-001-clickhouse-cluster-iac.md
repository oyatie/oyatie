...
- Surface evidence: `microservices/analytics/specs/IP-001-clickhouse-cluster-iac.md:151` - - `ClickHouseColdTierQueryLatency > 2s p99`.; `microservices/analytics/specs/IP-001-clickhouse-cluster-iac.md:218` - ## SLO commitment (downstream IP-014).
...
- Surface evidence: `microservices/analytics/specs/IP-001-clickhouse-cluster-iac.md:229` - ## Evidence emission.
