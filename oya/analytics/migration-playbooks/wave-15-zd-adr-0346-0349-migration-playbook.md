...
1. Search `analytics` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `analytics` manifest `governance_lanes` array only in the manifest-owning slot.
