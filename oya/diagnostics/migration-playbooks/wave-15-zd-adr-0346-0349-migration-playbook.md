...
1. Search `diagnostics` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `diagnostics` manifest `governance_lanes` array only in the manifest-owning slot.
