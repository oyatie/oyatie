...
1. Search `payments` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `payments` manifest `governance_lanes` array only in the manifest-owning slot.
