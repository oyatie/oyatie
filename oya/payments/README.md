...
- [`docs/decisions/ADR-0244-tenant-as-universal-scoping-primitive.md`](../../docs/decisions/ADR-0244-tenant-as-universal-scoping-primitive.md) — tenant scoping rules.
...
- [`docs/decisions/ADR-0263-observability-emission-contract.md`](../../docs/decisions/ADR-0263-observability-emission-contract.md) — audit-event emission.
