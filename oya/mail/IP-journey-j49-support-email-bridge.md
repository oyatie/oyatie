...
- Surface evidence: `microservices/mail/IP-journey-j49-support-email-bridge.md` matched `financial, payment`; anchors `microservices/mail/runbooks/mailbox-restore-from-backup.md, crates/oya-shared-email-comms-kernel/src/lib.rs`; type anchor `crates/oya-shared-email-comms-kernel/src/lib.rs::OutboundMessage`.
...
- Surface evidence: `microservices/mail/IP-journey-j49-support-email-bridge.md` plus `crates/oya-shared-email-comms-kernel/src/lib.rs`; type anchor `crates/oya-shared-email-comms-kernel/src/lib.rs::OutboundMessage`.
