# mail DR failover runbook

## Trigger

- Primary region or cell cannot meet the manifest RTO/RPO contract.
- Cedar, OpenBao, Postgres, Valkey, object storage, or audit-chain dependencies for mail are degraded beyond the service SLO.

## Authority

- ADR-0343 DR matrix.
- Manifest `dr` block in `microservices/mail/manifest.json`.
