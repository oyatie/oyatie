...
ip_id: IP-journey-j84-notice-delivery
...
# IP-journey-j84-notice-delivery - mail

## Goal

Implement the `notice-delivery` slice for `mail` so j84 can satisfy `JP-APPI` without leaking tenant data, collapsing provider-BYOK and encryption-BYOK meanings, or bypassing Cedar.
...
| File | Purpose | Notes |
|---|---|---|
| `microservices/mail/contracts/openapi/j84-notice-delivery-v1.yaml` | OpenAPI 3.2.0 REST surface | External read/write or admin action |
| `microservices/mail/contracts/asyncapi/j84-notice-delivery-events-v1.yaml` | AsyncAPI 3.1.0 event surface | Emits ADR-0263 events |
| `microservices/mail/contracts/proto/j84-notice-delivery-v1.proto` | proto3 internal RPC | Service-to-service call path |
| `microservices/mail/policy/j84-notice-delivery.cedar` | Cedar permit/forbid bundle | Deny-wins gate |
| `microservices/mail/runbooks/j84-notice-delivery-rollback.md` | Rollback and incident path | Includes regulator deadline handling |
| `microservices/mail/tests/j84_notice_delivery_test.rs` | Integration tests | Positive, negative, rollback, audit |
...
- `J84MailNoticeDeliveryStarted`.
- `J84MailNoticeDeliveryPermitted`.
- `J84MailNoticeDeliveryDenied`.
- `J84MailNoticeDeliveryCommitted`.
- `J84MailNoticeDeliveryRolledBack`.

## Implementation rows

### IP row 001 - mail notice-delivery
Scope: implement one mail behavior for j84, not a cross-service refactor.
...
- Surface evidence: `microservices/mail/IP-journey-j84-notice-delivery.md` matched `openapi, asyncapi, .proto`; contract files `microservices/mail/contracts/openapi/mail.yaml, microservices/mail/contracts/asyncapi/mail-events.yaml, microservices/mail/contracts/proto/mail.proto`; type anchor `crates/oya-shared-email-comms-kernel/src/lib.rs::OutboundMessage`.
...
- Surface evidence: `microservices/mail/IP-journey-j84-notice-delivery.md` matched `financial`; anchors `microservices/mail/runbooks/mailbox-restore-from-backup.md, crates/oya-shared-email-comms-kernel/src/lib.rs`; type anchor `crates/oya-shared-email-comms-kernel/src/lib.rs::OutboundMessage`.
