...
impl_plan_id: IP-journey-j64-cross-tenant-principals
journey_id: j64
journey_slug: j64-hospital-network-cross-tenant-referral
...
# IP: j64 `identity` — `cross-tenant-principals`

## Intent
Implement the `identity` slice of `j64-hospital-network-cross-tenant-referral` for Yejin Park referring a patient to a specialist at another hospital. The slice owns `cross-tenant-principals` in the cross-product workflow where cross-tenant referral shares scoped imaging and referral detail with HIPAA BAA and tracked specialist acceptance.
...
- Journey contract: `docs/user-journeys/j64-hospital-network-cross-tenant-referral/`.
...
| Path | Action | Purpose |
|---|---|---|
| `microservices/identity/contracts/openapi-j64-cross-tenant-principals.yaml` | create | OpenAPI 3.2.0 REST edge for the journey slice |
| `microservices/identity/contracts/asyncapi-j64-cross-tenant-principals.yaml` | create | AsyncAPI 3.1.0 events for the journey slice |
| `microservices/identity/contracts/j64-cross-tenant-principals.proto` | create | proto3 worker/internal contract |
| `microservices/identity/policy/j64-cross-tenant-principals.cedar` | create | Cedar default-deny permit for this slice |
| `microservices/identity/tests/j64-cross-tenant-principals.md` | create | executable test notes or harness fixture plan |
| `microservices/identity/dashboards/j64-cross-tenant-principals.json` | create | ADR-0263 metric and trace dashboard |
...
- Authority: ADR-0343.
- Trigger evidence: `microservices/identity/IP-journey-j64-cross-tenant-principals.md` matched `SLO, p99, payment`.
...
- Authority: ADR-0344.
- Trigger evidence: `microservices/identity/IP-journey-j64-cross-tenant-principals.md` matched `emission`.
