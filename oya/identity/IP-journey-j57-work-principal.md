...
impl_plan_id: IP-journey-j57-work-principal
journey_id: j57
...
# IP: j57 `identity` — `work-principal`

## Intent
Implement the `identity` slice of `j57-employee-onboarding-day-one-to-week-one` for Aiyana Robinson during her first week as a new employee. The slice owns `work-principal` in the cross-product workflow where day-one onboarding cascades across communication, files, meetings, tasks, notes, and workflow checkpoints.
...
| Path | Action | Purpose |
|---|---|---|
| `microservices/identity/contracts/openapi-j57-work-principal.yaml` | create | OpenAPI 3.2.0 REST edge for the journey slice |
| `microservices/identity/contracts/asyncapi-j57-work-principal.yaml` | create | AsyncAPI 3.1.0 events for the journey slice |
| `microservices/identity/contracts/j57-work-principal.proto` | create | proto3 worker/internal contract |
| `microservices/identity/policy/j57-work-principal.cedar` | create | Cedar default-deny permit for this slice |
| `microservices/identity/tests/j57-work-principal.md` | create | executable test notes or harness fixture plan |
| `microservices/identity/dashboards/j57-work-principal.json` | create | ADR-0263 metric and trace dashboard |
...
- Authority: ADR-0343.
- Trigger evidence: `microservices/identity/IP-journey-j57-work-principal.md` matched `SLO, p99, payment`.
...
- Authority: ADR-0344.
- Trigger evidence: `microservices/identity/IP-journey-j57-work-principal.md` matched `emission`.
