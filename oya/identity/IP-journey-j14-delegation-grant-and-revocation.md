...
ip_id: IP-journey-j14-delegation-grant-and-revocation
journey_id: j14-delegated-llm-agent-acting-for-yejin
microservice: identity
role: delegation-grant-and-revocation
status: draft
date: 2026-05-20
related_adrs:
  - ADR-0305
...
# IP - j14 - identity - delegation-grant-and-revocation

Goal: implement the identity portion of Delegated LLM agent acting for Yejin so Yejin enables an n8n and oyatie Workflow agent to summarize overnight messages while she sleeps.
Binding ADR: ADR-0305. This IP is one independently reviewable slice and must not weaken the common critical-path ADR pack.

## Scope

In scope: delegation-grant-and-revocation, JSON Schema validation, Cedar authorization, audit-chain emission, observability, failure branches, and integration tests for j14.
...
|---|---|---|---|
| delegated-agent-grant | identity.delegation-grant-and-revocation table or event stream | docs/user-journeys/j14-delegated-llm-agent-acting-for-yejin/schemas/delegated-agent-grant.json | pack-controlled, minimum audit retention |
| message-summary-run | identity.delegation-grant-and-revocation table or event stream | docs/user-journeys/j14-delegated-llm-agent-acting-for-yejin/schemas/message-summary-run.json | pack-controlled, minimum audit retention |
| agent-action-audit | identity.delegation-grant-and-revocation table or event stream | docs/user-journeys/j14-delegated-llm-agent-acting-for-yejin/schemas/agent-action-audit.json | pack-controlled, minimum audit retention |
...
openapi: 3.2.0
info:
  title: identity j14 delegation-grant-and-revocation
  version: 1.0.0
paths:
  /journeys/j14/identity/delegation-grant-and-revocation:
    post:
      operationId: j14IdentityDelegationGrantAndRevocation
...
asyncapi: 3.1.0
info:
  title: identity j14 events
  version: 1.0.0
channels:
  j14.identity.delegation-grant-and-revocation.accepted:
    address: j14.identity.delegation-grant-and-revocation.accepted
```
...
- Authority: ADR-0343.
- Trigger evidence: `microservices/identity/IP-journey-j14-delegation-grant-and-revocation.md` matched `SLO`.
...
- Authority: ADR-0344.
- Trigger evidence: `microservices/identity/IP-journey-j14-delegation-grant-and-revocation.md` matched `emission`.
