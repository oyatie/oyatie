...
ip_id: IP-journey-j09-phishing-resistant-recovery
journey_id: j09-account-recovery-phishing-resistant
microservice: identity
role: phishing-resistant-recovery
status: draft
date: 2026-05-20
related_adrs:
  - ADR-0299
...
# IP - j09 - identity - phishing-resistant-recovery

Goal: implement the identity portion of Phishing-resistant account recovery so Yejin loses her phone and recovers with passkey backup, recovery code, and delegated trusted contact.
Binding ADR: ADR-0299. This IP is one independently reviewable slice and must not weaken the common critical-path ADR pack.

## Scope

In scope: phishing-resistant-recovery, JSON Schema validation, Cedar authorization, audit-chain emission, observability, failure branches, and integration tests for j09.
...
|---|---|---|---|
| recovery-claim | identity.phishing-resistant-recovery table or event stream | docs/user-journeys/j09-account-recovery-phishing-resistant/schemas/recovery-claim.json | pack-controlled, minimum audit retention |
| trusted-contact-challenge | identity.phishing-resistant-recovery table or event stream | docs/user-journeys/j09-account-recovery-phishing-resistant/schemas/trusted-contact-challenge.json | pack-controlled, minimum audit retention |
| device-rebind-result | identity.phishing-resistant-recovery table or event stream | docs/user-journeys/j09-account-recovery-phishing-resistant/schemas/device-rebind-result.json | pack-controlled, minimum audit retention |
...
openapi: 3.2.0
info:
  title: identity j09 phishing-resistant-recovery
  version: 1.0.0
paths:
  /journeys/j09/identity/phishing-resistant-recovery:
    post:
      operationId: j09IdentityPhishingResistantRecovery
...
asyncapi: 3.1.0
info:
  title: identity j09 events
  version: 1.0.0
channels:
  j09.identity.phishing-resistant-recovery.accepted:
    address: j09.identity.phishing-resistant-recovery.accepted
```
...
- Authority: ADR-0343.
- Trigger evidence: `microservices/identity/IP-journey-j09-phishing-resistant-recovery.md` matched `SLO`.
...
- Authority: ADR-0344.
- Trigger evidence: `microservices/identity/IP-journey-j09-phishing-resistant-recovery.md` matched `emission`.
