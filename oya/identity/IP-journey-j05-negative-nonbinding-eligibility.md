...
ip_id: IP-journey-j05-negative-nonbinding-eligibility
journey_id: j05-whistleblower-anonymous-ethics-report
microservice: identity
role: negative-nonbinding-eligibility
status: draft
date: 2026-05-20
related_adrs:
  - ADR-0300
...
# IP - j05 - identity - negative-nonbinding-eligibility

Goal: implement the identity portion of Anonymous ethics report from SNU Hospital employee so An employee submits an anonymous ethics report through Community while identity proves eligibility but must not bind to submitter.
Binding ADR: ADR-0300. This IP is one independently reviewable slice and must not weaken the common critical-path ADR pack.

## Scope

In scope: negative-nonbinding-eligibility, JSON Schema validation, Cedar authorization, audit-chain emission, observability, failure branches, and integration tests for j05.
...
|---|---|---|---|
| anonymous-ethics-report | identity.negative-nonbinding-eligibility table or event stream | docs/user-journeys/j05-whistleblower-anonymous-ethics-report/schemas/anonymous-ethics-report.json | pack-controlled, minimum audit retention |
| nonbinding-eligibility-proof | identity.negative-nonbinding-eligibility table or event stream | docs/user-journeys/j05-whistleblower-anonymous-ethics-report/schemas/nonbinding-eligibility-proof.json | pack-controlled, minimum audit retention |
| report-evidence-envelope | identity.negative-nonbinding-eligibility table or event stream | docs/user-journeys/j05-whistleblower-anonymous-ethics-report/schemas/report-evidence-envelope.json | pack-controlled, minimum audit retention |
...
openapi: 3.2.0
info:
  title: identity j05 negative-nonbinding-eligibility
  version: 1.0.0
paths:
  /journeys/j05/identity/negative-nonbinding-eligibility:
    post:
      operationId: j05IdentityNegativeNonbindingEligibility
...
asyncapi: 3.1.0
info:
  title: identity j05 events
  version: 1.0.0
channels:
  j05.identity.negative-nonbinding-eligibility.accepted:
    address: j05.identity.negative-nonbinding-eligibility.accepted
```
...
- Authority: ADR-0343.
- Trigger evidence: `microservices/identity/IP-journey-j05-negative-nonbinding-eligibility.md` matched `SLO`.
...
- Authority: ADR-0344.
- Trigger evidence: `microservices/identity/IP-journey-j05-negative-nonbinding-eligibility.md` matched `emission`.
