...
- Trigger from CI when `buck2 build //:quality-lane-registry-authority-check # lane=identity-recovery-key-mass-issue-investigation --production-snapshot` exits non-zero against the latest production evidence bundle.
...
14. Run production snapshot gate: `buck2 build //:quality-lane-registry-authority-check # lane=identity-recovery-key-mass-issue-investigation --production-snapshot --cell $CELL`.
...
7. Add gate evidence: `buck2 build //:quality-lane-registry-authority-check # lane=identity-recovery-key-mass-issue-investigation --fixture incident-recovery-key-mass-issue-investigation.json`.
...
9. Add dashboard panel: `update microservices/identity/dashboards/scim-provisioning-health.json with oya_identity_recovery_key_mass_issue_investigation_error_ratio, oya_identity_recovery_key_mass_issue_investigation_lag_seconds, and oya_identity_recovery_key_mass_issue_investigation_queue_depth`.
