...
impl_plan_id: IP-journey-j56-candidate-verification
journey_id: j56
...
# IP: j56 `identity` — `candidate-verification`

## Intent
Implement the `identity` slice of `j56-job-application-to-offer` for Aiyana Robinson applying to Marcus's company through community Handshake mode. The slice owns `candidate-verification` in the cross-product workflow where an application becomes interviews, offer, e-sign acceptance, tenant provisioning, and SCIM lifecycle.
...
- Journey contract: `docs/user-journeys/j56-job-application-to-offer/`.
...
| Path | Action | Purpose |
|---|---|---|
| `microservices/identity/contracts/openapi-j56-candidate-verification.yaml` | create | OpenAPI 3.2.0 REST edge for the journey slice |
| `microservices/identity/contracts/asyncapi-j56-candidate-verification.yaml` | create | AsyncAPI 3.1.0 events for the journey slice |
| `microservices/identity/contracts/j56-candidate-verification.proto` | create | proto3 worker/internal contract |
| `microservices/identity/policy/j56-candidate-verification.cedar` | create | Cedar default-deny permit for this slice |
| `microservices/identity/tests/j56-candidate-verification.md` | create | executable test notes or harness fixture plan |
| `microservices/identity/dashboards/j56-candidate-verification.json` | create | ADR-0263 metric and trace dashboard |
...
- Authority: ADR-0343.
- Trigger evidence: `microservices/identity/IP-journey-j56-candidate-verification.md` matched `SLO, p99, payment`.
...
- Authority: ADR-0344.
- Trigger evidence: `microservices/identity/IP-journey-j56-candidate-verification.md` matched `emission`.
