...
- Trigger from CI when `buck2 build //:quality-lane-registry-authority-check # lane=community-verified-anonymous-deanonymization-incident --production-snapshot` exits non-zero against the latest production evidence bundle.
...
15. Run production snapshot gate: `buck2 build //:quality-lane-registry-authority-check # lane=community-verified-anonymous-deanonymization-incident --production-snapshot --cell $CELL`.
...
7. Add gate evidence: `buck2 build //:quality-lane-registry-authority-check # lane=community-verified-anonymous-deanonymization-incident --fixture incident-verified-anonymous-deanonymization-incident.json`.
