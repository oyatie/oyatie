...
ip_id: IP-journey-j79-community-surface
...
# IP - j79-eu-dsa-transparency-semi-annual-report - community - community-surface

## A. Intent

This implementation plan binds the `community` slice of `j79-eu-dsa-transparency-semi-annual-report` to real community contracts, Cedar fragments, event channels, proto3 services, SLOs, and counterpart behavior. The previous generated row loop has been consolidated: only rows with a grounded community action remain, and speculative rows without a backing artifact are removed rather than expanded.
...
- Surface evidence: `microservices/community/IP-journey-j79-community-surface.md` matched `openapi, asyncapi, .proto`; contract files `microservices/community/contracts/openapi/community.yaml, microservices/community/contracts/asyncapi/community-events.yaml, microservices/community/contracts/proto/community.proto`; type anchor `microservices/community/manifest.json`.
...
- Surface evidence: `microservices/community/IP-journey-j79-community-surface.md` matched `SLO, payment`; anchors `microservices/community/manifest.json`; type anchor `microservices/community/manifest.json`.
