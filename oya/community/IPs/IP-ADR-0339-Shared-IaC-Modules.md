...
SCOPE-002: Lifecycle state is PROPOSED for `community` until the service-owned wrapper files under `microservices/community/iac/<context>/main.tf` invoke signed cloud-iac modules and implementation evidence is reviewed.
...
DOSSIER-CONTRACT-001: OpenAPI 3.2.0: microservices/community/contracts/openapi/community.yaml.
DOSSIER-CONTRACT-002: AsyncAPI 3.1.0: microservices/community/contracts/asyncapi/community-events.yaml.
DOSSIER-CONTRACT-003: proto3: microservices/community/contracts/proto/community.proto.
DOSSIER-CAPABILITY-001: surface reddit-mode risk=minimal file=microservices/community/capabilities/reddit-mode.yaml.
DOSSIER-CAPABILITY-002: surface teamblind-mode risk=employment-sensitive file=microservices/community/capabilities/teamblind-mode.yaml.
DOSSIER-CAPABILITY-003: surface handshake-mode risk=employment-sensitive file=microservices/community/capabilities/handshake-mode.yaml.
DOSSIER-CAPABILITY-004: surface linkedin-profile-jobs-recruiter-mode risk=employment-high-risk file=microservices/community/capabilities/linkedin-mode.yaml.
DOSSIER-CAPABILITY-005: T1 moderate-action risk=minimal file=microservices/community/capabilities/moderate-action.yaml.
DOSSIER-CAPABILITY-006: T1 post-create risk=minimal file=microservices/community/capabilities/post-create.yaml.
DOSSIER-CAPABILITY-007: T1 vote-cast risk=minimal file=microservices/community/capabilities/vote-cast.yaml.
...
API-002: OpenAPI 3.2.0 references for `community` remain: OpenAPI 3.2.0: microservices/community/contracts/openapi/community.yaml
API-003: AsyncAPI 3.1.0 references for `community` remain: AsyncAPI 3.1.0: microservices/community/contracts/asyncapi/community-events.yaml
API-004: proto3 references for `community` remain: proto3: microservices/community/contracts/proto/community.proto
...
VERIFY-001: Static read confirms this file exists at `microservices/community/IPs/IP-ADR-0339-Shared-IaC-Modules.md`.
