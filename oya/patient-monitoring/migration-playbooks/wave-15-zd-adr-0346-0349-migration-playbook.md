...
1. Search `patient-monitoring` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `patient-monitoring` manifest `governance_lanes` array only in the manifest-owning slot.
