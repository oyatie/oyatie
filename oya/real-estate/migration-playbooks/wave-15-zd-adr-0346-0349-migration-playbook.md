...
1. Search `real-estate` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `real-estate` manifest `governance_lanes` array only in the manifest-owning slot.
