...
impl HttpHandler {
    pub fn routes() -> Vec<HttpRoute> {
        vec![
            HttpRoute {
                method: "POST",
                path: "/v1/real-estate/leases:manage",
                capability: "lease-contract",
                idempotent: true,
            },
            HttpRoute {
                method: "POST",
                path: "/v1/real-estate/rent-schedules:reconcile",
                capability: "rent-schedule",
                idempotent: true,
            },
            HttpRoute {
                method: "POST",
                path: "/v1/real-estate/facilities:register",
                capability: "facility-master",
                idempotent: true,
            },
            HttpRoute {
                method: "POST",
                path: "/v1/real-estate/occupancy:allocate",
                capability: "occupancy-allocation",
                idempotent: true,
            },
            HttpRoute {
                method: "POST",
                path: "/v1/real-estate/service-requests:open",
