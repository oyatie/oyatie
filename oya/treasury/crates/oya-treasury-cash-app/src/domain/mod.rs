...
pub const CAPABILITIES: &[Capability] = &[
    Capability::CashPosition,
    Capability::BankAccount,
    Capability::FxExposure,
    Capability::HedgeDesignation,
    Capability::PaymentExecution,
];
...
impl CapabilityDescriptor {
    pub fn descriptors() -> Vec<Self> {
        CAPABILITIES
            ...
            .map(|capability| Self {
                capability,
                bounded_context: BoundedContext::CashPosition,
