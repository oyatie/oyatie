...
SCOPE-006: treasury treats ADR-0349 Jenkins CI wording as historical/provenance after ADR-0515; future owned-runner or ArgoCD surfaces must preserve `oya-ci-required`/CD evidence without reviving Jenkins as live CI authority.
