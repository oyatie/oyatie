...
1. Search `ontology` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `ontology` manifest `governance_lanes` array only in the manifest-owning slot.
