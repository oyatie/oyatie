...
const ERP_PARITY_MODULES: &[ErpParityModuleCoverage] = &[
    ...
    ErpParityModuleCoverage {
        ...
        oyatie_destinations: &[
            ...
            "oya/hr/crates/oya-hr-employment-app",
            "oya/hr/crates/oya-hr-employment-api",
            ...
            "oya/payroll/crates/oya-payroll-run-app",
            "oya/payroll/crates/oya-payroll-run-api",
        ...
        evidence_refs: &[
            ...
            "evidence/multispectrum/cs-ent-hr-statutory-rulepack-manifest-1779544200.json",
            ...
            "root//oya/hr/crates/oya-hr-employment-app:backend-parity-tests",
            "root//oya/hr/crates/oya-hr-employment-api:backend-parity-tests",
            "root//oya/payroll/crates/oya-payroll-run-domain:backend-parity-tests",
            "root//oya/payroll/crates/oya-payroll-run-app:backend-parity-tests",
            "root//oya/payroll/crates/oya-payroll-run-api:backend-parity-tests",
        ],
        cloud_integration_ready: false,
        production_runtime_claimed: false,
    },
