...
pub const CAPABILITIES: &[Capability] = &[
    Capability::InboundDelivery,
    Capability::InventoryMovement,
    Capability::PickingWave,
    Capability::PackingConfirmation,
    Capability::ShipmentStaging,
];
...
impl CapabilityDescriptor {
    pub fn descriptors() -> Vec<Self> {
        CAPABILITIES
            ...
            .map(|capability| Self {
                capability,
                bounded_context: BoundedContext::InventoryMovement,
