...
1. Search `warehouse` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `warehouse` manifest `governance_lanes` array only in the manifest-owning slot.
