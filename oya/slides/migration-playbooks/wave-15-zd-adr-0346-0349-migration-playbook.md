...
1. Search `slides` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `slides` manifest `governance_lanes` array only in the manifest-owning slot.
