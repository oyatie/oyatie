...
- Trigger from CI when `buck2 build //:quality-lane-registry-authority-check # lane=governance-industry-baseline-refresh --production-snapshot` exits non-zero against the latest production evidence bundle.
...
14. Run production snapshot gate: `buck2 build //:quality-lane-registry-authority-check # lane=governance-industry-baseline-refresh --production-snapshot --cell $CELL`.
...
7. Add gate evidence: `buck2 build //:quality-lane-registry-authority-check # lane=governance-industry-baseline-refresh --fixture incident-industry-baseline-refresh.json`.
...
- Governance control-plane evidence: inspect industry_baseline_refresh invariants, alert emission, and ADR-0263 evidence fields before touching adjacent code path 2.
