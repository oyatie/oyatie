...
- Governance control-plane evidence: inspect cedar_policy_rollback_protocol invariants, alert emission, and ADR-0263 evidence fields before touching adjacent code path 2.
