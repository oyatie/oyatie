...
impl_plan_id: IP-020-mail-delivery-adapter
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-020: Mail Delivery Adapter

## Intent
Deliver the mail-delivery-adapter slice for Workplace Integration while preserving WorkplaceAgreement, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0320.

## Existing journey anchor
This IP is additive to `microservices/workplace-integration/IP-journey-j113-esign-roster-binding.md` and weaves Esign Roster Binding into the build sequence.
...
4. Cedar action workplace-integration.mail-delivery-adapter.execute using BNF v4.
