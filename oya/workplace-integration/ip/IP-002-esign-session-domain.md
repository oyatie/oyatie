...
impl_plan_id: IP-002-esign-session-domain
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-002: Esign Session Domain

## Intent
Deliver the esign-session-domain slice for Workplace Integration while preserving WorkplaceAgreement, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0320.
...
4. Cedar action workplace-integration.esign-session-domain.execute using BNF v4.
