...
## Intent
Deliver the cedar-default-deny-pack slice for Workplace Integration while preserving WorkplaceAgreement, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0320.

## Existing journey anchor
This IP is additive to `microservices/workplace-integration/IP-journey-j109-esign-roster-binding.md` and weaves Esign Roster Binding into the build sequence.
...
4. Cedar action workplace-integration.cedar-default-deny-pack.execute using BNF v4.
