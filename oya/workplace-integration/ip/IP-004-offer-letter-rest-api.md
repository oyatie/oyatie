...
impl_plan_id: IP-004-offer-letter-rest-api
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-004: Offer Letter Rest Api

## Intent
Deliver the offer-letter-rest-api slice for Workplace Integration while preserving WorkplaceAgreement, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0320.
...
4. Cedar action workplace-integration.offer-letter-rest-api.execute using BNF v4.
