...
impl_plan_id: IP-006-roster-binding-domain
execution_unit: ChangeSet
changeset_contract: claimable-verifiable-bundleable-promotable
---

# IP-006: Roster Binding Domain

## Intent
Deliver the roster-binding-domain slice for Workplace Integration while preserving WorkplaceAgreement, tenant scope, Cedar default-deny, audit-chain evidence, and ADR-0320.
...
4. Cedar action workplace-integration.roster-binding-domain.execute using BNF v4.
5. Audit event WorkplaceClockEventAttested.
