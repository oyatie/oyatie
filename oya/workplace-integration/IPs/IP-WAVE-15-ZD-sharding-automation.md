...
## 1. Scope
SCOPE-001: This IP is scoped only to `microservices/workplace-integration/IPs/IP-WAVE-15-ZD-sharding-automation.md` for the ZF-9 artifact lane.
...
SCOPE-006: workplace-integration keeps ADR-0349 only as historical rollout provenance; active CI/CD rollout expectations come from ADR-0513 Buck2/Prow oya-ci and release-conveyor-like native seams.
...
STANCE-018: CI stance is Buck2 target evidence plus trusted Rust/Prow `oya-ci-required` before merge for downstream code, schema, or workflow changes.
