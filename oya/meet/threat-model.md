...
| Valkey 8.1 (RESP3 wire-compatible) (lobby + presence + signaling session) | `oya-meet-audio-*` (6 crates) |
...
Per pack overlay at `cloud/cloud-iac/sovereign-cloud-overlays/<pack>/meet-overlay.md`; cross-mapped via compliance.md.
