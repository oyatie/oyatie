...
|---|---|---|
| `microservices/intelligence/iac/helm/cedar-engine/Chart.yaml` | create | Cedar v4 in-cluster serving |
| `microservices/intelligence/iac/helm/cedar-engine/values.yaml` | create | replica counts per `capacity-model.md`; image tag pinned to Cedar v4 LTS |
| `microservices/intelligence/iac/helm/cedar-engine/values-pack-kr.yaml` | create | pack-kr overlay |
| `microservices/intelligence/iac/kustomize/base/kustomization.yaml` | create | shared base (already in directory; this IP populates) |
| `microservices/intelligence/iac/kustomize/overlays/pack-kr/kustomization.yaml` | create | pack-kr overlay |
| `microservices/intelligence/policy/cedar-base.cedar` | create | base policy (default-deny) |
| `microservices/intelligence/policy/schema.cedarschema` | create | Cedar v4 schema for entities + actions |
| `microservices/intelligence/iac/cedar/build.sh` | create | bundle compilation pipeline (validates + signs bundle SHA) |
...
// Cedar v4 schema per microservices/intelligence/policy/schema.cedarschema
//
...
- `microservices/intelligence/tests/iac/cedar-engine.bats` runs `helm install --dry-run` + `helm test`.
