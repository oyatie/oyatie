...
Crates at `microservices/intelligence/src/crates/oya-foundry-supervisor-kill-switch-circuit-breaker-{kernel,domain,usecase,api,adapter}/`. rest + worker + sdk + app scheduled-for-distinct-tracked-work to IP-009 + IP-011 + IP-013 + IP-014.
