...
**Who:** Per actor table in `microservices/intelligence-eval/threat-model.md` §"Actors".
...
**Cross-border transfer:** Forbidden by default per `multi-region.md`. Allowed only with tenant-executed SCCs for GDPR-scope tenants per Arts. 44-46; recorded in `microservices/intelligence-eval/legal/transfer-register.md`.
...
- **Relationship to data subjects:** Joint controllership with the tenant under GDPR Art. 26 for the operational telemetry portion. Joint-controllership terms recorded in tenant DPA template (`microservices/intelligence-eval/legal/dpa-template.md`).
...
1. **Live PHI never enters eval-sets.** Eval-set baseline inputs and case prompts use synthetic-PHI fixtures only. Policy `policy/synthetic-phi-only.md` is BLOCKER on `microservices/intelligence-eval/eval-sets/**`.
...
- `microservices/intelligence-eval/threat-model.md`.
- `microservices/intelligence-eval/compliance.md`.
- `microservices/intelligence-eval/policy/synthetic-phi-only.md`.
- `microservices/intelligence-eval/policy/tenant-isolation.md`.
- `microservices/intelligence-eval/policy/data-residency.md`.
- `microservices/intelligence-eval/policy/two-person-admin-ops.md`.
