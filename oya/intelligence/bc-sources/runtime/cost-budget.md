...
- `buck2 build //:quality-lane-registry-authority-check # lane=cost-budget --microservice foundry-runtime` — exit 0; current spend within 110%.
...
- `microservices/intelligence-runtime/capacity-model.md`.
- `microservices/intelligence-runtime/multi-region.md`.
- `microservices/intelligence-runtime/policy/data-residency.md` (per-pack retention multipliers).
