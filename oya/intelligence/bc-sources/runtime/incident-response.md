...
related_artifacts:
  ...
  - microservices/intelligence-runtime/multi-region.md
...
- `microservices/intelligence-runtime/failure-modes.md` (FM-IDs + severity).
- `microservices/intelligence-runtime/compliance.md` §"Regulatory Notifications" (per-pack timelines).
- `microservices/intelligence-runtime/multi-region.md` (DR failover).
- `microservices/intelligence-runtime/runbooks/*`.
- `microservices/intelligence-runtime/dpia.md` (data-subject impact assessment).
- `microservices/intelligence-runtime/threat-model.md`.
