...
- `buck2 build //:quality-lane-registry-authority-check # lane=multi-region-conformance --microservice foundry-runtime` — exit 0; deployed topology matches this document for every active pack.
