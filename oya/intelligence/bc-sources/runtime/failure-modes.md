...
related_artifacts:
  ...
  - microservices/intelligence-runtime/runbooks/
...
- `microservices/intelligence-runtime/threat-model.md` (each FM has at least one corresponding STRIDE / LINDDUN threat ID).
- `microservices/intelligence-runtime/dpia.md` (FM-12, FM-13, FM-07 map to R-02, R-01, R-17).
- `microservices/intelligence-runtime/incident-response.md` §"Severity Definitions".
- `microservices/intelligence-runtime/runbooks/*`.
