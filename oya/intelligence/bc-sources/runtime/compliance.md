...
| CC1.3 | Organizational structure | RACI per µservice | `microservices/intelligence-runtime/CODEOWNERS` |
...
- `microservices/intelligence-runtime/evidence/multispectrum/<change_id>-<unix_ts>.json` — per-changeset.
...
- `microservices/intelligence-runtime/threat-model.md`; `dpia.md`; `policy/*.md`; `policy/*.cedar`; `incident-response.md`.
