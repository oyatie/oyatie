...
related_artifacts:
  - microservices/intelligence-guardrails/contracts/openapi/guardrails.yaml
  - microservices/intelligence-guardrails/contracts/proto/guardrails.proto
...
Per BC, one SDK crate at `microservices/intelligence-guardrails/src/crates/oya-foundry-guardrails-<bc>-sdk/`.
...
Generation pipeline at `microservices/intelligence-guardrails/sdk-generation/`.
...
- `microservices/intelligence-guardrails/contracts/openapi/guardrails.yaml`.
- `microservices/intelligence-guardrails/contracts/proto/guardrails.proto`.
- `microservices/intelligence-guardrails/PRD.md` (BC layer mapping — `-sdk` per ADR-0105).
