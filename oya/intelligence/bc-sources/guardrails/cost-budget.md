...
related_artifacts:
  ...
  - microservices/intelligence-guardrails/multi-region.md
...
- `buck2 build //:quality-lane-registry-authority-check # lane=cost-budget --microservice foundry-guardrails` — exit 0; current spend within 110%.
...
- `microservices/intelligence-guardrails/capacity-model.md`.
- `microservices/intelligence-guardrails/multi-region.md`.
- `microservices/intelligence-providers/cost-budget.md` (LLM-judge passthrough origin).
