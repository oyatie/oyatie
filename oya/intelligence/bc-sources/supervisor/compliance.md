...
related_artifacts:
  ...
  - microservices/intelligence-supervisor/policy/data-residency.md
  - microservices/intelligence-supervisor/incident-response.md
...
| CC1.3 | Org structure | RACI matrix per µservice | `microservices/intelligence-supervisor/CODEOWNERS` (Slice C) |
...
**EU AI Act notified-body engagement:** triggered at first high-risk Annex III tenant capability admit. Provider-side technical documentation per Art. 18 + Annex IV maintained at `microservices/intelligence-supervisor/legal/ai-act-technical-documentation.md` (Slice D).
...
- `microservices/intelligence-supervisor/evidence/multispectrum/<change_id>-<unix_ts>.json` — per-changeset evidence
...
- `microservices/intelligence-supervisor/threat-model.md`.
- `microservices/intelligence-supervisor/dpia.md`.
- `microservices/intelligence-supervisor/policy/{supervisor-isolation, data-residency}.md`.
- `microservices/intelligence-supervisor/policy/*.cedar`.
- `microservices/intelligence-supervisor/incident-response.md`.
