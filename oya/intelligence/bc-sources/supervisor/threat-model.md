...
| Cedar policy fragments | `INTERNAL_ONLY` (text); `SECRET` when carrying tenant identifiers | Medium | git history | `microservices/intelligence-supervisor/policy/*.cedar` |
