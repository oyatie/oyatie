...
related_artifacts:
  - microservices/intelligence-supervisor/contracts/openapi/foundry-supervisor.yaml
  - microservices/intelligence-supervisor/contracts/proto/foundry-supervisor.proto
...
One per BC at `microservices/intelligence-supervisor/src/crates/oya-foundry-supervisor-<bc>-sdk/`:
...
Pipeline at `microservices/intelligence-supervisor/sdk-generation/`:
...
- `microservices/intelligence-supervisor/contracts/openapi/foundry-supervisor.yaml`.
- `microservices/intelligence-supervisor/contracts/proto/foundry-supervisor.proto`.
- `microservices/intelligence-supervisor/PRD.md` BC layer mapping (`-sdk` crate per ADR-0105).
