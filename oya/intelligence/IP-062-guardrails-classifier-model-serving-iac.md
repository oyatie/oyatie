...
|---|---|---|
| `microservices/intelligence/iac/helm/classifier-model-serving/Chart.yaml` | create | upstream onnxruntime-server chart pinned |
| `microservices/intelligence/iac/helm/classifier-model-serving/values.yaml` | create | 4-model spec; replica counts per `capacity-model.md` |
| `microservices/intelligence/iac/helm/classifier-model-serving/values-pack-kr.yaml` | create | pack-kr overlay |
| `microservices/intelligence/iac/cosign/keys.yaml` | create | Cosign public-key references (OpenBao-bound) |
| `microservices/intelligence/iac/cosign/init-verify.sh` | create | pod-start verification script |
| `microservices/intelligence/iac/model-registry/layout.md` | create | per-pack S3 bucket layout + signed-manifest schema |

## Acceptance Gates

```bash
helm lint microservices/intelligence/iac/helm/classifier-model-serving
