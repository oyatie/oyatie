...
Author OpenSLO manifests at `microservices/intelligence/slos/` so that observability µservice (per ADR-0139) gates supervisor's own promotion. Registers HG-FND-SUP per ADR-0123.

## Concrete File Targets

| Path | Action |
|---|---|
| `microservices/intelligence/slos/kill-switch-engage.openslo.yaml` | create |
| `microservices/intelligence/slos/deployment-admit.openslo.yaml` | create |
| `microservices/intelligence/slos/supervision-event-lag.openslo.yaml` | create |
| `microservices/intelligence/slos/autonomy-policy-eval.openslo.yaml` | create |
