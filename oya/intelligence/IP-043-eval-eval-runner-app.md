...
`microservices/intelligence/src/crates/oya-foundry-eval-eval-runner-app/`.
...
This conversion replaces the prior line-count-as-proof acceptance note with contract, crate, policy, and SLO evidence requirements.
