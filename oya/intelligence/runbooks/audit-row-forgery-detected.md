...
- Trigger from CI when `buck2 build //:quality-lane-registry-authority-check # lane=intelligence-audit-row-forgery-detected --production-snapshot` exits non-zero against the latest production evidence bundle.
...
15. Run production snapshot gate: `buck2 build //:quality-lane-registry-authority-check # lane=intelligence-audit-row-forgery-detected --production-snapshot --cell $CELL`.
...
7. Add gate evidence: `buck2 build //:quality-lane-registry-authority-check # lane=intelligence-audit-row-forgery-detected --fixture incident-audit-row-forgery-detected.json`.
