...
use oya_intelligence_subagent_runtime_usecase::{
...
enum RuntimeMode {
    ...
    /// `oya-intelligence-subagent-runtime-app` binary or via an external
...
fn render_rollup_json(
    ...
    completeness: &oya_intelligence_pr_review_dispatcher_app::rollup::PanelCompletenessReport,
    verdict: Verdict,
