...
use oya_intelligence_model_routing_usecase::{
    CredentialMode, EnvTier, IntelligenceDataClass, IntelligenceModelRoutingUsecase,
    ModelCapability, ModelDefaultClass, ModelProfileTag, ModelProvider, ModelRouteRequest,
    ModelRoutingUsecaseDenialKind, ModelRoutingUsecaseInput, ModelRoutingUsecaseStatus,
    ProviderRouteProfile, RequestAudience, RouteDenialReason,
};
...
fn base_request() -> ModelRouteRequest {
    ModelRouteRequest {
        ...
        model_default_policy_ref: "policy:intelligence.env-tier.model-default.test.v1".to_owned(),
        tier_cost_budget_policy_ref: "policy:intelligence.env-tier.cost-budget.test.v1".to_owned(),
        tier_cost_budget_evidence_ref: Some("budget:intelligence:test:acceptance".to_owned()),
        model_route_registry_snapshot_ref: "route-registry:intelligence:env-tier:test".to_owned(),
