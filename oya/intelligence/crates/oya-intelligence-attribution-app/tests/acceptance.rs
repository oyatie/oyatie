...
use oya_intelligence_attribution_app::{
...
fn accepted_adapter(evidence_suffix: &str) -> IntelligenceAttributionAdapter {
    IntelligenceAttributionAdapter::try_new(
        ...
        oya_intelligence_attribution_app::AttributionRendererStatus::Accepted {
...
async fn hyper_transport_surfaces_honest_boundary_until_openbao_wires_in() {
    ...
    let envelope = oya_intelligence_attribution_app::AttributionRendererRequestEnvelope {
        method: oya_intelligence_attribution_app::AttributionRendererHttpMethod::Post,
        endpoint: "https://citation-renderer.oyatie.internal".to_owned(),
        path: "/v1/attribution/citation-renders".to_owned(),
        transport_mode:
            oya_intelligence_attribution_app::AttributionRendererTransportMode::EnvelopeOnly,
    ...
    let result =
        oya_intelligence_attribution_app::CitationRendererTransport::dispatch(&transport, envelope)
            .await;
