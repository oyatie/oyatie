...
|---|---|---|
| `microservices/intelligence/capabilities/regulator-export-profiles/eu-ai-act.yaml` | create | canonical field selector + citation anchors |
| `microservices/intelligence/capabilities/regulator-export-profiles/hipaa.yaml` | create | |
| `microservices/intelligence/capabilities/regulator-export-profiles/gdpr.yaml` | create | |
| `microservices/intelligence/capabilities/regulator-export-profiles/kr-pipa.yaml` | create | |
| `microservices/intelligence/capabilities/regulator-export-profiles/soc2.yaml` | create | |
| `microservices/intelligence/capabilities/regulator-export-profiles/iso-27001.yaml` | create | |
...
| `microservices/intelligence/capabilities/eval/regulator-export-baseline.jsonl` | create | baseline inputs |
