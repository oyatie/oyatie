...
One new Rust crate at `microservices/intelligence/src/crates/oya-foundry-providers-router-kernel/`. Workspace member added to root `Cargo.toml`. Catalog row at `microservices/intelligence/catalog/oya-foundry-providers-router-kernel.yaml`. No downstream consumers in this IP; they begin in IP-002+.

## Concrete File Targets

| Path | Action |
|---|---|
| `microservices/intelligence/src/crates/oya-foundry-providers-router-kernel/Cargo.toml` | create |
...
| `microservices/intelligence/catalog/oya-foundry-providers-router-kernel.yaml` | create |
...
buck2 build //:quality-lane-registry-authority-check # lane=lean-a1 --crate oya-foundry-providers-router-kernel
buck2 build //:quality-lane-registry-authority-check # lane=port-location --crate oya-foundry-providers-router-kernel
buck2 build //:quality-lane-registry-authority-check # lane=layer-correctness --crate oya-foundry-providers-router-kernel
buck2 build //:quality-lane-registry-authority-check # lane=data-class --crate oya-foundry-providers-router-kernel
```
