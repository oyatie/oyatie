...
Two new Rust crates under `microservices/intelligence/src/crates/`. Consumes kernel. Mock-port integration tests prove orchestration flow without infrastructure.
