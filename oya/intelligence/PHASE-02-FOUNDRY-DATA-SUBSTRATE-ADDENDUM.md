...
- Milvus search-latency SLO (`microservices/intelligence/slos/milvus-search-latency.openslo.yaml`) unburned over 30 consecutive days.
- Milvus ingest-lag SLO (`microservices/intelligence/slos/milvus-ingest-lag.openslo.yaml`) unburned over 30 consecutive days.
