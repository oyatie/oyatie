...
`microservices/intelligence/iac/helm/postgres/{Chart.yaml, values.yaml}`. No Rust changes.

## Concrete File Targets

| Path | Action |
|---|---|
| `microservices/intelligence/iac/helm/postgres/Chart.yaml` | create |
| `microservices/intelligence/iac/helm/postgres/values.yaml` | create |
| `microservices/intelligence/iac/kustomize/base/kustomization.yaml` | update (helmCharts list) |
