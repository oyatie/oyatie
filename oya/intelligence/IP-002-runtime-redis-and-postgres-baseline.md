...
All paths under `microservices/intelligence/iac/helm/{redis,postgres}/` + `iac/postgres-schema/`. No Rust crate changes.
...
psql --dry-run -f microservices/intelligence/iac/postgres-schema/001-capability-mirror.sql
