...
related_adrs: [ADR-0022, ADR-0028, ADR-0117, ADR-0139, ADR-0131, ADR-0140 (retired per ADR-0145)]
related_artifacts:
  - microservices/intelligence/threat-model.md (Trust Boundaries, T-S-01, T-I-03, T-E-02)
  - microservices/intelligence/dpia.md (R-05, R-15)
...
- `microservices/intelligence/threat-model.md` §"Trust Boundaries" + T-S-01, T-I-03, T-E-02.
- `microservices/intelligence/dpia.md` R-05, R-15.
- `microservices/intelligence/policy/{tenant-scope, ci-scope, auditor-scope, public-read}.cedar`.
