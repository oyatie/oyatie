...
| Path | Action |
|---|---|
| `microservices/intelligence/iac/helm/supervisor-controller/Chart.yaml` | create |
| `microservices/intelligence/iac/helm/supervisor-controller/values.yaml` | create |
| `microservices/intelligence/iac/helm/supervisor-controller/templates/{crds,rbac,deployment,admission-webhook}.yaml` | create |
