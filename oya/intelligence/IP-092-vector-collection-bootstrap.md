...
| `microservices/intelligence/iac/kustomize/components/milvus-tenant-bootstrap/deployment.yaml` | create | 1-80 | k8s Deployment |
| `microservices/intelligence/iac/kustomize/components/milvus-tenant-bootstrap/rbac.yaml` | create | 1-50 | ServiceAccount + Role |
...
- **Dashboard:** `microservices/intelligence/dashboards/milvus-tenants.json` (already present) shows per-tier tenant count + reconcile lag.
...
- Runbook: `microservices/intelligence/runbooks/milvus-tenant-quota.md`.
