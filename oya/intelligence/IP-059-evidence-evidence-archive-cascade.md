...
| `microservices/intelligence/iac/helm/postgres/templates/partition-cascade-cronjob.yaml` | create | daily kubernetes CronJob invoking cascade |
| `microservices/intelligence/iac/helm/evidence-blob-store/values.yaml` | edit | S3 lifecycle rules (hot→IA at 90d; IA→Glacier Deep at 1y) |
