...
1. Search `docs` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `docs` manifest `governance_lanes` array only in the manifest-owning slot.
