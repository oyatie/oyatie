...
DOSSIER-CONTRACT-001: OpenAPI 3.2.0: microservices/drive/contracts/openapi/drive.yaml.
DOSSIER-CONTRACT-002: AsyncAPI 3.1.0: microservices/drive/contracts/asyncapi/drive-events.yaml.
DOSSIER-CONTRACT-003: proto3: microservices/drive/contracts/proto/drive.proto.
DOSSIER-CAPABILITY-001: T1 T0-suggest risk=minimal file=microservices/drive/capabilities/T0-suggest.yaml.
DOSSIER-CAPABILITY-002: T1 T1-assist risk=minimal file=microservices/drive/capabilities/T1-assist.yaml.
DOSSIER-CAPABILITY-003: T1 T2-auto risk=minimal file=microservices/drive/capabilities/T2-auto.yaml.
...
API-002: OpenAPI 3.2.0 references for `drive` remain: OpenAPI 3.2.0: microservices/drive/contracts/openapi/drive.yaml
API-003: AsyncAPI 3.1.0 references for `drive` remain: AsyncAPI 3.1.0: microservices/drive/contracts/asyncapi/drive-events.yaml
API-004: proto3 references for `drive` remain: proto3: microservices/drive/contracts/proto/drive.proto
...
VERIFY-001: Static read confirms this file exists at `microservices/drive/IPs/IP-ADR-0339-Shared-IaC-Modules.md`.
