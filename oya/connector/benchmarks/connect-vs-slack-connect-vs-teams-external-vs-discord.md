...
# Benchmarks — oyatie connect vs Slack / Microsoft Teams External Access / Discord servers / Matrix federation / Mattermost Boards-and-Channels
...
Reading: oyatie paid leads. Slack is close. Matrix federation pays the federation-batch + signature-verify cost.
...
| Slack | "Up to 24 hours" (per Slack docs; depends on admin signoff) |
...
| Slack | 800 (per Slack engineering) |
...
| Slack (E2EE Slack Connect, in preview) | n/a (not GA at benchmark time) |
...
| Slack (admin audit log, cross-org) | 30 s (per Slack docs; audit log near-real-time but not sub-second) |
...
| Slack Business+ ($12.50/u/mo) | $150 | $150 000 | Per-user; Slack included |
| Slack Enterprise Grid ($18-24/u/mo, negotiated) | $216 | $216 000 | Per-user; included |
