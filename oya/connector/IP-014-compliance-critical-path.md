...
contributes to detection families:
...
- `microservices/connector/compliance.md` — concrete artifact to verify or update.
- `microservices/connector/dpia.md` — concrete artifact to verify or update.
- `microservices/connector/policy/data-residency.md` — concrete artifact to verify or update.
- `microservices/connector/policy/abuse-defence.cedar` — concrete artifact to verify or update.
