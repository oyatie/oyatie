...
companion_docs:
  - microservices/connector/contracts/connector-adapter-trait.md
  - microservices/connector/sdk-plan.md
...
- `oya-connector-sdk`: re-exports `ConnectorAdapter` trait + `InvokeContext` + `AdapterError`
- `oya-connector-sdk-test-harness`: mock `InvokeContext` + mock sidecar for unit testing adapters
...
3. `oya-connector-sdk-test-harness` enables offline adapter unit tests without real vendor credentials.
