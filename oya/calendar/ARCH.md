...
companion_docs:
  ...
  - microservices/calendar/README.md
...
- Integration state: PROPOSED for `calendar`; ACCEPTED waits for service wrapper implementation and signed module evidence.
- Ownership split: cloud-iac owns reusable OpenTofu primitive bodies; `calendar` owns wrapper selection, variables, SLO-driven sizing, and blast-radius review.
...
- Capacity: `per_request` drives CPU `0.08`, RAM `192`, storage `3`, and connection pool variables.
