...
1. Search `pharmacy` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `pharmacy` manifest `governance_lanes` array only in the manifest-owning slot.
