...
1. Search `finops-portal` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `finops-portal` manifest `governance_lanes` array only in the manifest-owning slot.
