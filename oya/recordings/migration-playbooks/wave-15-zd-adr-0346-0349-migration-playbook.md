...
1. Search `recordings` artifact surfaces for `oya-governance-*` references.
...
4. Update any future `recordings` manifest `governance_lanes` array only in the manifest-owning slot.
