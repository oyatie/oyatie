...
```bash
buck2 build //:quality-lane-registry-authority-check # lane=a11y-axe-zero-violations --target cm6
buck2 build //:quality-lane-registry-authority-check # lane=code-editor-correctness --target cm6
