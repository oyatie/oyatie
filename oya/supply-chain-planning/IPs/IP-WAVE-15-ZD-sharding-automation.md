...
## 1. Scope
SCOPE-001: This IP is scoped only to `microservices/supply-chain-planning/IPs/IP-WAVE-15-ZD-sharding-automation.md` for the ZF-9 artifact lane.
...
SCOPE-006: supply-chain-planning uses ADR-0515 for the single protected `oya-ci-required` context and separately authorized bridge/reference CD surfaces.
...
STANCE-001: Microservice: supply-chain-planning.
STANCE-002: Owner team: axis-supply-chain-planning + axis-erp-parity.
...
STANCE-005: Bounded context anchor: demand-plan.
