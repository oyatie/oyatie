...
impl HttpHandler {
    pub fn routes() -> Vec<HttpRoute> {
        vec![
            HttpRoute { method: "POST", path: "/v1/supply-chain-planning/demand-plans:publish", capability: "demand-plan", idempotent: true },
            HttpRoute { method: "POST", path: "/v1/supply-chain-planning/supply-network-plans:reconcile", capability: "supply-network-plan", idempotent: true },
            HttpRoute { method: "POST", path: "/v1/supply-chain-planning/replenishment-plans:approve", capability: "replenishment-plan", idempotent: true },
            HttpRoute { method: "POST", path: "/v1/supply-chain-planning/available-to-promise:reserve", capability: "available-to-promise", idempotent: true },
            HttpRoute { method: "POST", path: "/v1/supply-chain-planning/planning-scenarios:simulate", capability: "planning-scenario", idempotent: true },
        ]
    }
