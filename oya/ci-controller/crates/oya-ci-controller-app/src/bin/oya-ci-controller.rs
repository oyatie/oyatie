...
//! | `OYA_CI_CONTROLLER_FORGEJO_BASE`       | `http://forgejo.oya-forge.svc.cluster.local:3000`                        | Forgejo API base URL                           |
//! | `OYA_CI_CONTROLLER_FORGEJO_REPO_OWNER` | `oya-admin`                                                              | Forgejo repo owner                             |
//! | `OYA_CI_CONTROLLER_FORGEJO_REPO_NAME`  | `oyatie`                                                                 | Forgejo repo name                              |
//! | `FORGEJO_CI_TOKEN`                     | (required)                                                               | Forgejo token for status posting               |
...
async fn main() {
    ...
    let forgejo_poster = Arc::new(ForgejoCommitStatusPoster::new(
        &forgejo_base,
        &forgejo_repo_owner,
        &forgejo_repo_name,
        &forgejo_token,
