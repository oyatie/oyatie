...
- Authority: ADR-0343.
- Trigger evidence: `workflow/workflow-engine/IP-journey-j41-deployment-workflow.md` matched `financial, payment`.
...
- Surface evidence: `workflow/workflow-engine/IP-journey-j41-deployment-workflow.md`, `workflow/workflow-engine/manifest.json`; trigger terms `sandbox`.
