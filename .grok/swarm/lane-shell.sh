...
#
# Exports:
#   PATH          — .grok/swarm/shim-bin ahead of the rest (git/cargo/buck2)
...
#
# Usage:
#   ./.grok/swarm/lane-shell.sh              # interactive $SHELL
#   ./.grok/swarm/lane-shell.sh -- cmd...    # run one command under shims
set -euo pipefail
