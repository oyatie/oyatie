...
lift_target: oyatie/docs/release/branch-pipeline/INDEX.md
---
...
- **Inherits from:** [ADR-0040](../../../docs/decisions/ADR-0040-progressive-delivery-canary-blue-green-metric-gated-rollback.md) (canary + SLO mechanics applied at staging + prod), [ADR-0039](../../../docs/decisions/ADR-0039-supply-chain-security-trivy-cosign-sbom-signed-commits.md) (Cosign + SLSA), [ADR-0050](../../../docs/decisions/ADR-0050-automation-first-pipeline.md) (automation-first stance).
