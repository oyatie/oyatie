...
lift_target: oyatie/docs/release/branch-pipeline/rollback-mechanics-per-stage.md
enforced_by:
...
`oyatie/docs/release/branch-pipeline/rollback-mechanics-per-stage.md` on approval.
