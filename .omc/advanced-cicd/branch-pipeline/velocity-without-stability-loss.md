...
lift_target: oyatie/docs/release/branch-pipeline/velocity-without-stability-loss.md
enforced_by:
...
| Metric | Target | Lane |
|---|---|---|
| `local_main_to_dev_pr_open_to_merge_p95_minutes` (rename clarification: local-dev PR open → origin/dev merge) | ≤ 30 min | `oya-foundry-fitness-dev-promotion-cadence` (MED) |
