...
target_api_fingerprint=UNRESOLVED
...
arc_explicit_helm_release_names=ABSENT
live_arc_controller_release_inventory=ABSENT_REQUIRES_CAPTURE
live_arc_scale_set_release_inventory=ABSENT_REQUIRES_CAPTURE
secret_reference=FACT: arc-runners/oyatie-arc-app external GitHub-App Secret
secret_metadata_and_restoration_contract=ABSENT_REQUIRES_CAPTURE
...
Exact vendored paths/digests remain unresolved; v2 will not invent them. Repository source facts are recorded in `G028-BOOTSTRAP-REPOSITORY-FACTS-2026-08-02.md` and ARC declaration/live-inventory gaps in `G028-ARC-ADOPTION-REPOSITORY-FACTS-2026-08-02.md`.
