...
4. New issue 3 (docs sub-plan stale `M03-first-tenant/P04-connect-pro-mail` paths): docs sub-plan v5 replaces all stale M03 phase paths with canonical `M03-cloud-saas-search-workspace-preview/P04-saas-platform-preview` etc. per MASTERPLAN §13 line 588+.
