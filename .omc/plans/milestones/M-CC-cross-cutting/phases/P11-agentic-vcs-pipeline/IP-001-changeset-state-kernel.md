...
purpose: Land the foundational changeset state machine (12-value closed enum, monotonic transitions, event-sourced log) that every other M-CC-P11 IP depends on.
---

# M-CC-P11-IP-001 — Changeset state kernel + event log + monotonicity lane
