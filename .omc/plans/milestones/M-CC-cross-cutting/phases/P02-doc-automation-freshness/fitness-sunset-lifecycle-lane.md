...
# M-CC-P02-IP-FITNESS-SUNSET-LIFECYCLE — Fitness lane: sunset-lifecycle
...
structure (`.omc/plans/milestones/M-CC-cross-cutting/phases/P03-purpose-orphan-detection/fitness-adapter-with-no-importer-lane.md`).
...
`sunset_milestone: "M-CC-P01-merge"` (canonical milestone id).
