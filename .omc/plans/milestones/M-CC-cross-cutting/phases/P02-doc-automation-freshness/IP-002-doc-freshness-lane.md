...
# M-CC-P02-IP-002 — Doc-freshness CI lane
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M-CC-P02-IP-002 Doc-freshness CI lane shipped; acceptance commands green' -i high -k 'M-CC-P02-IP-002,complete'
```
