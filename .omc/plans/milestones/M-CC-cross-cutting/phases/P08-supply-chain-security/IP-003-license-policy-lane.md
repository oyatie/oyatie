...
# M-CC-P08-IP-003 — License-policy lane (AGPL/GPL/SSPL/BUSL/RSAL hard-deny)
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M-CC-P08-IP-003 License-policy lane (AGPL/GPL/SSPL/BUSL/RSAL hard-deny) shipped; acceptance commands green' -i high -k 'M-CC-P08-IP-003,complete'
```
