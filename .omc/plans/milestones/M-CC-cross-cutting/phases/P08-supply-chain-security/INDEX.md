...
# M-CC-P08 — Supply-Chain Security
...
## Agent-handoff
```
icm store -t context-oyatie -c "M-CC-P08 complete: Cosign + Rekor + SBOM + SLSA-3 + license-policy lane green" -i critical -k "M-CC,P08,supply-chain,complete"
```
