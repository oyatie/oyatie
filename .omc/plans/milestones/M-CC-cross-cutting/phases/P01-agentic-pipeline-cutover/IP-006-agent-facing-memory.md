...
# M-CC-P01-IP-006 — Agent-facing memory rewrite (P4)
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M-CC-P01-IP-006 Agent-facing memory rewrite (P4) shipped; acceptance commands green' -i high -k 'M-CC-P01-IP-006,complete'
```
