...
# M-CC-P01-IP-007 — Hook + skill audit + banned-primitives lane activation (P5)
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M-CC-P01-IP-007 Hook + skill audit + banned-primitives lane activation (P5) shipped; acceptance commands green' -i high -k 'M-CC-P01-IP-007,complete'
```
