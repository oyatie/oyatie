...
# M-CC-P01-IP-012 — Authoritative-tracked repo-walk audit (P10)
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M-CC-P01-IP-012 Authoritative-tracked repo-walk audit (P10) shipped; acceptance commands green' -i high -k 'M-CC-P01-IP-012,complete'
```
