...
# M-CC-P01-IP-003 — oya-tooling-agent-read helper (P2)
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M-CC-P01-IP-003 oya-tooling-agent-read helper (P2) shipped; acceptance commands green' -i high -k 'M-CC-P01-IP-003,complete'
```
