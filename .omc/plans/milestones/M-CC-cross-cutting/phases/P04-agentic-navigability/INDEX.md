...
## Agent-handoff
```
icm store -t context-oyatie -c "M-CC-P04 complete: agentic-navigability + predictable-naming lanes green" -i critical -k "M-CC,P04,agentic-navigability,complete"
```
