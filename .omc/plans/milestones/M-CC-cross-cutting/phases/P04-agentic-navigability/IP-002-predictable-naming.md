...
# M-CC-P04-IP-002 — Predictable-naming convention enforcement
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M-CC-P04-IP-002 Predictable-naming convention enforcement shipped; acceptance commands green' -i high -k 'M-CC-P04-IP-002,complete'
```
