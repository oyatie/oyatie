...
# M-CC-P09-IP-001 — oya-foundry-architecture-map-kernel source walkers
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M-CC-P09-IP-001 oya-foundry-architecture-map-kernel source walkers shipped; acceptance commands green' -i high -k 'M-CC-P09-IP-001,complete'
```
