...
# M-CC-P09-IP-002 — Mermaid + D2 + Graphviz emitters
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M-CC-P09-IP-002 Mermaid + D2 + Graphviz emitters shipped; acceptance commands green' -i high -k 'M-CC-P09-IP-002,complete'
```
