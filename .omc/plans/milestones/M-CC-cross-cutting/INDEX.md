...
|---|---|---|---|
| P00 | Polyglot GitOps-capable VCS Replacement (Oya VCS) — folds approved ralplan v5 | first-prerequisite planned | [`phases/P00-gitops-vcs-replacement/INDEX.md`](phases/P00-gitops-vcs-replacement/INDEX.md) |
...
| P06 | Distroless + Image-Discipline + Dependency-Seam/LTS Phaseout | stub | [`phases/P06-distroless-lts-image/INDEX.md`](phases/P06-distroless-lts-image/INDEX.md) |
