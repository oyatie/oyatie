...
parent: ./INDEX.md
id: M03-P07-IP-002
title: Second pack onboarding (JP/US/EU — council-elected)
status: complete
...
# M03-P07-IP-002 — Second pack onboarding (JP/US/EU — council-elected)

## Purpose
Onboard one of JP-Tokyo / US-NoVa / EU-Frankfurt; council elects.

## Symbols-to-grit-claim
```
regional-packs/<elected>/pack.yaml::Pack
regional-packs/<elected>/residency.yaml::Residency
```
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M03-P07-IP-002 Second pack onboarding (JP/US/EU — council-elected) shipped; acceptance commands green' -i high -k 'M03-P07-IP-002,complete'
```
