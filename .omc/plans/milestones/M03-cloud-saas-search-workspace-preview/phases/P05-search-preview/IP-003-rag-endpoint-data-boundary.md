...
parent: ./INDEX.md
id: M03-P05-IP-003
title: RAG endpoint to Foundry + data boundary enforcement
status: complete
...
# M03-P05-IP-003 — RAG endpoint to Foundry + data boundary enforcement

## Purpose
Search RAG endpoint exposed to Foundry capabilities under Data Use Boundary.

## Symbols-to-grit-claim
```
crates/oya-search-rag-api/src/lib.rs::query
crates/oya-search-rag-app/src/lib.rs::enforce_data_boundary
```
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M03-P05-IP-003 RAG endpoint to Foundry + data boundary enforcement shipped; acceptance commands green' -i high -k 'M03-P05-IP-003,complete'
```
