...
status: in-progress (IP-001 AWS/OCI deterministic VM adapter request-contracts green 2026-05-21; IP-002 K8s/Functions stable API entrypoints green 2026-05-21; live-provider smoke and self-hosted/colo adapter pending)
