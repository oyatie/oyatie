...
# M03-P03-IP-004 — Cloud FinOps report + anomaly detection

## Purpose
Per-tenant per-axis cost allocation + anomaly detection.

## Symbols-to-grit-claim
```
crates/oya-cloud-finops-kernel/src/lib.rs::FinopsReport
crates/oya-cloud-finops-kernel/src/lib.rs::detect_anomaly
```
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M03-P03-IP-004 Cloud FinOps report + anomaly detection shipped; acceptance commands green' -i high -k 'M03-P03-IP-004,complete'
```
