...
parent: ./INDEX.md
id: M03-P03-IP-003
title: Cloud Observability audit-read + OpenTelemetry
status: stub
...
# M03-P03-IP-003 — Cloud Observability audit-read + OpenTelemetry

## Purpose
Audit read + OTel-emitting kernel; per-region in-region telemetry storage.

## Symbols-to-grit-claim
```
crates/oya-cloud-observability-kernel/src/lib.rs::AuditRead
crates/oya-cloud-observability-kernel/src/lib.rs::OtelEmit
```
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M03-P03-IP-003 Cloud Observability audit-read + OpenTelemetry shipped; acceptance commands green' -i high -k 'M03-P03-IP-003,complete'
```
