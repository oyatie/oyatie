...
parent: ./INDEX.md
id: M03-P03-IP-005
title: Cloud Marketplace ISV onboarding
status: stub
...
# M03-P03-IP-005 — Cloud Marketplace ISV onboarding

## Purpose
Seller application → verification → listing → settlement state machine.

## Symbols-to-grit-claim
```
crates/oya-cloud-marketplace-kernel/src/lib.rs::SellerApplication
crates/oya-cloud-marketplace-kernel/src/lib.rs::Listing
```
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M03-P03-IP-005 Cloud Marketplace ISV onboarding shipped; acceptance commands green' -i high -k 'M03-P03-IP-005,complete'
```
