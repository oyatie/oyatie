...
status: in-progress (IP-001 adapter-port green; IP-002 OCI object+block plus S3 object request-contract green 2026-05-20; IP-003 OCI network plus self-hosted VPC+DNS request-contract green 2026-05-21; IP-004 Cedar bind plus federated OIDC STS API runtime plus provider-managed IdP CRUD API plus OCI/self-hosted provider-runtime request-contract green 2026-05-21; IP-005 region/AZ cell-isolation evidence API green 2026-05-21; live-smoke follow-up pending)
...
| IP-005 | Cloud region + AZ + cell taxonomy | region-az-cell-isolation-evidence-api-green; live-topology-smoke pending | [`IP-005-region-az-cell-taxonomy.md`](IP-005-region-az-cell-taxonomy.md) |
...
| Region/Cell | `oya-cloud-region-api` region/AZ listing with per-cell isolation evidence projection green; live-topology smoke pending — IP-005 | KR-Chuncheon AD-1 + on-prem KR-Seoul (per ADR-0043) — 2 cells live |
