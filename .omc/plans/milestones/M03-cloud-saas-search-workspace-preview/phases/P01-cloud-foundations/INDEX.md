...
status: in-progress (IP-001 adapter-port green; IP-002 OCI object+block plus S3 object request-contract green 2026-05-20; IP-003 OCI network plus self-hosted VPC+DNS request-contract green 2026-05-21; IP-004 Cedar bind app composition green 2026-05-21; live-smoke/SSO/STS follow-up pending)
...
| IP-004 | Cloud IAM Cedar + SSO + STS API | cedar-bind-app-composition-green; SSO/STS runtime follow-up pending | [`IP-004-iam-cedar-sso-sts.md`](IP-004-iam-cedar-sso-sts.md) |
...
| IAM | `oya-cloud-iam-{api,domain}` partial plus `oya-cloud-iam-app` Cedar bind composition green; SSO/federation and STS runtime expansion pending — IP-004 | OCI tenancy `bitween` (ap-chuncheon-1) + 4 sub-compartments (foundry / cloud / prod / nonprod) |
