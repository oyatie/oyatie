...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M03-P01-IP-002 Cloud Storage object + block API + adapter set shipped; acceptance commands green' -i high -k 'M03-P01-IP-002,complete'
```
