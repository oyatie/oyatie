...
parent: ./INDEX.md
id: M05-P04-IP-002
title: Search SLO public commitment
status: stub
...
# M05-P04-IP-002 — Search SLO public commitment

## Purpose
Publish Search SLO commitment.

## Symbols-to-grit-claim
```
docs/SLO-CATALOG.md::SearchSlo
crates/oya-ops-sre-sla-report-app/src/lib.rs::search_slo_report
```
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M05-P04-IP-002 Search SLO public commitment shipped; acceptance commands green' -i high -k 'M05-P04-IP-002,complete'
```
