...
parent: ./INDEX.md
id: M05-P04-IP-001
title: Cloud SLA public commitment + uphold-or-credit policy
status: stub
...
# M05-P04-IP-001 — Cloud SLA public commitment + uphold-or-credit policy

## Purpose
Publish 99.99% Cloud SLA with uphold-or-credit policy.

## Symbols-to-grit-claim
```
docs/legal/cloud-sla.md::SLA
crates/oya-ops-sre-sla-report-app/src/lib.rs::monthly_report
```
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M05-P04-IP-001 Cloud SLA public commitment + uphold-or-credit policy shipped; acceptance commands green' -i high -k 'M05-P04-IP-001,complete'
```
