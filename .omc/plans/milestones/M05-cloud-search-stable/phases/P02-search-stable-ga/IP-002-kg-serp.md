...
parent: ./INDEX.md
id: M05-P02-IP-002
title: Knowledge graph + SERP rendering
status: stub
...
# M05-P02-IP-002 — Knowledge graph + SERP rendering

## Purpose
Knowledge graph + SERP rendering for public search.

## Symbols-to-grit-claim
```
crates/oya-search-kg-kernel/src/lib.rs::KnowledgeGraph
crates/oya-search-serp-app/src/lib.rs::render
```
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M05-P02-IP-002 Knowledge graph + SERP rendering shipped; acceptance commands green' -i high -k 'M05-P02-IP-002,complete'
```
