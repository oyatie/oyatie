...
# M05-P03-IP-002 — Second-region attestation (JP/US/EU per council)

## Purpose
Achieve second-region regulator attestation.

## Symbols-to-grit-claim
```
regional-packs/<region>/attestation/<scheme>-production.md::Evidence
```
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M05-P03-IP-002 Second-region attestation (JP/US/EU per council) shipped; acceptance commands green' -i high -k 'M05-P03-IP-002,complete'
```
