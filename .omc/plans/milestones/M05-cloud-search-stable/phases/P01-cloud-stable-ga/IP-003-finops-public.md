...
## Purpose
Expose FinOps surface to public-GA tenants.

## Symbols-to-grit-claim
```
crates/oya-cloud-finops-api/src/lib.rs::report_public
crates/oya-cloud-finops-app/src/lib.rs::detect_anomaly_public
```
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M05-P01-IP-003 FinOps surface public-facing shipped; acceptance commands green' -i high -k 'M05-P01-IP-003,complete'
```
