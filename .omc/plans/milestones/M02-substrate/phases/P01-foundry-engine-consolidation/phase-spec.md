...
icm store \
  -t context-oyatie \
  -c "Phase P01-foundry-engine-consolidation started; milestone M02-substrate; scope: foundry 10 check crates + 4 LEAN binaries; entry gate met: M01-P05 complete" \
  -i high \
