...
icm store \
  -t context-oyatie \
  -c "Phase P12-workflow-engine started; milestone M02-substrate; scope: workflow µservice 7 BCs (engine/transitions/approvals/sla/automations/triggers/integrations); entry gate met: P02-ontology complete" \
  -i high \
