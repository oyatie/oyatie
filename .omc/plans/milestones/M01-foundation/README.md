...
`acceptance-evidence/` — TBD signed Ed25519 segment + cargo gate transcript. Lane `lean-a5-doc-coverage` flags missing acceptance evidence as a violation; closure scheduled for M02-P22 prep.
