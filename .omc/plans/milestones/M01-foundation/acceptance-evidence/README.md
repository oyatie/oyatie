...
- M01-P08: foundation-cleared/P5+; banned-primitives, archive-orphan, and authoritative-tracked lanes pass.
- M01-P07: accepted-for-masterplan-P00 but not ready. Waiver scope is acceptance reconciliation only; broad fanout, new foundation scaffolds, and M02/M03 implementation remain blocked until P00 readiness or an explicit waiver.
