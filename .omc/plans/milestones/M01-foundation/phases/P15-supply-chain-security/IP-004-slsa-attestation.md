...
# M01-P15-IP-004 — SLSA level ≥3 attestation publishing
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M01-P15-IP-004 SLSA level ≥3 attestation publishing shipped; acceptance commands green' -i high -k 'M01-P15-IP-004,complete'
```
