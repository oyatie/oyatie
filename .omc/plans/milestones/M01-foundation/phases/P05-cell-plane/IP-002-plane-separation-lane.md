...
# M01-P05-IP-002 — Plane separation enforcement lane

## Purpose
Ship the fitness lane that validates every catalog record declares plane.
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M01-P05-IP-002 Plane separation enforcement lane shipped; acceptance commands green' -i high -k 'M01-P05-IP-002,complete'
```
