...
parent: ./INDEX.md
id: M01-P10-IP-FITNESS-MIGRATION-STATUS-LIFECYCLE
...
# M01-P10-IP-FITNESS-MIGRATION-STATUS-LIFECYCLE — Fitness lane: migration-status lifecycle

## State machine
Stages: pre-cutover → in-cutover → cleanup → done. Stage transitions are gated by milestone anchors (e.g. `M01-P08-merge`).
