...
parent: ./INDEX.md
id: M01-P10-IP-FITNESS-DOC-STATUS-LIFECYCLE
title: Fitness lane — doc-status lifecycle (ADR-0109 framework instance #6)
status: scaffolded
execution_unit: ChangeSet
final_shape_compliance: true
dependency_additions:
  - specs/lifecycle-configs/doc-status-lifecycle.json
...
# M01-P10-IP-FITNESS-DOC-STATUS-LIFECYCLE — Fitness lane: doc-status lifecycle
...
Existing `oya-governance-doc-freshness-kernel` complements this: freshness detects mtime drift; lifecycle detects schema absence. They share the source corpus but evaluate different state machines.
