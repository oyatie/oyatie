...
# M01-P10-IP-002 — Orphan-detection lane kernel
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M01-P10-IP-002 Orphan-detection lane kernel shipped; acceptance commands green' -i high -k 'M01-P10-IP-002,complete'
```
