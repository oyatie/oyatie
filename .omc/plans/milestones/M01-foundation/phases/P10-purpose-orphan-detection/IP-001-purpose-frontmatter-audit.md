...
# M01-P10-IP-001 — Purpose-frontmatter authoring (audit every existing doc/JSON)
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M01-P10-IP-001 Purpose-frontmatter authoring (audit every existing doc/JSON) shipped; acceptance commands green' -i high -k 'M01-P10-IP-001,complete'
```
