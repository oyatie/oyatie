...
# M01-P12-IP-001 — Provider-coupling lane kernel
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M01-P12-IP-001 Provider-coupling lane kernel shipped; acceptance commands green' -i high -k 'M01-P12-IP-001,complete'
```
