...
# M01-P11-IP-001 — Agentic-navigability lane kernel + parent-pointer validator
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M01-P11-IP-001 Agentic-navigability lane kernel + parent-pointer validator shipped; acceptance commands green' -i high -k 'M01-P11-IP-001,complete'
```
