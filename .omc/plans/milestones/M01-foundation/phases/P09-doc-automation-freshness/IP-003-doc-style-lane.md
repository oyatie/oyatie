...
# M01-P09-IP-003 — Doc-style enforcement lane + auto-format
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M01-P09-IP-003 Doc-style enforcement lane + auto-format shipped; acceptance commands green' -i high -k 'M01-P09-IP-003,complete'
```
