...
# M01-P14-IP-001 — PRFAQ + Design-Doc + Postmortem templates
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M01-P14-IP-001 PRFAQ + Design-Doc + Postmortem templates shipped; acceptance commands green' -i high -k 'M01-P14-IP-001,complete'
```
