...
# M01-P14-IP-004 — Rust toolchain hyperscaler-gate set
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M01-P14-IP-004 Rust toolchain hyperscaler-gate set shipped; acceptance commands green' -i high -k 'M01-P14-IP-004,complete'
```
