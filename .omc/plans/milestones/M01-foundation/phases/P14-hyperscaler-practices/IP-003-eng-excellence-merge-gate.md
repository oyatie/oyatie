...
# M01-P14-IP-003 — Engineering Excellence Council merge gate
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M01-P14-IP-003 Engineering Excellence Council merge gate shipped; acceptance commands green' -i high -k 'M01-P14-IP-003,complete'
```
