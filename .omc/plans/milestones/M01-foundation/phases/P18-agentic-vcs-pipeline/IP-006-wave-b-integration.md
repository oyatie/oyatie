...
depends_on:
  ...
  - M01-P18-IP-004
  - M01-P18-IP-005
purpose: Wire wave-A substrate into the live pipeline. Promotion workflows gate on canary verdict; IP-004/005/006 from M01-P17 are retrofitted to receive events via the IP-003 webhook router instead of `workflow_run:` triggers.
---

# M01-P18-IP-006 — Wave-B integration
