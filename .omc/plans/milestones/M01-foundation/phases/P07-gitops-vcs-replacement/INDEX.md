...
# M01-P07 — Polyglot GitOps-capable VCS Replacement (Oya VCS)

## M02/M03 Authority gate

**Waiver retired 2026-05-15.** M01-P07 (Oya VCS) is the forward closure authority for broad M02/M03 agent fan-out. M02 and M03 may consume existing git/Cargo infrastructure, but promoted Foundry agentic ChangeSets must close through Oya VCS ChangeBundle → Promotion → ReleaseTrain evidence. Legacy grit/icm/rtk/vox/omx/omc surfaces are compatibility/provenance only and do not satisfy promotion authority.
