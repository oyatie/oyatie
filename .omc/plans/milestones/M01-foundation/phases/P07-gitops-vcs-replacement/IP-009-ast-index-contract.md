...
purpose: Define stable language-neutral AST/range/pointer/dependency contracts used by claims, review mapping, impacted tests, semantic conflict.
---
# M01-P07-IP-009 — AST index contract + impacted-test mapping
