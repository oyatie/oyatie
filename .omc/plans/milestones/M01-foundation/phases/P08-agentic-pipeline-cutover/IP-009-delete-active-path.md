...
# M01-P08-IP-009 — Delete archived glue from active path (P7)
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M01-P08-IP-009 Delete archived glue from active path (P7) shipped; acceptance commands green' -i high -k 'M01-P08-IP-009,complete'
```
