...
# M01-P08 — Agentic-Pipeline Cutover

## Purpose
Per [`../../../ralplan-oyatie-sst-consolidation.md`](../../../ralplan-oyatie-sst-consolidation.md) (iter-2 mid-consensus), this phase cleared the historical grit/icm foundation. As of 2026-05-15, M01-P07 Oya VCS supersedes grit/icm as the forward closure authority for Foundry agentic work; this phase remains historical evidence and compatibility context.
...
Forward agentic closeout is Oya VCS ChangeBundle → Promotion → ReleaseTrain. Legacy grit/icm/rtk/vox/omx/omc surfaces are compatibility/provenance only while command adapters finish landing and cannot satisfy new promotion authority.
