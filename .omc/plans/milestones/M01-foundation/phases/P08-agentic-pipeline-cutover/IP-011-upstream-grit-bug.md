...
# M01-P08-IP-011 — File upstream grit session bug (P9)
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M01-P08-IP-011 File upstream grit session bug (P9) shipped; acceptance commands green' -i high -k 'M01-P08-IP-011,complete'
```
