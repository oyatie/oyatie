...
# M01-P08-IP-004 — Bidirectional PRD citation + portfolio-citation lane (P3)
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M01-P08-IP-004 Bidirectional PRD citation + portfolio-citation lane (P3) shipped; acceptance commands green' -i high -k 'M01-P08-IP-004,complete'
```
