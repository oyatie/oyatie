...
# M01-P08-IP-005 — Foundry corpus cross-cite + PHASE-00-SPEC.md (P3.5)
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M01-P08-IP-005 Foundry corpus cross-cite + PHASE-00-SPEC.md (P3.5) shipped; acceptance commands green' -i high -k 'M01-P08-IP-005,complete'
```
