...
# M01-P08-IP-002 — Inventory pass + ADR-0052 (P1)
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M01-P08-IP-002 Inventory pass + ADR-0052 (P1) shipped; acceptance commands green' -i high -k 'M01-P08-IP-002,complete'
```
