...
# M01-P08-IP-001 — ADR-0054 scaffold-claim pattern + RACI human-orchestrator row (P0.5)
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M01-P08-IP-001 ADR-0054 scaffold-claim pattern + RACI human-orchestrator row (P0.5) shipped; acceptance commands green' -i high -k 'M01-P08-IP-001,complete'
```
