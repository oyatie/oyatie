...
# M01-P04-IP-001 — Outbox + topic registry kernel
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M01-P04-IP-001 Outbox + topic registry kernel shipped; acceptance commands green' -i high -k 'M01-P04-IP-001,complete'
```
