...
```
crates/oya-platform-object-graph-kernel/src/lib.rs::Entity
crates/oya-platform-object-graph-kernel/src/lib.rs::PropertyTier
crates/oya-platform-object-graph-{vector,timeseries,geo,ciphertext,struct}-kernel/src/lib.rs::Property
```
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M01-P04-IP-002 Object Graph entity upsert + 5 property tiers shipped; acceptance commands green' -i high -k 'M01-P04-IP-002,complete'
```
