...
# M01-P13-IP-001 — Distroless base + image-discipline lane
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M01-P13-IP-001 Distroless base + image-discipline lane shipped; acceptance commands green' -i high -k 'M01-P13-IP-001,complete'
```
