...
# M01-P13-IP-002 — Dependency-seam discipline + tech-debt ledger + LTS roster
...
```bash
icm store -t context-oyatie -c 'M01-P13-IP-002 dependency-seam discipline shipped; tech-debt ledger rows=11; composite lane green; trigger DSL split; ADR-0091..0094 indexed; LTS roster updated' -i high -k 'M01-P13-IP-002,dependency-seam,lts,complete'
```
