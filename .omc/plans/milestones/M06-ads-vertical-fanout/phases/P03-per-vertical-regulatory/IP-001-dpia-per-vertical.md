...
parent: ./INDEX.md
id: M06-P03-IP-001
title: DPIA template + per-vertical authoring (13 verticals)
status: stub
...
# M06-P03-IP-001 — DPIA template + per-vertical authoring (13 verticals)

## Purpose
Author DPIA per vertical at regional-packs/kr/dpia/<vertical>.md.

## Symbols-to-grit-claim
```
regional-packs/kr/dpia/<vertical>.md::Dpia
```
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M06-P03-IP-001 DPIA template + per-vertical authoring (13 verticals) shipped; acceptance commands green' -i high -k 'M06-P03-IP-001,complete'
```
