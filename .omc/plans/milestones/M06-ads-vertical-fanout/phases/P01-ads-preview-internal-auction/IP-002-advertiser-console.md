...
parent: ./INDEX.md
id: M06-P01-IP-002
title: Advertiser console (tenant-internal)
status: stub
...
# M06-P01-IP-002 — Advertiser console (tenant-internal)

## Purpose
Tenant-internal advertiser console.

## Symbols-to-grit-claim
```
crates/oya-ads-console-app/src/lib.rs::AdvertiserConsole
```
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M06-P01-IP-002 Advertiser console (tenant-internal) shipped; acceptance commands green' -i high -k 'M06-P01-IP-002,complete'
```
