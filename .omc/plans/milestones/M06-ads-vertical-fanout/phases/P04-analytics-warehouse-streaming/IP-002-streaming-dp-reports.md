...
# M06-P04-IP-002 — Streaming + DP-bounded reports

## Purpose
Ship analytics.streaming.subscribe + analytics.report.dp-bounded.

## Symbols-to-grit-claim
```
crates/oya-analytics-streaming-kernel/src/lib.rs::Subscribe
crates/oya-analytics-dp-app/src/lib.rs::DpBoundedReport
```
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M06-P04-IP-002 Streaming + DP-bounded reports shipped; acceptance commands green' -i high -k 'M06-P04-IP-002,complete'
```
