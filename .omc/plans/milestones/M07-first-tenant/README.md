...
milestone_id: M07-first-tenant
parent: ../../../docs/MASTERPLAN.md
status: Proposed
entry_gate: 'M02b-substrate Complete; all 22 M02 phases green; all 14+ CI lanes BLOCKER;
...
---
# M07-first-tenant — 1 KR paying tenant live (HR + Payroll + Accounting + Connect Pro Mail/Messenger + Workflow Studio)
