...
parent: ./INDEX.md
id: M02-P04-IP-001
title: REST + GraphQL API transports
status: complete
...
# M02-P04-IP-001 — REST + GraphQL API transports

## Purpose
Ship REST + GraphQL transports binding to same use-case ports.
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M02-P04-IP-001 REST + GraphQL API transports shipped; acceptance commands green' -i high -k 'M02-P04-IP-001,complete'
```
