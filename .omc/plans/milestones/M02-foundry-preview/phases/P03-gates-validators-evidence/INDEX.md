...
## Symbols-touched
`scripts/validate_foundry_phase00_evidence.mjs`, `crates/oya-foundry-fitness-{claim-ceiling,authority-cohesion,bypass,pr-traceability,pre-push,quality-lane,cohesion-fitness}-kernel`.
