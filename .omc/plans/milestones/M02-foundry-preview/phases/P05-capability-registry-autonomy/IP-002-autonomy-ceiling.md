...
parent: ./INDEX.md
id: M02-P05-IP-002
title: Autonomy ceiling Cedar policy + runtime check
status: complete
...
# M02-P05-IP-002 — Autonomy ceiling Cedar policy + runtime check

## Purpose
Ship autonomy ceiling T1-T4 Cedar policy + runtime check; T4 disabled by default for actuation.
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M02-P05-IP-002 Autonomy ceiling Cedar policy + runtime check shipped; acceptance commands green' -i high -k 'M02-P05-IP-002,complete'
```
