...
parent: ./INDEX.md
id: M02-P05-IP-001
title: Capability registry kernel + publish surface
status: complete
...
# M02-P05-IP-001 — Capability registry kernel + publish surface

## Purpose
Ship capability registry with ≥50 capabilities publishable.
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M02-P05-IP-001 Capability registry kernel + publish surface shipped; acceptance commands green' -i high -k 'M02-P05-IP-001,complete'
```
