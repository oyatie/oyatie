...
parent: ./INDEX.md
id: M02-P05-IP-003
title: RAG endpoint exposed to Foundry-internal capabilities
status: complete
...
# M02-P05-IP-003 — RAG endpoint exposed to Foundry-internal capabilities

## Purpose
Ship RAG endpoint to Foundry-internal capabilities; per-class data boundary.

## Symbols-to-grit-claim
```
crates/oya-foundry-rag-endpoint-api/src/lib.rs::rag_query
crates/oya-foundry-rag-endpoint-app/src/lib.rs::retrieve_with_data_boundary
```
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M02-P05-IP-003 RAG endpoint exposed to Foundry-internal capabilities shipped; acceptance commands green' -i high -k 'M02-P05-IP-003,complete'
```
