...
(expanding M02b-substrate-schema-foundation §2), implements all kernel port traits with
...
| `migrations/workflow/V001__workflow_schema.sql` | create | Full DDL from M02b-substrate-schema-foundation §2 EXPANDED: definitions, runs, step_history, step_runs, triggers, approvals, approval_decisions, sla_timers, automation_bindings, integration_runs, outbox; all with RLS + indexes |
...
- M02b-substrate-schema-foundation.md §2 (expanded into V001 migration)
