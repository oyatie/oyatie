...
icm store \
  -t context-oyatie \
  -c "Phase P14-policy started; milestone M02b-substrate; scope: policy µservice 2 BCs (engine, rule-packs); Cedar integration; entry gate: P03-identity complete" \
  -i high \
...
- M02b-substrate-schema-foundation §6-N (policy outlined; expanded here)
