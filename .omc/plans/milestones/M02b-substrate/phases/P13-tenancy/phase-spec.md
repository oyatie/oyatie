...
icm store \
  -t context-oyatie \
  -c "Phase P13-tenancy started; milestone M02b-substrate; scope: tenancy µservice; entry gate met: P03-identity complete" \
  -i high \
...
- M02b-substrate-schema-foundation.md §4 (expanded here)
