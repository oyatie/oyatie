...
parent: ./INDEX.md
id: M04-P02-IP-001
title: PIPA + CSAP control evidence pack
status: stub
...
# M04-P02-IP-001 — PIPA + CSAP control evidence pack

## Purpose
Author PIPA + CSAP control evidence pack for elected vertical.

## Symbols-to-grit-claim
```
regional-packs/kr/evidence/pipa.md::Controls
regional-packs/kr/evidence/csap.md::Controls
```
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M04-P02-IP-001 PIPA + CSAP control evidence pack shipped; acceptance commands green' -i high -k 'M04-P02-IP-001,complete'
```
