...
parent: ./INDEX.md
id: M04-P02-IP-002
title: K-ISMS-P + KCMVP HSM operational
status: stub
...
# M04-P02-IP-002 — K-ISMS-P + KCMVP HSM operational

## Purpose
Operationalize K-ISMS-P controls + KCMVP HSM for production.

## Symbols-to-grit-claim
```
regional-packs/kr/evidence/k-isms-p.md::Controls
regional-packs/kr/evidence/kcmvp-hsm.md::Operational
```
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M04-P02-IP-002 K-ISMS-P + KCMVP HSM operational shipped; acceptance commands green' -i high -k 'M04-P02-IP-002,complete'
```
