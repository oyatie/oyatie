...
parent: ./INDEX.md
id: M04-P04-IP-002
title: Retention measurement + KPI dashboard
status: stub
...
# M04-P04-IP-002 — Retention measurement + KPI dashboard

## Purpose
8-week retention measurement + KPI dashboard for ≥50K runs/wk ≥99.5%.
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M04-P04-IP-002 Retention measurement + KPI dashboard shipped; acceptance commands green' -i high -k 'M04-P04-IP-002,complete'
```
