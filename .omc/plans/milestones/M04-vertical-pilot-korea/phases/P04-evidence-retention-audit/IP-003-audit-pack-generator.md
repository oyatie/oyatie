...
parent: ./INDEX.md
id: M04-P04-IP-003
title: Regulator audit-pack generator
status: stub
...
# M04-P04-IP-003 — Regulator audit-pack generator

## Purpose
Audit-pack regenerator ≤4h from request.

## Symbols-to-grit-claim
```
crates/oya-ops-compliance-evidence-pack-app/src/lib.rs::generate
crates/oya-ops-compliance-evidence-pack-app/src/lib.rs::regenerate_within_4h
```
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M04-P04-IP-003 Regulator audit-pack generator shipped; acceptance commands green' -i high -k 'M04-P04-IP-003,complete'
```
