...
parent: ./INDEX.md
id: M04-P01-IP-002
title: Capability pack kernel (oya-vertical-<elected>-pack-kernel)
status: stub
...
## Purpose
Ship the elected vertical's capability pack kernel + entities + workflows.

## Symbols-to-grit-claim
```
crates/oya-vertical-<elected>-pack-kernel/src/lib.rs::CapabilityPack
crates/oya-vertical-<elected>-pack-kernel/src/lib.rs::PackVersion
```
...
## Icm-store-payload
```
icm store -t context-oyatie -c 'M04-P01-IP-002 Capability pack kernel (oya-vertical-<elected>-pack-kernel) shipped; acceptance commands green' -i high -k 'M04-P01-IP-002,complete'
```
