...
23. `foundry` — 438 missing refs; samples: microservices/intelligence/IP-064-guardrails-prompt-classifier-kernel.md:24->microservices/intelligence/src/crates/oya-foundry-guardrails-prompt-classifier-kernel/; microservices/intelligence/IP-076-providers-router-kernel.md:24->microservices/intelligence/src/crates/oya-foundry-providers-router-kernel/; microservices/intelligence/IP-076-providers-router-kernel.md:30->microservices/intelligence/src/crates/oya-foundry-providers-router-kernel/Cargo.toml
...
- missing_ref_sample_1: microservices/intelligence/IP-064-guardrails-prompt-classifier-kernel.md:24->microservices/intelligence/src/crates/oya-foundry-guardrails-prompt-classifier-kernel/
- missing_ref_sample_2: microservices/intelligence/IP-076-providers-router-kernel.md:24->microservices/intelligence/src/crates/oya-foundry-providers-router-kernel/
- missing_ref_sample_3: microservices/intelligence/IP-076-providers-router-kernel.md:30->microservices/intelligence/src/crates/oya-foundry-providers-router-kernel/Cargo.toml
- sampled: no
- ownership_risk: high
- recommended_probe: assign a single service owner to reconcile PRD, ADRs, contracts, SLOs, runbooks, journey IP references, and migration surfaces before accepting the service as coherent.
