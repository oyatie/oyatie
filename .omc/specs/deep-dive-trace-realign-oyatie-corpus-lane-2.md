...
- Missing-ref samples: microservices/workflow-studio/IP-027-cedar-grammar-
  impl.md:39->microservices/foundry/specs/cedar/; microservices/workflow-studio/IP-027-cedar-grammar-
...
23. `foundry` — 438 missing refs; samples: microservices/foundry/IP-064-guardrails-prompt-classifier-kernel.md:24->microservices/foundry/src/crates/oya-foundry-guardrails-prompt-classifier-kernel/; microservices/foundry/IP-076-providers-router-kernel.md:24->microservices/foundry/src/crates/oya-foundry-providers-router-kernel/; microservices/foundry/IP-076-providers-router-kernel.md:30->microservices/foundry/src/crates/oya-foundry-providers-router-kernel/Cargo.toml
...
- missing_ref_sample_1: microservices/foundry/IP-064-guardrails-prompt-classifier-kernel.md:24->microservices/foundry/src/crates/oya-foundry-guardrails-prompt-classifier-kernel/
- missing_ref_sample_2: microservices/foundry/IP-076-providers-router-kernel.md:24->microservices/foundry/src/crates/oya-foundry-providers-router-kernel/
- missing_ref_sample_3: microservices/foundry/IP-076-providers-router-kernel.md:30->microservices/foundry/src/crates/oya-foundry-providers-router-kernel/Cargo.toml
- sampled: no
- ownership_risk: high
- recommended_probe: assign a single service owner to reconcile PRD, ADRs, contracts, SLOs, runbooks, journey IP references, and migration surfaces before accepting the service as coherent.
...
- missing_ref_sample_1: microservices/workflow-studio/IP-027-cedar-grammar-impl.md:39->microservices/foundry/specs/cedar/
