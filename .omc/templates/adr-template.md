...
lift_target: oyatie/docs/templates/adr-template.md
...
Optional but **RECOMMENDED**. List the Master Plan principles (1-12) this ADR explicitly inherits, with one-line justification each. Used by `oya-foundry-fitness-adr-shape` to verify principle coverage on cross-cutting ADRs.
