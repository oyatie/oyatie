...
lift_target: oyatie/docs/templates/incident-postmortem-template.md
supersedes: docs/templates/incident-postmortem-template.md
enforcing_fitness_lane: oya-foundry-fitness-postmortem-shape
...
related:
  ...
  - .omc/templates/runbook-template.md
  - .omc/templates/mistakes-ledger-row-template.md
---
...
- Replay command: `oya admin incident replay <id>` → produces an evidence bundle conforming to `.omc/templates/evidence-bundle-template.json`.
