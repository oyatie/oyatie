...
related:
  ...
  - .omc/templates/postmortem-template.md
---
...
- Halt and emit `BLOCKED_ON_HUMAN_ORCHESTRATOR` per `.omc/templates/checklists/escalation-checklist.md` if an unexpected outcome appears at any step.
...
- Sev-1: postmortem required within 30 days (per `.omc/templates/postmortem-template.md`).
...
- [ ] Postmortem authored per `.omc/templates/postmortem-template.md`.
- [ ] `docs/MISTAKES-LEDGER.md` row added if a new mechanical prevention is identified (per `.omc/templates/mistakes-ledger-row-template.md`).
