...
related:
  ...
  - .omc/templates/phase-index-template.md
  - .omc/templates/milestone-index-template.md
...
- [ ] `docs/AGENTS.md §Done-Definition checklist` D1-D18 walked (see `.omc/templates/checklists/done-definition-checklist.md`).
