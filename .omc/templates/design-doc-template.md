...
lift_target: oyatie/docs/templates/design-doc-template.md
...
Schema definitions, invariants, state-machine transitions. If a domain `State → State` machine, draw it. Cite `data_class` per `docs/PRIVACY-PROGRAM.md §2.2.1`.
...
- ADR(s) authored / amended: `ADR-NNNN`.
