...
related:
  ...
  - .omc/templates/pull-request-template.md
---
...
- [ ] **X5** Notify every consumer-axis team via PR review request. *Lane:* `oya-foundry-fitness-cross-axis-notify`. (Auto-emit to per-axis Slack channels via Foundry capability `pr.cross-axis.notify`.)
- [ ] **X6** Update `docs/DESIGN.md §10` registry row in the same PR. *Lane:* `oya-foundry-fitness-design-contracts-mirror`.
- [ ] **X7** If breaking: author an ADR per `.omc/templates/adr-template.md` documenting the migration path. *Lane:* `oya-foundry-fitness-adr-shape`.
