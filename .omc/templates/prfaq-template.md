...
related:
  ...
  - docs/PRD.md
  - docs/GTM-PLAN.md
  - .omc/templates/design-doc-template.md
length_cap: 200
authoring_rules:
...
4. On `proceed-to-design-doc`: author lifts to a Google-style design doc (`.omc/templates/design-doc-template.md`) before any IP claim.
5. On `kill`: archive at `.omc/specs/killed/PRFAQ-NNNN-<slug>.md` with the kill reason recorded.
