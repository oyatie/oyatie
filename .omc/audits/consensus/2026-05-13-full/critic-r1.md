...
- (iii) verified-claims:         FAIL — `git ls-files` returned tracked entries for canonical specs/registries such as `.omc/specs/active-machine-readable-artifact-contract.json`, `.omc/specs/root-hub-pointers.json`, `docs/AGENTS.md`, `docs/DOC-CATALOG.md`, `.omc/registries/artifact-capabilities-registry.json`, `.omc/registries/reusable-building-blocks-registry.json`, `.omc/specs/master-plan-sequencing.json`, and `registry/quality/lanes.yaml`. It returned no tracked entries for `.omc/audits/consensus/2026-05-13-full/planner-v2.md`, `architect-r1.md`, `architect-r2.md`, or `planner-v1.md`.
