...
1. Consensus artifacts HEAD-tracked: PASS — `git ls-files .omc/audits/consensus/2026-05-13-full/` returns `architect-r1.md`, `architect-r2.md`, `critic-r1.md`, `planner-v1.md`, `planner-v2.md`, and `planner-v3.md`.
