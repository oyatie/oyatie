...
| `docs/STANDARDS-AND-TEMPLATES.md` | Index | Standards + templates index (post-lift) | council-architecture | Tier 1 | `oya-governance-standards-index` | 2026-05-12 | AGENTS, .omc/standards/INDEX.md |
