...
> The one-stop lookup. When you need to know "which doc governs X / who owns it / which lane enforces it / when was it last verified", read the row here. Do not duplicate content — link.
...
| `docs/STANDARDS-AND-TEMPLATES.md` | Index | Standards + templates index (post-lift) | council-architecture | Tier 1 | `oya-foundry-fitness-standards-index` | 2026-05-12 | AGENTS, .omc/standards/INDEX.md |
