...
lift_target: oyatie/docs/agents/AGENT-ENTRY-POINT.md
canonical_authority: docs/CONSTITUTION.md
related:
  - .omc/agent-kickoff/AGENT-DECISION-TREE.md
  - .omc/agent-kickoff/AGENT-TOOL-PROTOCOL.md
  - .omc/agent-kickoff/AGENT-COMPLETION-PROTOCOL.md
  - .omc/agent-kickoff/AGENT-FAILURE-RECOVERY.md
  - .omc/agent-kickoff/AGENT-ICM-TOPIC-CONVENTIONS.md
  - .omc/agent-kickoff/AGENT-CHEAT-SHEET.md
  - .omc/agent-kickoff/CROSS-REFERENCE-INDEX.md
  - .omc/plans/MASTERPLAN.md
  - docs/AGENTS.md
authority_chain_declaration: |
  docs/CONSTITUTION.md > docs/AGENTS.md > .omc/plans/MASTERPLAN.md > this file
---

# Oyatie Agent Entry Point

> **You are a fresh autonomous agent. Read this page top-to-bottom once. Then start at step 1.**
> Authority: this page operates under [`docs/CONSTITUTION.md`](../../docs/CONSTITUTION.md) and the [Oyatie Operating Contract](../../docs/AGENTS.md). Sanctioned primitives only: `{grit, icm, oya-tooling-agent-read}` plus Directive-12 documented exceptions.
...
1. **Master plan**: read [`.omc/plans/MASTERPLAN.md`](../plans/MASTERPLAN.md) §3 milestone index.
...
Confirm: change class is named (per [`docs/AGENTS.md`](../../docs/AGENTS.md) §Pre-flight #1). Authority docs for that class are read.
