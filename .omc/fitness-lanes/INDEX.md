...
| banned-primitives | new-directive | Directive 12 (sanctioned primitives) | oya-foundry-fitness-banned-primitives-kernel | tools/oya-foundry-fitness-banned-primitives-app | `cargo run -q -p oya-dev-cli -- gate validate banned-primitives` | 500 | BLOCKER |
