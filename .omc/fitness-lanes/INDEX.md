...
| sbom-attestation | new-hyperscaler | hyperscaler/SBOM | oya-governance-sbom-attestation-kernel | tools/oya-governance-sbom-attestation | `cargo run -p oya-governance-sbom-attestation` | 1500 | HIGH |
...
| direct-tool-invocation-audit | new-directive | Directive 12 (icm record) | oya-governance-direct-tool-invocation-kernel | tools/oya-governance-direct-tool-invocation-audit | `cargo run -p oya-governance-direct-tool-invocation-audit` | 800 | HIGH |
