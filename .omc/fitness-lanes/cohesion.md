...
- enforces: STANDARD/cross-axis-cohesion; AGENTS.md fitness-lane `oya-foundry-fitness-cohesion` (already implemented as the reference kernel).
- kernel_crate: `oya-foundry-cohesion-fitness-kernel` (EXISTING) — `CrossAxisContract`, verdict `CohesionFitnessReport`.
- runner_path: `tools/oya-foundry-fitness-cohesion`
...
- failure_modes:
  ...
  - empty consumer_axes
- ci_invocation: `cargo run -p oya-foundry-fitness-cohesion`
