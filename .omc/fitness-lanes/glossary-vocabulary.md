...
- kernel_crate: `oya-foundry-fitness-glossary-vocabulary-kernel` — `RetiredTermOccurrence { token, path, line, archived }`, verdict `GlossaryVocabularyFitnessReport { occurrences_checked }`.
- runner_path: `tools/oya-foundry-fitness-glossary-vocabulary`
...
- ci_invocation: `cargo run -p oya-foundry-fitness-glossary-vocabulary`
