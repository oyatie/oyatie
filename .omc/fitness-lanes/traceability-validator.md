...
- enforces: STANDARD/traceability-chain; AGENTS.md fitness-lane `oya-foundry-fitness-traceability-validator`.
- kernel_crate: `oya-foundry-fitness-traceability-kernel` — `TraceLink { requirement_id, adr_ids, crate_ids, test_ids }`, verdict `TraceabilityFitnessReport { links_checked }`.
- runner_path: `tools/oya-foundry-fitness-traceability-validator`
...
- ci_invocation: `cargo run -p oya-foundry-fitness-traceability-validator`
