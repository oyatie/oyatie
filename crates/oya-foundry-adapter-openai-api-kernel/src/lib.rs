//! M02-P01 — OpenAi Api-auth kernel.
...
pub const AUTH_MODE: AuthMode = AuthMode::Api;
pub const PROVIDER_FAMILY: ProviderFamily = ProviderFamily::OpenAiOrCodex;
...
mod tests {
    ...
    fn provider_family_matches_crate_intent() {
        assert_eq!(PROVIDER_FAMILY, ProviderFamily::OpenAiOrCodex);
    }
