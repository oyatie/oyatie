...
mod tests {
    ...
    fn empty_policy_set_denies_by_default() {
        ...
        assert!(matches!(
            decision.reason(),
            oya_identity_workload_domain::DecisionReason::DefaultDeny
        ));
    }
    ...
    fn permit_reason_carries_policy_id() {
        ...
        assert!(matches!(
            decision.reason(),
            oya_identity_workload_domain::DecisionReason::ExplicitPermit { policy_id }
    ...
    fn forbid_overrides_permit() {
        ...
        assert!(matches!(
            decision.reason(),
            oya_identity_workload_domain::DecisionReason::ExplicitForbid { policy_id }
