...
const CONTRACT_NAME: &str = "fd001-enterprise-tenant-egress-policy-contract";
...
const EXPECTED_EVIDENCE_REF: &str =
    "evidence/network-egress/fd001-enterprise/egress-policy-review.jsonl";
...
fn validate_rule(rule: &Fd001TenantEgressPolicyRule) -> Result<(), Fd001TenantEgressPolicyError> {
    ...
    validate_prefixed_ref(
        ...
        "evidence/network-egress/fd001-enterprise/",
