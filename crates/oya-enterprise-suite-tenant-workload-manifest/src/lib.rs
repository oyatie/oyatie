...
//! Enterprise Suite, HR, Payroll, and Accounting run as tenant workloads on the
...
const MANIFEST_NAME: &str = "fd001-enterprise-tenant-workload-manifest";
    ...
    Fd001TenantWorkloadManifest {
        ...
        workloads: vec![
            workload(
                ...
                "enterprise-suite",
                "oya-enterprise-suite-runtime",
                "crates/oya-enterprise-suite-runtime",
            ...
            workload(
                ...
                "hr-employment",
                "oya-hr-employment-runtime",
                "crates/oya-hr-employment-runtime",
            ...
            workload(
                ...
                "payroll-run-runtime",
                "payroll-run",
                "oya-payroll-run-runtime",
                "crates/oya-payroll-run-runtime",
            ...
            workload(
                ...
                "accounting-journal",
                "oya-accounting-journal-runtime",
                "crates/oya-accounting-journal-runtime",
...
fn workload(
    ...
    Fd001TenantWorkload {
        ...
        residency_region: RESIDENCY_REGION,
        runtime_package_ref,
        route_scope_ref: "crates/oya-enterprise-suite-local-runtime-composition/src/lib.rs::enterprise_local_runtime_composition",
        deployment_manifest_ref: "crates/oya-enterprise-suite-cloud-deployment-manifest/src/lib.rs::enterprise_suite_cloud_deployment_manifest",
        resource_quota_ref: "deploy/oyatie-cloud/fd001-enterprise/resource-quota.yaml",
        network_policy_ref: "deploy/oyatie-cloud/fd001-enterprise/network-policy.yaml",
        service_account_ref: "serviceaccount/fd001-enterprise-workload",
        gateway_route_ref: "gateway/httproute/fd001-enterprise-workloads",
...
fn validate_workload(
    ...
    validate_prefixed_ref(
        ...
        "crates/oya-enterprise-suite-local-runtime-composition/",
