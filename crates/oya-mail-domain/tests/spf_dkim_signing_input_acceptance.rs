...
mod spf_alignment_edge_cases {
    use oya_mail_domain::{evaluate_spf_alignment, SpfAlignmentMode, SpfAlignmentVerdict};
...
mod dkim_canonicalization_coverage {
    use oya_mail_domain::{canonicalize_body, canonicalize_header, DkimCanonicalizationAlgorithm, RawHeader};
...
mod dkim_signing_input_builder_acceptance {
    ...
    use oya_mail_domain::sending_domain_authentication::DkimSigningAlgorithm;
    use oya_mail_domain::dkim_canonicalization::RawHeader;
