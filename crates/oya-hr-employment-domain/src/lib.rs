...
//! Korea-first labor-compliance threshold obligations. Enterprise Generic and
//! SMB Generic remain product-surface metadata; this crate is not an enterprise
//! suite boundary. It does not perform storage, workflow dispatch, payroll
