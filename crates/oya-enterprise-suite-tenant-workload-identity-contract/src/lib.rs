...
//! must exist before FD-001 Enterprise Suite, HR, Payroll, and Accounting
...
const CONTRACT_NAME: &str = "fd001-enterprise-tenant-workload-identity-contract";
...
const SPIFFE_ID_PREFIX: &str = "spiffe://oyatie.dev/fd001-enterprise/";
...
const SOURCE_ADMISSION_POLICY_REF: &str = "crates/oya-enterprise-suite-tenant-admission-policy/src/lib.rs::fd001_tenant_admission_policy_contract";
const POLICY_REF_PREFIX: &str = "policy/workload-identity/fd001/";
const EXPECTED_EVIDENCE_REF: &str =
    "evidence/workload-identity/fd001-enterprise/workload-identity-review.jsonl";
...
fn workload_identity_requirements() -> Vec<Fd001TenantWorkloadIdentityRequirement> {
    vec![
        requirement(
            ...
            Fd001TenantWorkloadKind::EnterpriseSuite,
            Fd001TenantWorkloadIdentityRequirementKind::SpiffeIdRequired,
            "SpiffeId",
            "enterprise-suite-api",
            "spiffe-id",
...
fn spiffe_id(spiffe_suffix: &'static str) -> &'static str {
    match spiffe_suffix {
        "enterprise-suite-api" => "spiffe://oyatie.dev/fd001-enterprise/enterprise-suite-api",
        "hr-employment-api" => "spiffe://oyatie.dev/fd001-enterprise/hr-employment-api",
        "payroll-run-api" => "spiffe://oyatie.dev/fd001-enterprise/payroll-run-api",
        "accounting-journal-api" => "spiffe://oyatie.dev/fd001-enterprise/accounting-journal-api",
        "enterprise-suite-runtime" => {
            "spiffe://oyatie.dev/fd001-enterprise/enterprise-suite-runtime"
        }
        "hr-employment-runtime" => "spiffe://oyatie.dev/fd001-enterprise/hr-employment-runtime",
        "payroll-run-runtime" => "spiffe://oyatie.dev/fd001-enterprise/payroll-run-runtime",
        "accounting-journal-runtime" => {
            "spiffe://oyatie.dev/fd001-enterprise/accounting-journal-runtime"
        }
        "enterprise-suite-workload-api" => {
            "spiffe://oyatie.dev/fd001-enterprise/enterprise-suite-workload-api"
        }
        "hr-employment-workload-api" => {
            "spiffe://oyatie.dev/fd001-enterprise/hr-employment-workload-api"
        }
        "payroll-run-telemetry" => "spiffe://oyatie.dev/fd001-enterprise/payroll-run-telemetry",
        "accounting-journal-authz" => {
            "spiffe://oyatie.dev/fd001-enterprise/accounting-journal-authz"
        }
        "enterprise-suite-audit" => "spiffe://oyatie.dev/fd001-enterprise/enterprise-suite-audit",
        _ => "spiffe://oyatie.dev/fd001-enterprise/invalid",
    }
}
...
fn validate_requirement(
    ...
    validate_prefixed_ref(
        ...
        "evidence/workload-identity/fd001-enterprise/",
    ...
    validate_prefixed_ref(
        ...
        "crates/oya-enterprise-suite-tenant-admission-policy/",
