...
const CONTRACT_NAME: &str = "fd001-enterprise-tenant-resource-quota-contract";
...
const EXPECTED_EVIDENCE_REF: &str =
    "evidence/resource-quota/fd001-enterprise/resource-quota-contract-review.jsonl";
...
fn validate_requirement(
    ...
    validate_prefixed_ref(
        ...
        "evidence/resource-quota/fd001-enterprise/",
