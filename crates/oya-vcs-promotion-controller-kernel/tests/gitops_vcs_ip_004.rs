...
use oya_vcs_changebundle_kernel::{
...
use oya_vcs_promotion_controller_kernel::{
...
use oya_vcs_test_standard_gate_kernel::{AdmissionDecision, FixupTask};
...
fn unhealthy_environment_and_admission_fixup_reject() {
    ...
    blocked.admission = AdmissionDecision {
        ...
        fixup_tasks: vec![FixupTask {
            ...
            reason: oya_vcs_test_standard_gate_kernel::FixupReason::MissingRequiredEvidence,
            tier: None,
            suite_id: None,
