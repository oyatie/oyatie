...
//!
//! - Crate `oya-vcs-provider-execution-gate-kernel` —
...
//! - Companion `oya-vcs-provider-execution-gate-app` —
        ...
        "provider_slots": [
            {
                ...
                "decision": "passed",
                "evidence_ref": "tools/oya-vcs-provider-execution-gate-app",
                "command": "cargo run -q -p oya-vcs-provider-execution-gate-app -- --mode check"
            },
            {
                "id": "github-actions",
