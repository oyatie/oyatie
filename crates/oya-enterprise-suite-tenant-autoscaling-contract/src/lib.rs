...
const CONTRACT_NAME: &str = "fd001-enterprise-tenant-autoscaling-contract";
...
const EXPECTED_EVIDENCE_REF: &str =
    "evidence/autoscaling/fd001-enterprise/autoscaling-contract-review.jsonl";
...
fn validate_requirement(
    ...
    validate_prefixed_ref(
        ...
        "evidence/autoscaling/fd001-enterprise/",
