...
const PUBLIC_ZONE_ID: &str = "oya:cloud:region-home:ten_kr:dns-zone:example-com";
const PRIVATE_ZONE_ID: &str = "oya:cloud:region-home:ten_kr:dns-zone:internal-example";
...
fn public_zone_body(resource_id: &str) -> CloudNetworkDnsZoneCreateRequest {
    CloudNetworkDnsZoneCreateRequest {
        ...
        vpc_id: None,
        dnssec_key_ref: Some("dnssec/region-home/ten_kr/example-com".to_string()),
...
fn dns_zone_create_api_creates_public_zone_once_and_replays_same_idempotent_result() {
    ...
    assert_eq!(
        ...
        Some("dnssec/region-home/ten_kr/example-com".to_string())
    );
...
fn dns_zone_create_api_rejects_path_body_zone_drift_before_catalog_mutation() {
    ...
    request.body.resource_id = "oya:cloud:region-home:ten_kr:dns-zone:other".to_string();
    ...
    assert_eq!(
        ...
        CloudNetworkDnsApiError::ZoneIdMismatch {
            path_zone_id: PUBLIC_ZONE_ID.to_string(),
            body_resource_id: "oya:cloud:region-home:ten_kr:dns-zone:other".to_string(),
        }
    );
