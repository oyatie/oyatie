...
mod tests {
    ...
    fn registers_region_az_cell_and_produces_platform_cell_binding() {
        ...
        assert_eq!(binding.tenant_id, "ten_kr");
        assert_eq!(binding.region, "kr-seoul");
        assert_eq!(binding.az.value, "kr-seoul-a");
        assert_eq!(binding.cell_id.value, "cell-kr-seoul-a-001");
    ...
    fn rejects_cell_id_that_does_not_match_az_namespace() {
        let error = CloudCell::new(CloudCellCreate {
            id: "cell-kr-seoul-b-001".to_string(),
            ..cell_create()
        })
    ...
    fn rejects_cell_when_residency_is_not_allowed_in_region() {
        let error = CloudCell::new(CloudCellCreate {
            ...
            az_code: "us-virginia-a".to_string(),
            id: "cell-us-virginia-a-001".to_string(),
            hsm_partition_ref: "hsm/us-virginia/cell-us-virginia-a-001".to_string(),
            ..cell_create()
        })
        .expect_err("strict KR residency cannot be advertised in a US region");
    ...
    fn route_denies_residency_class_not_allowed_by_cell() {
        ...
        let error = catalog
            ...
            .expect_err("cell does not advertise global residency");
    ...
    fn direct_cell_binding_revalidates_residency_against_cell_manifest() {
        let catalog = catalog_with_cell();
        let cell_id = CellId::new("cell-kr-seoul-a-001").expect("fixture cell id is valid");
