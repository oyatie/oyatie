...
mod tests {
    ...
    fn region_create() -> CloudRegionCreate {
        CloudRegionCreate {
            ...
            regulatory_packs: vec!["oya-pack-core".to_string()],
    ...
    fn az_create() -> CloudAzCreate {
        CloudAzCreate {
            ...
            physical_ref: "dc/alpha-region/a".to_string(),
    ...
    fn cell_create() -> CloudCellCreate {
        CloudCellCreate {
            ...
            hsm_partition_ref: format!("hsm/{REGION}/{CELL}"),
    ...
    fn registers_region_az_cell_and_produces_platform_cell_binding() {
        ...
        let binding = catalog
            .bind_route_for_tenant(
                ...
                TenantCellRouteRequest {
                    ...
                    home_region_code: REGION.to_string(),
        ...
        assert_eq!(binding.tenant_id, TENANT);
        assert_eq!(binding.region, REGION);
        assert_eq!(binding.az.value, AZ);
        assert_eq!(binding.cell_id.value, CELL);
    ...
    fn rejects_cell_id_that_does_not_match_az_namespace() {
        let error = CloudCell::new(CloudCellCreate {
            id: "cell-alpha-region-b-001".to_string(),
            ..cell_create()
        })
    ...
    fn rejects_cell_when_residency_is_not_allowed_in_region() {
        let error = CloudCell::new(CloudCellCreate {
            allowed_residency: vec![pack_residency()],
            region_code: "beta-region".to_string(),
            az_code: "beta-region-a".to_string(),
            id: "cell-beta-region-a-001".to_string(),
            hsm_partition_ref: "hsm/beta-region/cell-beta-region-a-001".to_string(),
            ..cell_create()
        })
        .expect_err("pack residency cannot be advertised outside its allowed region");
    ...
    fn route_denies_residency_class_not_allowed_by_cell() {
        ...
        let error = catalog
            .route_for_tenant(TenantCellRouteRequest {
                ...
                home_region_code: REGION.to_string(),
                residency_class: pack_residency(),
    ...
    fn direct_cell_binding_revalidates_residency_against_cell_manifest() {
        let catalog = catalog_with_cell();
        let cell_id = CellId::new(CELL).expect("fixture cell id is valid");
