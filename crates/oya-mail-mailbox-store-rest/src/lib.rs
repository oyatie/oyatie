...
use oya_mail_mailbox_store_app::{MailAppError, MailSubmissionPlan, plan_submit_message};
use oya_mail_mailbox_store_usecase::{MailUsecaseError, submit_message};
...
mod tests {
    ...
    fn openapi_route_catalog_covers_declared_operations() {
        assert_eq!(OPENAPI_ROUTES.len(), 15);
        assert_eq!(
