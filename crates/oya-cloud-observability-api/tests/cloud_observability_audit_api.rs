...
const CELL: &str = "cell-home-region-a-001";
const SIGNED_EXPORT: &str = "s3+signed://home-region/ten_alpha/audit?sig=abc123";
const RESOURCE_ID: &str = "oya:cloud:home-region:ten_alpha:instance:vm-a";
...
fn audit_read_api_maps_kernel_read_window_cursor_and_topic_scope_errors() {
    ...
    bad_cursor.body.cursor = Some("cur/ten_other/home-region/1000/0".to_string());
