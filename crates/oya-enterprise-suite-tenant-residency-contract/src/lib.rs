...
const CONTRACT_NAME: &str = "fd001-enterprise-tenant-residency-contract";
...
const EXPECTED_EVIDENCE_REF: &str =
    "evidence/residency/fd001-enterprise/residency-contract-review.jsonl";
...
fn validate_requirement(
    ...
    validate_prefixed_ref(
        ...
        "evidence/residency/fd001-enterprise/",
