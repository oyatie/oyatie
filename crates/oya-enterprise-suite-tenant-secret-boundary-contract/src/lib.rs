...
//! exist before FD-001 Enterprise Suite, HR, Payroll, and Accounting workloads
...
const CONTRACT_NAME: &str = "fd001-enterprise-tenant-secret-boundary-contract";
...
const BOUNDARY_REF: &str = "secret-boundary/fd001-enterprise/all-manifest-workloads";
const POLICY_REF_PREFIX: &str = "policy/secret-boundary/fd001/";
const EVIDENCE_REF: &str = "evidence/secret-boundary/fd001-enterprise/secret-boundary-review.jsonl";
...
fn validate_requirement(
    ...
    validate_prefixed_ref(
        ...
        "secret-boundary/fd001-enterprise/",
    ...
    validate_prefixed_ref(
        ...
        "evidence/secret-boundary/fd001-enterprise/",
