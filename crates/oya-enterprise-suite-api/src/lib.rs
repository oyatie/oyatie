//! Enterprise Suite API DTO contract layer.
//!
//! Serializable request shapes convert into Enterprise Suite domain/app inputs
...
use oya_enterprise_suite_app::{EnterpriseOpsCommandInput, EnterpriseOpsRoute, OpsCommandKind};
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct ChildWriteAdmissionRequest {
    pub child_product: EnterpriseChildProductDto, // data_class: INTERNAL_ONLY
    pub write_kind: SuiteWriteKindDto,            // data_class: INTERNAL_ONLY
...
impl ChildWriteAdmissionRequest {
    pub fn into_domain(self) -> ChildWriteInput {
        ChildWriteInput {
            child_product: self.child_product.into(),
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct CrossProductWorkflowPlanRequest {
    pub tenant_id: String,                      // data_class: INTERNAL_ONLY
    ...
    pub child_products: Vec<EnterpriseChildProductDto>, // data_class: INTERNAL_ONLY
...
impl CrossProductWorkflowPlanRequest {
    pub fn into_domain(self) -> CrossProductWorkflowInput {
        CrossProductWorkflowInput {
            ...
            child_products: self
                .child_products
                .into_iter()
                .map(EnterpriseChildProductDto::into)
                .collect(),
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct EnterpriseOpsCommandRequest {
    pub tenant_id: String,               // data_class: INTERNAL_ONLY
    pub route: EnterpriseOpsRouteDto,    // data_class: INTERNAL_ONLY
...
impl EnterpriseOpsCommandRequest {
    pub fn into_app(self) -> EnterpriseOpsCommandInput {
...
pub enum EnterpriseChildProductDto {
    Hr,
    Payroll,
    Accounting,
}

impl From<EnterpriseChildProductDto> for EnterpriseChildProduct {
    fn from(value: EnterpriseChildProductDto) -> Self {
        match value {
            EnterpriseChildProductDto::Hr => Self::Hr,
            EnterpriseChildProductDto::Payroll => Self::Payroll,
            EnterpriseChildProductDto::Accounting => Self::Accounting,
        }
    }
}
...
#[derive(Clone, Copy, Debug, Eq, PartialEq, Serialize, Deserialize)]
#[serde(rename_all = "SCREAMING_SNAKE_CASE")]
pub enum SuiteWriteKindDto {
    HrLifecycle,
    PayrollClose,
    AccountingJournal,
}

impl From<SuiteWriteKindDto> for SuiteWriteKind {
    fn from(value: SuiteWriteKindDto) -> Self {
        match value {
            SuiteWriteKindDto::HrLifecycle => Self::HrLifecycle,
            SuiteWriteKindDto::PayrollClose => Self::PayrollClose,
            SuiteWriteKindDto::AccountingJournal => Self::AccountingJournal,
        }
    }
}
...
impl From<WorkflowRoutingOwnerDto> for WorkflowRoutingOwner {
    fn from(value: WorkflowRoutingOwnerDto) -> Self {
        match value {
            ...
            WorkflowRoutingOwnerDto::ChildServiceHr => {
                Self::ChildService(EnterpriseChildProduct::Hr)
            }
            WorkflowRoutingOwnerDto::ChildServicePayroll => {
                Self::ChildService(EnterpriseChildProduct::Payroll)
            }
            WorkflowRoutingOwnerDto::ChildServiceAccounting => {
                Self::ChildService(EnterpriseChildProduct::Accounting)
            }
...
impl From<ObjectGraphRelationshipOwnerDto> for ObjectGraphRelationshipOwner {
    fn from(value: ObjectGraphRelationshipOwnerDto) -> Self {
        match value {
            ...
            ObjectGraphRelationshipOwnerDto::ChildServiceHr => {
                Self::ChildService(EnterpriseChildProduct::Hr)
            }
            ObjectGraphRelationshipOwnerDto::ChildServicePayroll => {
                Self::ChildService(EnterpriseChildProduct::Payroll)
            }
            ObjectGraphRelationshipOwnerDto::ChildServiceAccounting => {
                Self::ChildService(EnterpriseChildProduct::Accounting)
            }
...
#[derive(Clone, Copy, Debug, Eq, PartialEq, Serialize, Deserialize)]
#[serde(rename_all = "SCREAMING_SNAKE_CASE")]
pub enum EnterpriseOpsRouteDto {
    MakefileTarget,
    OyaOps,
    OpsConsole,
    ManualSsh,
...
impl From<EnterpriseOpsRouteDto> for EnterpriseOpsRoute {
    fn from(value: EnterpriseOpsRouteDto) -> Self {
        match value {
            EnterpriseOpsRouteDto::MakefileTarget => Self::MakefileTarget,
            EnterpriseOpsRouteDto::OyaOps => Self::OyaOps,
            EnterpriseOpsRouteDto::OpsConsole => Self::OpsConsole,
            EnterpriseOpsRouteDto::ManualSsh => Self::ManualSsh,
        }
    }
}
