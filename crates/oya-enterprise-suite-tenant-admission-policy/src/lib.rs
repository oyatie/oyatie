...
//! future Oyatie Cloud substrate must enforce before FD-001 Enterprise Suite,
...
const CONTRACT_NAME: &str = "fd001-enterprise-tenant-admission-policy-contract";
...
fn admission_rules() -> Vec<Fd001TenantAdmissionRule> {
    vec![
        rule(
            "tenant-labels-required-enterprise-suite",
        ...
        rule(
            "digest-pinned-image-enterprise-suite",
            Fd001TenantWorkloadKind::EnterpriseSuite,
        ...
        rule(
            "latest-image-tag-forbidden-enterprise-suite",
            Fd001TenantWorkloadKind::EnterpriseSuite,
...
fn rule(
    ...
    Fd001TenantAdmissionRule {
        ...
        cel_expression_ref,
        expected_evidence_ref: "evidence/tenant-admission/fd001-enterprise/policy-review.jsonl",
        official_doc_url,
