...
const CONTRACT_NAME: &str = "fd001-enterprise-tenant-cost-allocation-contract";
...
const EXPECTED_EVIDENCE_REF: &str =
    "evidence/cost-allocation/fd001-enterprise/cost-allocation-contract-review.jsonl";
...
fn validate_requirement(
    ...
    validate_prefixed_ref(
        ...
        "evidence/cost-allocation/fd001-enterprise/",
