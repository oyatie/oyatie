...
fn foundation_projects_per_tenant_mcp_descriptor_without_cross_tenant_leakage() {
    ...
    assert_eq!(
        ...
        "https://mcp.foundry.home-region.oyatie.test/tenants/ten_mcp"
    );
    assert_eq!(
        descriptor
            .tools
    ...
    wrong_audience.audience =
        "https://mcp.foundry.failover-region.oyatie.test/tenants/ten_mcp".into();
    assert_eq!(
        foundation.discover_mcp_gateway(McpDiscoveryRequest {
            tenant_id: "ten_mcp".into(),
...
fn access_token(
    ...
    McpAccessTokenClaims {
        ...
        audience: "https://mcp.foundry.home-region.oyatie.test/tenants/ten_mcp".into(),
