...
fn tenant_endpoint_and_descriptor_project_mcp_tools_and_prompts() {
    ...
    assert_eq!(
        endpoint.url(),
        "https://mcp.foundry.kr-seoul.oyatie.test/tenants/ten_alpha"
    );
    assert_eq!(
        endpoint.protected_resource_metadata_uri(),
        "https://mcp.foundry.kr-seoul.oyatie.test/.well-known/oauth-protected-resource/tenants/ten_alpha"
    );
...
fn authorization_challenges_follow_mcp_oauth_resource_metadata_shape() {
    ...
    assert_eq!(
        ...
        r#"Bearer resource_metadata="https://mcp.foundry.kr-seoul.oyatie.test/.well-known/oauth-protected-resource/tenants/ten_alpha", scope="foundry.capability.discover""#
    );
