...
//! FD-001 Enterprise Suite, HR, Payroll, and Accounting images can be promoted
...
const CONTRACT_NAME: &str = "fd001-enterprise-tenant-image-provenance-contract";
...
const ARTIFACT_REF: &str = "oci-image/fd001-enterprise/all-manifest-workloads-sha256-digest";
const POLICY_REF_PREFIX: &str = "policy/supply-chain/fd001/";
const EVIDENCE_REF: &str = "evidence/supply-chain/fd001-enterprise/image-provenance.jsonl";
...
fn validate_requirement(
    ...
    validate_prefixed_ref(
        ...
        "evidence/supply-chain/fd001-enterprise/",
