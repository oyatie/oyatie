...
//! before FD-001 Enterprise Suite, HR, Payroll, and Accounting workloads can be
...
const CONTRACT_NAME: &str = "fd001-enterprise-tenant-availability-contract";
...
const EXPECTED_EVIDENCE_REF: &str =
    "evidence/availability/fd001-enterprise/availability-contract-review.jsonl";
...
fn validate_requirement(
    ...
    validate_prefixed_ref(
        ...
        "evidence/availability/fd001-enterprise/",
