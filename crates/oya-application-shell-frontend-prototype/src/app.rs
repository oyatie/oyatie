        ...
        <aside class="app-rail" aria-label="Product navigation">
            ...
            <section class="rail-proof-card" aria-label="FD-001 and Oyatie Cloud shell proof">
                ...
                <div class="rail-proof-actions" aria-label="Persistent shell proof routes">
                    <button type="button" class="is-selected" data-rail-proof-action="product-graph">"Product graph"</button>
            ...
            <a class="rail-nav active" href="#prototype-shell"><span aria-hidden="true">"⌂"</span>"Command center"</a>
            ...
            <a class="rail-nav" href="#identity-workforce-suite"><span aria-hidden="true">"⚿"</span>"Auth · Org"</a>
    ...
    view! {
        <header class="app-header" role="banner">
            ...
            <div class="header-route-strip" aria-label="FD-001 and Oyatie Cloud quick routes">
                <button type="button" class="is-selected" data-header-route="fd001"><span>"FD-001"</span>"Product graph"</button>
            ...
            <div class="hero-side">
                <div class="hero-copy page-actions">
                    <button
                        ...
                        data-sidepeek-owner="Current prototype user"
    ...
    view! {
        ...
        >
            ...
            <div class="settings-person-card">
                ...
                <div><strong>"최유나 · Choi Yu-na"</strong><p>"Tenant admin · Finance owner · PIPA-safe prototype"</p></div>
            </div>
            ...
            <article class="settings-panel" data-settings-panel="integrations">
                <ol class="integration-list">
                    <li><strong>"Shinhan Bank"</strong><span class="status-chip success">"verified"</span><small>"Bank transport mock; no money movement."</small></li>
    ...
    view! {
        ...
        >
            ...
            <div class="side-peek-body">
                ...
                <dl class="peek-kv">
                    <div><dt>"Owner"</dt><dd data-sidepeek-owner-target="true">"Platform operations"</dd></div>
                    ...
                    <div><dt>"Execution"</dt><dd>"Prototype visual-only"</dd></div>
                </dl>
...
fn dashboard_view(
    ...
    view! {
        ...
        {enterprise_suite_board(envelope.clone())}

        {identity_workforce_suite()}

        {finance_commercial_suite()}
            ...
            <section id="service-catalog" class="panel modules-panel catalog-workbench" aria-labelledby="modules-title">
                <div class="panel-header catalog-header">
                    <div>
                        ...
                        <h3 id="modules-title">"Permitted product graph"</h3>
                    </div>
...
const COMMAND_SHELL_ROUTES: [(&str, &str, &str, &str); 8] = [
    ("fd001", "FD-001", "Product graph", "#service-catalog"),
    (
        "daily",
        "Action Inbox",
        "Priority work",
    ...
    (
        ...
        "Finance",
        "Close + ledger",
        "#finance-commercial-suite",
    ),
    (
        "identity",
        "Identity",
        "Org + access",
        "#identity-workforce-suite",
    ),
                        ...
                        view! {
                            ...
                            >
                                ...
                                <button
                                    ...
                                    data-sidepeek-sla="4.0h target · local mock"
                                >
                                    <strong>{title}</strong>
                                    <p>{detail}</p>
                                </button>
...
fn enterprise_suite_board(envelope: TenantRenderEnvelope) -> impl IntoView {
    view! {
        <section
            class="enterprise-suite-board"
            aria-labelledby="suite-board-title"
            id="business-logics"
        >
            <div class="suite-board-head">
                <div>
                    <p class="screen-anchor">"COHESIVE PRODUCT SUITE"</p>
                    <h3 id="suite-board-title">"Corporate operations graph"</h3>
                </div>
                <span class="status-chip success">{format!("{} permitted modules", envelope.modules.len())}</span>
            </div>

            {business_logic_os_panel()}
            {governance_ops_command_board(envelope.workflow.name.clone())}

            <article id="payroll-cockpit" class="suite-card payroll-card">
                <p class="screen-anchor">"PAYROLL CLOSE"</p>
                <h4>"2026-04 payroll close"</h4>
                <p class="suite-card-brief">"FD-001 payroll workload dogfooded on Oyatie Cloud with workflow, Mail, and evidence return paths."</p>
                <div class="suite-metric-row">
                ...
                <div class="suite-card-actions">
                    <button type="button" data-suite-action="payroll-finance">"Finance cockpit"</button>
                    <button type="button" data-suite-action="payroll-workflow">"Workflow gate"</button>
                    <button type="button" data-suite-action="payroll-mail">"Mail brief"</button>
                    <button type="button" data-suite-action="payroll-evidence">"Evidence"</button>
                </div>
            </article>

            <article id="filing-readiness" class="suite-card filing-card">
                <p class="screen-anchor">"FILING READINESS"</p>
                <h4>"Withholding return"</h4>
                <p class="suite-card-brief">"Korea localization workload joins the same substrate proof loop: reviewer attestation, transport, and receipt."</p>
                ...
                <div class="suite-card-actions">
                    <button type="button" data-sidepeek-trigger="filing" data-sidepeek-title="Withholding return" data-sidepeek-id="FILE-KR-2026-04" data-sidepeek-desc="Filing readiness is staged locally and never submitted from this mock." data-sidepeek-owner="Finance close" data-sidepeek-risk="2 review" data-sidepeek-sla="Due 2026-05-10">"Inspect"</button>
                    <button type="button" data-suite-action="filing-billing">"Billing · tax"</button>
                    <button type="button" data-suite-action="filing-community">"Council note"</button>
                    <button type="button" data-suite-action="filing-evidence">"Receipt"</button>
                </div>
                {filing_readiness_anchor_board()}
            </article>

            <article id="employee-directory" class="suite-card employee-card">
                <p class="screen-anchor">"EMPLOYEES"</p>
                <h4>"Employee directory"</h4>
                <p class="suite-card-brief">"Identity and workforce data remain role-visible while FD-001 tenant workloads prove policy envelopes."</p>
                <div class="suite-people-stats">
                ...
                <table class="employee-mini-table">
                    ...
                    <tbody>
                        ...
                        <tr><td>"박서준 Seojun Park"</td><td>"VP Engineering"</td><td>"Platform"</td><td>"활성"</td></tr>
                        <tr><td>"김지영 Jiyoung Kim"</td><td>"Manager"</td><td>"Platform"</td><td>"수습"</td></tr>
                    </tbody>
                </table>
                <div class="suite-card-actions">
                    <button type="button" data-suite-action="employee-identity">"Identity suite"</button>
                    <button type="button" data-suite-action="employee-onboarding">"Onboarding"</button>
                    <button type="button" data-suite-action="employee-policy">"Policy"</button>
                    <button type="button" data-suite-action="employee-mail">"Mail reviewer"</button>
                </div>
            </article>

            <article id="governance-analytics-summary" class="suite-card governance-card">
                <p class="screen-anchor">"GOVERNANCE ANALYTICS"</p>
                <h4>"Policy, receipts, workflow health"</h4>
                <p class="suite-card-brief">"Executive posture rolls FD-001 workload proof, cloud cell evidence, and built-in surface routes into one council view."</p>
                <div class="suite-graph" aria-hidden="true">
                ...
                <div class="suite-card-actions">
                    <button type="button" data-suite-action="governance-command">"Command board"</button>
                    <button type="button" data-suite-action="governance-risk">"Risk heatmap"</button>
                    <button type="button" data-suite-action="governance-community">"Community"</button>
                    <button type="button" data-suite-action="governance-evidence">"Evidence"</button>
                </div>
            </article>
        </section>
    }
        ...
        <div class="trust-anchor-board filing-trust-board" aria-label="FD-001 filing readiness and Oyatie Cloud localization proof">
            <div class="trust-anchor-grid">
                <article class="trust-anchor-card selected" data-trust-proof-card="filing-fd001">
                    ...
                    <h5>"Korea filing is product delivery, not a side widget"</h5>
                    <p>
    ...
    view! {
        <section class="business-logic-os" aria-label="Business logic operating system">
            <div class="logic-os-kpis" aria-label="Business logic summary">
                <article class="logic-os-kpi"><span>"Active logics"</span><strong>"17"</strong><small>"7 visible in prototype"</small></article>
...
fn identity_workforce_suite() -> impl IntoView {
    view! {
        <section
            id="identity-workforce-suite"
            class="identity-workforce-suite panel"
            data-identity-suite="true"
            aria-labelledby="identity-suite-title"
        >
            <div class="identity-suite-head">
                <div>
                    <p class="screen-anchor">"SETTINGS · WORKFORCE"</p>
                    <h3 id="identity-suite-title">"Identity, organization profile, onboarding, and employees"</h3>
                </div>
                <div class="identity-suite-actions">
            ...
            <div class="identity-suite-shell">
                ...
                <div class="identity-suite-main">
                    <div class="identity-tabs" role="tablist" aria-label="Identity suite views">
                    ...
                    <article id="identity-employees" class="identity-panel" data-identity-panel="employees" aria-labelledby="employees-panel-title">
                        ...
                        <div class="employee-directory-tools">
                            ...
                            <div class="employee-filter-pills" aria-label="Employee filters">
                                ...
                                <button type="button" data-employee-filter="platform">"플랫폼팀"</button>
                        ...
                        <table class="employee-directory-table">
                            ...
                            <tbody>
                                ...
                                <tr data-employee-row="true" data-employee-team="platform"><td><strong>"박서준"</strong><small>"Seojun Park · emp_0001"</small></td><td>"VP of Engineering"</td><td>"플랫폼팀"</td><td>"이재현"</td><td>"2021-06-01"</td><td><span class="status-chip success">"활성"</span></td><td><button type="button" data-employee-action="inspect">"Inspect"</button></td></tr>
                                <tr data-employee-row="true" data-employee-team="platform"><td><strong>"김지영"</strong><small>"Jiyoung Kim · emp_0002"</small></td><td>"Engineering Manager"</td><td>"플랫폼팀"</td><td>"박서준"</td><td>"2022-09-12"</td><td><span class="status-chip success">"활성"</span></td><td><button type="button" data-employee-action="inspect">"Inspect"</button></td></tr>
                                <tr data-employee-row="true" data-employee-team="platform"><td><strong>"윤태민"</strong><small>"Taemin Yoon · emp_0003"</small></td><td>"Senior Software Engineer"</td><td>"플랫폼팀"</td><td>"김지영"</td><td>"2026-05-12"</td><td><span class="status-chip warning">"수습"</span></td><td><button type="button" data-employee-action="inspect">"Inspect"</button></td></tr>
        ...
        <div class="identity-command-board" aria-label="Identity command center">
            ...
            <section class="identity-command-card identity-route-card">
                <div class="identity-command-card-head">
                    <div>
                        <p class="screen-anchor">"ROUTE MATRIX"</p>
                        <h5>"Every identity action lands inside the same product"</h5>
                    </div>
                </div>
...
fn finance_commercial_suite() -> impl IntoView {
    view! {
        <section
            id="finance-commercial-suite"
            class="finance-commercial-suite panel"
            data-finance-suite="true"
            aria-labelledby="finance-suite-title"
        >
            <div class="finance-suite-head">
                <div>
                    <p class="screen-anchor">"MONEY · COMMERCIAL OPERATIONS"</p>
                    <h3 id="finance-suite-title">"Finance, ledger, vendor spend, billing, and leave-time"</h3>
                </div>
                <div class="finance-suite-actions">
            ...
            <div class="finance-suite-shell">
                ...
                <div class="finance-suite-main">
                    <div class="finance-tabs" role="tablist" aria-label="Finance suite views">
                    ...
                    <article id="vendors-spend" class="finance-panel" data-finance-panel="vendors" aria-labelledby="vendors-panel-title">
                        <div class="finance-panel-copy">
                            ...
                            <p>"Contracts, approvals, owners, and cost-of-delay are tied to the same object graph as workflow and mail."</p>
                        </div>
                    ...
                    <article id="billing-tax" class="finance-panel" data-finance-panel="billing" aria-labelledby="billing-panel-title">
                        ...
                        <div class="billing-grid">
                            <article><p class="screen-anchor">"REVENUE"</p><strong>"₩2.31B"</strong><span>"ARR mock · 42 active contracts"</span><button type="button" data-finance-action="send-invoice">"Stage invoice"</button></article>
    ...
    view! {
        <div class="finance-anchor-grid" aria-label="FD-001 leave time and Oyatie Cloud tenant proof">
            <article class="finance-anchor-card selected" data-finance-anchor-card="leave-fd001">
                ...
                <h5>"Leave and time feed payroll, schedule, and product delivery"</h5>
                <p>
        ...
        >
            <div class="evidence-console-head">
                <div>
                    ...
                    <p>
                        "Workflow, approvals, Messenger, Mail, Community, cloud operations, and audit receipts are shown as one cohesive local product graph."
                    </p>
                </div>
            ...
            <div class="evidence-kpi-strip" aria-label="Operational intelligence summary">
                ...
                <span><strong>{signal_count}</strong><small>"cross-suite signals"</small></span>
        ...
        <div class="trust-anchor-board" aria-label="FD-001 evidence ledger and Oyatie Cloud substrate proof">
            <div class="trust-anchor-grid">
                <article class="trust-anchor-card selected" data-trust-proof-card="ledger-fd001">
                    ...
                    <h5>"Product delivery remains the master-plan goal"</h5>
                    <p>
        ...
        <div class="trust-anchor-board" aria-label="FD-001 object graph and Oyatie Cloud substrate proof">
            <div class="trust-anchor-grid">
                <article class="trust-anchor-card selected" data-trust-proof-card="graph-fd001">
                    ...
                    <h5>"One product graph spans every surface"</h5>
                    <p>
        ...
        <section id="cloud-ops-cockpit" class="ops-cockpit panel" aria-labelledby="ops-cockpit-title">
            ...
            <div class="cockpit-panels">
                <article class="cockpit-panel active" data-cockpit-panel="topology" aria-labelledby="cloud-topology-title">
                    ...
                    <div class="cockpit-actions">
                        <button
                            ...
                            data-sidepeek-desc="Primary cell running compute, network, storage, and audit-chain mock surfaces."
                            data-sidepeek-owner="Cloud platform"
                            data-sidepeek-risk="Medium"
                            data-sidepeek-sla="99.95% target · local mock"
                        >
                            "Inspect cell"
                        </button>
                ...
                <article id="policy-access" class="cockpit-panel" data-cockpit-panel="policy" aria-labelledby="policy-access-title">
                    ...
                    <div class="policy-command-grid" aria-label="FD-001 and Oyatie Cloud policy proof">
                        <article class="policy-command-card selected" data-policy-card="fd001">
                            <div>
                                ...
                                <p>
                                    ...
                                    "Oyatie Cloud proves they can be hosted without moving the product north star."
                                </p>
                            </div>
                        ...
                        <article class="policy-command-card" data-policy-card="substrate">
                            <div>
                                ...
                                <p>
                                    "Cloud controls stay tenant-scoped, PIPA-aware, auditable, and local-only in this mock until "
                    ...
                    <table class="policy-table">
                        ...
                        <tbody>
                            ...
                            <tr><td>"Workflow builder"</td><td>"Execution"</td><td><span class="status-chip danger">"Deny"</span></td><td>"Prototype"</td></tr>
                        </tbody>
                    </table>
                    ...
                    <div class="policy-decision-strip" aria-label="Policy decision proof path">
                        ...
                        <article class="policy-decision-card" data-policy-card="deny">
                            ...
                            <p>"Prototype autonomy ceiling blocks real execution; visual routing proves the UX without wiring side effects."</p>
                ...
                <article id="finops-pane" class="cockpit-panel" data-cockpit-panel="finops" aria-labelledby="finops-title">
                    ...
                    {finops_anchor_board()}
                    <p class="cockpit-note">{format!("{visible_modules} modules visible in this envelope · backend wiring remains disabled")}</p>
                </article>
            </div>
        </section>
    }
    ...
    view! {
        ...
        >
            ...
            <div class="resource-console-spine" aria-label="Console summary">
                ...
                <span><strong>{visible_modules}</strong>" modules visible"</span>
            ...
            <div class="resource-toolbar" aria-label="Resource console controls">
                ...
                <div class="resource-actions">
                    <button type="button" data-resource-action="refresh">"Refresh mock"</button>
                                ...
                                <tr data-resource-row="true" data-resource-state=row.state>
                                    ...
                                    <td>
                                        <button
                                            ...
                                            data-sidepeek-sla="Inventory mock · no live mutation"
                                        >
                                            "Inspect"
                                        </button>
                                    </td>
...
fn resource_inventory_rows() -> [ResourceRow; 6] {
    [
        ...
        ResourceRow {
            ...
            description: "Event topic used by prototype receipts, evidence spine, and deployment gates.",
        },
    ]
}
...
fn deployment_gates() -> [DeploymentGate; 4] {
    [
        ...
        DeploymentGate {
            ...
            detail: "Deployment event payload shaped but not emitted in prototype.",
            state: "draft",
            progress: "48%",
        },
    ]
        ...
        <section class="daily-proof-board" aria-label="FD-001 daily execution and Oyatie Cloud tenant proof">
            <div class="daily-proof-grid">
                ...
                <article class="daily-proof-card" data-daily-proof-card="daily-cloud">
                    ...
                    <p>
                        "Oyatie Cloud proves the platform can host real production tenants by tying daily FD-001 work to cell health, policy envelopes, FinOps, and audit freshness."
                    </p>
                    <div class="daily-proof-actions">
                        <button type="button" data-daily-proof-action="route-cloud">"Cloud cells"</button>
...
fn communication_hub(
    ...
    view! {
        <div class="communications-hub interactive-hub">
            ...
            <div class="comms-suite-toolbar" aria-label="Communications workspace controls">
                <label>
                    <span aria-hidden="true">"⌕"</span>
                ...
                <span data-comms-status="true">"Local suite ready · no external send"</span>
            </div>

            <div class="hub-workspace comms-suite-shell">
...
fn service_catalog_panel(modules: Vec<ModuleCard>, omitted_note: String) -> impl IntoView {
    ...
    view! {
        <div class="catalog-kpi-strip" aria-label="Service catalog summary">
            ...
            <div class="catalog-kpi"><span>"Cross-suite routes"</span><strong>"7"</strong><small>"workflow → mail/community/ops"</small></div>
        </div>
        ...
        <div class="catalog-workspace">
            ...
            <aside id="product-graph" class="catalog-product-graph" aria-label="Product graph and module lineage">
                <div class="graph-head">
                    <p class="screen-anchor">"PRODUCT GRAPH"</p>
                ...
                <div class="catalog-graph-actions" aria-label="Product graph actions">
        ...
        <div class="trust-anchor-board catalog-trust-board" aria-label="FD-001 service catalog and Oyatie Cloud tenant workload proof">
            <div class="trust-anchor-grid">
                <article class="trust-anchor-card selected" data-trust-proof-card="catalog-fd001">
                    ...
                    <h5>"Catalog is the product graph manifest"</h5>
                    <p>
                ...
                <article class="trust-anchor-card" data-trust-proof-card="catalog-cloud">
                    ...
                    <p>
                        "Cloud cells, policy gates, resource inventory, deployment gates, FinOps, and audit receipts make hosting readiness explicit before product claims."
                    </p>
                    <div class="trust-anchor-actions">
        ...
        <div class="ontology-command-console" data-ontology-console="true">
            <div class="ontology-console-head">
                <div>
                    ...
                    <span>"Typed entities connect FD-001 product delivery to Oyatie Cloud cells, policy envelopes, workflow outputs, and evidence receipts."</span>
                </div>
            ...
            <div class="ontology-topology-grid" aria-label="FD-001 tenant workload ontology graph">
                ...
                <button type="button" class="ontology-node evidence" data-ontology-node="Evidence" data-node-route="evidence" data-sidepeek-trigger="ontology-node" data-sidepeek-title="Evidence spine" data-sidepeek-id="ONT-EVIDENCE" data-sidepeek-desc="Receipts bind workload state, approvals, messages, and deployment gates." data-sidepeek-owner="Audit spine" data-sidepeek-risk="Immutable mock" data-sidepeek-sla="Sealed draft"><span>"AUDIT"</span><strong>"Evidence spine"</strong><em>"proves"</em></button>
            ...
            <div class="ontology-proof-rail" aria-label="Substrate proof contract">
                <article><p class="screen-anchor">"SUBSTRATE PROOF"</p><strong>"FD-001 runs as tenant workloads before product claim"</strong><span>"Cloud cells, policy envelopes, and evidence receipts prove the platform can host real production tenants."</span></article>
...
fn static_hero_html() -> String {
    r#"<section class="hero-panel" aria-labelledby="prototype-title"><div class="hero-main"><div class="page-title-copy"><p class="screen-anchor">01 / Command Center</p><div class="hero-title-row"><h1 id="prototype-title">Operations · 2026 May, week 19</h1><span class="hero-lens-chip">● Lens: tenant admin · Finance · 1,000 ppl</span></div><p id="prototype-notice" class="demo-notice" role="note">이번 주 운영 현황 — 마감, 신고, 인적자원, 결재 대기 <span>This week — close, filings, people, approvals.</span></p></div><section class="hero-close-strip" aria-label="FD-001 close command proof"><div><p class="screen-anchor">FD-001 CLOSE COMMAND</p><strong>April close proves the product workload on Oyatie Cloud</strong><span data-hero-status="true">Ready · REC-CLOSE-2026-04 · cell-us-east-2 · local command only</span></div><div class="hero-close-actions" aria-label="Close package routes"><button type="button" data-hero-action="close-april">Stage close</button><button type="button" data-hero-action="route-ledger">Ledger</button><button type="button" data-hero-action="route-cloud">Cloud proof</button><button type="button" data-hero-action="route-evidence">Evidence</button></div></section><section class="render-architecture-strip" aria-label="SSR shell and selective WASM hydration model"><article class="selected" data-render-arch-card="ssr"><p class="screen-anchor">SSR SHELL</p><strong>Fast baseline, product graph visible first</strong><span>Navigation, proof copy, tenant posture, and core dashboards render before island hydration.</span><button type="button" class="is-selected" data-render-arch-action="ssr">Show shell</button></article><article data-render-arch-card="islands"><p class="screen-anchor">SELECTIVE WASM</p><strong>Only interactive product surfaces hydrate</strong><span>Workflow Studio, Work Hub, filters, canvas state, and local drafts become browser-only islands.</span><button type="button" data-render-arch-action="islands">Show islands</button></article><article data-render-arch-card="boundary"><p class="screen-anchor">LOCAL BOUNDARY</p><strong>Visually functional, deliberately unwired</strong><span data-render-arch-status="true">No workflow execution, external send, IAM, billing, deploy, or cloud mutation.</span><button type="button" data-render-arch-action="boundary">Show evidence</button></article></section></div><div class="hero-side"><div class="hero-copy page-actions"><button type="button" data-sidepeek-trigger="new-action" data-sidepeek-title="Create governed action" data-sidepeek-id="ACT-LOCAL-DRAFT" data-sidepeek-desc="Local visual-only action draft. Nothing is persisted or sent." data-sidepeek-owner="Current prototype user" data-sidepeek-risk="Draft" data-sidepeek-sla="No live SLA">New action</button><button type="button" data-command-trigger="true">Search ⌘K</button><button type="button" class="primary" data-hero-action="close-april">Close April →</button></div></div></section>"#
        .to_string()
}
...
fn static_command_palette_html() -> String {
    ...
    <section class="command-palette" role="dialog" aria-modal="true" aria-label="Command palette">
      ...
      <section class="command-proof-strip" aria-label="FD-001 command palette proof">
        ...
        <div class="command-proof-grid" aria-label="Command proof shortcuts"><button type="button" data-command-proof-action="fd001"><span>FD-001</span><strong>Product graph</strong></button><button type="button" data-command-proof-action="cloud"><span>Cloud</span><strong>Substrate cells</strong></button><button type="button" data-command-proof-action="receipt"><span>Receipt</span><strong>REC-WF-7741</strong></button></div>
      </section>
      <div class="command-results" role="listbox" aria-label="Local command routes">
        ...
        <button type="button" data-command-action="catalog"><strong>Open Service Catalog</strong><span>Inspect product graph, routes, owners, and module access</span><kbd>⌘S</kbd></button>
      ...
      <div class="command-palette-footer"><span>Local-only: commands route the visual mockup without backend, workflow, mail, IAM, billing, deploy, or cloud mutation.</span><button type="button" data-command-proof-action="local-boundary">Show boundary</button></div>
    </section>
  </div>"#
        .to_string()
}
...
fn static_utility_panels_html() -> String {
  ...
  <section class="utility-panel settings-center" data-utility-panel="settings" aria-label="Workspace settings" aria-hidden="true">
    ...
    <div class="settings-person-card"><span class="workspace-avatar" aria-hidden="true">최</span><div><strong>최유나 · Choi Yu-na</strong><p>Tenant admin · Finance owner · PIPA-safe prototype</p></div></div>
    ...
    <article class="settings-panel" data-settings-panel="integrations"><ol class="integration-list"><li><strong>Shinhan Bank</strong><span class="status-chip success">verified</span><small>Bank transport mock; no money movement.</small></li><li><strong>HomeTax</strong><span class="status-chip warning">review</span><small>Filing transport waits for human attestation.</small></li><li><strong>Google Workspace</strong><span class="status-chip">local</span><small>Mail and community previews only.</small></li></ol></article>
...
<section class="studio-grid" aria-label="Workflow, ontology, and intelligence">{workflow_studio}<section id="ontology-command-console" class="panel ontology-command-shell"><div class="panel-header"><p class="eyebrow">Ontology</p><h3 id="ontology-title">Tenant workload graph</h3></div>{ontology}</section><section id="intelligence-command-console" class="panel intelligence-command-shell"><div class="panel-header"><p class="eyebrow">Intelligence</p><h3 id="intelligence-title">Governed AI command</h3></div>{suggestions}</section></section>"#,
        ...
        enterprise_suite = static_enterprise_suite_board(envelope),
        identity_suite = static_identity_workforce_suite(),
        finance_suite = static_finance_commercial_suite(),
...
fn static_filing_readiness_anchor_board() -> &'static str {
    r#"<div class="trust-anchor-board filing-trust-board" aria-label="FD-001 filing readiness and Oyatie Cloud localization proof"><div class="trust-anchor-grid"><article class="trust-anchor-card selected" data-trust-proof-card="filing-fd001"><p class="screen-anchor">FD-001 LOCALIZATION WORKLOAD</p><h5>Korea filing is product delivery, not a side widget</h5><p>Withholding return, employee validation, HomeTax transport, billing, Mail, Community, and evidence receipts stay in the FD-001 tenant workload graph.</p><div class="trust-anchor-actions"><button type="button" data-trust-proof-action="stage-filing">Stage filing</button><button type="button" data-trust-proof-action="route-billing">Billing · tax</button></div></article><article class="trust-anchor-card" data-trust-proof-card="filing-cloud"><p class="screen-anchor">OYATIE CLOUD RESIDENCY</p><h5>Substrate proves regional pack posture</h5><p>Oyatie Cloud shows PIPA-aware residency, policy envelope, release gates, audit freshness, and rollback posture before any tax workload readiness claim.</p><div class="trust-anchor-actions"><button type="button" data-trust-proof-action="route-policy">PIPA policy</button><button type="button" data-trust-proof-action="route-cloud">Cloud cells</button></div></article><article class="trust-anchor-card" data-trust-proof-card="filing-local"><p class="screen-anchor">LOCAL-ONLY FILING RAIL</p><h5>Reviewer-ready, never submitted</h5><p>Operators can inspect readiness, stage a reviewer packet, and route council notes visually; no HomeTax, bank, payroll, billing, mail, or cloud mutation executes.</p><div class="trust-anchor-actions"><button type="button" data-trust-proof-action="route-mail">Reviewer Mail</button><button type="button" data-trust-proof-action="route-evidence">Receipt spine</button></div></article></div><div class="trust-anchor-footer"><span data-trust-proof-status="true">Filing readiness ready · FD-001 localization workload dogfoods Oyatie Cloud with local-only submission controls.</span><div class="trust-anchor-routes" aria-label="Filing readiness connected routes"><button type="button" data-trust-proof-action="route-finance">Finance close</button><button type="button" data-trust-proof-action="route-community">Community note</button><button type="button" data-trust-proof-action="route-audit">Audit ledger</button><button type="button" data-trust-proof-action="route-catalog">Catalog</button></div></div></div>"#
}

#[cfg(any(feature = "ssr", test))]
fn static_enterprise_suite_board(envelope: &TenantRenderEnvelope) -> String {
    format!(
        r#"<section class="enterprise-suite-board" aria-labelledby="suite-board-title" id="business-logics"><div class="suite-board-head"><div><p class="screen-anchor">COHESIVE PRODUCT SUITE</p><h3 id="suite-board-title">Corporate operations graph</h3></div><span class="status-chip success">{module_count} permitted modules</span></div>{business_logic_os}{governance_ops_command}<article id="payroll-cockpit" class="suite-card payroll-card"><p class="screen-anchor">PAYROLL CLOSE</p><h4>2026-04 payroll close</h4><p class="suite-card-brief">FD-001 payroll workload dogfooded on Oyatie Cloud with workflow, Mail, and evidence return paths.</p><div class="suite-metric-row"><span><strong>73%</strong><small>close progress</small></span><span><strong>5.4d</strong><small>cycle time</small></span><span><strong>₩2.18M</strong><small>cost of delay</small></span></div><ol class="suite-checklist"><li><span class="status-chip danger">blocking</span>4대보험 변동 확인 필요</li><li><span class="status-chip warning">review</span>Payroll reminder mail draft ready</li><li><span class="status-chip success">sealed</span>Receipt REC-PAY-2026-04 staged</li></ol><div class="suite-card-actions"><button type="button" data-suite-action="payroll-finance">Finance cockpit</button><button type="button" data-suite-action="payroll-workflow">Workflow gate</button><button type="button" data-suite-action="payroll-mail">Mail brief</button><button type="button" data-suite-action="payroll-evidence">Evidence</button></div></article><article id="filing-readiness" class="suite-card filing-card"><p class="screen-anchor">FILING READINESS</p><h4>Withholding return</h4><p class="suite-card-brief">Korea localization workload joins the same substrate proof loop: reviewer attestation, transport, and receipt.</p><div class="readiness-bars compact" aria-label="Filing readiness"><span style="--bar: 86%"><em>Employee validation</em></span><span style="--bar: 64%"><em>HomeTax transport</em></span><span style="--bar: 52%"><em>Reviewer attestation</em></span></div><div class="suite-card-actions"><button type="button" data-sidepeek-trigger="filing" data-sidepeek-title="Withholding return" data-sidepeek-id="FILE-KR-2026-04" data-sidepeek-desc="Filing readiness is staged locally and never submitted from this mock." data-sidepeek-owner="Finance close" data-sidepeek-risk="2 review" data-sidepeek-sla="Due 2026-05-10">Inspect</button><button type="button" data-suite-action="filing-billing">Billing · tax</button><button type="button" data-suite-action="filing-community">Council note</button><button type="button" data-suite-action="filing-evidence">Receipt</button></div>{filing_readiness_anchor_board}</article><article id="employee-directory" class="suite-card employee-card"><p class="screen-anchor">EMPLOYEES</p><h4>Employee directory</h4><p class="suite-card-brief">Identity and workforce data remain role-visible while FD-001 tenant workloads prove policy envelopes.</p><div class="suite-people-stats"><span><strong>118</strong><small>employees</small></span><span><strong>109</strong><small>active</small></span><span><strong>5</strong><small>probation watch</small></span></div><table class="employee-mini-table"><thead><tr><th>Name</th><th>Role</th><th>Team</th><th>Status</th></tr></thead><tbody><tr><td>이재현 Jaehyun Lee</td><td>CEO</td><td>Office</td><td>활성</td></tr><tr><td>최유나 Yuna Choi</td><td>CFO</td><td>Finance</td><td>활성</td></tr><tr><td>박서준 Seojun Park</td><td>VP Engineering</td><td>Platform</td><td>활성</td></tr><tr><td>김지영 Jiyoung Kim</td><td>Manager</td><td>Platform</td><td>수습</td></tr></tbody></table><div class="suite-card-actions"><button type="button" data-suite-action="employee-identity">Identity suite</button><button type="button" data-suite-action="employee-onboarding">Onboarding</button><button type="button" data-suite-action="employee-policy">Policy</button><button type="button" data-suite-action="employee-mail">Mail reviewer</button></div></article><article id="governance-analytics-summary" class="suite-card governance-card"><p class="screen-anchor">GOVERNANCE ANALYTICS</p><h4>Policy, receipts, workflow health</h4><p class="suite-card-brief">Executive posture rolls FD-001 workload proof, cloud cell evidence, and built-in surface routes into one council view.</p><div class="suite-graph" aria-hidden="true"><span style="--bar: 78%"></span><span style="--bar: 48%"></span><span style="--bar: 92%"></span><span style="--bar: 61%"></span><span style="--bar: 72%"></span></div><dl class="suite-kv"><div><dt>Risk</dt><dd>3 high-risk approvals</dd></div><div><dt>Evidence</dt><dd>12 sealed draft receipts</dd></div><div><dt>Workflow</dt><dd>{workflow}</dd></div></dl><div class="suite-card-actions"><button type="button" data-suite-action="governance-command">Command board</button><button type="button" data-suite-action="governance-risk">Risk heatmap</button><button type="button" data-suite-action="governance-community">Community</button><button type="button" data-suite-action="governance-evidence">Evidence</button></div></article></section>"#,
...
fn static_identity_command_board() -> &'static str {
  ...
  <section class="identity-command-card identity-route-card">
    <div class="identity-command-card-head"><div><p class="screen-anchor">ROUTE MATRIX</p><h5>Every identity action lands inside the same product</h5></div></div>
...
#[cfg(any(feature = "ssr", test))]
fn static_identity_workforce_suite() -> String {
    format!(
        r#"<section id="identity-workforce-suite" class="identity-workforce-suite panel" data-identity-suite="true" aria-labelledby="identity-suite-title">
  <div class="identity-suite-head">
    <div><p class="screen-anchor">SETTINGS · WORKFORCE</p><h3 id="identity-suite-title">Identity, organization profile, onboarding, and employees</h3></div>
    <div class="identity-suite-actions"><span class="status-chip success" data-identity-status="true">local profile ready</span><button type="button" data-identity-action="open-audit">Audit log</button></div>
  </div>
  <div class="identity-suite-shell">
    <aside class="identity-settings-rail" aria-label="Identity and organization sections">
    ...
    <aside class="identity-context-rail" aria-label="Identity provenance">
      <p class="screen-anchor">PROVENANCE</p><dl class="suite-kv"><div><dt>Actor</dt><dd>Choi Yu-na · Admin</dd></div><div><dt>Scope</dt><dd>Auth · org · people</dd></div><div><dt>Receipt</dt><dd>REC-ID-2026-05</dd></div></dl>
...
#[cfg(any(feature = "ssr", test))]
fn static_finance_commercial_suite() -> String {
    format!(
        r#"<section id="finance-commercial-suite" class="finance-commercial-suite panel" data-finance-suite="true" aria-labelledby="finance-suite-title">
  <div class="finance-suite-head">
    <div><p class="screen-anchor">MONEY · COMMERCIAL OPERATIONS</p><h3 id="finance-suite-title">Finance, ledger, vendor spend, billing, and leave-time</h3></div>
    <div class="finance-suite-actions"><span class="status-chip success" data-finance-status="true">close package ready</span><button type="button" data-finance-action="reconcile">Reconcile</button><button type="button" data-finance-action="export-pack">Export pack</button></div>
  </div>
  ...
  <div class="finance-suite-shell">
    ...
    <div class="finance-suite-main">
      <div class="finance-tabs" role="tablist" aria-label="Finance suite views"><button type="button" class="active" data-finance-tab="ledger" role="tab" aria-selected="true">Ledger</button><button type="button" data-finance-tab="vendors" role="tab" aria-selected="false">Vendors</button><button type="button" data-finance-tab="billing" role="tab" aria-selected="false">Billing</button><button type="button" data-finance-tab="leave" role="tab" aria-selected="false">Leave &amp; time</button></div>
      <article id="ledger-preview" class="finance-panel active" data-finance-panel="ledger" aria-labelledby="ledger-panel-title">
      ...
      <article id="vendors-spend" class="finance-panel" data-finance-panel="vendors" aria-labelledby="vendors-panel-title">
        <div class="finance-panel-copy"><p class="screen-anchor">PROCUREMENT · VENDORS</p><h4 id="vendors-panel-title">Vendors &amp; spend control</h4><p>Contracts, approvals, owners, and cost-of-delay are tied to the same object graph as workflow and mail.</p></div>
        ...
        <table class="finance-table vendor-table"><thead><tr><th>Vendor</th><th>Owner</th><th>Monthly</th><th>Renewal</th><th>Risk</th><th>Action</th></tr></thead><tbody><tr data-vendor-row="true"><td><strong>Stripe</strong><small>Payments · invoice INV-4281</small></td><td>Finance</td><td>₩4.82M</td><td>2026-05-31</td><td><span class="status-chip danger">High</span></td><td><button type="button" data-finance-action="approve-vendor">Review</button></td></tr><tr data-vendor-row="true"><td><strong>AWS Korea</strong><small>Cloud platform · reserved capacity</small></td><td>SRE</td><td>₩63.4M</td><td>2026-06-12</td><td><span class="status-chip warning">Medium</span></td><td><button type="button" data-finance-action="optimize-spend">Optimize</button></td></tr><tr data-vendor-row="true"><td><strong>Shinhan Bank</strong><small>Payroll and withholding transport</small></td><td>CFO</td><td>₩1.2M</td><td>2027-01-10</td><td><span class="status-chip success">Low</span></td><td><button type="button" data-sidepeek-trigger="bank-vendor" data-sidepeek-title="Shinhan Bank transport" data-sidepeek-id="VEN-SHINHAN" data-sidepeek-desc="Bank transport is staged visually and is not connected to a real payment rail." data-sidepeek-owner="CFO" data-sidepeek-risk="Low" data-sidepeek-sla="Mock only">Inspect</button></td></tr></tbody></table>
        {finance_vendors_anchor_board}
      </article>
      <article id="billing-tax" class="finance-panel" data-finance-panel="billing" aria-labelledby="billing-panel-title">
