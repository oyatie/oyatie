use oya_platform_object_graph_api::{
    upsert_object_graph_entity_from_api, ObjectGraphApiAuthorization,
    ObjectGraphApiBoundaryContext, ObjectGraphApiPrincipal, ObjectGraphEntityDirectory,
    ObjectGraphEntityPropertyRef, ObjectGraphEntityUpsertApiError,
