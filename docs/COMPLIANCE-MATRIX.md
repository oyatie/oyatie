...
> **Companion:** [`machine-readable/compliance.json`](machine-readable/compliance.json), [`PRIVACY-PROGRAM.md`](PRIVACY-PROGRAM.md), [`security-program.json`](security-program.json).
...
The single `oya-platform-regulatory-kernel` (per [DESIGN §12.2 seam](DESIGN.md)) drives the *implementation*; this matrix tracks the *evidence*.
...
|---|---|---|---|---|
| KR PIPA (개인정보보호법) | South Korea | `oya-pack-kr` | All | W-Foundation (cross-axis privacy posture) |
| KR KISA Security Assessment | South Korea | `oya-pack-kr` | SaaS, Cloud | W-Cloud-Preview |
| KR CSAP (Cloud Security Assurance Program) | South Korea | `oya-pack-kr` | Cloud | W-Cloud-Stable |
| KR K-ISMS-P | South Korea | `oya-pack-kr` | All commercial | W-Cloud-Preview |
| KR KCMVP (cryptographic module validation) | South Korea | `oya-pack-kr` | Cloud (KMS), Security | W-Cloud-Preview (HSM lead 6-9 mo) |
| KR MFDS (식품의약품안전처) | South Korea | `oya-pack-kr` | Healthcare | W-Vertical-Pilot (if healthcare) |
| KR FSC + 금감원 + 신용정보법 | South Korea | `oya-pack-kr` | Fintech | per fintech vertical wave |
| KR KCC + 정보통신망법 | South Korea | `oya-pack-kr` | All; ads heavy | per ads/comms wave |
| KR NIS | South Korea | `oya-pack-kr` | Defense (out of scope per anti-scope), Public-sector | per public-sector wave |
| KR 청소년보호법 | South Korea | `oya-pack-kr` | Education, ads, content | per education / ads wave |
| KR 의료법 + 의료광고심의 | South Korea | `oya-pack-kr` | Healthcare, ads-medical | W-Vertical-Pilot (healthcare) |
| KR 약사법 | South Korea | `oya-pack-kr` | Healthcare (pharma) | per healthcare wave |
| KR 망분리 | South Korea | `oya-pack-kr` | Cloud (network), Fintech, Public-sector | W-Cloud-Preview |
| KR 전자세금계산서 (NTS) | South Korea | `oya-pack-kr` | All (billing) | W-Cloud-Preview |
| KR 조달청 (Public Procurement) | South Korea | `oya-pack-kr` | Public-sector, Cloud GA | W-Cloud-Stable |
| JP APPI (個人情報保護法) | Japan | `oya-pack-jp` | All | W-Cloud-Preview |
| JP ISMAP (Information System Security Management & Assessment) | Japan | `oya-pack-jp` | Cloud (gov) | W-Cloud-Stable |
| JP PMDA | Japan | `oya-pack-jp` | Healthcare | per healthcare wave |
| JP JFSA | Japan | `oya-pack-jp` | Fintech | per fintech wave |
| JP マイナンバー法 | Japan | `oya-pack-jp` | SaaS (identity) | W-Cloud-Preview |
| JP 適格請求書 (e-invoicing) | Japan | `oya-pack-jp` | All (billing) | W-Cloud-Preview |
| US HIPAA + HITECH | United States | `oya-pack-us` | Healthcare | W-Vertical-Pilot (healthcare) |
| US PCI-DSS v4.0 | United States | `oya-pack-us` | Fintech, all card-touching | per fintech wave |
| US SOX | United States | `oya-pack-us` | All (public-co customers) | W-Cloud-Stable |
| US CCPA / CPRA | California | `oya-pack-us` (state overlay) | All US tenants | W-Cloud-Preview |
| US State AG (NY SHIELD, IL BIPA, TX TDPSA, …) | per state | `oya-pack-us` (state overlays) | All US tenants | per state |
| US FedRAMP (Moderate / High) | United States Federal | `oya-pack-us-fed` (subset of `oya-pack-us`) | Cloud (gov) | W-Cloud-Stable |
| US OCC + FFIEC | United States | `oya-pack-us` | Fintech | per fintech wave |
| US FDA (21 CFR Part 11 + 820 + SaMD) | United States | `oya-pack-us` | Healthcare devices | per healthcare wave |
| US 42 CFR Part 2 (substance use) | United States | `oya-pack-us` | Healthcare | per healthcare wave |
| EU GDPR | European Union | `oya-pack-eu` | All EU tenants | W-Cloud-Preview |
| EU DORA | European Union | `oya-pack-eu` | Fintech | per fintech wave |
| EU AI Act | European Union | `oya-pack-eu` | All AI surfaces (Foundry esp.) | W-Foundry-Preview |
| EU GAIA-X | European Union | `oya-pack-eu` | Cloud | W-Cloud-Stable |
| EU EMA | European Union | `oya-pack-eu` | Healthcare devices | per healthcare wave |
| EU NIS2 | European Union | `oya-pack-eu` | Cloud, all | W-Cloud-Stable |
| EU eIDAS | European Union | `oya-pack-eu` | SaaS (identity) | W-Cloud-Preview |
| EU e-Invoicing (per country: DE / IT / FR / PL / ES / …) | European Union | `oya-pack-eu` (per-country overlays) | All (billing) | W-Cloud-Preview |
| EU DSA / DMA | European Union | `oya-pack-eu` | Ads, marketplace, search | W-Search-Preview / W-Ads-Preview |
| EU MiCA | European Union | `oya-pack-eu` | Fintech (crypto) | if applicable |
| IN DPDP Act (Digital Personal Data Protection) | India | `oya-pack-in` | All | per IN wave |
| IN MeitY empanelment | India | `oya-pack-in` | Cloud (gov) | per cloud wave |
| IN RBI | India | `oya-pack-in` | Fintech | per fintech wave |
| IN CDSCO | India | `oya-pack-in` | Healthcare | per healthcare wave |
| IN GST e-invoicing | India | `oya-pack-in` | All (billing) | per IN wave |
| BR LGPD | Brazil | `oya-pack-br` | All | per BR wave |
| BR ANS / ANVISA | Brazil | `oya-pack-br` | Healthcare | per healthcare wave |
| BR BACEN | Brazil | `oya-pack-br` | Fintech | per fintech wave |
| BR ICP-Brasil | Brazil | `oya-pack-br` | SaaS (identity) | per BR wave |
| BR NF-e (electronic invoice) | Brazil | `oya-pack-br` | All (billing) | per BR wave |
| KSA PDPL | Saudi Arabia | `oya-pack-ksa` | All | per KSA wave |
| KSA NDMO | Saudi Arabia | `oya-pack-ksa` | Cloud | per cloud wave |
| KSA SDAIA | Saudi Arabia | `oya-pack-ksa` | All AI | per Foundry wave |
| KSA SAMA | Saudi Arabia | `oya-pack-ksa` | Fintech | per fintech wave |
| KSA SFDA | Saudi Arabia | `oya-pack-ksa` | Healthcare | per healthcare wave |
| UAE TDRA / ADGM / DIFC | United Arab Emirates | `oya-pack-ae` | All (varies by zone) | per AE wave |
| UAE UAE-CB | United Arab Emirates | `oya-pack-ae` | Fintech | per fintech wave |
| UAE FATOORA (e-invoicing) | United Arab Emirates | `oya-pack-ae` | All (billing) | per AE wave |
| AU Privacy Act 1988 | Australia | `oya-pack-au` | All | per AU wave |
| AU IRAP | Australia | `oya-pack-au` | Cloud (gov) | per cloud wave |
| AU TGA | Australia | `oya-pack-au` | Healthcare | per healthcare wave |
| AU ASIC | Australia | `oya-pack-au` | Fintech | per fintech wave |
| SG PDPA | Singapore | `oya-pack-sg` | All | per SG wave |
| SG MAS | Singapore | `oya-pack-sg` | Fintech | per fintech wave |
| SG HSA | Singapore | `oya-pack-sg` | Healthcare | per healthcare wave |
| SG IMDA | Singapore | `oya-pack-sg` | Telecom, ads | per SG wave |
...
| 21 CFR Part 11 | Electronic records + signatures | `oya-vertical-healthcare-app-electronic-signature-*` | per-document |
...
1. **Defense / drone scope** (per rename agent's user-input #1) — keep out of compliance scope or open a `oya-pack-defense` separate vehicle?
2. **EU AI Act risk classification** per capability — who classifies (Foundry team or per-axis team)?
3. **Continuous control monitoring tool** — buy (Drata / Vanta / Secureframe) or build (`oya-trust-portal`)? Recommendation: build (consistent with in-house preference per [TOOLCHAIN.md §3](TOOLCHAIN.md)).
