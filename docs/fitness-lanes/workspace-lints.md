...
- kernel_crate: `oya-foundry-fitness-workspace-lints-kernel` — `MemberManifest { crate_id, inherits_lints }`, verdict `WorkspaceLintsFitnessReport { crates_checked }`.
- runner_path: `tools/oya-foundry-fitness-workspace-lints`
...
- ci_invocation: `cargo run -p oya-foundry-fitness-workspace-lints`
