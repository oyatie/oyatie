...
- enforces: STANDARD/doc-catalog; AGENTS.md fitness-lane `oya-foundry-fitness-doc-catalog`.
...
- runner_path: `tools/oya-foundry-fitness-doc-catalog`
...
- ci_invocation: `cargo run -p oya-foundry-fitness-doc-catalog`
