...
- kernel_crate: `oya-foundry-fitness-openapi-contract-binding-kernel` — `ApiContract { api_id, openapi_path, schema_crate, runtime_crate, schema_revision, runtime_revision }`, verdict `OpenApiContractBindingFitnessReport { apis_checked }`.
- runner_path: `tools/oya-foundry-fitness-openapi-contract-binding`
...
- ci_invocation: `cargo run -p oya-foundry-fitness-openapi-contract-binding`
