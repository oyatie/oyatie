...
- replacement: Foundry pipeline admission + projected-merge-state + conflict-kernel under M01-P18, with ADR-0116 retiring grit/rtk/icm/vox-era coordination surfaces.
- former_kernel_crate: `oya-governance-archive-orphan-kernel` — retired; removed from workspace members.
- former_runner_path: `tools/oya-governance-archive-orphan-app` — retired; removed from workspace members.
