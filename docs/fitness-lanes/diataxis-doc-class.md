...
- kernel_crate: `oya-foundry-fitness-diataxis-doc-class-kernel` — `ClassifiedDoc { path, declared_class, has_required_sections }`, verdict `DiataxisDocClassFitnessReport { docs_checked }`.
- runner_path: `tools/oya-foundry-fitness-diataxis-doc-class`
...
- ci_invocation: `cargo run -p oya-foundry-fitness-diataxis-doc-class`
