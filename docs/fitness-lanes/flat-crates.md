...
- enforces: STANDARD/flat-workspace; AGENTS.md fitness-lane `oya-foundry-fitness-flat-crates`.
- kernel_crate: `oya-foundry-fitness-flat-crates-kernel` — `CrateLocation { crate_id, manifest_path }`, verdict `FlatCratesFitnessReport { crates_checked }`.
- runner_path: `tools/oya-foundry-fitness-flat-crates`
...
- ci_invocation: `cargo run -p oya-foundry-fitness-flat-crates`
