...
- [ ] **IP6** Done-definition checklist (`docs/checklists/done-definition-checklist.md`) D1-D18 walked for merge readiness; D19 post-merge closeout owner/packet slot identified. *Lane:* per-row.
