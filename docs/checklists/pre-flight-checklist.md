...
- [ ] **P8** For cross-axis contract changes: apply cross-axis review label + notify consumer-axis teams. *Lane:* `oya-foundry-fitness-cross-axis-notify`. Use `docs/checklists/cross-axis-contract-change-checklist.md`.
...
- [ ] Design doc authored per `docs/templates/design-doc-template.md`; reviewers named. *Lane:* `oya-foundry-fitness-design-doc-shape` (advisory).
- [ ] IP authored per `docs/templates/implementation-plan-template.md`; grit-claim symbols enumerated (ADR-0054). *Lane:* `oya-foundry-fitness-plan-hierarchy`.
...
### migration
- [ ] Inventory ledger row drafted per `docs/checklists/inventory-update-checklist.md` (ADR-0052). *Lane:* `oya-foundry-fitness-inventory-tracker`.
...
### runbook
- [ ] Trigger / SLO impact / mitigation steps drafted from `docs/templates/runbook-template-v2.md`. *Lane:* `oya-foundry-fitness-runbook-index-resolves`.
- [ ] Drill scheduled (date). *(advisory)*

### ADR
- [ ] Next-free ADR slot identified by reading `docs/ADR-INDEX.md`. *(advisory)*
- [ ] ≥ 2 viable alternatives drafted per `docs/templates/adr-template-v2.md §Alternatives considered`. *Lane:* `oya-foundry-fitness-adr-shape`.
