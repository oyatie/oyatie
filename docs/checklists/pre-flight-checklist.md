...
- [ ] **P9** For hook / harness / CLI changes: run the relevant Buck2/Rust harness self-test first; do not add Node/npm/pnpm unless the lane has an explicit strict-TypeScript tooling exception.
