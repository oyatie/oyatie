...
- **Inputs read:** MASTERPLAN.md (`.omc/plans/`, 218 lines, 12-directive anchor), hyperscaler-best-practices (now at `docs/standards/hyperscaler-best-practices.md`), lts-versions-verified (now at `docs/standards/lts-versions-verified.md`).
...
1. **Node 20 EOL (Oct 2025)** — AGENTS.md still references Node 20; current LTS is 24 per `docs/standards/lts-versions-verified.md`. **Fix:** Update to Node 24; cite lts-versions-verified in AGENTS.md.

2. **Hyperscaler-best-practices adoption gaps** — Three top-rank gaps from `docs/standards/hyperscaler-best-practices.md` are undocumented: (a) build-artifact signing/SBOM/SLSA provenance (missing `oya-foundry-fitness-supply-chain` lane); (b) progressive-delivery rail (missing feature-flag substrate); (c) cargo-vet audit trail (missing from standards/code-style.md). **Fix:** Update TOOLCHAIN.md with supply-chain section; add cargo-vet + feature-flag details.
...
| docs/standards/code-style.md | STANDARD | unknown | No hyperscaler Principle 9 cite; cargo-vet + workspace-lints adoption missing | MED | Add "Rust workspace practices" section; cite hyperscaler-best-practices |
...
- `docs/standards/hyperscaler-best-practices.md` (387 lines; lifted 2026-05-12)
- `docs/standards/lts-versions-verified.md` (167 lines; lifted 2026-05-12)
...
**Hyperscaler-best-practices adoption gaps:** Three top-rank items from `docs/standards/hyperscaler-best-practices.md` are undocumented: build-artifact signing/SBOM/SLSA (missing `oya-foundry-fitness-supply-chain` lane); progressive-delivery rail (no feature-flag substrate); cargo-vet audit trail (missing from standards). Update TOOLCHAIN.md systematically.
