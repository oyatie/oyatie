...
Plugin starters are generated by the governed plugin authoring service/pipeline and verified by the same shared gate logic behind `oya-ci-required`; author-side generators do not create marketplace or production authority.
