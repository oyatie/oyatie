...
3. **OpenAPI is uniformly 3.2.0; AsyncAPI is uniformly 3.1.0; proto3 only.** Per `specs/canonical-primitives.json`. Any contract file at a different version is REVISE.
