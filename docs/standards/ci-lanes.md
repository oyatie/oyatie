...
| `oya-foundry-fitness-banned-primitives` | block banned primitive use inside fenced agent-instruction contracts unless a direct primitive has a documented genuine-need rationale | specs/master-plan-sequencing.json / F-FORBIDDEN-PRIMITIVES-CI-GUARD |
