...
| Foundry fitness functions | `oya-foundry-fitness-{license, data-class, cohesion, doc-catalog, slo-coverage, blast-radius, glossary, adr-citation, ...}` |
...
- License drift → `oya-foundry-fitness-license` (per ADR-0013)
- Data-class annotation gap → `oya-foundry-fitness-data-class` (per ADR-0008)
- Cross-axis contract drift → `oya-foundry-fitness-cohesion` (per ADR-0011)
- Brand residue (deprecated aliases or tautological brand transitions) → `oya-foundry-fitness-brand-residue` (per ADR-0017 / MFL-0011)
- Legacy ADR citation in active docs → `oya-foundry-fitness-adr-citation`
- Glossary term drift → `oya-foundry-fitness-glossary`
