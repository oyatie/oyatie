...
planned_enforcement_ref: governance-tool-map-cohesion
companion_docs:
  - docs/AGENTS.md
...
The lane `governance-tool-map-cohesion` validates that the
...
single protected `presubmit` context (ADR-0515). The reviewing
