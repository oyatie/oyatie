...
| [`hyperscaler-adoption-fitness.md`](hyperscaler-adoption-fitness.md) | Google/AWS/Azure-style fitness gate for methodology, reasoning, technology, operations, dependencies, vendored tools, and self-write/adopt decisions | `buck2 build //:repo-hygiene-automation-check` | Tier 2 |
