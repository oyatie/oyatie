...
| sbom-attestation | absorbed-by-pipeline | hyperscaler/SBOM | pipeline-supply-chain-audit | cloud/cloud-ci/gates/pipeline-supply-chain-audit-app | `buck2 test //cloud/cloud-ci/gates/pipeline-supply-chain-audit-app:pipeline-supply-chain-audit-app-gate` | 1500 | BLOCKER |
| cosign-signature | absorbed-by-pipeline | hyperscaler/Cosign | pipeline-supply-chain-audit | cloud/cloud-ci/gates/pipeline-supply-chain-audit-app | `buck2 test //cloud/cloud-ci/gates/pipeline-supply-chain-audit-app:pipeline-supply-chain-audit-app-gate` | 1800 | BLOCKER |
| slsa-provenance | absorbed-by-pipeline | hyperscaler/SLSA L2+ | pipeline-supply-chain-audit | cloud/cloud-ci/gates/pipeline-supply-chain-audit-app | `buck2 test //cloud/cloud-ci/gates/pipeline-supply-chain-audit-app:pipeline-supply-chain-audit-app-gate` | 1200 | BLOCKER |
| cargo-vet | retired-until-inputs | hyperscaler/cargo-vet | retired | retired | retired; no CI invocation; current dependency/advisory authority is `pipeline-supply-chain-audit` | 0 | retired |
