...
- current_authority: `pipeline-supply-chain-audit` — owned RustSec advisory scan over vendored mirror, wired into `presubmit`.
...
- ci_invocation: none while retired; reintroduction requires maintained input files plus a pipeline gate wired into `presubmit`.
