...
Verdict recorded via `icm store -t pr-review-verdicts` per [ADR-0053](../../decisions/ADR-0053-grit-icm-as-sanctioned-primitives.md); without the record, `oya-governance-pr-review-verdict-present` blocks promotion.
