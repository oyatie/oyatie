...
- **Foundry capability publish** with replay-affecting changes ([ADR-0024](../../decisions/ADR-0024-foundry-eval-harness-and-replay.md)).
...
- `oya-intelligence-shadow-diff-adapter-event` (NEW) — outbox-pattern event pair capture ([ADR-0005](../../decisions/ADR-0005-eventing-backbone-outbox-pattern.md)).
