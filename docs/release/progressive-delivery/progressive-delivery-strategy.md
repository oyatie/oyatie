...
| **Capability** (Foundry publish) | Canary + eval-set gate | Per [ADR-0024](../../decisions/ADR-0024-foundry-eval-harness-and-replay.md) | Stable cohort honoured | Flagger + capability-publish-kernel |
