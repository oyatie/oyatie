...
Per [COMPLIANCE-MATRIX](COMPLIANCE-MATRIX.md), every control has an evidence cadence tracked by planned advisory lane `oya-governance-control-monitoring`. Failures emit `EVT-CONTROL-EVIDENCE-MISSING` and trigger a runbook.
