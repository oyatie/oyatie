...
| R-011 | Korea-locale regulatory shift mid-build (PIPA / FSC / MFDS / KCC) | 4 | 3 | 3 | **36** | `docs/regional-packs/oya-pack-kr` + `ops-compliance` | Quarterly regulatory-change watch lane per ADR-0050; KR-pack maintainer engages with regulator-relations | KR regulator publication monitoring |
...
| R-014 | KCMVP HSM procurement lead-time (6-9 months) blocks KR cloud GA | 4 | 3 | 2 | **24** (~25) | `axis-cloud` + `docs/regional-packs/oya-pack-kr` | Order at month 0 of W-Cloud-Preview per recon; secondary supplier identified | HSM delivery tracking |
