...
| **Threat models per service** | `docs/security/threat-models/<service>.md` | `ops-security` + per-team | Hand-authored; references in [`security-program.json`](security-program.json) |
