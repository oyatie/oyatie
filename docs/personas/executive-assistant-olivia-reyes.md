...
| 13 | connect | ambient | Executive Assistant Olivia Reyes must preserve tenant scope, audit events, active-context UX, and pack overlays if this surface is reached. |
