...
| 13 | connector | ambient | AV Coordinator Jordan Park must preserve tenant scope, audit events, active-context UX, and pack overlays if this surface is reached. |
