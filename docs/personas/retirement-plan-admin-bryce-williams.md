...
| 13 | connector | ambient | Retirement Plan Admin Bryce Williams must preserve tenant scope, audit events, active-context UX, and pack overlays if this surface is reached. |
