...
| 13 | connector | ambient | Banker external Hideki Watanabe must preserve tenant scope, audit events, active-context UX, and pack overlays if this surface is reached. |
