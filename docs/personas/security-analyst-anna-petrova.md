...
| 13 | connector | ambient | Security Analyst Anna Petrova must preserve tenant scope, audit events, active-context UX, and pack overlays if this surface is reached. |
