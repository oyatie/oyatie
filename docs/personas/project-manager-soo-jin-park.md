...
| 13 | connector | ambient | Project Manager Soo-Jin Park must preserve tenant scope, audit events, active-context UX, and pack overlays if this surface is reached. |
