...
| C5 | `templates/foundry-supervisor/` (claude/codex/gemini.toml) | 3 | **DELETED** (hooks → missing `tools/foundry-supervisor-*`; no `intelligence-supervisor/` replacement) | 13 files | **DONE delete** (integ/docs) — do not recreate; hub/registry cites elevated |
