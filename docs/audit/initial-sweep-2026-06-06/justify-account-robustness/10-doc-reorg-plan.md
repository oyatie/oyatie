...
| `runbooks/` (207), `checklists/` (31), `release/` (28), `advanced-cicd/` (39), `operators/` (2), `customer-success/` (8) | **`how-to/`** | `HowTo` | `doc-style.md:50` "How-to … runbooks, `RUNBOOKS-INDEX.md` rows, `checklists/`"; `planning-ssot-consolidation.md:110` "how-to/ (runbooks)"; cap ≤300 |
