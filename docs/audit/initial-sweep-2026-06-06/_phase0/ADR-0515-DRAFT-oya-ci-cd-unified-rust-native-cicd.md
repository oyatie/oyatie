...
---
*Draft for founder review (door:one-way). Authority: D-CICD / D3 / D-LAYER / D-SCOPE-UNIFY / D-PURESPLIT / D-SEQUENCE / D-DOCTRINE. Design SSOT: `bespoke-ci-design-2026-06-06/40-PRODUCT-SPEC.md`. On sign-off → write to `source/docs/decisions/ADR-0515-oya-ci-cd-unified-rust-native-cicd.md` + write the reciprocal `superseded_by` edges on 0124/0349/0359/0361/0511/0513/0514 + amend 0408 refs, as the A-CI Phase-1 lane (gate-verified).*
