...
| `source/docs/decisions/ADR-0709-general-live-apex.md | 75 (full) | **Proposed.** Buck2 RBE + `cquery rdeps` affected-targets + cache-backed image builds; `supersedes:[ADR-0358]`; "complementary to 0359, NOT superseded." |
