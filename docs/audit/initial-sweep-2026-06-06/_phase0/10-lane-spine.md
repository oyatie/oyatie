...
|---|---|---|
| **Decision/spec source (canon)** | `docs/decisions/ADR-0363/0512/0513/0514…` (M), `specs/masterplan.json` (MM), `specs/master-plan-sequencing.json` (MM), `registry/quality/lanes.yaml` (MM) | **STAGE as base canon** — this is the corpus Phase-0 gates will police. Verify each diff is intended (separate verifier pass) before committing. |
