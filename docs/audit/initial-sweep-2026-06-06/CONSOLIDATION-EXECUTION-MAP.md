...
| 5 | `/Users/jasonlee/Developer/source/docs/decisions/ADR-0000…ADR-NNNN.md` (clean ADR series) | the SSOT decisions of record. Prose body stays as Obsidian-wikilink `body_ref` (§7); metadata+edges mirror into design-store | ADRs = SSOT; masterplan GENERATED from these |
