...
| `docs/decisions/ADR-0254-deployment-model-spectrum.md` | 30 |
...
| `docs/decisions/ADR-0257-ontology-object-type-versioning-deprecation-handshake.md` | 20 |
| `docs/products/foundry/PRD.md` | 14 |
| `specs/microservices/ontology.json` | 11 |
| `docs/decisions/ADR-0242-oyatie-is-a-tenant-doctrine.md` | 10 |
...
| `docs/decisions/ADR-0250-build-ahead-of-certification-doctrine.md` | 7 |
...
| `docs/decisions/ADR-0145-inter-microservice-communication-reform.md` | 5 |
| `docs/decisions/ADR-0356-amendment-library-first-ontology-read-path.md` | 5 |
| `specs/hyperscaler-architecture-invariants.json` | 5 |
| `ADR-INVENTORY.tsv` | 4 |
| `cloud/cell-lifecycle/IPs/IP-ADR-0341-Cellular-Promotion-Gates.md` | 4 |
| `docs/GLOSSARY.md` | 4 |
| `docs/decisions/ADR-0055-object-graph-renamed-to-ontology.md` | 4 |
| `docs/decisions/ADR-0122-ontology-crate-rename-from-object-graph.md` | 4 |
| `docs/decisions/ADR-0141-workflow-ontology-read-path-direct.md` | 4 |
...
| `docs/decisions/ADR-0130-deprecate-knowledge-graph-registry-file-migrate-to-ontology.md` | 3 |
| `docs/decisions/ADR-0142-crdt-portability-trait.md` | 3 |
| `docs/decisions/ADR-0276-backup-portability-format-gdpr-article-20.md` | 3 |
| `docs/decisions/ADR-0316-capability-tier-over-product-fragmentation.md` | 3 |
