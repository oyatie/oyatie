...
## Detection
- Source signal: ADR-0003 chain-integrity check exit code; `oya gate validate audit-chain-replay`; `oya-foundry-fitness-audit-emit` block; chain-replay drill anomaly
