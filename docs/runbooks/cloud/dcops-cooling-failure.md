# Oyatie Runbook — Datacenter Cooling Failure (post W-DC-Operations)

> **Status:** Stub (P0 must-have for W-Foundation gate per [`RUNBOOKS-INDEX.md`](../../RUNBOOKS-INDEX.md))
> **Owner:** `axis-cloud + dcim-team`
...
## Symptom
cooling system failure or thermal-runaway risk in an Oyatie-operated DC

## Detection
- Source signal: DCIM thermal dashboard; CRAC/CRAH alert; rack-inlet temperature exceedance
...
## Containment
Throttle/shutdown highest-thermal racks first; activate emergency cooling; preserve thermal logs

## Diagnosis
Identify failure: chiller, CRAC/CRAH, airflow blockage, or external (heat wave + condenser failure)

## Recovery
Restore cooling; verify thermal envelope recovers; emit EVT-DC-THERMAL-EVENT; schedule post-event review
