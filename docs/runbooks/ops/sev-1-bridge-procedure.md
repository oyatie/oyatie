...
## Symptom
any Sev-1 incident requires the bridge procedure

## Detection
- Source signal: any Sev-1 page
...
## Containment
Open #incident-bridge channel; spawn bridge call; assign incident commander + scribe + comms lead

## Diagnosis
Per-incident triage: identify scope, blast radius, regulator-reportable status; coordinate with affected teams

## Recovery
Per INCIDENT-MANAGEMENT.md lifecycle; emit per-stage status updates; close incident only after recovery + postmortem authored
