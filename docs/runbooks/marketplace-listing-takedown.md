...
> **Status:** Link-continuity page; the canonical SaaS operator procedure is [`docs/runbooks/saas/marketplace-listing-takedown.md`](saas/marketplace-listing-takedown.md).
> **Owner:** `axis-saas`
...
Use [`docs/runbooks/saas/marketplace-listing-takedown.md`](saas/marketplace-listing-takedown.md) for marketplace listing takedown and plugin/install state containment. This root path is retained for existing inbound links only and does not define a separate incident authority.
...
[`docs/runbooks/saas/marketplace-listing-takedown.md`](saas/marketplace-listing-takedown.md), [`docs/products/saas-platform/PRD.md`](../products/saas-platform/PRD.md), `specs/masterplan.json` M03-P04/M03-P08, and `HANDOFF.md`.
