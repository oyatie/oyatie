...
## Symptom
Cardholder Data Environment isolation violated; potential PCI-DSS scope creep

## Detection
- Source signal: CDE network-segmentation negative-test failure; CDE-traffic anomaly
...
## Containment
Quarantine CDE; freeze affected workloads; preserve network/audit evidence

## Diagnosis
Identify violation vector: network policy drift, IAM bind, or kernel bug

## Recovery
Restore CDE isolation; ship fitness lane that catches the regression; coordinate QSA notification per PCI-DSS v4 SLA
