...
- Added [`specs/cache-endpoints.json`](../specs/cache-endpoints.json) as the reviewed
  writer/reader address and REAPI instance reference that the hand-maintained
