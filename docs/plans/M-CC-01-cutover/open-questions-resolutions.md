...
**Resolution:** The fallback from `docs/plans/M-CC-01-cutover/pre-cutover-drafts.md §Draft 2` is the actual path:
...
The pre-cutover demo script (`docs/plans/M-CC-01-cutover/pre-cutover-drafts.md §Draft 3`) uses:
