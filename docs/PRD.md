...
| **Tenant builder / IT** | A tenant's internal engineer or a Connect partner | Workflow Studio, Ontology (legacy: Object Graph — renamed per MASTERPLAN.md §2.4), capability authoring, plugin marketplace consumption | Tenant-builder seats + plugin runtime usage |
