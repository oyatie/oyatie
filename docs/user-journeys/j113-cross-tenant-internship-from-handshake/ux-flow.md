...
# j113-cross-tenant-internship-from-handshake - UX flow

Purpose: screen-by-screen flow for Aiyana, a student, interns at KrampusCorp through Community Handshake-mode with
student and employer tenant bindings, weekly timesheets, stipend, and mentor DM channel.
...
## Screen 001 - Aiyana Brooks on desktop wide
- Locale and format: `ko-KR` renders currency, dates, fiscal calendars, and legal copy for `b2c-aiyana-brooks`.
- Context indicator: active tenant is `b2c-aiyana-brooks`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: community exposes the next action for j113 with status, owner, due time, and counterparty evidence.
...
- Context indicator: active tenant is `tenant-university-career-center`; any counterparty read is labeled as
  cross-tenant and permit-bound.
- Primary view: identity exposes the next action for j113 with status, owner, due time, and counterparty evidence.
- Action controls: approve, request change, revoke grant, open evidence, export audit, and appeal are visible only when
  Cedar permits them.
- Error state: if the grant is expired, the screen shows the denied action, the Cedar fragment, and a safe
  request-renewal path.
...
## Screen 003 - university career center tenant on mobile compact
...
- Context indicator: active tenant is `tenant-krampuscorp-seoul`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: workplace-integration exposes the next action for j113 with status, owner, due time, and counterparty
  evidence.
- Action controls: approve, request change, revoke grant, open evidence, export audit, and appeal are visible only when
  Cedar permits them.
- Error state: if the grant is expired, the screen shows the denied action, the Cedar fragment, and a safe
...
- Locale and format: `en-US` renders currency, dates, fiscal calendars, and legal copy for `b2c-aiyana-brooks`.
- Context indicator: active tenant is `b2c-aiyana-brooks`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: payments exposes the next action for j113 with status, owner, due time, and counterparty evidence.
- Action controls: approve, request change, revoke grant, open evidence, export audit, and appeal are visible only when
  Cedar permits them.
- Error state: if the grant is expired, the screen shows the denied action, the Cedar fragment, and a safe
  request-renewal path.
...
- Context indicator: active tenant is `tenant-university-career-center`; any counterparty read is labeled as
  cross-tenant and permit-bound.
- Primary view: messenger exposes the next action for j113 with status, owner, due time, and counterparty evidence.
- Action controls: approve, request change, revoke grant, open evidence, export audit, and appeal are visible only when
  Cedar permits them.
- Error state: if the grant is expired, the screen shows the denied action, the Cedar fragment, and a safe
  request-renewal path.
...
- Context indicator: active tenant is `tenant-krampuscorp-seoul`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: calendar exposes the next action for j113 with status, owner, due time, and counterparty evidence.
- Action controls: approve, request change, revoke grant, open evidence, export audit, and appeal are visible only when
  Cedar permits them.
- Error state: if the grant is expired, the screen shows the denied action, the Cedar fragment, and a safe
  request-renewal path.
...
## Screen 007 - Aiyana Brooks on tablet field mode
- Locale and format: `en-AU` renders currency, dates, fiscal calendars, and legal copy for `b2c-aiyana-brooks`.
- Context indicator: active tenant is `b2c-aiyana-brooks`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: community exposes the next action for j113 with status, owner, due time, and counterparty evidence.
- Action controls: approve, request change, revoke grant, open evidence, export audit, and appeal are visible only when
...
## Screen 008 - KrampusCorp Seoul on mobile compact
...
## Screen 009 - university career center tenant on screen-reader mode
...
- Locale and format: `en-SG` renders currency, dates, fiscal calendars, and legal copy for `b2c-aiyana-brooks`.
- Context indicator: active tenant is `b2c-aiyana-brooks`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: payments exposes the next action for j113 with status, owner, due time, and counterparty evidence.
- Action controls: approve, request change, revoke grant, open evidence, export audit, and appeal are visible only when
...
## Screen 013 - Aiyana Brooks on mobile compact
- Locale and format: `en-GB` renders currency, dates, fiscal calendars, and legal copy for `b2c-aiyana-brooks`.
- Context indicator: active tenant is `b2c-aiyana-brooks`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: community exposes the next action for j113 with status, owner, due time, and counterparty evidence.
- Action controls: approve, request change, revoke grant, open evidence, export audit, and appeal are visible only when
...
## Screen 014 - KrampusCorp Seoul on screen-reader mode
...
## Screen 015 - university career center tenant on low-bandwidth mode
...
- Locale and format: `de-DE` renders currency, dates, fiscal calendars, and legal copy for `b2c-aiyana-brooks`.
- Context indicator: active tenant is `b2c-aiyana-brooks`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: payments exposes the next action for j113 with status, owner, due time, and counterparty evidence.
- Action controls: approve, request change, revoke grant, open evidence, export audit, and appeal are visible only when
...
## Screen 019 - Aiyana Brooks on screen-reader mode
- Locale and format: `pt-BR` renders currency, dates, fiscal calendars, and legal copy for `b2c-aiyana-brooks`.
- Context indicator: active tenant is `b2c-aiyana-brooks`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: community exposes the next action for j113 with status, owner, due time, and counterparty evidence.
- Action controls: approve, request change, revoke grant, open evidence, export audit, and appeal are visible only when
...
## Screen 020 - KrampusCorp Seoul on low-bandwidth mode
...
## Screen 021 - university career center tenant on desktop wide
...
## Screen 025 - Aiyana Brooks on low-bandwidth mode
- Locale and format: `en-US` renders currency, dates, fiscal calendars, and legal copy for `b2c-aiyana-brooks`.
- Context indicator: active tenant is `b2c-aiyana-brooks`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: community exposes the next action for j113 with status, owner, due time, and counterparty evidence.
...
## Screen 026 - KrampusCorp Seoul on desktop wide
- Locale and format: `pt-BR` renders currency, dates, fiscal calendars, and legal copy for
  `tenant-university-career-center`.
- Context indicator: active tenant is `tenant-university-career-center`; any counterparty read is labeled as
  cross-tenant and permit-bound.
...
## Screen 027 - university career center tenant on tablet field mode
- Locale and format: `en-GB` renders currency, dates, fiscal calendars, and legal copy for `tenant-krampuscorp-seoul`.
- Context indicator: active tenant is `tenant-krampuscorp-seoul`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: workplace-integration exposes the next action for j113 with status, owner, due time, and counterparty
...
## Screen 031 - Aiyana Brooks on desktop wide
- Locale and format: `en-SG` renders currency, dates, fiscal calendars, and legal copy for `b2c-aiyana-brooks`.
- Context indicator: active tenant is `b2c-aiyana-brooks`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: community exposes the next action for j113 with status, owner, due time, and counterparty evidence.
...
## Screen 032 - KrampusCorp Seoul on tablet field mode
- Locale and format: `en-US` renders currency, dates, fiscal calendars, and legal copy for
  `tenant-university-career-center`.
- Context indicator: active tenant is `tenant-university-career-center`; any counterparty read is labeled as
  cross-tenant and permit-bound.
...
## Screen 033 - university career center tenant on mobile compact
- Locale and format: `pt-BR` renders currency, dates, fiscal calendars, and legal copy for `tenant-krampuscorp-seoul`.
- Context indicator: active tenant is `tenant-krampuscorp-seoul`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: workplace-integration exposes the next action for j113 with status, owner, due time, and counterparty
...
## Screen 037 - Aiyana Brooks on tablet field mode
- Locale and format: `de-DE` renders currency, dates, fiscal calendars, and legal copy for `b2c-aiyana-brooks`.
- Context indicator: active tenant is `b2c-aiyana-brooks`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: community exposes the next action for j113 with status, owner, due time, and counterparty evidence.
...
## Screen 038 - KrampusCorp Seoul on mobile compact
- Locale and format: `en-SG` renders currency, dates, fiscal calendars, and legal copy for
  `tenant-university-career-center`.
- Context indicator: active tenant is `tenant-university-career-center`; any counterparty read is labeled as
  cross-tenant and permit-bound.
...
## Screen 039 - university career center tenant on screen-reader mode
- Locale and format: `en-US` renders currency, dates, fiscal calendars, and legal copy for `tenant-krampuscorp-seoul`.
- Context indicator: active tenant is `tenant-krampuscorp-seoul`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: workplace-integration exposes the next action for j113 with status, owner, due time, and counterparty
...
## Screen 043 - Aiyana Brooks on mobile compact
- Locale and format: `ko-KR` renders currency, dates, fiscal calendars, and legal copy for `b2c-aiyana-brooks`.
- Context indicator: active tenant is `b2c-aiyana-brooks`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: community exposes the next action for j113 with status, owner, due time, and counterparty evidence.
...
## Screen 045 - university career center tenant on low-bandwidth mode
- Locale and format: `en-SG` renders currency, dates, fiscal calendars, and legal copy for `tenant-krampuscorp-seoul`.
- Context indicator: active tenant is `tenant-krampuscorp-seoul`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: workplace-integration exposes the next action for j113 with status, owner, due time, and counterparty
...
## Screen 049 - Aiyana Brooks on screen-reader mode
- Locale and format: `en-AU` renders currency, dates, fiscal calendars, and legal copy for `b2c-aiyana-brooks`.
- Context indicator: active tenant is `b2c-aiyana-brooks`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: community exposes the next action for j113 with status, owner, due time, and counterparty evidence.
...
## Screen 050 - KrampusCorp Seoul on low-bandwidth mode
- Locale and format: `ko-KR` renders currency, dates, fiscal calendars, and legal copy for
  `tenant-university-career-center`.
- Context indicator: active tenant is `tenant-university-career-center`; any counterparty read is labeled as
  cross-tenant and permit-bound.
...
## Screen 051 - university career center tenant on desktop wide
- Locale and format: `de-DE` renders currency, dates, fiscal calendars, and legal copy for `tenant-krampuscorp-seoul`.
- Context indicator: active tenant is `tenant-krampuscorp-seoul`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: workplace-integration exposes the next action for j113 with status, owner, due time, and counterparty
...
## Screen 055 - Aiyana Brooks on low-bandwidth mode
- Locale and format: `en-GB` renders currency, dates, fiscal calendars, and legal copy for `b2c-aiyana-brooks`.
- Context indicator: active tenant is `b2c-aiyana-brooks`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: community exposes the next action for j113 with status, owner, due time, and counterparty evidence.
...
## Screen 056 - KrampusCorp Seoul on desktop wide
- Locale and format: `en-AU` renders currency, dates, fiscal calendars, and legal copy for
  `tenant-university-career-center`.
- Context indicator: active tenant is `tenant-university-career-center`; any counterparty read is labeled as
  cross-tenant and permit-bound.
...
## Screen 057 - university career center tenant on tablet field mode
- Locale and format: `ko-KR` renders currency, dates, fiscal calendars, and legal copy for `tenant-krampuscorp-seoul`.
- Context indicator: active tenant is `tenant-krampuscorp-seoul`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: workplace-integration exposes the next action for j113 with status, owner, due time, and counterparty
...
## Screen 061 - Aiyana Brooks on desktop wide
- Locale and format: `pt-BR` renders currency, dates, fiscal calendars, and legal copy for `b2c-aiyana-brooks`.
- Context indicator: active tenant is `b2c-aiyana-brooks`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: community exposes the next action for j113 with status, owner, due time, and counterparty evidence.
...
## Screen 062 - KrampusCorp Seoul on tablet field mode
- Locale and format: `en-GB` renders currency, dates, fiscal calendars, and legal copy for
  `tenant-university-career-center`.
- Context indicator: active tenant is `tenant-university-career-center`; any counterparty read is labeled as
  cross-tenant and permit-bound.
...
- Locale matrix 1: `ko-KR` has translated legal labels, numeric formats, pack names, and right-to-appeal copy for j113.
- Locale matrix 2: `de-DE` has translated legal labels, numeric formats, pack names, and right-to-appeal copy for j113.
- Locale matrix 3: `en-SG` has translated legal labels, numeric formats, pack names, and right-to-appeal copy for j113.
- Locale matrix 4: `en-US` has translated legal labels, numeric formats, pack names, and right-to-appeal copy for j113.
- Locale matrix 5: `pt-BR` has translated legal labels, numeric formats, pack names, and right-to-appeal copy for j113.
- Locale matrix 6: `en-GB` has translated legal labels, numeric formats, pack names, and right-to-appeal copy for j113.
- Locale matrix 7: `en-AU` has translated legal labels, numeric formats, pack names, and right-to-appeal copy for j113.
