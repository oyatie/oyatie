...
| connector | `shipping-label-ingest` | OpenAPI 3.2.0 plus AsyncAPI 3.1.0 plus proto3 when RPC is needed |
...
| 2 | workflow-engine | connector | `j29.workflow-engine.label-filing-runner.step_02` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
| 3 | connector | marketplace | `j29.connect.shipping-label-ingest.step_03` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
...
| 6 | workflow-engine | connector | `j29.workflow-engine.label-filing-runner.step_06` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
| 7 | connector | marketplace | `j29.connect.shipping-label-ingest.step_07` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
...
| 10 | workflow-engine | connector | `j29.workflow-engine.label-filing-runner.step_10` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
| 11 | connector | marketplace | `j29.connect.shipping-label-ingest.step_11` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
...
| 14 | workflow-engine | connector | `j29.workflow-engine.label-filing-runner.step_14` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
| 15 | connector | marketplace | `j29.connect.shipping-label-ingest.step_15` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
...
| 18 | workflow-engine | connector | `j29.workflow-engine.label-filing-runner.step_18` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
| 19 | connector | marketplace | `j29.connect.shipping-label-ingest.step_19` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
...
| 22 | workflow-engine | connector | `j29.workflow-engine.label-filing-runner.step_22` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
| 23 | connector | marketplace | `j29.connect.shipping-label-ingest.step_23` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
...
| 26 | workflow-engine | connector | `j29.workflow-engine.label-filing-runner.step_26` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
| 27 | connector | marketplace | `j29.connect.shipping-label-ingest.step_27` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
...
| 30 | workflow-engine | connector | `j29.workflow-engine.label-filing-runner.step_30` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
| 31 | connector | marketplace | `j29.connect.shipping-label-ingest.step_31` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
...
| 34 | workflow-engine | connector | `j29.workflow-engine.label-filing-runner.step_34` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
| 35 | connector | marketplace | `j29.connect.shipping-label-ingest.step_35` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
...
| 38 | workflow-engine | connector | `j29.workflow-engine.label-filing-runner.step_38` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
| 39 | connector | marketplace | `j29.connect.shipping-label-ingest.step_39` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
...
| 42 | workflow-engine | connector | `j29.workflow-engine.label-filing-runner.step_42` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
| 43 | connector | marketplace | `j29.connect.shipping-label-ingest.step_43` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
...
| 46 | workflow-engine | connector | `j29.workflow-engine.label-filing-runner.step_46` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
| 47 | connector | marketplace | `j29.connect.shipping-label-ingest.step_47` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
...
| 50 | workflow-engine | connector | `j29.workflow-engine.label-filing-runner.step_50` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
| 51 | connector | marketplace | `j29.connect.shipping-label-ingest.step_51` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
...
| 54 | workflow-engine | connector | `j29.workflow-engine.label-filing-runner.step_54` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
| 55 | connector | marketplace | `j29.connect.shipping-label-ingest.step_55` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
...
| 58 | workflow-engine | connector | `j29.workflow-engine.label-filing-runner.step_58` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
| 59 | connector | marketplace | `j29.connect.shipping-label-ingest.step_59` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
...
| 62 | workflow-engine | connector | `j29.workflow-engine.label-filing-runner.step_62` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
| 63 | connector | marketplace | `j29.connect.shipping-label-ingest.step_63` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
...
| 66 | workflow-engine | connector | `j29.workflow-engine.label-filing-runner.step_66` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
| 67 | connector | marketplace | `j29.connect.shipping-label-ingest.step_67` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
...
| 70 | workflow-engine | connector | `j29.workflow-engine.label-filing-runner.step_70` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
| 71 | connector | marketplace | `j29.connect.shipping-label-ingest.step_71` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
...
| 74 | workflow-engine | connector | `j29.workflow-engine.label-filing-runner.step_74` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
| 75 | connector | marketplace | `j29.connect.shipping-label-ingest.step_75` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
...
| 78 | workflow-engine | connector | `j29.workflow-engine.label-filing-runner.step_78` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
| 79 | connector | marketplace | `j29.connect.shipping-label-ingest.step_79` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
...
| 82 | workflow-engine | connector | `j29.workflow-engine.label-filing-runner.step_82` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
| 83 | connector | marketplace | `j29.connect.shipping-label-ingest.step_83` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
...
| 86 | workflow-engine | connector | `j29.workflow-engine.label-filing-runner.step_86` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
| 87 | connector | marketplace | `j29.connect.shipping-label-ingest.step_87` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
...
| 90 | workflow-engine | connector | `j29.workflow-engine.label-filing-runner.step_90` | tenant_id, principal_id, purpose, HLC, traceparent mandatory |
...
| 3 | `j29.connect.shipping-label-ingest.sealed` | connector | audit-chain and observability |
...
| 7 | `j29.connect.shipping-label-ingest.sealed` | connector | audit-chain and observability |
...
| 11 | `j29.connect.shipping-label-ingest.sealed` | connector | audit-chain and observability |
...
| 15 | `j29.connect.shipping-label-ingest.sealed` | connector | audit-chain and observability |
...
| 19 | `j29.connect.shipping-label-ingest.sealed` | connector | audit-chain and observability |
...
| 23 | `j29.connect.shipping-label-ingest.sealed` | connector | audit-chain and observability |
...
| 27 | `j29.connect.shipping-label-ingest.sealed` | connector | audit-chain and observability |
...
| 31 | `j29.connect.shipping-label-ingest.sealed` | connector | audit-chain and observability |
...
| 35 | `j29.connect.shipping-label-ingest.sealed` | connector | audit-chain and observability |
...
| 39 | `j29.connect.shipping-label-ingest.sealed` | connector | audit-chain and observability |
...
| 43 | `j29.connect.shipping-label-ingest.sealed` | connector | audit-chain and observability |
...
| 47 | `j29.connect.shipping-label-ingest.sealed` | connector | audit-chain and observability |
...
| 51 | `j29.connect.shipping-label-ingest.sealed` | connector | audit-chain and observability |
...
| 55 | `j29.connect.shipping-label-ingest.sealed` | connector | audit-chain and observability |
...
| 59 | `j29.connect.shipping-label-ingest.sealed` | connector | audit-chain and observability |
...
| 63 | `j29.connect.shipping-label-ingest.sealed` | connector | audit-chain and observability |
...
| 67 | `j29.connect.shipping-label-ingest.sealed` | connector | audit-chain and observability |
...
| H-A001 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A005 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A009 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A013 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A017 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A021 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A025 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A029 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A033 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A037 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A041 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A045 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A049 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A053 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A057 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A061 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A065 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A069 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A073 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A077 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A081 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A085 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A089 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A093 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A097 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A101 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A105 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A109 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A113 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A117 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A121 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A125 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A129 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A133 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A137 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A141 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A145 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A149 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A153 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A157 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A161 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A165 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A169 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A173 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A177 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A181 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A185 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A189 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A193 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A197 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A201 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A205 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A209 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A213 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A217 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A221 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A225 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A229 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A233 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A237 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A241 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A245 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A249 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A253 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A257 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A261 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A265 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A269 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A273 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A277 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A281 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A285 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A289 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A293 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A297 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A301 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
...
| H-A305 | `connector` `shipping-label-ingest` carries tenant_id, principal_id, audience_type, purpose, HLC, traceparent, audit_event_class, idempotency_key, recovery_hint, and contract_version. |
