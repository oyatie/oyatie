...
3. `connector` IP slice maps positive, negative, resilience, rollback, and telemetry tests to `shipping-label-ingest`.
...
| T-A001 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A005 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A009 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A013 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A017 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A021 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A025 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A029 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A033 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A037 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A041 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A045 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A049 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A053 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A057 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A061 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A065 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A069 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A073 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A077 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A081 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A085 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A089 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A093 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A097 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A101 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A105 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A109 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A113 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A117 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A121 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A125 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A129 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A133 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A137 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A141 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A145 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A149 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A153 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A157 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A161 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A165 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A169 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A173 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A177 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A181 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A185 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A189 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A193 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A197 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A201 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A205 | Fixture for `connector` `shipping-label-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
