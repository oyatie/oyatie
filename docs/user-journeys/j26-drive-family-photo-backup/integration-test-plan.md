...
4. `connector` IP slice maps positive, negative, resilience, rollback, and telemetry tests to `device-ingest`.
...
| T-A002 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A006 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A010 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A014 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A018 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A022 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A026 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A030 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A034 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A038 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A042 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A046 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A050 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A054 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A058 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A062 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A066 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A070 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A074 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A078 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A082 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A086 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A090 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A094 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A098 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A102 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A106 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A110 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A114 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A118 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A122 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A126 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A130 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A134 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A138 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A142 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A146 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A150 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A154 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A158 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A162 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A166 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A170 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A174 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A178 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A182 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A186 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A190 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A194 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A198 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A202 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
...
| T-A206 | Fixture for `connector` `device-ingest` verifies positive path, replay denial, tenant denial, outage recovery, audit seal, metric cardinality, and rollback event. |
