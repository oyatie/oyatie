...
critical_path_rows_satisfied:
  - "§3.2.5 row 23 — Cross-jurisdiction conflict (PRIMARY)"
...
# j131 — Cross-jurisdiction audit: EU vs KR data-residency reconciliation

## At a glance

Diana audits Aurora Defense Systems — a US-incorporated federal
contractor with subsidiaries in Germany (Aurora-DE) and South
Korea (Aurora-KR). Three jurisdictions, three sets of regulator
rules: US FedRAMP Mod, EU GDPR Art 48 + EU-C5, KR PIPA Art 28 +
KR-CSAP. The platform's multi-jurisdiction-evidence-bridge
primitive (per ADR-0304) produces region-local audit bundles +
PI-free reconciliation manifest. Diana drills into PI detail by
launching cell-routed sessions that route her browser via the
respective region's cell. Data never crosses jurisdictions; the
audit produces a coherent single docket.

## Index of artifacts

| Artifact | Purpose | Line count |
|---|---|---:|
| [`story.md`](story.md) | Diana's multi-region audit | ≥800 |
| [`ux-flow.md`](ux-flow.md) | Cell-routed session UX | ≥400 |
| [`handshake.md`](handshake.md) | µservice sequence | ≥600 |
| [`schemas/multi-region-evidence-manifest.json`](schemas/multi-region-evidence-manifest.json) | Reconciliation manifest | n/a |
| [`schemas/region-local-pi-read-permit.json`](schemas/region-local-pi-read-permit.json) | Cell-routed Cedar permit | n/a |
| [`schemas/cell-routed-session.json`](schemas/cell-routed-session.json) | Cell-routed session shape | n/a |
...
|---|---|---|
| audit-chain | [`microservices/audit-chain/IP-journey-j131-region-local-seal.md`](../../../microservices/audit-chain/IP-journey-j131-region-local-seal.md) | Region-local Merkle seal + cross-region root |
| compliance | [`microservices/compliance/IP-journey-j131-multi-jurisdiction-pack-overlay.md`](../../../microservices/compliance/IP-journey-j131-multi-jurisdiction-pack-overlay.md) | EU + KR pack overlay composition |
| workflow-engine | [`microservices/workflow-engine/IP-journey-j131-multi-region-pull-orchestrator.md`](../../../microservices/workflow-engine/IP-journey-j131-multi-region-pull-orchestrator.md) | Parallel region-local pull |
| tenancy | [`microservices/tenancy/IP-journey-j131-cross-region-cedar-permit.md`](../../../microservices/tenancy/IP-journey-j131-cross-region-cedar-permit.md) | Region-local-bound Cedar permit grammar |
| observability | [`microservices/observability/IP-journey-j131-cross-region-metric-labels.md`](../../../microservices/observability/IP-journey-j131-cross-region-metric-labels.md) | Per-jurisdiction metric labels |
...
- [j126](../j126-government-auditor-3pao-conducts-fedramp-audit/) — Foundation (US-domestic only)
- [j129](../j129-court-warrant-pierces-personal-tenant-with-judicial-oversight/) — Domestic warrant
- [j13](../j13-cross-jurisdiction-eu-cloud-act-conflict/) — Generic EU vs CLOUD Act
- [j76](../j76-eu-gdpr-dsar-full-cascade/) — GDPR DSAR cascade
- [j80](../j80-kr-pipa-personal-info-cross-border-transfer/) — KR PIPA cross-border
- [j87](../j87-fedramp-high-il5-air-gap-deployment/) — FedRAMP High air-gap

### Binding ADRs

- ADR-0304 (cross-jurisdiction conflict resolution) — load-bearing
...
- AWS GovCloud + AWS Frankfurt + AWS Seoul cell isolation
- Google Cloud Sovereignty Solutions
- Microsoft Azure for Sovereign Government

## Doctrine summary

j131 demonstrates that multi-jurisdiction audits are achievable
without compromising any one jurisdiction's data-residency
requirements. The architecture's cell-based isolation + Cedar
session-cell-binding + PI-free reconciliation manifest enables
the platform to ship under FedRAMP/EU/KR simultaneously.

## Completion expansion — j131 readme rigor pass
...
Coverage row 001: compliance owns pack overlay, regulator mapping, legal basis matrix, and retention policy composition and cites ADR-0299.
...
Coverage row 005: audit-chain owns Merkle-sealed evidence, deny-event trail, and ADR-0263 audit emission and cites ADR-0319.
...
Coverage row 009: observability owns trace, metric, log, detector signal, and cardinality-budget instrumentation and cites ADR-0312.
...
Coverage row 017: workflow-engine owns durable orchestration, state-machine replay, and idempotent cross-service compensation and cites ADR-0319.
...
Coverage row 021: compliance owns pack overlay, regulator mapping, legal basis matrix, and retention policy composition and cites ADR-0312.
...
Coverage row 029: observability owns trace, metric, log, detector signal, and cardinality-budget instrumentation and cites ADR-0319.
...
Coverage row 033: tenancy owns tenant membership, sub-scope, residency, and cross-tenant grant boundary and cites ADR-0312.
...
Coverage row 037: workflow-engine owns durable orchestration, state-machine replay, and idempotent cross-service compensation and cites ADR-0299.
...
Coverage row 041: compliance owns pack overlay, regulator mapping, legal basis matrix, and retention policy composition and cites ADR-0319.
...
Coverage row 045: audit-chain owns Merkle-sealed evidence, deny-event trail, and ADR-0263 audit emission and cites ADR-0312.
...
Coverage row 049: observability owns trace, metric, log, detector signal, and cardinality-budget instrumentation and cites ADR-0299.
...
Coverage row 053: tenancy owns tenant membership, sub-scope, residency, and cross-tenant grant boundary and cites ADR-0319.
...
Coverage row 061: compliance owns pack overlay, regulator mapping, legal basis matrix, and retention policy composition and cites ADR-0299.
...
Coverage row 065: audit-chain owns Merkle-sealed evidence, deny-event trail, and ADR-0263 audit emission and cites ADR-0319.
...
Coverage row 069: observability owns trace, metric, log, detector signal, and cardinality-budget instrumentation and cites ADR-0312.
...
Coverage row 077: workflow-engine owns durable orchestration, state-machine replay, and idempotent cross-service compensation and cites ADR-0319.
...
Coverage row 081: compliance owns pack overlay, regulator mapping, legal basis matrix, and retention policy composition and cites ADR-0312.
...
Coverage row 089: observability owns trace, metric, log, detector signal, and cardinality-budget instrumentation and cites ADR-0319.
...
Coverage row 093: tenancy owns tenant membership, sub-scope, residency, and cross-tenant grant boundary and cites ADR-0312.
...
Coverage row 097: workflow-engine owns durable orchestration, state-machine replay, and idempotent cross-service compensation and cites ADR-0299.
...
Coverage row 101: compliance owns pack overlay, regulator mapping, legal basis matrix, and retention policy composition and cites ADR-0319.
...
Coverage row 105: audit-chain owns Merkle-sealed evidence, deny-event trail, and ADR-0263 audit emission and cites ADR-0312.
...
Coverage row 109: observability owns trace, metric, log, detector signal, and cardinality-budget instrumentation and cites ADR-0299.
...
Coverage row 113: tenancy owns tenant membership, sub-scope, residency, and cross-tenant grant boundary and cites ADR-0319.
...
Coverage row 121: compliance owns pack overlay, regulator mapping, legal basis matrix, and retention policy composition and cites ADR-0299.
...
Coverage row 125: audit-chain owns Merkle-sealed evidence, deny-event trail, and ADR-0263 audit emission and cites ADR-0319.
...
Coverage row 129: observability owns trace, metric, log, detector signal, and cardinality-budget instrumentation and cites ADR-0312.
...
Coverage row 137: workflow-engine owns durable orchestration, state-machine replay, and idempotent cross-service compensation and cites ADR-0319.
...
Coverage row 141: compliance owns pack overlay, regulator mapping, legal basis matrix, and retention policy composition and cites ADR-0312.
...
Coverage row 149: observability owns trace, metric, log, detector signal, and cardinality-budget instrumentation and cites ADR-0319.
...
Coverage row 153: tenancy owns tenant membership, sub-scope, residency, and cross-tenant grant boundary and cites ADR-0312.
...
Coverage row 157: workflow-engine owns durable orchestration, state-machine replay, and idempotent cross-service compensation and cites ADR-0299.
...
Coverage row 161: compliance owns pack overlay, regulator mapping, legal basis matrix, and retention policy composition and cites ADR-0319.
...
Coverage row 165: audit-chain owns Merkle-sealed evidence, deny-event trail, and ADR-0263 audit emission and cites ADR-0312.
...
Coverage row 169: observability owns trace, metric, log, detector signal, and cardinality-budget instrumentation and cites ADR-0299.
...
Coverage row 173: tenancy owns tenant membership, sub-scope, residency, and cross-tenant grant boundary and cites ADR-0319.
...
Coverage row 181: compliance owns pack overlay, regulator mapping, legal basis matrix, and retention policy composition and cites ADR-0299.
...
Coverage row 185: audit-chain owns Merkle-sealed evidence, deny-event trail, and ADR-0263 audit emission and cites ADR-0319.
...
Coverage row 189: observability owns trace, metric, log, detector signal, and cardinality-budget instrumentation and cites ADR-0312.
...
Coverage row 193: tenancy owns tenant membership, sub-scope, residency, and cross-tenant grant boundary and cites ADR-0299.
