...
purpose: >
  Screen-by-screen flow for A side-business receives a DRMP laundering signal, freezes suspicious funds within 24 hours, files a SAR-style regulator packet, and preserves appeal rights.
---
...
Visible context: `Marcus side-business`, active tenant, `KR-FSS`, `KR`, regulator `FSS + KoFIU`.
...
User intent: Marcus side-business needs a trustworthy next step for Electronic Financial Transactions Act KR fraud response.
...
Copy: localized for `ko-KR` and says exactly which pack obligation is active without hiding the consequences.
...
### UX row 002 - identity-step-up / intelligence
User intent: Marcus side-business needs a trustworthy next step for KR-FSS suspicious transaction reporting expectations.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
Copy: localized for `ko-KR` and says exactly which pack obligation is active without hiding the consequences.
...
User intent: Marcus side-business needs a trustworthy next step for KR-PIPA Art 29 safety measures.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
Copy: localized for `ko-KR` and says exactly which pack obligation is active without hiding the consequences.
...
User intent: Marcus side-business needs a trustworthy next step for KR-PIPA Art 34 incident notice.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
Copy: localized for `ko-KR` and says exactly which pack obligation is active without hiding the consequences.
...
User intent: Marcus side-business needs a trustworthy next step for AML/KYC regulator floor.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
Copy: localized for `ko-KR` and says exactly which pack obligation is active without hiding the consequences.
...
### UX row 006 - cedar-review / identity
User intent: Marcus side-business needs a trustworthy next step for Electronic Financial Transactions Act KR fraud response.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
...
### UX row 008 - conflict-resolution / finops-portal
User intent: Marcus side-business needs a trustworthy next step for KR-PIPA Art 29 safety measures.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
...
### UX row 010 - evidence-download / ops-dashboard-control-center
User intent: Marcus side-business needs a trustworthy next step for AML/KYC regulator floor.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
...
### UX row 011 - completion / observability
User intent: Marcus side-business needs a trustworthy next step for Electronic Financial Transactions Act KR fraud response.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
...
### UX row 014 - pack-receipt / workflow-engine
User intent: Marcus side-business needs a trustworthy next step for KR-PIPA Art 34 incident notice.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
...
### UX row 019 - conflict-resolution / finops-portal
User intent: Marcus side-business needs a trustworthy next step for KR-PIPA Art 34 incident notice.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
...
### UX row 022 - completion / observability
User intent: Marcus side-business needs a trustworthy next step for KR-FSS suspicious transaction reporting expectations.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
...
### UX row 028 - cedar-review / identity
User intent: Marcus side-business needs a trustworthy next step for KR-PIPA Art 29 safety measures.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
