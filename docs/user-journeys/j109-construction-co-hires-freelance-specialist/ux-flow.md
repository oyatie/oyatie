...
# j109-construction-co-hires-freelance-specialist - UX flow

Purpose: screen-by-screen flow for ConstructionCo Sydney posts a three-month specialist contract through Community
Handshake-mode, runs interview and e-sign through workflow-engine, verifies insurance, and pays milestones.
...
## Screen 001 - Amelia Wright on desktop wide
...
- Context indicator: active tenant is `tenant-constructionco-sydney`; any counterparty read is labeled as cross-tenant
  and permit-bound.
- Primary view: community exposes the next action for j109 with status, owner, due time, and counterparty evidence.
...
## Screen 002 - freelance structural specialist personal tenant on tablet field mode
- Locale and format: `de-DE` renders currency, dates, fiscal calendars, and legal copy for `b2c-specialist-ravi-menon`.
- Context indicator: active tenant is `b2c-specialist-ravi-menon`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: identity exposes the next action for j109 with status, owner, due time, and counterparty evidence.
- Action controls: approve, request change, revoke grant, open evidence, export audit, and appeal are visible only when
  Cedar permits them.
- Error state: if the grant is expired, the screen shows the denied action, the Cedar fragment, and a safe
  request-renewal path.
...
- Context indicator: active tenant is `tenant-constructionco-sydney`; any counterparty read is labeled as cross-tenant
  and permit-bound.
- Primary view: workflow-engine exposes the next action for j109 with status, owner, due time, and counterparty
  evidence.
- Action controls: approve, request change, revoke grant, open evidence, export audit, and appeal are visible only when
  Cedar permits them.
- Error state: if the grant is expired, the screen shows the denied action, the Cedar fragment, and a safe
...
- Locale and format: `en-US` renders currency, dates, fiscal calendars, and legal copy for `b2c-specialist-ravi-menon`.
- Context indicator: active tenant is `b2c-specialist-ravi-menon`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: workplace-integration exposes the next action for j109 with status, owner, due time, and counterparty
  evidence.
- Action controls: approve, request change, revoke grant, open evidence, export audit, and appeal are visible only when
  Cedar permits them.
- Error state: if the grant is expired, the screen shows the denied action, the Cedar fragment, and a safe
...
- Context indicator: active tenant is `tenant-constructionco-sydney`; any counterparty read is labeled as cross-tenant
  and permit-bound.
- Primary view: payments exposes the next action for j109 with status, owner, due time, and counterparty evidence.
- Action controls: approve, request change, revoke grant, open evidence, export audit, and appeal are visible only when
  Cedar permits them.
- Error state: if the grant is expired, the screen shows the denied action, the Cedar fragment, and a safe
  request-renewal path.
...
## Screen 006 - Amelia Wright on desktop wide
- Locale and format: `en-GB` renders currency, dates, fiscal calendars, and legal copy for `b2c-specialist-ravi-menon`.
- Context indicator: active tenant is `b2c-specialist-ravi-menon`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: observability exposes the next action for j109 with status, owner, due time, and counterparty evidence.
- Action controls: approve, request change, revoke grant, open evidence, export audit, and appeal are visible only when
  Cedar permits them.
- Error state: if the grant is expired, the screen shows the denied action, the Cedar fragment, and a safe
  request-renewal path.
...
## Screen 007 - freelance structural specialist personal tenant on tablet field mode
...
- Locale and format: `ko-KR` renders currency, dates, fiscal calendars, and legal copy for `b2c-specialist-ravi-menon`.
- Context indicator: active tenant is `b2c-specialist-ravi-menon`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: identity exposes the next action for j109 with status, owner, due time, and counterparty evidence.
- Action controls: approve, request change, revoke grant, open evidence, export audit, and appeal are visible only when
...
- Locale and format: `en-SG` renders currency, dates, fiscal calendars, and legal copy for `b2c-specialist-ravi-menon`.
- Context indicator: active tenant is `b2c-specialist-ravi-menon`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: workplace-integration exposes the next action for j109 with status, owner, due time, and counterparty
  evidence.
...
## Screen 011 - Amelia Wright on desktop wide
...
## Screen 012 - freelance structural specialist personal tenant on tablet field mode
- Locale and format: `pt-BR` renders currency, dates, fiscal calendars, and legal copy for `b2c-specialist-ravi-menon`.
- Context indicator: active tenant is `b2c-specialist-ravi-menon`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: observability exposes the next action for j109 with status, owner, due time, and counterparty evidence.
- Action controls: approve, request change, revoke grant, open evidence, export audit, and appeal are visible only when
...
- Locale and format: `en-AU` renders currency, dates, fiscal calendars, and legal copy for `b2c-specialist-ravi-menon`.
- Context indicator: active tenant is `b2c-specialist-ravi-menon`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: identity exposes the next action for j109 with status, owner, due time, and counterparty evidence.
- Action controls: approve, request change, revoke grant, open evidence, export audit, and appeal are visible only when
...
## Screen 016 - Amelia Wright on desktop wide
- Locale and format: `de-DE` renders currency, dates, fiscal calendars, and legal copy for `b2c-specialist-ravi-menon`.
- Context indicator: active tenant is `b2c-specialist-ravi-menon`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: workplace-integration exposes the next action for j109 with status, owner, due time, and counterparty
...
## Screen 017 - freelance structural specialist personal tenant on tablet field mode
- Locale and format: `en-SG` renders currency, dates, fiscal calendars, and legal copy for
  `tenant-constructionco-sydney`.
- Context indicator: active tenant is `tenant-constructionco-sydney`; any counterparty read is labeled as cross-tenant
  and permit-bound.
...
## Screen 021 - Amelia Wright on desktop wide
- Locale and format: `en-AU` renders currency, dates, fiscal calendars, and legal copy for
  `tenant-constructionco-sydney`.
- Context indicator: active tenant is `tenant-constructionco-sydney`; any counterparty read is labeled as cross-tenant
  and permit-bound.
...
## Screen 022 - freelance structural specialist personal tenant on tablet field mode
- Locale and format: `ko-KR` renders currency, dates, fiscal calendars, and legal copy for `b2c-specialist-ravi-menon`.
- Context indicator: active tenant is `b2c-specialist-ravi-menon`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: workplace-integration exposes the next action for j109 with status, owner, due time, and counterparty
...
## Screen 026 - Amelia Wright on desktop wide
- Locale and format: `pt-BR` renders currency, dates, fiscal calendars, and legal copy for `b2c-specialist-ravi-menon`.
- Context indicator: active tenant is `b2c-specialist-ravi-menon`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: identity exposes the next action for j109 with status, owner, due time, and counterparty evidence.
...
## Screen 027 - freelance structural specialist personal tenant on tablet field mode
- Locale and format: `en-GB` renders currency, dates, fiscal calendars, and legal copy for
  `tenant-constructionco-sydney`.
- Context indicator: active tenant is `tenant-constructionco-sydney`; any counterparty read is labeled as cross-tenant
  and permit-bound.
...
## Screen 031 - Amelia Wright on desktop wide
- Locale and format: `en-SG` renders currency, dates, fiscal calendars, and legal copy for
  `tenant-constructionco-sydney`.
- Context indicator: active tenant is `tenant-constructionco-sydney`; any counterparty read is labeled as cross-tenant
  and permit-bound.
...
## Screen 032 - freelance structural specialist personal tenant on tablet field mode
- Locale and format: `en-US` renders currency, dates, fiscal calendars, and legal copy for `b2c-specialist-ravi-menon`.
- Context indicator: active tenant is `b2c-specialist-ravi-menon`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: identity exposes the next action for j109 with status, owner, due time, and counterparty evidence.
...
## Screen 036 - Amelia Wright on desktop wide
- Locale and format: `ko-KR` renders currency, dates, fiscal calendars, and legal copy for `b2c-specialist-ravi-menon`.
- Context indicator: active tenant is `b2c-specialist-ravi-menon`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: observability exposes the next action for j109 with status, owner, due time, and counterparty evidence.
...
## Screen 037 - freelance structural specialist personal tenant on tablet field mode
- Locale and format: `de-DE` renders currency, dates, fiscal calendars, and legal copy for
  `tenant-constructionco-sydney`.
- Context indicator: active tenant is `tenant-constructionco-sydney`; any counterparty read is labeled as cross-tenant
  and permit-bound.
...
## Screen 041 - Amelia Wright on desktop wide
- Locale and format: `en-GB` renders currency, dates, fiscal calendars, and legal copy for
  `tenant-constructionco-sydney`.
- Context indicator: active tenant is `tenant-constructionco-sydney`; any counterparty read is labeled as cross-tenant
  and permit-bound.
...
## Screen 042 - freelance structural specialist personal tenant on tablet field mode
- Locale and format: `en-AU` renders currency, dates, fiscal calendars, and legal copy for `b2c-specialist-ravi-menon`.
- Context indicator: active tenant is `b2c-specialist-ravi-menon`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: observability exposes the next action for j109 with status, owner, due time, and counterparty evidence.
...
## Screen 046 - Amelia Wright on desktop wide
- Locale and format: `en-US` renders currency, dates, fiscal calendars, and legal copy for `b2c-specialist-ravi-menon`.
- Context indicator: active tenant is `b2c-specialist-ravi-menon`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: workplace-integration exposes the next action for j109 with status, owner, due time, and counterparty
...
## Screen 047 - freelance structural specialist personal tenant on tablet field mode
- Locale and format: `pt-BR` renders currency, dates, fiscal calendars, and legal copy for
  `tenant-constructionco-sydney`.
- Context indicator: active tenant is `tenant-constructionco-sydney`; any counterparty read is labeled as cross-tenant
  and permit-bound.
...
## Screen 051 - Amelia Wright on desktop wide
- Locale and format: `de-DE` renders currency, dates, fiscal calendars, and legal copy for
  `tenant-constructionco-sydney`.
- Context indicator: active tenant is `tenant-constructionco-sydney`; any counterparty read is labeled as cross-tenant
  and permit-bound.
...
## Screen 052 - freelance structural specialist personal tenant on tablet field mode
- Locale and format: `en-SG` renders currency, dates, fiscal calendars, and legal copy for `b2c-specialist-ravi-menon`.
- Context indicator: active tenant is `b2c-specialist-ravi-menon`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: workplace-integration exposes the next action for j109 with status, owner, due time, and counterparty
...
## Screen 056 - Amelia Wright on desktop wide
- Locale and format: `en-AU` renders currency, dates, fiscal calendars, and legal copy for `b2c-specialist-ravi-menon`.
- Context indicator: active tenant is `b2c-specialist-ravi-menon`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: identity exposes the next action for j109 with status, owner, due time, and counterparty evidence.
...
## Screen 057 - freelance structural specialist personal tenant on tablet field mode
- Locale and format: `ko-KR` renders currency, dates, fiscal calendars, and legal copy for
  `tenant-constructionco-sydney`.
- Context indicator: active tenant is `tenant-constructionco-sydney`; any counterparty read is labeled as cross-tenant
  and permit-bound.
...
## Screen 061 - Amelia Wright on desktop wide
- Locale and format: `pt-BR` renders currency, dates, fiscal calendars, and legal copy for
  `tenant-constructionco-sydney`.
- Context indicator: active tenant is `tenant-constructionco-sydney`; any counterparty read is labeled as cross-tenant
  and permit-bound.
...
## Screen 062 - freelance structural specialist personal tenant on tablet field mode
- Locale and format: `en-GB` renders currency, dates, fiscal calendars, and legal copy for `b2c-specialist-ravi-menon`.
- Context indicator: active tenant is `b2c-specialist-ravi-menon`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: identity exposes the next action for j109 with status, owner, due time, and counterparty evidence.
...
- Locale matrix 1: `ko-KR` has translated legal labels, numeric formats, pack names, and right-to-appeal copy for j109.
- Locale matrix 2: `de-DE` has translated legal labels, numeric formats, pack names, and right-to-appeal copy for j109.
- Locale matrix 3: `en-SG` has translated legal labels, numeric formats, pack names, and right-to-appeal copy for j109.
- Locale matrix 4: `en-US` has translated legal labels, numeric formats, pack names, and right-to-appeal copy for j109.
- Locale matrix 5: `pt-BR` has translated legal labels, numeric formats, pack names, and right-to-appeal copy for j109.
- Locale matrix 6: `en-GB` has translated legal labels, numeric formats, pack names, and right-to-appeal copy for j109.
- Locale matrix 7: `en-AU` has translated legal labels, numeric formats, pack names, and right-to-appeal copy for j109.
