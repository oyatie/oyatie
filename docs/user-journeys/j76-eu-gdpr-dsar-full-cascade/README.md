...
purpose: >
  Directory index and build contract for EU GDPR DSAR full cascade.
---
...
- `schemas/gdpr-dsar-cascade.json`: machine-readable journey object contract.
...
- Pack overlay: `EU-GDPR-2018-baseline`.
- Regulator: Berlin DPA.
- Jurisdiction: `EU`.
- Locale: `de-DE`.
...
Article focus: GDPR Art 12 transparent communication.
...
Article focus: GDPR Art 22 automated-decision appeal.
Critical-path focus: documentation-rigor.md section 3.2.5 row 13 non-native-language user.
Implementation boundary: service owns only its local contract, policy, event, metrics, and rollback logic.
Shared boundary: workflow-engine owns orchestration; audit-chain owns seals; compliance owns regulator evidence; identity owns principal context.
Review evidence: schema validates as JSON; line floors pass; report includes this pack in the matrix.
...
Article focus: GDPR Art 30 records of processing.
Critical-path focus: documentation-rigor.md section 3.2.5 row 17 regulator-deadline outage.
Implementation boundary: service owns only its local contract, policy, event, metrics, and rollback logic.
Shared boundary: workflow-engine owns orchestration; audit-chain owns seals; compliance owns regulator evidence; identity owns principal context.
Review evidence: schema validates as JSON; line floors pass; report includes this pack in the matrix.
