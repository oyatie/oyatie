...
purpose: >
  Screen-by-screen flow for Yejin works in a hospital tenant whose de-identified research package is sent to a US partner under KR-PIPA safeguards, SCC-like transfer records, and PIPC notice.
---
...
Visible context: `Yejin Park`, active tenant, `KR-PIPA + KR-CSAP`, `KR`, regulator `PIPC + KISA`.
...
User intent: Yejin Park needs a trustworthy next step for KR-PIPA Art 23 sensitive information.
...
User intent: Yejin Park needs a trustworthy next step for KR-PIPA Art 28 entrusted processing safeguards.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
Copy: localized for `ko-KR` and says exactly which pack obligation is active without hiding the consequences.
...
User intent: Yejin Park needs a trustworthy next step for KR-PIPA Art 28-2 pseudonymized information.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
Copy: localized for `ko-KR` and says exactly which pack obligation is active without hiding the consequences.
...
User intent: Yejin Park needs a trustworthy next step for KR-PIPA Art 28-8 cross-border transfer safeguards.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
Copy: localized for `ko-KR` and says exactly which pack obligation is active without hiding the consequences.
...
User intent: Yejin Park needs a trustworthy next step for KR-PIPA Art 34 breach notification.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
Copy: localized for `ko-KR` and says exactly which pack obligation is active without hiding the consequences.
...
User intent: Yejin Park needs a trustworthy next step for Medical Service Act record boundary.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
Copy: localized for `ko-KR` and says exactly which pack obligation is active without hiding the consequences.
...
### UX row 010 - evidence-download / cloud-secrets
User intent: Yejin Park needs a trustworthy next step for KR-PIPA Art 28-8 cross-border transfer safeguards.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
...
### UX row 021 - evidence-download / cloud-iac
User intent: Yejin Park needs a trustworthy next step for KR-PIPA Art 28-2 pseudonymized information.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
...
### UX row 022 - completion / cloud-secrets
User intent: Yejin Park needs a trustworthy next step for KR-PIPA Art 28-8 cross-border transfer safeguards.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
...
### UX row 024 - identity-step-up / mail
User intent: Yejin Park needs a trustworthy next step for Medical Service Act record boundary.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
...
### UX row 027 - scope-preview / workflow-engine
User intent: Yejin Park needs a trustworthy next step for KR-PIPA Art 28-2 pseudonymized information.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
...
### UX row 028 - cedar-review / ontology
User intent: Yejin Park needs a trustworthy next step for KR-PIPA Art 28-8 cross-border transfer safeguards.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
