...
# j110-traveling-nurse-multi-employer-roster - Integration test plan

Purpose: prove that HealthcareSystem-Megacorp recruits one nurse to work shifts across three hospital tenants with
per-shift Cedar permits, per-hospital identity binding, and payroll cascade.

## Test environment

- Test tenants: tenant-healthcaresystem-megacorp, tenant-hospital-east, tenant-hospital-west, tenant-hospital-rural,
  b2c-nora-ellis.
...
### IT-110-002: identity handles three hospital subsidiary tenants
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
...
### IT-110-003: workplace-integration handles HealthcareSystem-Megacorp US
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
...
### IT-110-004: payments handles three hospital subsidiary tenants
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
...
### IT-110-005: tenancy handles HealthcareSystem-Megacorp US
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
...
### IT-110-006: community handles three hospital subsidiary tenants
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the community role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-008: workplace-integration handles three hospital subsidiary tenants
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the workplace-integration role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-009: payments handles HealthcareSystem-Megacorp US
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the payments role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-010: tenancy handles three hospital subsidiary tenants
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the tenancy role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-011: community handles HealthcareSystem-Megacorp US
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the community role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-012: identity handles three hospital subsidiary tenants
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the identity role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-014: payments handles three hospital subsidiary tenants
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the payments role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-015: tenancy handles HealthcareSystem-Megacorp US
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the tenancy role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-016: community handles three hospital subsidiary tenants
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the community role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-017: identity handles HealthcareSystem-Megacorp US
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the identity role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-018: workplace-integration handles three hospital subsidiary tenants
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the workplace-integration role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-020: tenancy handles three hospital subsidiary tenants
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the tenancy role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-021: community handles HealthcareSystem-Megacorp US
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the community role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-022: identity handles three hospital subsidiary tenants
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the identity role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-023: workplace-integration handles HealthcareSystem-Megacorp US
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the workplace-integration role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-024: payments handles three hospital subsidiary tenants
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the payments role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-026: community handles three hospital subsidiary tenants
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the community role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-027: identity handles HealthcareSystem-Megacorp US
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the identity role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-028: workplace-integration handles three hospital subsidiary tenants
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the workplace-integration role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-029: payments handles HealthcareSystem-Megacorp US
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the payments role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-030: tenancy handles three hospital subsidiary tenants
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the tenancy role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-032: identity handles three hospital subsidiary tenants
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the identity role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-033: workplace-integration handles HealthcareSystem-Megacorp US
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the workplace-integration role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-034: payments handles three hospital subsidiary tenants
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the payments role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-035: tenancy handles HealthcareSystem-Megacorp US
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the tenancy role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-036: community handles three hospital subsidiary tenants
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the community role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-038: workplace-integration handles three hospital subsidiary tenants
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the workplace-integration role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-039: payments handles HealthcareSystem-Megacorp US
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the payments role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-040: tenancy handles three hospital subsidiary tenants
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the tenancy role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-041: community handles HealthcareSystem-Megacorp US
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the community role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-042: identity handles three hospital subsidiary tenants
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the identity role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-044: payments handles three hospital subsidiary tenants
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the payments role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-045: tenancy handles HealthcareSystem-Megacorp US
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the tenancy role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-046: community handles three hospital subsidiary tenants
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the community role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-047: identity handles HealthcareSystem-Megacorp US
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the identity role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-048: workplace-integration handles three hospital subsidiary tenants
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the workplace-integration role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-050: tenancy handles three hospital subsidiary tenants
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the tenancy role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-051: community handles HealthcareSystem-Megacorp US
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the community role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-052: identity handles three hospital subsidiary tenants
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the identity role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-053: workplace-integration handles HealthcareSystem-Megacorp US
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the workplace-integration role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-054: payments handles three hospital subsidiary tenants
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the payments role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-056: community handles three hospital subsidiary tenants
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the community role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-057: identity handles HealthcareSystem-Megacorp US
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the identity role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-058: workplace-integration handles three hospital subsidiary tenants
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the workplace-integration role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-059: payments handles HealthcareSystem-Megacorp US
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the payments role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
### IT-110-060: tenancy handles three hospital subsidiary tenants
- Arrange: seed tenant pair, Cedar permit, marketplace deal-set, pack overlays, and deterministic clock for j110.
- Act: execute the tenancy role through the public contract and capture traceparent plus audit_id.
- Assert: only declared tenants can read state; personal-tenant surfaces remain default-deny unless owner consent
  exists.
...
- Critical-path row 5: covered by at least one test that proves safety, security, and policy adherence simultaneously.
