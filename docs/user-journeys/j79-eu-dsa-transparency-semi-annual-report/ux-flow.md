...
purpose: >
  Screen-by-screen flow for A publisher acting as a VLOP prepares Digital Services Act transparency reporting across moderation, recommender, minor-protection, and ad-delivery surfaces.
---
...
Visible context: `Publisher tenant`, active tenant, `EU-DSA`, `EU`, regulator `Digital Services Coordinator`.
...
### UX row 001 - entry / community
User intent: Publisher tenant needs a trustworthy next step for DSA Art 14 terms and conditions.
...
### UX row 002 - identity-step-up / social
User intent: Publisher tenant needs a trustworthy next step for DSA Art 15 transparency reporting.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
Copy: localized for `de-DE` and says exactly which pack obligation is active without hiding the consequences.
...
### UX row 003 - pack-receipt / shorts
User intent: Publisher tenant needs a trustworthy next step for DSA Art 24 online platform transparency reporting.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
Copy: localized for `de-DE` and says exactly which pack obligation is active without hiding the consequences.
...
### UX row 004 - right-selection / intelligence
User intent: Publisher tenant needs a trustworthy next step for DSA Art 28 online protection of minors.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
Copy: localized for `de-DE` and says exactly which pack obligation is active without hiding the consequences.
...
User intent: Publisher tenant needs a trustworthy next step for DSA Art 34 systemic risk assessment.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
Copy: localized for `de-DE` and says exactly which pack obligation is active without hiding the consequences.
...
User intent: Publisher tenant needs a trustworthy next step for DSA Art 39 ad transparency repository.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
Copy: localized for `de-DE` and says exactly which pack obligation is active without hiding the consequences.
...
### UX row 008 - conflict-resolution / ontology
User intent: Publisher tenant needs a trustworthy next step for DSA Art 15 transparency reporting.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
...
### UX row 013 - identity-step-up / social
User intent: Publisher tenant needs a trustworthy next step for DSA Art 14 terms and conditions.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
...
### UX row 014 - pack-receipt / shorts
User intent: Publisher tenant needs a trustworthy next step for DSA Art 15 transparency reporting.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
...
### UX row 015 - right-selection / intelligence
User intent: Publisher tenant needs a trustworthy next step for DSA Art 24 online platform transparency reporting.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
...
### UX row 016 - scope-preview / audit-chain
User intent: Publisher tenant needs a trustworthy next step for DSA Art 28 online protection of minors.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
...
### UX row 017 - cedar-review / compliance
User intent: Publisher tenant needs a trustworthy next step for DSA Art 34 systemic risk assessment.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
...
### UX row 018 - cascade-progress / workflow-engine
User intent: Publisher tenant needs a trustworthy next step for DSA Art 39 ad transparency repository.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
...
### UX row 019 - conflict-resolution / ontology
User intent: Publisher tenant needs a trustworthy next step for DSA Art 14 terms and conditions.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
...
### UX row 024 - identity-step-up / social
User intent: Publisher tenant needs a trustworthy next step for DSA Art 39 ad transparency repository.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
...
### UX row 025 - pack-receipt / shorts
User intent: Publisher tenant needs a trustworthy next step for DSA Art 14 terms and conditions.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
...
### UX row 026 - right-selection / intelligence
User intent: Publisher tenant needs a trustworthy next step for DSA Art 15 transparency reporting.
Layout: compact task pane, evidence drawer, progress rail, and regulator deadline badge; no explanatory marketing cards.
Input: typed field or toggle only when the law requires an explicit choice; default is privacy-preserving and reversible.
Validation: client-side hints mirror server-side Cedar conditions but server remains authoritative.
