...
# j105-dispute-cross-tenant-arbitration - UX flow

Purpose: screen-by-screen flow for KrampusCorp claims delivered material is off-spec, AcmeRawMaterials disputes,
workflow-engine arbitrates against the mutual contract, and evidence is held in Drive with dual audit seals.
...
## Screen 001 - Soo-jin Han on desktop wide
...
- Context indicator: active tenant is `tenant-krampuscorp-seoul`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: workflow-engine exposes the next action for j105 with status, owner, due time, and counterparty
  evidence.
...
- Primary view: payments exposes the next action for j105 with status, owner, due time, and counterparty evidence.
- Action controls: approve, request change, revoke grant, open evidence, export audit, and appeal are visible only when
  Cedar permits them.
- Error state: if the grant is expired, the screen shows the denied action, the Cedar fragment, and a safe
  request-renewal path.
...
## Screen 003 - neutral arbitration board tenant on mobile compact
- Locale and format: `en-SG` renders currency, dates, fiscal calendars, and legal copy for `tenant-arbiter-board-eu`.
- Context indicator: active tenant is `tenant-arbiter-board-eu`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: drive exposes the next action for j105 with status, owner, due time, and counterparty evidence.
- Action controls: approve, request change, revoke grant, open evidence, export audit, and appeal are visible only when
  Cedar permits them.
- Error state: if the grant is expired, the screen shows the denied action, the Cedar fragment, and a safe
  request-renewal path.
...
- Context indicator: active tenant is `tenant-krampuscorp-seoul`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: messenger exposes the next action for j105 with status, owner, due time, and counterparty evidence.
- Action controls: approve, request change, revoke grant, open evidence, export audit, and appeal are visible only when
  Cedar permits them.
- Error state: if the grant is expired, the screen shows the denied action, the Cedar fragment, and a safe
  request-renewal path.
...
- Context indicator: active tenant is `tenant-acme-rawmaterials-hamburg`; any counterparty read is labeled as
  cross-tenant and permit-bound.
- Primary view: mail exposes the next action for j105 with status, owner, due time, and counterparty evidence.
- Action controls: approve, request change, revoke grant, open evidence, export audit, and appeal are visible only when
  Cedar permits them.
- Error state: if the grant is expired, the screen shows the denied action, the Cedar fragment, and a safe
  request-renewal path.
...
- Locale and format: `en-GB` renders currency, dates, fiscal calendars, and legal copy for `tenant-arbiter-board-eu`.
- Context indicator: active tenant is `tenant-arbiter-board-eu`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: audit-chain exposes the next action for j105 with status, owner, due time, and counterparty evidence.
- Action controls: approve, request change, revoke grant, open evidence, export audit, and appeal are visible only when
  Cedar permits them.
- Error state: if the grant is expired, the screen shows the denied action, the Cedar fragment, and a safe
  request-renewal path.
...
## Screen 007 - Soo-jin Han on tablet field mode
- Locale and format: `en-AU` renders currency, dates, fiscal calendars, and legal copy for `tenant-krampuscorp-seoul`.
- Context indicator: active tenant is `tenant-krampuscorp-seoul`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: compliance exposes the next action for j105 with status, owner, due time, and counterparty evidence.
- Action controls: approve, request change, revoke grant, open evidence, export audit, and appeal are visible only when
  Cedar permits them.
- Error state: if the grant is expired, the screen shows the denied action, the Cedar fragment, and a safe
  request-renewal path.
...
## Screen 009 - neutral arbitration board tenant on screen-reader mode
- Locale and format: `de-DE` renders currency, dates, fiscal calendars, and legal copy for `tenant-arbiter-board-eu`.
- Context indicator: active tenant is `tenant-arbiter-board-eu`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: payments exposes the next action for j105 with status, owner, due time, and counterparty evidence.
- Action controls: approve, request change, revoke grant, open evidence, export audit, and appeal are visible only when
...
- Locale and format: `pt-BR` renders currency, dates, fiscal calendars, and legal copy for `tenant-arbiter-board-eu`.
- Context indicator: active tenant is `tenant-arbiter-board-eu`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: mail exposes the next action for j105 with status, owner, due time, and counterparty evidence.
- Action controls: approve, request change, revoke grant, open evidence, export audit, and appeal are visible only when
...
## Screen 013 - Soo-jin Han on mobile compact
...
## Screen 015 - neutral arbitration board tenant on low-bandwidth mode
- Locale and format: `ko-KR` renders currency, dates, fiscal calendars, and legal copy for `tenant-arbiter-board-eu`.
- Context indicator: active tenant is `tenant-arbiter-board-eu`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: workflow-engine exposes the next action for j105 with status, owner, due time, and counterparty
  evidence.
...
- Locale and format: `en-US` renders currency, dates, fiscal calendars, and legal copy for `tenant-arbiter-board-eu`.
- Context indicator: active tenant is `tenant-arbiter-board-eu`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: messenger exposes the next action for j105 with status, owner, due time, and counterparty evidence.
- Action controls: approve, request change, revoke grant, open evidence, export audit, and appeal are visible only when
...
## Screen 019 - Soo-jin Han on screen-reader mode
...
## Screen 021 - neutral arbitration board tenant on desktop wide
- Locale and format: `en-AU` renders currency, dates, fiscal calendars, and legal copy for `tenant-arbiter-board-eu`.
- Context indicator: active tenant is `tenant-arbiter-board-eu`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: compliance exposes the next action for j105 with status, owner, due time, and counterparty evidence.
- Action controls: approve, request change, revoke grant, open evidence, export audit, and appeal are visible only when
...
## Screen 025 - Soo-jin Han on low-bandwidth mode
- Locale and format: `en-US` renders currency, dates, fiscal calendars, and legal copy for `tenant-krampuscorp-seoul`.
- Context indicator: active tenant is `tenant-krampuscorp-seoul`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: messenger exposes the next action for j105 with status, owner, due time, and counterparty evidence.
...
## Screen 027 - neutral arbitration board tenant on tablet field mode
- Locale and format: `en-GB` renders currency, dates, fiscal calendars, and legal copy for `tenant-arbiter-board-eu`.
- Context indicator: active tenant is `tenant-arbiter-board-eu`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: audit-chain exposes the next action for j105 with status, owner, due time, and counterparty evidence.
...
## Screen 031 - Soo-jin Han on desktop wide
- Locale and format: `en-SG` renders currency, dates, fiscal calendars, and legal copy for `tenant-krampuscorp-seoul`.
- Context indicator: active tenant is `tenant-krampuscorp-seoul`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: drive exposes the next action for j105 with status, owner, due time, and counterparty evidence.
...
## Screen 033 - neutral arbitration board tenant on mobile compact
- Locale and format: `pt-BR` renders currency, dates, fiscal calendars, and legal copy for `tenant-arbiter-board-eu`.
- Context indicator: active tenant is `tenant-arbiter-board-eu`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: mail exposes the next action for j105 with status, owner, due time, and counterparty evidence.
...
## Screen 037 - Soo-jin Han on tablet field mode
- Locale and format: `de-DE` renders currency, dates, fiscal calendars, and legal copy for `tenant-krampuscorp-seoul`.
- Context indicator: active tenant is `tenant-krampuscorp-seoul`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: payments exposes the next action for j105 with status, owner, due time, and counterparty evidence.
...
## Screen 039 - neutral arbitration board tenant on screen-reader mode
- Locale and format: `en-US` renders currency, dates, fiscal calendars, and legal copy for `tenant-arbiter-board-eu`.
- Context indicator: active tenant is `tenant-arbiter-board-eu`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: messenger exposes the next action for j105 with status, owner, due time, and counterparty evidence.
...
## Screen 043 - Soo-jin Han on mobile compact
- Locale and format: `ko-KR` renders currency, dates, fiscal calendars, and legal copy for `tenant-krampuscorp-seoul`.
- Context indicator: active tenant is `tenant-krampuscorp-seoul`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: workflow-engine exposes the next action for j105 with status, owner, due time, and counterparty
...
## Screen 045 - neutral arbitration board tenant on low-bandwidth mode
- Locale and format: `en-SG` renders currency, dates, fiscal calendars, and legal copy for `tenant-arbiter-board-eu`.
- Context indicator: active tenant is `tenant-arbiter-board-eu`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: drive exposes the next action for j105 with status, owner, due time, and counterparty evidence.
...
## Screen 049 - Soo-jin Han on screen-reader mode
- Locale and format: `en-AU` renders currency, dates, fiscal calendars, and legal copy for `tenant-krampuscorp-seoul`.
- Context indicator: active tenant is `tenant-krampuscorp-seoul`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: compliance exposes the next action for j105 with status, owner, due time, and counterparty evidence.
...
## Screen 051 - neutral arbitration board tenant on desktop wide
- Locale and format: `de-DE` renders currency, dates, fiscal calendars, and legal copy for `tenant-arbiter-board-eu`.
- Context indicator: active tenant is `tenant-arbiter-board-eu`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: payments exposes the next action for j105 with status, owner, due time, and counterparty evidence.
...
## Screen 055 - Soo-jin Han on low-bandwidth mode
- Locale and format: `en-GB` renders currency, dates, fiscal calendars, and legal copy for `tenant-krampuscorp-seoul`.
- Context indicator: active tenant is `tenant-krampuscorp-seoul`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: audit-chain exposes the next action for j105 with status, owner, due time, and counterparty evidence.
...
## Screen 057 - neutral arbitration board tenant on tablet field mode
- Locale and format: `ko-KR` renders currency, dates, fiscal calendars, and legal copy for `tenant-arbiter-board-eu`.
- Context indicator: active tenant is `tenant-arbiter-board-eu`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: workflow-engine exposes the next action for j105 with status, owner, due time, and counterparty
...
## Screen 061 - Soo-jin Han on desktop wide
- Locale and format: `pt-BR` renders currency, dates, fiscal calendars, and legal copy for `tenant-krampuscorp-seoul`.
- Context indicator: active tenant is `tenant-krampuscorp-seoul`; any counterparty read is labeled as cross-tenant and
  permit-bound.
- Primary view: mail exposes the next action for j105 with status, owner, due time, and counterparty evidence.
...
- Locale matrix 1: `ko-KR` has translated legal labels, numeric formats, pack names, and right-to-appeal copy for j105.
- Locale matrix 2: `de-DE` has translated legal labels, numeric formats, pack names, and right-to-appeal copy for j105.
- Locale matrix 3: `en-SG` has translated legal labels, numeric formats, pack names, and right-to-appeal copy for j105.
- Locale matrix 4: `en-US` has translated legal labels, numeric formats, pack names, and right-to-appeal copy for j105.
- Locale matrix 5: `pt-BR` has translated legal labels, numeric formats, pack names, and right-to-appeal copy for j105.
- Locale matrix 6: `en-GB` has translated legal labels, numeric formats, pack names, and right-to-appeal copy for j105.
- Locale matrix 7: `en-AU` has translated legal labels, numeric formats, pack names, and right-to-appeal copy for j105.
