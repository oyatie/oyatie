...
| `LEDG-021` | `rename-and-contradiction.md` H15 | Connect Personal "no ads, ever" inviolable vs ads-axis carving it out | SaaS (Connect) + Ads | `PRIVACY-PROGRAM.md` open question (Q2); council decision | OPEN | `council-privacy` + founder |
