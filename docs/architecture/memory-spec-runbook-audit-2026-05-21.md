...
| `feedback_flat_product_catalog.md` | Description and body both use "Object Graph" terminology (old); also lists `oya-foundry-grit-cli` and `oya-foundry-icm-cli` as planned crates under Foundry — both using deprecated tooling names. **P1** |
