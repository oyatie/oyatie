...
related_adrs:
  ...
  - ADR-0296
  - ADR-0297
planned_enforcement_ref: oya-foundry-fitness-doc-rigor
companion_docs:
  - docs/standards/documentation-rigor.md
  - docs/architecture/corpus-rigor-audit-2026-05-20.md
  - docs/architecture/keystone-bundle-2026-05-20-synthesis.md
...
parseable by `oya-foundry-fitness-doc-rigor`. The section structure uses numbered
...
`oya-foundry-fitness-cross-consistency` reads `compliance_packs`; it will not
...
the canonical enum. The `oya-foundry-fitness-cross-consistency` lane invariant 5
...
manifest. The CI lane `oya-foundry-fitness-cross-consistency` invariant 6 check
...
the `oya-foundry-fitness-cross-consistency` lane goes BLOCKER.
...
All 68 occurrences trigger `oya-foundry-fitness-doc-link-resolves` (BLOCKER
...
`oya-foundry-fitness-doc-link-resolves` frontmatter validation entirely.
...
None of these six are parseable by `oya-foundry-fitness-doc-rigor`. The CI
...
`oya-foundry-fitness-cross-consistency` invariant 6 check requires canonical
...
|---|---|---|---|
| `oya-foundry-fitness-doc-rigor` | ADVISORY (warnings only) | 2026-07-16 | PRD line floor, story count, §A–§J presence, ARCHITECTURE.md anchor count, compliance.md anchor count, manifest field presence |
| `oya-foundry-fitness-doc-link-resolves` | ADVISORY (warnings only) | 2026-07-16 | placeholder markers occurrences, dead cross-references, missing frontmatter fields |
| `oya-foundry-fitness-cross-consistency` | ADVISORY (warnings only) | 2026-07-16 | Invariants 1–10 from §3.2.2 |
| `oya-foundry-fitness-doc-coverage` | ADVISORY (warnings only) | 2026-07-16 | Per-µservice doc suite completeness (all 4 file classes present) |
