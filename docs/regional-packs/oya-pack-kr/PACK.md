...
- **Tax-engine adapter:** `oya-platform-billing-tax-kr-app` (in-pack impl of `TaxInvoiceFormatter`)

## 7. Identity providers

| Provider | Use case | Implementing trait impl |
|---|---|---|
| 본인확인서비스 (KISA-designated) | Real-name verification (CI/DI 88-byte/64-byte hashes) | `oya-platform-identity-kr-bonin-app` |
...
- **Address-validation impl:** `oya-platform-address-kr-app`
