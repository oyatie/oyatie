...
- [ ] **Governance-lanes disposition** — do `buck2 build/test` replace the 99 `oya gate` lanes, or do select lanes run as buck2 test targets? (per oya-cli-retirement-blueprint).
...
## Open Questions
- Governance lanes (99 `oya gate`): retire into buck2 test targets, or keep a thin subset?
