...
- [ ] **Governance-lanes disposition** — do `buck2 build/test` replace the 99 `oya gate` lanes, or do select lanes run as buck2 test targets? (per cli-retirement-blueprint).
