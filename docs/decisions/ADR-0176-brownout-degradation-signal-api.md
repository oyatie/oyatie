...
is made executable by the following PR-local artifacts (homed under the `comms`
capability per ADR-0562 §10.16 messenger move, enforced by the
...
- `comms/messenger/chaos/scenarios/pod-kill.yaml` — chaos scenario backing the contract (per ADR-0165 chaos-engineering substrate).
- `comms/messenger/chaos/scenarios/network-delay-100ms.yaml` — chaos scenario backing the contract (ADR-0165).
- `comms/messenger/chaos/scenarios/dependency-failure.yaml` — chaos scenario backing the contract (ADR-0165).
- `comms/messenger/chaos/scenarios/disk-slow-1000ms.yaml` — chaos scenario backing the contract (ADR-0165).
