...
capability owner (ADR-0562 capability-registry: `data` maps to the `data` capability,
...
record is minted: the direct adapter peer `data-sql-adapter-sqlx` carries none (the gate-tool
