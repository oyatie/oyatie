...
**Accepted topic-apex ADRs live here, plus any GATED PROPOSED apex.** Historical and rejected proposals remain recoverable from git history rather than occupying the live authority surface. All historical ADRs (former Accepted members, Superseded, Rejected) are in [`docs/adr-archive/`](../adr-archive/).
