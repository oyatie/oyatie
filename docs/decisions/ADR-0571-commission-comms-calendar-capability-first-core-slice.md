...
# ADR-0571: Commission the comms calendar capability-first slice
...
ADR-0571` from the paths named below), owned by `comms/OWNERS` / `registry/catalog/OWNERS` /
...
maps each tracked path mentioned here to `ADR-0571`):
