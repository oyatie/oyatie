...
inbound_citations:
  ...
  - /Users/jasonlee/oyatie/docs/decisions/ADR-0132-no-suite-policy-and-flat-microservice-layout.md
...
- Anchor 2: ADR-0132 (no-suite policy + governance prefix) — declaration of the canonical governance prefix.
...
- ADR-0132 (no-suite policy + governance prefix) — amended; per-lane IP cadence replaced by bulk-rename cadence.
