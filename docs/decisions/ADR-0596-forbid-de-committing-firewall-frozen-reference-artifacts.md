...
**Superseded by [ADR-0614](ADR-0614-de-commit-firewall-frozen-reference-baseline.md) - 2026-07-09.**
ADR-0614 keeps the #828 deadlock class IMPOSSIBLE but INVERTS the mechanism: instead of forbidding
...
frozen-reference baseline must stay committed; ADR-0614 is the deliberate one-way reversal to the
