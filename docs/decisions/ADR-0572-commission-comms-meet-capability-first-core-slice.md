...
# ADR-0572: Commission the comms meet capability-first core slice
...
THIS ADR (the producer derives `justification_ref: ADR-0572` from the paths named below), owned by
...
maps each tracked path mentioned here to `ADR-0572`):
