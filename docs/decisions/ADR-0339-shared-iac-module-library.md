...
IAC-001 materializes the first fixture slice under the repo-current `cloud/cloud-iac/modules/` home while preserving this ADR's shared-module/thin-wrapper shape and non-runtime claim ceiling. The fixture-owned surfaces are `cloud/cloud-billing/iac/aws-guest/OWNERS`, `cloud/cloud-billing/iac/aws-guest/main.tf`, `cloud/cloud-iac/modules/OWNERS`, `cloud/cloud-iac/modules/catalog.json`, `cloud/cloud-iac/modules/aws-guest/sg-baseline/README.md`, `cloud/cloud-iac/modules/aws-guest/sg-baseline/cosign-attestation.json`, `cloud/cloud-iac/modules/aws-guest/sg-baseline/main.tofu`, `cloud/cloud-iac/modules/aws-guest/sg-baseline/outputs.tofu`, `cloud/cloud-iac/modules/aws-guest/sg-baseline/variables.tofu`, and `cloud/cloud-iac/modules/aws-guest/sg-baseline/versions.tofu`.
