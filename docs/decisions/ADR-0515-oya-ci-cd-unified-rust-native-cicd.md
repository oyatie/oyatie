...
---
*Accepted 2026-06-06 (founder-ruled; door:one-way). Authority: D-CICD / D3 / D-LAYER / D-SCOPE-UNIFY / D-PURESPLIT / D-SEQUENCE / D-DOCTRINE. Design SSOT: `bespoke-ci-design-2026-06-06/40-PRODUCT-SPEC.md` (relocate into source/docs/research/ in Phase-1, A-STRUCT). Reciprocal `superseded_by` edges written on 0124/0349/0359/0361/0511/0513/0514; 0408 `depends_on`.*
