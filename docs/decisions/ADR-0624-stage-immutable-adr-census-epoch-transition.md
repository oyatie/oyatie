...
related_specs: [/registry/adr-census-epoch/control-plane.json, /specs/adr-census-epoch-control-plane.schema.json, /specs/adr-census-epoch-receipt.schema.json]
milestone: W0
---
