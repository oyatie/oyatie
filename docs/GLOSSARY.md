...
Per ADR-0015: `oya-<context>-<role>[-<capability>]`. Roles: `kernel`, `domain`, `app`, `api`, `worker`, `adapter`, `runtime`. Examples: `oya-platform-tenant-kernel`, `oya-foundry-policy-app`, `oya-cloud-iam-api`.
