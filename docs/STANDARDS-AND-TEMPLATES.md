...
|---|---|---|---|---|
| Pull request | [`templates/pull-request-template.md`](templates/pull-request-template.md) | Every PR | Issue / Summary / Verification / Traceability / Evidence plus `## Code Review` evidence | PR-shape validation + Prow/Kubernetes-native `oya-ci-required`; GitHub Actions is shadow compatibility |
