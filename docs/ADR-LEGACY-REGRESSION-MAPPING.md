...
| ADR-0201 | Native phone/tablet CI quality bar (Android Compose + iOS SwiftUI) | Proposed | native mobile CI quality bar | ADR-0051 mobile-and-native-client-strategy | FULL | Mobile native CI quality bar `governance-mobile-native` defined in ADR-0051 §7 (crash-free %, p99 cold-start, accessibility audit, per-pack store-policy validator, capability-invocation parity vs web, SBOM gate per ADR-0039) |
