...
| New OG property tier approved without council sign-off | Catastrophic | `oya-foundry-fitness-data-use-boundary` CI gate blocks merges without data-class annotation |
