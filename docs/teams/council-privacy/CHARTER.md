...
| New OG property tier approved without council sign-off | Catastrophic | Planned advisory lane `oya-foundry-fitness-data-use-boundary` records merge-readiness gaps until the CI gate exists |
