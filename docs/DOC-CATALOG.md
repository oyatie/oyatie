...
| `doc.prd_workflow` | `/specs/products/workflow.json` | `council-architecture + axis-foundry` | workflow PRD change (engine half of ecosystem-backbone pair) | per event | workflow-studio PRD, ontology PRD, contracts/workflow_spec.v1.json | `spec-contract-mirror`, `authority-cohesion` | NO |
| `doc.prd_workflow_studio` | `/specs/products/workflow-studio.json` | `council-design-system + workflow-team` | workflow-studio PRD change (visual editor + DSL half) | per event | workflow PRD, design-system specs | `spec-contract-mirror`, `authority-cohesion` | NO |
| `doc.prd_ontology` | `/specs/products/ontology.json` | `council-architecture + ontology-team` | ontology+KG PRD change (typed-entity backbone + 3-layer runtime) | per event | knowledge-graph specs, Bominal-ADR-0106/0107/0133 | `spec-contract-mirror`, `authority-cohesion` | NO |
