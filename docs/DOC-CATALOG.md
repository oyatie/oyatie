...
| `doc.agents_operating_contract` | `AGENTS-OPERATING-CONTRACT.md` | `axis-foundry` + `council-architecture` | agent operating-contract doctrine reference change, PHASE-5 operating-contract promotion change | quarterly | AGENTS.md, agent-operating-contract.json | `doc-catalog-self-coverage`, `readme-doc-coverage` | NO |
