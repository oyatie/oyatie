...
| `doc.agents_operating_contract_refs` | `AGENTS-OPERATING-CONTRACT.md` | `axis-foundry` + `council-architecture` | Wave 15-ZF operating-contract doctrine propagation | per ADR-0346..ADR-0515 doctrine update | AGENTS.md | `doc-catalog-self-coverage`, `authority-cohesion` | NO |
