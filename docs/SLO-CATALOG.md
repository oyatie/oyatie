...
Each surface has a `slo:` field in its catalog record (`registry/catalog/<crate>.yaml`). This doc is generated from the catalog. CI lane `oya-governance-slo-coverage` checks every public surface has a row.
