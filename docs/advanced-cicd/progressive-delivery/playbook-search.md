...
1. **Dark-launch.** 100% mirror of production query traffic; new ranker produces shadow rankings; `oya-foundry-shadow-diff-kernel` diffs top-10 overlap + per-position position-bias-corrected delta.
