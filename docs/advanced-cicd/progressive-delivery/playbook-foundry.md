...
Foundry capability publishes through `intelligence-capability-kernel` + `intelligence-mcp-gateway-kernel` ([ADR-0021](../../../docs/decisions/ADR-0700-ci-admission-live-apex.md)).
