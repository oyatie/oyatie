...
| `staging` | `staging` (Layer 3) | dev-tier + staging-tier consumers + canary cohort | `evidence: pass` (full replay; eval-harness green per [ADR-0024](../../../docs/decisions/ADR-0024-foundry-eval-harness-and-replay.md)) | `staging-promoter` agent (autonomous) |
...
Per [ADR-0024](../../../docs/decisions/ADR-0024-foundry-eval-harness-and-replay.md), every capability has an eval-set. The eval-harness runs:
...
- Capability registry implementation — owned by [ADR-0021](../../../docs/decisions/ADR-0021-foundry-capability-registry-and-mcp-gateway.md).
- Eval-harness — owned by [ADR-0024](../../../docs/decisions/ADR-0024-foundry-eval-harness-and-replay.md).
