...
- ADR-0347 binds Workplace Integration authoring to the `oya-governance-*` lane vocabulary after the `oya-foundry-fitness-*` bulk rename. Enforced-by cross-reference: `oya-governance-no-foundry-fitness-residue`, `oya-governance-lane-prefix-vocabulary`, `oya-governance-rename-inventory-presence`.
