...
- `product-control/capabilities/workflow.agent.invoke.yaml` (existing capability YAML pattern)
- `product-control/metering/evt_01JTP8K7FND7YAGENT00000100.yaml` (metering event pattern)
