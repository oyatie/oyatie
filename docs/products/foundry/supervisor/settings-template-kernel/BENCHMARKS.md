...
```bash
cargo bench -p oya-foundry-settings-template-kernel -- load_template
...
```bash
cargo bench -p oya-foundry-settings-template-kernel -- template_clone
...
```bash
cargo bench -p oya-foundry-settings-template-kernel -- verify_latency
...
- **Benchmarks:** `crates/oya-foundry-settings-template-kernel/benches/`
