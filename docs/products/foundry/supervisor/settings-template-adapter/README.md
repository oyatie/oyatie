...
**Renamed:** `intelligence-settings-template-adapter-fs` → `intelligence-settings-template-adapter` (v6 PRE-1)
...
- **Kernel API:** `crates/intelligence-settings-template-kernel/src/lib.rs`
