...
```bash
cargo bench -p oya-foundry-settings-template-adapter -- claude_render
...
```bash
cargo bench -p oya-foundry-settings-template-adapter -- codex_render
...
```bash
cargo bench -p oya-foundry-settings-template-adapter -- gemini_render
...
```bash
cargo bench -p oya-foundry-settings-template-adapter -- verify_latency
...
- **Benchmarks:** `crates/oya-foundry-settings-template-adapter/benches/`
