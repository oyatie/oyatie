...
cargo bench -p oya-foundry-jsonl-supervisor-adapter -- peek_lock_latency

# Profile with flamegraph
cargo flamegraph -p oya-foundry-jsonl-supervisor-adapter --bench jsonl_ops
```
...
- **Benchmarks:** `crates/oya-foundry-jsonl-supervisor-adapter/benches/`
