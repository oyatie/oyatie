...
5. Never hand-edit generated projections. Materialize with the sanctioned Buck target or `infra/ci/materialize-pipeline-generated-faces.sh`, commit PR-owned generated deltas separately, and run face-settle `--verify` last before every push. Controller-owned faces are not contributor-authored.
