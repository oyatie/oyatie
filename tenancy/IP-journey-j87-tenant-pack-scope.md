...
- Surface evidence: `tenancy/IP-journey-j87-tenant-pack-scope.md` matched `openapi, asyncapi, .proto`; contract files `tenancy/contracts/openapi/tenancy.yaml, tenancy/contracts/asyncapi/tenant-events.yaml, tenancy/contracts/proto/tenancy.proto`; type anchor `crates/oya-tenancy-api/src/lib.rs::TenantCreateApiRequest`.
