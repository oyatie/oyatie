...
- Surface evidence: `microservices/tenancy/IP-journey-j99-multi-pack-conflict-resolution.md` matched `finops, emission`; anchors `microservices/tenancy/manifest.json, crates/tenancy-api/src/lib.rs`; type anchor `crates/tenancy-api/src/lib.rs::TenantCreateApiRequest`.
