...
- `cargo run -p dev-cli -- gate validate compliance-evidence-recency --microservice tenancy` — exit 0.
- `cargo run -p dev-cli -- gate validate authority-cohesion` — exit 0; HG-TEN registered.
...
- Inventory artifacts: `microservices/tenancy/catalog/tenancy-cell-assignment-adapter-citus.yaml`, `microservices/tenancy/catalog/tenancy-dr-pairing-usecase.yaml`, `microservices/tenancy/catalog/tenancy-kyb-kyc-verifier-domain.yaml`, `microservices/tenancy/catalog/tenancy-lifecycle-locks-kernel.yaml`, `microservices/tenancy/catalog/tenancy-per-tenant-quota-usecase.yaml`, `microservices/tenancy/catalog/tenancy-reserved-namespace-usecase.yaml`; +21 more.
