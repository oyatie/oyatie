...
- Surface evidence: `tenancy/IP-journey-j50-sub-tenant-helper-scope.md` matched `financial, payment`; anchors `tenancy/runbooks/dr-pair-promotion-drill.md, crates/oya-tenancy-api/src/lib.rs`; type anchor `crates/oya-tenancy-api/src/lib.rs::TenantCreateApiRequest`.
