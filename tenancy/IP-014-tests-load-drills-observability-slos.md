...
- Surface evidence: `tenancy/IP-014-tests-load-drills-observability-slos.md` matched `p99, SLO`; anchors `tenancy/runbooks/dr-pair-promotion-drill.md, crates/oya-tenancy-api/src/lib.rs`; type anchor `crates/oya-tenancy-api/src/lib.rs::TenantCreateApiRequest`.
