...
## Resolution Steps
1. Identify code owner path: `rg "tenant_isolation_breach_response|TenancyTenantIsolationBreachResponseCritical|tenancy.tenant_isolation_breach_response.incident_state" crates microservices/tenancy -g "!tenancy/runbooks/**"`.
...
8. Add SLO assertion: `update tenancy/observability/slos/* with alert TenancyTenantIsolationBreachResponseCritical when this was a missing alert`.
