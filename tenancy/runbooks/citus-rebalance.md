...
23. Check catalog components: `find tenancy/catalog -maxdepth 1 -type f | sort | rg "tenancy|citus"`.
...
15. Protect evidence: `oya evidence freeze --incident $INCIDENT_ID --paths tenancy/runbooks/citus-rebalance.md,evidence/incidents/$INCIDENT_ID.json`.
...
## Resolution Steps
1. Identify code owner path: `rg "citus_rebalance|TenancyCitusRebalanceCritical|tenancy.citus_rebalance.incident_state" crates microservices/tenancy -g "!tenancy/runbooks/**"`.
...
8. Add SLO assertion: `update tenancy/observability/slos/* with alert TenancyCitusRebalanceCritical when this was a missing alert`.
9. Add dashboard panel: `update tenancy/dashboards/rls-enforcement.json with oya_tenancy_citus_rebalance_error_ratio, oya_tenancy_citus_rebalance_lag_seconds, and oya_tenancy_citus_rebalance_queue_depth`.
