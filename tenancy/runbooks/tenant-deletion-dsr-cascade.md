...
15. Protect evidence: `oya evidence freeze --incident $INCIDENT_ID --paths tenancy/runbooks/tenant-deletion-dsr-cascade.md,evidence/incidents/$INCIDENT_ID.json`.
...
## Resolution Steps
1. Identify code owner path: `rg "tenant_deletion_dsr_cascade|TenancyTenantDeletionDsrCascadeCritical|tenancy.tenant_deletion_dsr_cascade.incident_state" crates microservices/tenancy -g "!tenancy/runbooks/**"`.
...
8. Add SLO assertion: `update tenancy/observability/slos/* with alert TenancyTenantDeletionDsrCascadeCritical when this was a missing alert`.
9. Add dashboard panel: `update tenancy/dashboards/dr-pairing-state.json with oya_tenancy_tenant_deletion_dsr_cascade_error_ratio, oya_tenancy_tenant_deletion_dsr_cascade_lag_seconds, and oya_tenancy_tenant_deletion_dsr_cascade_queue_depth`.
