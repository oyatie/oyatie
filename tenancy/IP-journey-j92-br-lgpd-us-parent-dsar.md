...
tenancy owns tenant scope, pack activation state, and audience-type boundaries for j92-br-lgpd-dsar-with-us-parent. The slice is a flat per-microservice implementation plan under tenancy/, matching ADR-0131.
