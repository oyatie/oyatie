...
- Surface evidence: `microservices/tenancy/IP-011-audit-chain-integration.md` matched `p99, SLO`; anchors `microservices/tenancy/runbooks/dr-pair-promotion-drill.md, crates/oya-tenancy-api/src/lib.rs`; type anchor `crates/oya-tenancy-api/src/lib.rs::TenantCreateApiRequest`.
