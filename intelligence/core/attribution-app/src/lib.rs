...
//! - [`intelligence_attribution_usecase`] — idempotent intent caching +
//!   audit-event metadata for requested/rendered/denied/conflict paths.
//! - [`intelligence_attribution_worker`] — job-lifecycle / retry
//!   progression with renderer transport dispatch.
//! - [`intelligence_attribution_adapter`] — citation-renderer envelope
...
pub use intelligence_attribution_worker::{
