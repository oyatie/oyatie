...
pub use vocabulary::{
    ...
    KNOWN_DECLARATION_KINDS, KNOWN_FLAGS, KNOWN_MEMBER_KINDS, PRODUCER_BOOTSTRAP_GO,
    PRODUCER_OWNED_RUST, SCHEMA_VERSION_DECLARATIONS, SCHEMA_VERSION_IDENTITY_ONLY,
};
