...
pub use vocabulary::{
    KNOWN_DECLARATION_KINDS, KNOWN_MEMBER_KINDS, KNOWN_TYPE_KINDS, PRODUCER_BOOTSTRAP_GO,
    PRODUCER_OWNED_RUST, SCHEMA_VERSION_DECLARATIONS, SCHEMA_VERSION_FLAT_TYPES,
    SCHEMA_VERSION_IDENTITY_ONLY,
};
pub use vocabulary_facts::{
    ATTR_GO_NODE, ATTR_INTERFACE, ATTR_LIT_KIND, ATTR_OP, ATTR_REF, ATTR_VALUE, KNOWN_ATTR_KEYS,
    KNOWN_FLAGS,
};
