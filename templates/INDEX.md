...
|---|---|---|---|---|---|
| CHK-DONE | `done-definition-checklist.md` | Extends `docs/AGENTS.md` D1-D18 with per-change-class variants. | `docs/checklists/done-definition.md` | `platform-governance` + `council-architecture` | `oya-ci-required` + per-lane CI status |
