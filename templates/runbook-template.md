...
- Sev-1: postmortem required within 30 days (per `/templates/postmortem-template.md`).
...
- [ ] Postmortem authored per `/templates/postmortem-template.md`.
- [ ] `docs/MISTAKES-LEDGER.md` row added if a new mechanical prevention is identified (per `/templates/mistakes-ledger-row-template.md`).
